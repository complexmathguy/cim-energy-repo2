...
public class ControlAggregate {  
    ...
    public void handle(UpdateControlCommand command) throws Exception {
    	...
    	UpdateControlEvent event = new UpdateControlEvent(command.getControlId(), command.getControlType(), command.getOperationInProgress(), command.getTimeStamp(), command.getUnitMultiplier(), command.getUnitSymbol(), command.getPowerSystemResource());        
    ...
    @CommandHandler
    public void handle(AssignPowerSystemResourceToControlCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignPowerSystemResourceToControlCommand" );
        ...
        apply(new AssignPowerSystemResourceToControlEvent(command.getControlId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignPowerSystemResourceFromControlCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignPowerSystemResourceFromControlCommand" );

    	if (  powerSystemResource == null )
    		throw new ProcessingException( "PowerSystemResource already has nothing assigned." );  

    	apply(new UnAssignPowerSystemResourceFromControlEvent(command.getControlId()));
    }
	...
	// single associations
    @EventSourcingHandler
    void on(AssignPowerSystemResourceToControlEvent event ) {	
    	LOGGER.info( "Event sourcing AssignPowerSystemResourceToControlEvent" );
    	this.powerSystemResource = event.getAssignment();
    }

	@EventSourcingHandler
	void on(UnAssignPowerSystemResourceFromControlEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignPowerSystemResourceFromControlEvent" );
