...
public class SynchronousMachineAggregate {  
    ...
    @CommandHandler
    public void handle(AssignInitialReactiveCapabilityCurveToSynchronousMachineCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignInitialReactiveCapabilityCurveToSynchronousMachineCommand" );
    	
    	if (  initialReactiveCapabilityCurve != null && initialReactiveCapabilityCurve.getReactiveCapabilityCurveId() == command.getAssignment().getReactiveCapabilityCurveId() )
    		throw new ProcessingException( "InitialReactiveCapabilityCurve already assigned with id " + command.getAssignment().getReactiveCapabilityCurveId() );  
    		
        apply(new AssignInitialReactiveCapabilityCurveToSynchronousMachineEvent(command.getSynchronousMachineId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignInitialReactiveCapabilityCurveFromSynchronousMachineCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignInitialReactiveCapabilityCurveFromSynchronousMachineCommand" );

    	if (  initialReactiveCapabilityCurve == null )
    		throw new ProcessingException( "InitialReactiveCapabilityCurve already has nothing assigned." );  

    	apply(new UnAssignInitialReactiveCapabilityCurveFromSynchronousMachineEvent(command.getSynchronousMachineId()));
    }
    ...
    void on(UpdateSynchronousMachineEvent event) {
        ...
        this.x0 = event.getX0();
        this.x2 = event.getX2();
        this.initialReactiveCapabilityCurve = event.getInitialReactiveCapabilityCurve();
    }   
	...
	// single associations
    @EventSourcingHandler
    void on(AssignInitialReactiveCapabilityCurveToSynchronousMachineEvent event ) {	
    	LOGGER.info( "Event sourcing AssignInitialReactiveCapabilityCurveToSynchronousMachineEvent" );
    	this.initialReactiveCapabilityCurve = event.getAssignment();
    }

	@EventSourcingHandler
	void on(UnAssignInitialReactiveCapabilityCurveFromSynchronousMachineEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignInitialReactiveCapabilityCurveFromSynchronousMachineEvent" );
    ...
    private PU x0 = null;
    private PU x2 = null;
    private ReactiveCapabilityCurve initialReactiveCapabilityCurve = null;
    private SynchronousMachineDynamics synchronousMachine = null;
