...
public class PositionPointAggregate {  
    ...
    public void handle(UpdatePositionPointCommand command) throws Exception {
    	...
    	UpdatePositionPointEvent event = new UpdatePositionPointEvent(command.getPositionPointId(), command.getSequenceNumber(), command.getXPosition(), command.getYPosition(), command.getZPosition(), command.getLocation());        
    ...
    @CommandHandler
    public void handle(AssignLocationToPositionPointCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignLocationToPositionPointCommand" );
        ...
        apply(new AssignLocationToPositionPointEvent(command.getPositionPointId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignLocationFromPositionPointCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignLocationFromPositionPointCommand" );

    	if (  location == null )
    		throw new ProcessingException( "Location already has nothing assigned." );  

    	apply(new UnAssignLocationFromPositionPointEvent(command.getPositionPointId()));
    }
	...
	// single associations
    @EventSourcingHandler
    void on(AssignLocationToPositionPointEvent event ) {	
    	LOGGER.info( "Event sourcing AssignLocationToPositionPointEvent" );
    	this.location = event.getAssignment();
    }

	@EventSourcingHandler
	void on(UnAssignLocationFromPositionPointEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignLocationFromPositionPointEvent" );
		this.location = null;
	}
