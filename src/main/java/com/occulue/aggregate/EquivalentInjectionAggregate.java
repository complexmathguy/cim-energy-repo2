...
public class EquivalentInjectionAggregate {  
    ...
    @CommandHandler
    public void handle(AssignReactiveCapabilityCurveToEquivalentInjectionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignReactiveCapabilityCurveToEquivalentInjectionCommand" );
    	
    	if (  reactiveCapabilityCurve != null && reactiveCapabilityCurve.getReactiveCapabilityCurveId() == command.getAssignment().getReactiveCapabilityCurveId() )
    		throw new ProcessingException( "ReactiveCapabilityCurve already assigned with id " + command.getAssignment().getReactiveCapabilityCurveId() );  
    		
        apply(new AssignReactiveCapabilityCurveToEquivalentInjectionEvent(command.getEquivalentInjectionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignReactiveCapabilityCurveFromEquivalentInjectionCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignReactiveCapabilityCurveFromEquivalentInjectionCommand" );

    	if (  reactiveCapabilityCurve == null )
    		throw new ProcessingException( "ReactiveCapabilityCurve already has nothing assigned." );  

    	apply(new UnAssignReactiveCapabilityCurveFromEquivalentInjectionEvent(command.getEquivalentInjectionId()));
    }
    ...
    void on(UpdateEquivalentInjectionEvent event) {
        ...
        this.x0 = event.getX0();
        this.x2 = event.getX2();
        this.reactiveCapabilityCurve = event.getReactiveCapabilityCurve();
    }   
	...
	// single associations
    @EventSourcingHandler
    void on(AssignReactiveCapabilityCurveToEquivalentInjectionEvent event ) {	
    	LOGGER.info( "Event sourcing AssignReactiveCapabilityCurveToEquivalentInjectionEvent" );
    	this.reactiveCapabilityCurve = event.getAssignment();
    }

	@EventSourcingHandler
	void on(UnAssignReactiveCapabilityCurveFromEquivalentInjectionEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignReactiveCapabilityCurveFromEquivalentInjectionEvent" );
