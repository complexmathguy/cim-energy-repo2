...
public class LoadStaticAggregate {  
    ...
    @CommandHandler
    public void handle(AssignLoadAggregateToLoadStaticCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignLoadAggregateToLoadStaticCommand" );
        ...
        apply(new AssignLoadAggregateToLoadStaticEvent(command.getLoadStaticId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignLoadAggregateFromLoadStaticCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignLoadAggregateFromLoadStaticCommand" );

    	if (  loadAggregate == null )
    		throw new ProcessingException( "LoadAggregate already has nothing assigned." );  

    	apply(new UnAssignLoadAggregateFromLoadStaticEvent(command.getLoadStaticId()));
    }
	...
	// single associations
    @EventSourcingHandler
    void on(AssignLoadAggregateToLoadStaticEvent event ) {	
    	LOGGER.info( "Event sourcing AssignLoadAggregateToLoadStaticEvent" );
    	this.loadAggregate = event.getAssignment();
    }

	@EventSourcingHandler
	void on(UnAssignLoadAggregateFromLoadStaticEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignLoadAggregateFromLoadStaticEvent" );
