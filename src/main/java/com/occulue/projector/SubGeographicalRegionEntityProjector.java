...
public class SubGeographicalRegionEntityProjector {
     ...
     * 
     * @param	parentId	UUID
     * @param	assignment 	GeographicalRegion 
     * @return	SubGeographicalRegion
     */
    public SubGeographicalRegion assignRegion( UUID parentId, GeographicalRegion assignment ) {
	    LOGGER.info("assigning Region as " + assignment.toString() );

	    SubGeographicalRegion parentEntity = repository.findById( parentId ).get();
	    assignment = GeographicalRegionProjector.find(assignment.getGeographicalRegionId());
	 ...
	 * @return	SubGeographicalRegion
	 */
	public SubGeographicalRegion unAssignRegion( UUID parentId ) {
		SubGeographicalRegion parentEntity = repository.findById(parentId).get();
    ...
    @Autowired
	@Qualifier(value = "geographicalRegion-entity-projector")
	GeographicalRegionEntityProjector GeographicalRegionProjector;
