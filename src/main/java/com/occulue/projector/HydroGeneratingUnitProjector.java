...
public class HydroGeneratingUnitProjector extends HydroGeneratingUnitEntityProjector {
    ...
    /*
     * @param	event AssignHydroPowerPlantToHydroGeneratingUnitEvent
     */
    @EventHandler( payloadType=AssignHydroPowerPlantToHydroGeneratingUnitEvent.class)
    public void handle( AssignHydroPowerPlantToHydroGeneratingUnitEvent event) {
	    LOGGER.info("handling AssignHydroPowerPlantToHydroGeneratingUnitEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    HydroGeneratingUnit entity = assignHydroPowerPlant( event.getHydroGeneratingUnitId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignHydroPowerPlantFromHydroGeneratingUnitEvent
	 */
	@EventHandler( payloadType=UnAssignHydroPowerPlantFromHydroGeneratingUnitEvent.class)
	public void handle( UnAssignHydroPowerPlantFromHydroGeneratingUnitEvent event) {
	    LOGGER.info("handling UnAssignHydroPowerPlantFromHydroGeneratingUnitEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    HydroGeneratingUnit entity = unAssignHydroPowerPlant( event.getHydroGeneratingUnitId() );
