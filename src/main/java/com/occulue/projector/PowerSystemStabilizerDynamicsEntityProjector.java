...
public class PowerSystemStabilizerDynamicsEntityProjector {
     ...
     */
    public PowerSystemStabilizerDynamics assignExcitationSystemDynamics( UUID parentId, ExcitationSystemDynamics assignment ) {
	 ...
	 * @return	PowerSystemStabilizerDynamics
	 */
	public PowerSystemStabilizerDynamics unAssignExcitationSystemDynamics( UUID parentId ) {
		PowerSystemStabilizerDynamics parentEntity = repository.findById(parentId).get();
