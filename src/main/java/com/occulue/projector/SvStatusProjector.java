...
public class SvStatusProjector extends SvStatusEntityProjector {
    ...
    public void handle( UpdateSvStatusEvent event) {
        ...
        entity.setConductingEquipment( event.getConductingEquipment() );
    ...
    /*
     * @param	event AssignConductingEquipmentToSvStatusEvent
     */
    @EventHandler( payloadType=AssignConductingEquipmentToSvStatusEvent.class)
    public void handle( AssignConductingEquipmentToSvStatusEvent event) {
	    LOGGER.info("handling AssignConductingEquipmentToSvStatusEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SvStatus entity = assignConductingEquipment( event.getSvStatusId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignConductingEquipmentFromSvStatusEvent
	 */
	@EventHandler( payloadType=UnAssignConductingEquipmentFromSvStatusEvent.class)
	public void handle( UnAssignConductingEquipmentFromSvStatusEvent event) {
	    LOGGER.info("handling UnAssignConductingEquipmentFromSvStatusEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SvStatus entity = unAssignConductingEquipment( event.getSvStatusId() );
