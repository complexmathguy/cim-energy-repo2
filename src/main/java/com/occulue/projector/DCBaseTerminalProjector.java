...
public class DCBaseTerminalProjector extends DCBaseTerminalEntityProjector {
    ...
    public void handle( UpdateDCBaseTerminalEvent event) {
	    ...
	    DCBaseTerminal entity = new DCBaseTerminal();
        entity.setDCBaseTerminalId( event.getDCBaseTerminalId() );
        entity.setDCNode( event.getDCNode() );
    ...
    /*
     * @param	event AssignDCNodeToDCBaseTerminalEvent
     */
    @EventHandler( payloadType=AssignDCNodeToDCBaseTerminalEvent.class)
    public void handle( AssignDCNodeToDCBaseTerminalEvent event) {
	    LOGGER.info("handling AssignDCNodeToDCBaseTerminalEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    DCBaseTerminal entity = assignDCNode( event.getDCBaseTerminalId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignDCNodeFromDCBaseTerminalEvent
	 */
	@EventHandler( payloadType=UnAssignDCNodeFromDCBaseTerminalEvent.class)
	public void handle( UnAssignDCNodeFromDCBaseTerminalEvent event) {
	    LOGGER.info("handling UnAssignDCNodeFromDCBaseTerminalEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    DCBaseTerminal entity = unAssignDCNode( event.getDCBaseTerminalId() );
