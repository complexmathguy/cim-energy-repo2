...
public class RotatingMachineProjector extends RotatingMachineEntityProjector {
    ...
    /*
     * @param	event AssignGeneratingUnitToRotatingMachineEvent
     */
    @EventHandler( payloadType=AssignGeneratingUnitToRotatingMachineEvent.class)
    public void handle( AssignGeneratingUnitToRotatingMachineEvent event) {
	    LOGGER.info("handling AssignGeneratingUnitToRotatingMachineEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    RotatingMachine entity = assignGeneratingUnit( event.getRotatingMachineId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignGeneratingUnitFromRotatingMachineEvent
	 */
	@EventHandler( payloadType=UnAssignGeneratingUnitFromRotatingMachineEvent.class)
	public void handle( UnAssignGeneratingUnitFromRotatingMachineEvent event) {
	    LOGGER.info("handling UnAssignGeneratingUnitFromRotatingMachineEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    RotatingMachine entity = unAssignGeneratingUnit( event.getRotatingMachineId() );
