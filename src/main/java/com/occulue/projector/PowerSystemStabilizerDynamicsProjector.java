...
public class PowerSystemStabilizerDynamicsProjector extends PowerSystemStabilizerDynamicsEntityProjector {
    ...
    /*
     * @param	event AssignExcitationSystemDynamicsToPowerSystemStabilizerDynamicsEvent
     */
    @EventHandler( payloadType=AssignExcitationSystemDynamicsToPowerSystemStabilizerDynamicsEvent.class)
    public void handle( AssignExcitationSystemDynamicsToPowerSystemStabilizerDynamicsEvent event) {
	    LOGGER.info("handling AssignExcitationSystemDynamicsToPowerSystemStabilizerDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    PowerSystemStabilizerDynamics entity = assignExcitationSystemDynamics( event.getPowerSystemStabilizerDynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignExcitationSystemDynamicsFromPowerSystemStabilizerDynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignExcitationSystemDynamicsFromPowerSystemStabilizerDynamicsEvent.class)
	public void handle( UnAssignExcitationSystemDynamicsFromPowerSystemStabilizerDynamicsEvent event) {
	    LOGGER.info("handling UnAssignExcitationSystemDynamicsFromPowerSystemStabilizerDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    PowerSystemStabilizerDynamics entity = unAssignExcitationSystemDynamics( event.getPowerSystemStabilizerDynamicsId() );
