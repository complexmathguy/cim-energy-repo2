...
public class RegulatingCondEqProjector extends RegulatingCondEqEntityProjector {
    ...
    /*
     * @param	event AssignRegulatingControlToRegulatingCondEqEvent
     */
    @EventHandler( payloadType=AssignRegulatingControlToRegulatingCondEqEvent.class)
    public void handle( AssignRegulatingControlToRegulatingCondEqEvent event) {
	    LOGGER.info("handling AssignRegulatingControlToRegulatingCondEqEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    RegulatingCondEq entity = assignRegulatingControl( event.getRegulatingCondEqId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignRegulatingControlFromRegulatingCondEqEvent
	 */
	@EventHandler( payloadType=UnAssignRegulatingControlFromRegulatingCondEqEvent.class)
	public void handle( UnAssignRegulatingControlFromRegulatingCondEqEvent event) {
	    LOGGER.info("handling UnAssignRegulatingControlFromRegulatingCondEqEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    RegulatingCondEq entity = unAssignRegulatingControl( event.getRegulatingCondEqId() );
