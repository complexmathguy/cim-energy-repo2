...
public class PhaseTapChangerTabularProjector extends PhaseTapChangerTabularEntityProjector {
    ...
    /*
     * @param	event AssignPhaseTapChangerTableToPhaseTapChangerTabularEvent
     */
    @EventHandler( payloadType=AssignPhaseTapChangerTableToPhaseTapChangerTabularEvent.class)
    public void handle( AssignPhaseTapChangerTableToPhaseTapChangerTabularEvent event) {
	    LOGGER.info("handling AssignPhaseTapChangerTableToPhaseTapChangerTabularEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    PhaseTapChangerTabular entity = assignPhaseTapChangerTable( event.getPhaseTapChangerTabularId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignPhaseTapChangerTableFromPhaseTapChangerTabularEvent
	 */
	@EventHandler( payloadType=UnAssignPhaseTapChangerTableFromPhaseTapChangerTabularEvent.class)
	public void handle( UnAssignPhaseTapChangerTableFromPhaseTapChangerTabularEvent event) {
	    LOGGER.info("handling UnAssignPhaseTapChangerTableFromPhaseTapChangerTabularEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    PhaseTapChangerTabular entity = unAssignPhaseTapChangerTable( event.getPhaseTapChangerTabularId() );
