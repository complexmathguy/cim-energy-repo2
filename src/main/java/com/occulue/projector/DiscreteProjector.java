...
public class DiscreteProjector extends DiscreteEntityProjector {
    ...
    /*
     * @param	event AssignValueAliasSetToDiscreteEvent
     */
    @EventHandler( payloadType=AssignValueAliasSetToDiscreteEvent.class)
    public void handle( AssignValueAliasSetToDiscreteEvent event) {
	    LOGGER.info("handling AssignValueAliasSetToDiscreteEvent - " + event );
	    
	    // ------------------------------------------
    	// delegate to addTo 
    	// ------------------------------------------ 
	    Discrete entity = addToValueAliasSet(event.getDiscreteId(), event.getAddTo() );
...
/*
 * @param	event RemoveValueAliasSetFromDiscreteEvent
 */
@EventHandler( payloadType=RemoveValueAliasSetFromDiscreteEvent.class)
public void handle( RemoveValueAliasSetFromDiscreteEvent event) {
    LOGGER.info("handling RemoveValueAliasSetFromDiscreteEvent - " + event );

    Discrete entity = removeFromValueAliasSet(event.getDiscreteId(), event.getRemoveFrom() );
