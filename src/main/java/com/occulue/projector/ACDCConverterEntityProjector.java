...
public class ACDCConverterEntityProjector {
    ...
    /*
     * Assign a PccTerminal
     * 
     * @param	parentId	UUID
     * @param	assignment 	Terminal 
     * @return	ACDCConverter
     */
    public ACDCConverter assignPccTerminal( UUID parentId, Terminal assignment ) {
	    LOGGER.info("assigning PccTerminal as " + assignment.toString() );

	    ACDCConverter parentEntity = repository.findById( parentId ).get();
	    assignment = TerminalProjector.find(assignment.getTerminalId());
	    
	    // ------------------------------------------
		// assign the PccTerminal to the parent entity
		// ------------------------------------------ 
	    parentEntity.setPccTerminal( assignment );
	...
	/*
	 * Unassign the PccTerminal
	 * 
	 * @param	parentId		UUID
	 * @return	ACDCConverter
	 */
	public ACDCConverter unAssignPccTerminal( UUID parentId ) {
		ACDCConverter parentEntity = repository.findById(parentId).get();

		LOGGER.info("unAssigning PccTerminal on " + parentEntity.toString() );
		
	    // ------------------------------------------
		// null out the PccTerminal on the parent entithy
		// ------------------------------------------     
	    parentEntity.setPccTerminal(null);
