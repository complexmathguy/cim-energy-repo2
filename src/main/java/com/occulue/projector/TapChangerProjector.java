...
public class TapChangerProjector extends TapChangerEntityProjector {
    ...
    public void handle( UpdateTapChangerEvent event) {
        ...
        entity.setTapChangerControl( event.getTapChangerControl() );
    ...
    /*
     * @param	event AssignTapChangerControlToTapChangerEvent
     */
    @EventHandler( payloadType=AssignTapChangerControlToTapChangerEvent.class)
    public void handle( AssignTapChangerControlToTapChangerEvent event) {
	    LOGGER.info("handling AssignTapChangerControlToTapChangerEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    TapChanger entity = assignTapChangerControl( event.getTapChangerId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignTapChangerControlFromTapChangerEvent
	 */
	@EventHandler( payloadType=UnAssignTapChangerControlFromTapChangerEvent.class)
	public void handle( UnAssignTapChangerControlFromTapChangerEvent event) {
	    LOGGER.info("handling UnAssignTapChangerControlFromTapChangerEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    TapChanger entity = unAssignTapChangerControl( event.getTapChangerId() );
