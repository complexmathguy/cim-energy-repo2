...
public class PFVArControllerType1DynamicsProjector extends PFVArControllerType1DynamicsEntityProjector {
    ...
    /*
     * @param	event AssignExcitationSystemDynamicsToPFVArControllerType1DynamicsEvent
     */
    @EventHandler( payloadType=AssignExcitationSystemDynamicsToPFVArControllerType1DynamicsEvent.class)
    public void handle( AssignExcitationSystemDynamicsToPFVArControllerType1DynamicsEvent event) {
	    LOGGER.info("handling AssignExcitationSystemDynamicsToPFVArControllerType1DynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArControllerType1Dynamics entity = assignExcitationSystemDynamics( event.getPFVArControllerType1DynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignExcitationSystemDynamicsFromPFVArControllerType1DynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignExcitationSystemDynamicsFromPFVArControllerType1DynamicsEvent.class)
	public void handle( UnAssignExcitationSystemDynamicsFromPFVArControllerType1DynamicsEvent event) {
	    LOGGER.info("handling UnAssignExcitationSystemDynamicsFromPFVArControllerType1DynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    PFVArControllerType1Dynamics entity = unAssignExcitationSystemDynamics( event.getPFVArControllerType1DynamicsId() );
