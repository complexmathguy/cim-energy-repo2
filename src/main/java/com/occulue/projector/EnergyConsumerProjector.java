...
public class EnergyConsumerProjector extends EnergyConsumerEntityProjector {
    ...
    public void handle( UpdateEnergyConsumerEvent event) {
        ...
        entity.setLoadResponse( event.getLoadResponse() );
    ...
    /*
     * @param	event AssignLoadResponseToEnergyConsumerEvent
     */
    @EventHandler( payloadType=AssignLoadResponseToEnergyConsumerEvent.class)
    public void handle( AssignLoadResponseToEnergyConsumerEvent event) {
	    LOGGER.info("handling AssignLoadResponseToEnergyConsumerEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    EnergyConsumer entity = assignLoadResponse( event.getEnergyConsumerId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignLoadResponseFromEnergyConsumerEvent
	 */
	@EventHandler( payloadType=UnAssignLoadResponseFromEnergyConsumerEvent.class)
	public void handle( UnAssignLoadResponseFromEnergyConsumerEvent event) {
	    LOGGER.info("handling UnAssignLoadResponseFromEnergyConsumerEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    EnergyConsumer entity = unAssignLoadResponse( event.getEnergyConsumerId() );
