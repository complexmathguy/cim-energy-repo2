...
public class RaiseLowerCommandEntityProjector {
     ...
     */
    public RaiseLowerCommand addToValueAliasSet( UUID parentId, ValueAliasSet addTo ) {
	    LOGGER.info("handling AssignValueAliasSetToRaiseLowerCommandEvent - " );
     ...
     * @return	RaiseLowerCommand
     */
	public RaiseLowerCommand removeFromValueAliasSet( UUID parentId, ValueAliasSet removeFrom ) {
	    LOGGER.info("handling RemoveValueAliasSetFromRaiseLowerCommandEvent " );
