...
public class SynchronousMachineDynamicsProjector extends SynchronousMachineDynamicsEntityProjector {
    ...
    public void handle( UpdateSynchronousMachineDynamicsEvent event) {
	    ...
	    SynchronousMachineDynamics entity = new SynchronousMachineDynamics();
        entity.setSynchronousMachineDynamicsId( event.getSynchronousMachineDynamicsId() );
        entity.setSynchronousMachine( event.getSynchronousMachine() );
    ...
    /*
     * @param	event AssignSynchronousMachineToSynchronousMachineDynamicsEvent
     */
    @EventHandler( payloadType=AssignSynchronousMachineToSynchronousMachineDynamicsEvent.class)
    public void handle( AssignSynchronousMachineToSynchronousMachineDynamicsEvent event) {
	    LOGGER.info("handling AssignSynchronousMachineToSynchronousMachineDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineDynamics entity = assignSynchronousMachine( event.getSynchronousMachineDynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignSynchronousMachineFromSynchronousMachineDynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignSynchronousMachineFromSynchronousMachineDynamicsEvent.class)
	public void handle( UnAssignSynchronousMachineFromSynchronousMachineDynamicsEvent event) {
	    LOGGER.info("handling UnAssignSynchronousMachineFromSynchronousMachineDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineDynamics entity = unAssignSynchronousMachine( event.getSynchronousMachineDynamicsId() );
