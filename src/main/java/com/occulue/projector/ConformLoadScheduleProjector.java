...
public class ConformLoadScheduleProjector extends ConformLoadScheduleEntityProjector {
    ...
    public void handle( UpdateConformLoadScheduleEvent event) {
	    ...
	    ConformLoadSchedule entity = new ConformLoadSchedule();
        entity.setConformLoadScheduleId( event.getConformLoadScheduleId() );
        entity.setConformLoadGroup( event.getConformLoadGroup() );
    ...
    /*
     * @param	event AssignConformLoadGroupToConformLoadScheduleEvent
     */
    @EventHandler( payloadType=AssignConformLoadGroupToConformLoadScheduleEvent.class)
    public void handle( AssignConformLoadGroupToConformLoadScheduleEvent event) {
	    LOGGER.info("handling AssignConformLoadGroupToConformLoadScheduleEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    ConformLoadSchedule entity = assignConformLoadGroup( event.getConformLoadScheduleId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignConformLoadGroupFromConformLoadScheduleEvent
	 */
	@EventHandler( payloadType=UnAssignConformLoadGroupFromConformLoadScheduleEvent.class)
	public void handle( UnAssignConformLoadGroupFromConformLoadScheduleEvent event) {
	    LOGGER.info("handling UnAssignConformLoadGroupFromConformLoadScheduleEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    ConformLoadSchedule entity = unAssignConformLoadGroup( event.getConformLoadScheduleId() );
