...
public class DCTerminalProjector extends DCTerminalEntityProjector {
    ...
    /*
     * @param	event AssignDCConductingEquipmentToDCTerminalEvent
     */
    @EventHandler( payloadType=AssignDCConductingEquipmentToDCTerminalEvent.class)
    public void handle( AssignDCConductingEquipmentToDCTerminalEvent event) {
	    LOGGER.info("handling AssignDCConductingEquipmentToDCTerminalEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    DCTerminal entity = assignDCConductingEquipment( event.getDCTerminalId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignDCConductingEquipmentFromDCTerminalEvent
	 */
	@EventHandler( payloadType=UnAssignDCConductingEquipmentFromDCTerminalEvent.class)
	public void handle( UnAssignDCConductingEquipmentFromDCTerminalEvent event) {
	    LOGGER.info("handling UnAssignDCConductingEquipmentFromDCTerminalEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    DCTerminal entity = unAssignDCConductingEquipment( event.getDCTerminalId() );
