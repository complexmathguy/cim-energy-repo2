...
public class MeasurementValueQualityProjector extends MeasurementValueQualityEntityProjector {
    ...
    public void handle( UpdateMeasurementValueQualityEvent event) {
	    ...
	    MeasurementValueQuality entity = new MeasurementValueQuality();
        entity.setMeasurementValueQualityId( event.getMeasurementValueQualityId() );
        entity.setMeasurementValue( event.getMeasurementValue() );
    ...
    /*
     * @param	event AssignMeasurementValueToMeasurementValueQualityEvent
     */
    @EventHandler( payloadType=AssignMeasurementValueToMeasurementValueQualityEvent.class)
    public void handle( AssignMeasurementValueToMeasurementValueQualityEvent event) {
	    LOGGER.info("handling AssignMeasurementValueToMeasurementValueQualityEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    MeasurementValueQuality entity = assignMeasurementValue( event.getMeasurementValueQualityId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignMeasurementValueFromMeasurementValueQualityEvent
	 */
	@EventHandler( payloadType=UnAssignMeasurementValueFromMeasurementValueQualityEvent.class)
	public void handle( UnAssignMeasurementValueFromMeasurementValueQualityEvent event) {
	    LOGGER.info("handling UnAssignMeasurementValueFromMeasurementValueQualityEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    MeasurementValueQuality entity = unAssignMeasurementValue( event.getMeasurementValueQualityId() );
