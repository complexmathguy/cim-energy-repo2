...
public class AnalogValueProjector extends AnalogValueEntityProjector {
    ...
    public void handle( UpdateAnalogValueEvent event) {
        ...
        entity.setAnalog( event.getAnalog() );
    ...
    /*
     * @param	event AssignAnalogToAnalogValueEvent
     */
    @EventHandler( payloadType=AssignAnalogToAnalogValueEvent.class)
    public void handle( AssignAnalogToAnalogValueEvent event) {
	    LOGGER.info("handling AssignAnalogToAnalogValueEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    AnalogValue entity = assignAnalog( event.getAnalogValueId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignAnalogFromAnalogValueEvent
	 */
	@EventHandler( payloadType=UnAssignAnalogFromAnalogValueEvent.class)
	public void handle( UnAssignAnalogFromAnalogValueEvent event) {
	    LOGGER.info("handling UnAssignAnalogFromAnalogValueEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    AnalogValue entity = unAssignAnalog( event.getAnalogValueId() );
