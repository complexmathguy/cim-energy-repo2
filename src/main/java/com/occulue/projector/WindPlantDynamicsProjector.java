...
public class WindPlantDynamicsProjector extends WindPlantDynamicsEntityProjector {
    ...
    /*
     * @param	event AssignRemoteInputSignalToWindPlantDynamicsEvent
     */
    @EventHandler( payloadType=AssignRemoteInputSignalToWindPlantDynamicsEvent.class)
    public void handle( AssignRemoteInputSignalToWindPlantDynamicsEvent event) {
	    LOGGER.info("handling AssignRemoteInputSignalToWindPlantDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantDynamics entity = assignRemoteInputSignal( event.getWindPlantDynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignRemoteInputSignalFromWindPlantDynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignRemoteInputSignalFromWindPlantDynamicsEvent.class)
	public void handle( UnAssignRemoteInputSignalFromWindPlantDynamicsEvent event) {
	    LOGGER.info("handling UnAssignRemoteInputSignalFromWindPlantDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindPlantDynamics entity = unAssignRemoteInputSignal( event.getWindPlantDynamicsId() );
