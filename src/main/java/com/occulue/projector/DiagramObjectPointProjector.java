...
public class DiagramObjectPointProjector extends DiagramObjectPointEntityProjector {
    ...
    public void handle( UpdateDiagramObjectPointEvent event) {
        ...
        entity.setDiagramObject( event.getDiagramObject() );
        entity.setDiagramObjectGluePoint( event.getDiagramObjectGluePoint() );
    ...
    /*
     * @param	event AssignDiagramObjectToDiagramObjectPointEvent
     */
    @EventHandler( payloadType=AssignDiagramObjectToDiagramObjectPointEvent.class)
    public void handle( AssignDiagramObjectToDiagramObjectPointEvent event) {
	    LOGGER.info("handling AssignDiagramObjectToDiagramObjectPointEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    DiagramObjectPoint entity = assignDiagramObject( event.getDiagramObjectPointId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignDiagramObjectFromDiagramObjectPointEvent
	 */
	@EventHandler( payloadType=UnAssignDiagramObjectFromDiagramObjectPointEvent.class)
	public void handle( UnAssignDiagramObjectFromDiagramObjectPointEvent event) {
	    LOGGER.info("handling UnAssignDiagramObjectFromDiagramObjectPointEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    DiagramObjectPoint entity = unAssignDiagramObject( event.getDiagramObjectPointId() );
    ...
    /*
     * @param	event AssignDiagramObjectGluePointToDiagramObjectPointEvent
     */
    @EventHandler( payloadType=AssignDiagramObjectGluePointToDiagramObjectPointEvent.class)
    public void handle( AssignDiagramObjectGluePointToDiagramObjectPointEvent event) {
	    LOGGER.info("handling AssignDiagramObjectGluePointToDiagramObjectPointEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    DiagramObjectPoint entity = assignDiagramObjectGluePoint( event.getDiagramObjectPointId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignDiagramObjectGluePointFromDiagramObjectPointEvent
	 */
	@EventHandler( payloadType=UnAssignDiagramObjectGluePointFromDiagramObjectPointEvent.class)
	public void handle( UnAssignDiagramObjectGluePointFromDiagramObjectPointEvent event) {
	    LOGGER.info("handling UnAssignDiagramObjectGluePointFromDiagramObjectPointEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    DiagramObjectPoint entity = unAssignDiagramObjectGluePoint( event.getDiagramObjectPointId() );
