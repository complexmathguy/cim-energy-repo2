...
public class LoadMotorProjector extends LoadMotorEntityProjector {
    ...
    /*
     * @param	event AssignLoadAggregateToLoadMotorEvent
     */
    @EventHandler( payloadType=AssignLoadAggregateToLoadMotorEvent.class)
    public void handle( AssignLoadAggregateToLoadMotorEvent event) {
	    LOGGER.info("handling AssignLoadAggregateToLoadMotorEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadMotor entity = assignLoadAggregate( event.getLoadMotorId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignLoadAggregateFromLoadMotorEvent
	 */
	@EventHandler( payloadType=UnAssignLoadAggregateFromLoadMotorEvent.class)
	public void handle( UnAssignLoadAggregateFromLoadMotorEvent event) {
	    LOGGER.info("handling UnAssignLoadAggregateFromLoadMotorEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    LoadMotor entity = unAssignLoadAggregate( event.getLoadMotorId() );
