...
public class TerminalProjector extends TerminalEntityProjector {
    ...
    /*
     * @param	event AssignConductingEquipmentToTerminalEvent
     */
    @EventHandler( payloadType=AssignConductingEquipmentToTerminalEvent.class)
    public void handle( AssignConductingEquipmentToTerminalEvent event) {
	    LOGGER.info("handling AssignConductingEquipmentToTerminalEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    Terminal entity = assignConductingEquipment( event.getTerminalId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignConductingEquipmentFromTerminalEvent
	 */
	@EventHandler( payloadType=UnAssignConductingEquipmentFromTerminalEvent.class)
	public void handle( UnAssignConductingEquipmentFromTerminalEvent event) {
	    LOGGER.info("handling UnAssignConductingEquipmentFromTerminalEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    Terminal entity = unAssignConductingEquipment( event.getTerminalId() );
