...
public class NonlinearShuntCompensatorPointProjector extends NonlinearShuntCompensatorPointEntityProjector {
    ...
    public void handle( UpdateNonlinearShuntCompensatorPointEvent event) {
        ...
        entity.setNonlinearShuntCompensator( event.getNonlinearShuntCompensator() );
    ...
    /*
     * @param	event AssignNonlinearShuntCompensatorToNonlinearShuntCompensatorPointEvent
     */
    @EventHandler( payloadType=AssignNonlinearShuntCompensatorToNonlinearShuntCompensatorPointEvent.class)
    public void handle( AssignNonlinearShuntCompensatorToNonlinearShuntCompensatorPointEvent event) {
	    LOGGER.info("handling AssignNonlinearShuntCompensatorToNonlinearShuntCompensatorPointEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    NonlinearShuntCompensatorPoint entity = assignNonlinearShuntCompensator( event.getNonlinearShuntCompensatorPointId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignNonlinearShuntCompensatorFromNonlinearShuntCompensatorPointEvent
	 */
	@EventHandler( payloadType=UnAssignNonlinearShuntCompensatorFromNonlinearShuntCompensatorPointEvent.class)
	public void handle( UnAssignNonlinearShuntCompensatorFromNonlinearShuntCompensatorPointEvent event) {
	    LOGGER.info("handling UnAssignNonlinearShuntCompensatorFromNonlinearShuntCompensatorPointEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    NonlinearShuntCompensatorPoint entity = unAssignNonlinearShuntCompensator( event.getNonlinearShuntCompensatorPointId() );
