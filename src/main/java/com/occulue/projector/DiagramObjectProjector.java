...
public class DiagramObjectProjector extends DiagramObjectEntityProjector {
    ...
    public void handle( UpdateDiagramObjectEvent event) {
        ...
        entity.setDiagramObjectStyle( event.getDiagramObjectStyle() );
        entity.setDiagram( event.getDiagram() );
        entity.setIdentifiedObject( event.getIdentifiedObject() );
    ...
    /*
     * @param	event AssignDiagramObjectStyleToDiagramObjectEvent
     */
    @EventHandler( payloadType=AssignDiagramObjectStyleToDiagramObjectEvent.class)
    public void handle( AssignDiagramObjectStyleToDiagramObjectEvent event) {
	    LOGGER.info("handling AssignDiagramObjectStyleToDiagramObjectEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    DiagramObject entity = assignDiagramObjectStyle( event.getDiagramObjectId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignDiagramObjectStyleFromDiagramObjectEvent
	 */
	@EventHandler( payloadType=UnAssignDiagramObjectStyleFromDiagramObjectEvent.class)
	public void handle( UnAssignDiagramObjectStyleFromDiagramObjectEvent event) {
	    LOGGER.info("handling UnAssignDiagramObjectStyleFromDiagramObjectEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    DiagramObject entity = unAssignDiagramObjectStyle( event.getDiagramObjectId() );
    ...
    /*
     * @param	event AssignDiagramToDiagramObjectEvent
     */
    @EventHandler( payloadType=AssignDiagramToDiagramObjectEvent.class)
    public void handle( AssignDiagramToDiagramObjectEvent event) {
	    LOGGER.info("handling AssignDiagramToDiagramObjectEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    DiagramObject entity = assignDiagram( event.getDiagramObjectId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignDiagramFromDiagramObjectEvent
	 */
	@EventHandler( payloadType=UnAssignDiagramFromDiagramObjectEvent.class)
	public void handle( UnAssignDiagramFromDiagramObjectEvent event) {
	    LOGGER.info("handling UnAssignDiagramFromDiagramObjectEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    DiagramObject entity = unAssignDiagram( event.getDiagramObjectId() );
    ...
    /*
     * @param	event AssignIdentifiedObjectToDiagramObjectEvent
     */
    @EventHandler( payloadType=AssignIdentifiedObjectToDiagramObjectEvent.class)
    public void handle( AssignIdentifiedObjectToDiagramObjectEvent event) {
	    LOGGER.info("handling AssignIdentifiedObjectToDiagramObjectEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    DiagramObject entity = assignIdentifiedObject( event.getDiagramObjectId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignIdentifiedObjectFromDiagramObjectEvent
	 */
	@EventHandler( payloadType=UnAssignIdentifiedObjectFromDiagramObjectEvent.class)
	public void handle( UnAssignIdentifiedObjectFromDiagramObjectEvent event) {
	    LOGGER.info("handling UnAssignIdentifiedObjectFromDiagramObjectEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    DiagramObject entity = unAssignIdentifiedObject( event.getDiagramObjectId() );
