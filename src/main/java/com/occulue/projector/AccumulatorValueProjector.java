...
public class AccumulatorValueProjector extends AccumulatorValueEntityProjector {
    ...
    public void handle( UpdateAccumulatorValueEvent event) {
        ...
        entity.setAccumulator( event.getAccumulator() );
    ...
    /*
     * @param	event AssignAccumulatorToAccumulatorValueEvent
     */
    @EventHandler( payloadType=AssignAccumulatorToAccumulatorValueEvent.class)
    public void handle( AssignAccumulatorToAccumulatorValueEvent event) {
	    LOGGER.info("handling AssignAccumulatorToAccumulatorValueEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    AccumulatorValue entity = assignAccumulator( event.getAccumulatorValueId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignAccumulatorFromAccumulatorValueEvent
	 */
	@EventHandler( payloadType=UnAssignAccumulatorFromAccumulatorValueEvent.class)
	public void handle( UnAssignAccumulatorFromAccumulatorValueEvent event) {
	    LOGGER.info("handling UnAssignAccumulatorFromAccumulatorValueEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    AccumulatorValue entity = unAssignAccumulator( event.getAccumulatorValueId() );
