...
public class PFVArControllerType1DynamicsEntityProjector {
     ...
     */
    public PFVArControllerType1Dynamics assignExcitationSystemDynamics( UUID parentId, ExcitationSystemDynamics assignment ) {
	 ...
	 * @return	PFVArControllerType1Dynamics
	 */
	public PFVArControllerType1Dynamics unAssignExcitationSystemDynamics( UUID parentId ) {
		PFVArControllerType1Dynamics parentEntity = repository.findById(parentId).get();
