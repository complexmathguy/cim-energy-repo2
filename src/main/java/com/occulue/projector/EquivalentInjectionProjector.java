...
public class EquivalentInjectionProjector extends EquivalentInjectionEntityProjector {
    ...
    public void handle( UpdateEquivalentInjectionEvent event) {
        ...
        entity.setReactiveCapabilityCurve( event.getReactiveCapabilityCurve() );
    ...
    /*
     * @param	event AssignReactiveCapabilityCurveToEquivalentInjectionEvent
     */
    @EventHandler( payloadType=AssignReactiveCapabilityCurveToEquivalentInjectionEvent.class)
    public void handle( AssignReactiveCapabilityCurveToEquivalentInjectionEvent event) {
	    LOGGER.info("handling AssignReactiveCapabilityCurveToEquivalentInjectionEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    EquivalentInjection entity = assignReactiveCapabilityCurve( event.getEquivalentInjectionId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignReactiveCapabilityCurveFromEquivalentInjectionEvent
	 */
	@EventHandler( payloadType=UnAssignReactiveCapabilityCurveFromEquivalentInjectionEvent.class)
	public void handle( UnAssignReactiveCapabilityCurveFromEquivalentInjectionEvent event) {
	    LOGGER.info("handling UnAssignReactiveCapabilityCurveFromEquivalentInjectionEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    EquivalentInjection entity = unAssignReactiveCapabilityCurve( event.getEquivalentInjectionId() );
