...
public class WindTurbineType4aIECProjector extends WindTurbineType4aIECEntityProjector {
    ...
    public void handle( UpdateWindTurbineType4aIECEvent event) {
	    ...
	    WindTurbineType4aIEC entity = new WindTurbineType4aIEC();
        entity.setWindTurbineType4aIECId( event.getWindTurbineType4aIECId() );
        entity.setWindContPType4aIEC( event.getWindContPType4aIEC() );
    ...
    /*
     * @param	event AssignWindContPType4aIECToWindTurbineType4aIECEvent
     */
    @EventHandler( payloadType=AssignWindContPType4aIECToWindTurbineType4aIECEvent.class)
    public void handle( AssignWindContPType4aIECToWindTurbineType4aIECEvent event) {
	    LOGGER.info("handling AssignWindContPType4aIECToWindTurbineType4aIECEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    WindTurbineType4aIEC entity = assignWindContPType4aIEC( event.getWindTurbineType4aIECId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignWindContPType4aIECFromWindTurbineType4aIECEvent
	 */
	@EventHandler( payloadType=UnAssignWindContPType4aIECFromWindTurbineType4aIECEvent.class)
	public void handle( UnAssignWindContPType4aIECFromWindTurbineType4aIECEvent event) {
	    LOGGER.info("handling UnAssignWindContPType4aIECFromWindTurbineType4aIECEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindTurbineType4aIEC entity = unAssignWindContPType4aIEC( event.getWindTurbineType4aIECId() );
