...
public class MechanicalLoadDynamicsProjector extends MechanicalLoadDynamicsEntityProjector {
    ...
    /*
     * @param	event AssignSynchronousMachineDynamicsToMechanicalLoadDynamicsEvent
     */
    @EventHandler( payloadType=AssignSynchronousMachineDynamicsToMechanicalLoadDynamicsEvent.class)
    public void handle( AssignSynchronousMachineDynamicsToMechanicalLoadDynamicsEvent event) {
	    LOGGER.info("handling AssignSynchronousMachineDynamicsToMechanicalLoadDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    MechanicalLoadDynamics entity = assignSynchronousMachineDynamics( event.getMechanicalLoadDynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignSynchronousMachineDynamicsFromMechanicalLoadDynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignSynchronousMachineDynamicsFromMechanicalLoadDynamicsEvent.class)
	public void handle( UnAssignSynchronousMachineDynamicsFromMechanicalLoadDynamicsEvent event) {
	    LOGGER.info("handling UnAssignSynchronousMachineDynamicsFromMechanicalLoadDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    MechanicalLoadDynamics entity = unAssignSynchronousMachineDynamics( event.getMechanicalLoadDynamicsId() );
    ...
    /*
     * @param	event AssignAsynchronousMachineDynamicsToMechanicalLoadDynamicsEvent
     */
    @EventHandler( payloadType=AssignAsynchronousMachineDynamicsToMechanicalLoadDynamicsEvent.class)
    public void handle( AssignAsynchronousMachineDynamicsToMechanicalLoadDynamicsEvent event) {
	    LOGGER.info("handling AssignAsynchronousMachineDynamicsToMechanicalLoadDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    MechanicalLoadDynamics entity = assignAsynchronousMachineDynamics( event.getMechanicalLoadDynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignAsynchronousMachineDynamicsFromMechanicalLoadDynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignAsynchronousMachineDynamicsFromMechanicalLoadDynamicsEvent.class)
	public void handle( UnAssignAsynchronousMachineDynamicsFromMechanicalLoadDynamicsEvent event) {
	    LOGGER.info("handling UnAssignAsynchronousMachineDynamicsFromMechanicalLoadDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    MechanicalLoadDynamics entity = unAssignAsynchronousMachineDynamics( event.getMechanicalLoadDynamicsId() );
