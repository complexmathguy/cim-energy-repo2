...
public class MechanicalLoadDynamicsEntityProjector {
     ...
     */
    public MechanicalLoadDynamics assignSynchronousMachineDynamics( UUID parentId, SynchronousMachineDynamics assignment ) {
	 ...
	 * @return	MechanicalLoadDynamics
	 */
	public MechanicalLoadDynamics unAssignSynchronousMachineDynamics( UUID parentId ) {
		MechanicalLoadDynamics parentEntity = repository.findById(parentId).get();
     ...
     * @return	MechanicalLoadDynamics
     */
    public MechanicalLoadDynamics assignAsynchronousMachineDynamics( UUID parentId, AsynchronousMachineDynamics assignment ) {
	 ...
	 * @return	MechanicalLoadDynamics
	 */
	public MechanicalLoadDynamics unAssignAsynchronousMachineDynamics( UUID parentId ) {
		MechanicalLoadDynamics parentEntity = repository.findById(parentId).get();
