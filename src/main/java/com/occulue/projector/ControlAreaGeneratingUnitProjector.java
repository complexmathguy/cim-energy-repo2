...
public class ControlAreaGeneratingUnitProjector extends ControlAreaGeneratingUnitEntityProjector {
    ...
    public void handle( UpdateControlAreaGeneratingUnitEvent event) {
        ...
        entity.setGeneratingUnit( event.getGeneratingUnit() );
    ...
    /*
     * @param	event AssignControlAreaToControlAreaGeneratingUnitEvent
     */
    @EventHandler( payloadType=AssignControlAreaToControlAreaGeneratingUnitEvent.class)
    public void handle( AssignControlAreaToControlAreaGeneratingUnitEvent event) {
	    LOGGER.info("handling AssignControlAreaToControlAreaGeneratingUnitEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    ControlAreaGeneratingUnit entity = assignControlArea( event.getControlAreaGeneratingUnitId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignControlAreaFromControlAreaGeneratingUnitEvent
	 */
	@EventHandler( payloadType=UnAssignControlAreaFromControlAreaGeneratingUnitEvent.class)
	public void handle( UnAssignControlAreaFromControlAreaGeneratingUnitEvent event) {
	    LOGGER.info("handling UnAssignControlAreaFromControlAreaGeneratingUnitEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    ControlAreaGeneratingUnit entity = unAssignControlArea( event.getControlAreaGeneratingUnitId() );
    ...
    /*
     * @param	event AssignGeneratingUnitToControlAreaGeneratingUnitEvent
     */
    @EventHandler( payloadType=AssignGeneratingUnitToControlAreaGeneratingUnitEvent.class)
    public void handle( AssignGeneratingUnitToControlAreaGeneratingUnitEvent event) {
	    LOGGER.info("handling AssignGeneratingUnitToControlAreaGeneratingUnitEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    ControlAreaGeneratingUnit entity = assignGeneratingUnit( event.getControlAreaGeneratingUnitId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignGeneratingUnitFromControlAreaGeneratingUnitEvent
	 */
	@EventHandler( payloadType=UnAssignGeneratingUnitFromControlAreaGeneratingUnitEvent.class)
	public void handle( UnAssignGeneratingUnitFromControlAreaGeneratingUnitEvent event) {
	    LOGGER.info("handling UnAssignGeneratingUnitFromControlAreaGeneratingUnitEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    ControlAreaGeneratingUnit entity = unAssignGeneratingUnit( event.getControlAreaGeneratingUnitId() );
