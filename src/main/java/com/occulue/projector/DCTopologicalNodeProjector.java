...
public class DCTopologicalNodeProjector extends DCTopologicalNodeEntityProjector {
    ...
    public void handle( UpdateDCTopologicalNodeEvent event) {
	    ...
	    DCTopologicalNode entity = new DCTopologicalNode();
        entity.setDCTopologicalNodeId( event.getDCTopologicalNodeId() );
        entity.setDCEquipmentContainer( event.getDCEquipmentContainer() );
    ...
    /*
     * @param	event AssignDCEquipmentContainerToDCTopologicalNodeEvent
     */
    @EventHandler( payloadType=AssignDCEquipmentContainerToDCTopologicalNodeEvent.class)
    public void handle( AssignDCEquipmentContainerToDCTopologicalNodeEvent event) {
	    LOGGER.info("handling AssignDCEquipmentContainerToDCTopologicalNodeEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    DCTopologicalNode entity = assignDCEquipmentContainer( event.getDCTopologicalNodeId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignDCEquipmentContainerFromDCTopologicalNodeEvent
	 */
	@EventHandler( payloadType=UnAssignDCEquipmentContainerFromDCTopologicalNodeEvent.class)
	public void handle( UnAssignDCEquipmentContainerFromDCTopologicalNodeEvent event) {
	    LOGGER.info("handling UnAssignDCEquipmentContainerFromDCTopologicalNodeEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    DCTopologicalNode entity = unAssignDCEquipmentContainer( event.getDCTopologicalNodeId() );
