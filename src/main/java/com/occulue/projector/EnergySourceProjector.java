...
public class EnergySourceProjector extends EnergySourceEntityProjector {
    ...
    public void handle( UpdateEnergySourceEvent event) {
	    ...
	    EnergySource entity = new EnergySource();
        entity.setEnergySourceId( event.getEnergySourceId() );
        entity.setEnergySchedulingType( event.getEnergySchedulingType() );
    ...
    /*
     * @param	event AssignEnergySchedulingTypeToEnergySourceEvent
     */
    @EventHandler( payloadType=AssignEnergySchedulingTypeToEnergySourceEvent.class)
    public void handle( AssignEnergySchedulingTypeToEnergySourceEvent event) {
	    LOGGER.info("handling AssignEnergySchedulingTypeToEnergySourceEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    EnergySource entity = assignEnergySchedulingType( event.getEnergySourceId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignEnergySchedulingTypeFromEnergySourceEvent
	 */
	@EventHandler( payloadType=UnAssignEnergySchedulingTypeFromEnergySourceEvent.class)
	public void handle( UnAssignEnergySchedulingTypeFromEnergySourceEvent event) {
	    LOGGER.info("handling UnAssignEnergySchedulingTypeFromEnergySourceEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    EnergySource entity = unAssignEnergySchedulingType( event.getEnergySourceId() );
