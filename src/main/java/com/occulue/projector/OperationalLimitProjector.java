...
public class OperationalLimitProjector extends OperationalLimitEntityProjector {
    ...
    public void handle( UpdateOperationalLimitEvent event) {
	    ...
	    OperationalLimit entity = new OperationalLimit();
        entity.setOperationalLimitId( event.getOperationalLimitId() );
        entity.setOperationalLimitType( event.getOperationalLimitType() );
    ...
    /*
     * @param	event AssignOperationalLimitTypeToOperationalLimitEvent
     */
    @EventHandler( payloadType=AssignOperationalLimitTypeToOperationalLimitEvent.class)
    public void handle( AssignOperationalLimitTypeToOperationalLimitEvent event) {
	    LOGGER.info("handling AssignOperationalLimitTypeToOperationalLimitEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    OperationalLimit entity = assignOperationalLimitType( event.getOperationalLimitId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignOperationalLimitTypeFromOperationalLimitEvent
	 */
	@EventHandler( payloadType=UnAssignOperationalLimitTypeFromOperationalLimitEvent.class)
	public void handle( UnAssignOperationalLimitTypeFromOperationalLimitEvent event) {
	    LOGGER.info("handling UnAssignOperationalLimitTypeFromOperationalLimitEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    OperationalLimit entity = unAssignOperationalLimitType( event.getOperationalLimitId() );
    ...
    /*
     * @param	event AssignOperationalLimitSetToOperationalLimitEvent
     */
    @EventHandler( payloadType=AssignOperationalLimitSetToOperationalLimitEvent.class)
    public void handle( AssignOperationalLimitSetToOperationalLimitEvent event) {
	    LOGGER.info("handling AssignOperationalLimitSetToOperationalLimitEvent - " + event );
	    
	    // ------------------------------------------
    	// delegate to addTo 
    	// ------------------------------------------ 
	    OperationalLimit entity = addToOperationalLimitSet(event.getOperationalLimitId(), event.getAddTo() );
...
/*
 * @param	event RemoveOperationalLimitSetFromOperationalLimitEvent
 */
@EventHandler( payloadType=RemoveOperationalLimitSetFromOperationalLimitEvent.class)
public void handle( RemoveOperationalLimitSetFromOperationalLimitEvent event) {
    LOGGER.info("handling RemoveOperationalLimitSetFromOperationalLimitEvent - " + event );

    OperationalLimit entity = removeFromOperationalLimitSet(event.getOperationalLimitId(), event.getRemoveFrom() );
