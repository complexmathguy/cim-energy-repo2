...
public class WindTurbineType1or2IECEntityProjector {
     ...
     */
    public WindTurbineType1or2IEC assignWindProtectionIEC( UUID parentId, WindProtectionIEC assignment ) {
	 ...
	 * @return	WindTurbineType1or2IEC
	 */
	public WindTurbineType1or2IEC unAssignWindProtectionIEC( UUID parentId ) {
		WindTurbineType1or2IEC parentEntity = repository.findById(parentId).get();
     ...
     * @return	WindTurbineType1or2IEC
     */
    public WindTurbineType1or2IEC assignWindMechIEC( UUID parentId, WindMechIEC assignment ) {
	 ...
	 * @return	WindTurbineType1or2IEC
	 */
	public WindTurbineType1or2IEC unAssignWindMechIEC( UUID parentId ) {
		WindTurbineType1or2IEC parentEntity = repository.findById(parentId).get();
