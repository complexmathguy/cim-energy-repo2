...
public class SynchronousMachineEntityProjector {
    ...
    /*
     * Assign a InitialReactiveCapabilityCurve
     * 
     * @param	parentId	UUID
     * @param	assignment 	ReactiveCapabilityCurve 
     * @return	SynchronousMachine
     */
    public SynchronousMachine assignInitialReactiveCapabilityCurve( UUID parentId, ReactiveCapabilityCurve assignment ) {
	    LOGGER.info("assigning InitialReactiveCapabilityCurve as " + assignment.toString() );

	    SynchronousMachine parentEntity = repository.findById( parentId ).get();
	    assignment = ReactiveCapabilityCurveProjector.find(assignment.getReactiveCapabilityCurveId());
	    
	    // ------------------------------------------
		// assign the InitialReactiveCapabilityCurve to the parent entity
		// ------------------------------------------ 
	    parentEntity.setInitialReactiveCapabilityCurve( assignment );
	...
	/*
	 * Unassign the InitialReactiveCapabilityCurve
	 * 
	 * @param	parentId		UUID
	 * @return	SynchronousMachine
	 */
	public SynchronousMachine unAssignInitialReactiveCapabilityCurve( UUID parentId ) {
		SynchronousMachine parentEntity = repository.findById(parentId).get();

		LOGGER.info("unAssigning InitialReactiveCapabilityCurve on " + parentEntity.toString() );
		
	    // ------------------------------------------
		// null out the InitialReactiveCapabilityCurve on the parent entithy
		// ------------------------------------------     
	    parentEntity.setInitialReactiveCapabilityCurve(null);
    ...
    @Autowired
	@Qualifier(value = "reactiveCapabilityCurve-entity-projector")
	ReactiveCapabilityCurveEntityProjector ReactiveCapabilityCurveProjector;
    @Autowired
