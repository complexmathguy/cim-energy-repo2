...
public class MeasurementValueProjector extends MeasurementValueEntityProjector {
    ...
    public void handle( UpdateMeasurementValueEvent event) {
        ...
        entity.setMeasurementValueSource( event.getMeasurementValueSource() );
    ...
    /*
     * @param	event AssignMeasurementValueSourceToMeasurementValueEvent
     */
    @EventHandler( payloadType=AssignMeasurementValueSourceToMeasurementValueEvent.class)
    public void handle( AssignMeasurementValueSourceToMeasurementValueEvent event) {
	    LOGGER.info("handling AssignMeasurementValueSourceToMeasurementValueEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    MeasurementValue entity = assignMeasurementValueSource( event.getMeasurementValueId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignMeasurementValueSourceFromMeasurementValueEvent
	 */
	@EventHandler( payloadType=UnAssignMeasurementValueSourceFromMeasurementValueEvent.class)
	public void handle( UnAssignMeasurementValueSourceFromMeasurementValueEvent event) {
	    LOGGER.info("handling UnAssignMeasurementValueSourceFromMeasurementValueEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    MeasurementValue entity = unAssignMeasurementValueSource( event.getMeasurementValueId() );
