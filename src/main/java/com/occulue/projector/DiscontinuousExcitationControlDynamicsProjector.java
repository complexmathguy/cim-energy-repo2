...
public class DiscontinuousExcitationControlDynamicsProjector extends DiscontinuousExcitationControlDynamicsEntityProjector {
    ...
    /*
     * @param	event AssignExcitationSystemDynamicsToDiscontinuousExcitationControlDynamicsEvent
     */
    @EventHandler( payloadType=AssignExcitationSystemDynamicsToDiscontinuousExcitationControlDynamicsEvent.class)
    public void handle( AssignExcitationSystemDynamicsToDiscontinuousExcitationControlDynamicsEvent event) {
	    LOGGER.info("handling AssignExcitationSystemDynamicsToDiscontinuousExcitationControlDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscontinuousExcitationControlDynamics entity = assignExcitationSystemDynamics( event.getDiscontinuousExcitationControlDynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignExcitationSystemDynamicsFromDiscontinuousExcitationControlDynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignExcitationSystemDynamicsFromDiscontinuousExcitationControlDynamicsEvent.class)
	public void handle( UnAssignExcitationSystemDynamicsFromDiscontinuousExcitationControlDynamicsEvent event) {
	    LOGGER.info("handling UnAssignExcitationSystemDynamicsFromDiscontinuousExcitationControlDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    DiscontinuousExcitationControlDynamics entity = unAssignExcitationSystemDynamics( event.getDiscontinuousExcitationControlDynamicsId() );
