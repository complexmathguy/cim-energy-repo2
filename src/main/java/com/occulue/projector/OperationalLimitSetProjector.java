...
public class OperationalLimitSetProjector extends OperationalLimitSetEntityProjector {
    ...
    public void handle( UpdateOperationalLimitSetEvent event) {
	    ...
	    OperationalLimitSet entity = new OperationalLimitSet();
        entity.setOperationalLimitSetId( event.getOperationalLimitSetId() );
        entity.setEquipment( event.getEquipment() );
    ...
    /*
     * @param	event AssignEquipmentToOperationalLimitSetEvent
     */
    @EventHandler( payloadType=AssignEquipmentToOperationalLimitSetEvent.class)
    public void handle( AssignEquipmentToOperationalLimitSetEvent event) {
	    LOGGER.info("handling AssignEquipmentToOperationalLimitSetEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    OperationalLimitSet entity = assignEquipment( event.getOperationalLimitSetId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignEquipmentFromOperationalLimitSetEvent
	 */
	@EventHandler( payloadType=UnAssignEquipmentFromOperationalLimitSetEvent.class)
	public void handle( UnAssignEquipmentFromOperationalLimitSetEvent event) {
	    LOGGER.info("handling UnAssignEquipmentFromOperationalLimitSetEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    OperationalLimitSet entity = unAssignEquipment( event.getOperationalLimitSetId() );
    ...
    /*
     * @param	event AssignTerminalToOperationalLimitSetEvent
     */
    @EventHandler( payloadType=AssignTerminalToOperationalLimitSetEvent.class)
    public void handle( AssignTerminalToOperationalLimitSetEvent event) {
	    LOGGER.info("handling AssignTerminalToOperationalLimitSetEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    OperationalLimitSet entity = assignTerminal( event.getOperationalLimitSetId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignTerminalFromOperationalLimitSetEvent
	 */
	@EventHandler( payloadType=UnAssignTerminalFromOperationalLimitSetEvent.class)
	public void handle( UnAssignTerminalFromOperationalLimitSetEvent event) {
	    LOGGER.info("handling UnAssignTerminalFromOperationalLimitSetEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    OperationalLimitSet entity = unAssignTerminal( event.getOperationalLimitSetId() );
