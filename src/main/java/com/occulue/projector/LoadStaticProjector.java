...
public class LoadStaticProjector extends LoadStaticEntityProjector {
    ...
    public void handle( UpdateLoadStaticEvent event) {
        ...
        entity.setStaticLoadModelType( event.getStaticLoadModelType() );
        entity.setLoadAggregate( event.getLoadAggregate() );
    ...
    /*
     * @param	event AssignLoadAggregateToLoadStaticEvent
     */
    @EventHandler( payloadType=AssignLoadAggregateToLoadStaticEvent.class)
    public void handle( AssignLoadAggregateToLoadStaticEvent event) {
	    LOGGER.info("handling AssignLoadAggregateToLoadStaticEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadStatic entity = assignLoadAggregate( event.getLoadStaticId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignLoadAggregateFromLoadStaticEvent
	 */
	@EventHandler( payloadType=UnAssignLoadAggregateFromLoadStaticEvent.class)
	public void handle( UnAssignLoadAggregateFromLoadStaticEvent event) {
	    LOGGER.info("handling UnAssignLoadAggregateFromLoadStaticEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    LoadStatic entity = unAssignLoadAggregate( event.getLoadStaticId() );
