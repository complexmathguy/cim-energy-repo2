...
public class WindGenTurbineType2IECProjector extends WindGenTurbineType2IECEntityProjector {
    ...
    public void handle( UpdateWindGenTurbineType2IECEvent event) {
        ...
        entity.setWindPitchContEmulIEC( event.getWindPitchContEmulIEC() );
    ...
    /*
     * @param	event AssignWindContRotorRIECToWindGenTurbineType2IECEvent
     */
    @EventHandler( payloadType=AssignWindContRotorRIECToWindGenTurbineType2IECEvent.class)
    public void handle( AssignWindContRotorRIECToWindGenTurbineType2IECEvent event) {
	    LOGGER.info("handling AssignWindContRotorRIECToWindGenTurbineType2IECEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    WindGenTurbineType2IEC entity = assignWindContRotorRIEC( event.getWindGenTurbineType2IECId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignWindContRotorRIECFromWindGenTurbineType2IECEvent
	 */
	@EventHandler( payloadType=UnAssignWindContRotorRIECFromWindGenTurbineType2IECEvent.class)
	public void handle( UnAssignWindContRotorRIECFromWindGenTurbineType2IECEvent event) {
	    LOGGER.info("handling UnAssignWindContRotorRIECFromWindGenTurbineType2IECEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindGenTurbineType2IEC entity = unAssignWindContRotorRIEC( event.getWindGenTurbineType2IECId() );
    ...
    /*
     * @param	event AssignWindPitchContEmulIECToWindGenTurbineType2IECEvent
     */
    @EventHandler( payloadType=AssignWindPitchContEmulIECToWindGenTurbineType2IECEvent.class)
    public void handle( AssignWindPitchContEmulIECToWindGenTurbineType2IECEvent event) {
	    LOGGER.info("handling AssignWindPitchContEmulIECToWindGenTurbineType2IECEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    WindGenTurbineType2IEC entity = assignWindPitchContEmulIEC( event.getWindGenTurbineType2IECId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignWindPitchContEmulIECFromWindGenTurbineType2IECEvent
	 */
	@EventHandler( payloadType=UnAssignWindPitchContEmulIECFromWindGenTurbineType2IECEvent.class)
	public void handle( UnAssignWindPitchContEmulIECFromWindGenTurbineType2IECEvent event) {
	    LOGGER.info("handling UnAssignWindPitchContEmulIECFromWindGenTurbineType2IECEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindGenTurbineType2IEC entity = unAssignWindPitchContEmulIEC( event.getWindGenTurbineType2IECId() );
