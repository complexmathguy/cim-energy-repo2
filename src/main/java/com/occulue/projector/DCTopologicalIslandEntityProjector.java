...
public class DCTopologicalIslandEntityProjector {
    ...
    /*
     * Assign a DCTopologicalNodes
     * 
     * @param	parentId	UUID
     * @param	assignment 	DCTopologicalNode 
     * @return	DCTopologicalIsland
     */
    public DCTopologicalIsland assignDCTopologicalNodes( UUID parentId, DCTopologicalNode assignment ) {
	    LOGGER.info("assigning DCTopologicalNodes as " + assignment.toString() );

	    DCTopologicalIsland parentEntity = repository.findById( parentId ).get();
	    assignment = DCTopologicalNodeProjector.find(assignment.getDCTopologicalNodeId());
	    
	    // ------------------------------------------
		// assign the DCTopologicalNodes to the parent entity
		// ------------------------------------------ 
	    parentEntity.setDCTopologicalNodes( assignment );
	...
	/*
	 * Unassign the DCTopologicalNodes
	 * 
	 * @param	parentId		UUID
	 * @return	DCTopologicalIsland
	 */
	public DCTopologicalIsland unAssignDCTopologicalNodes( UUID parentId ) {
		DCTopologicalIsland parentEntity = repository.findById(parentId).get();

		LOGGER.info("unAssigning DCTopologicalNodes on " + parentEntity.toString() );
		
	    // ------------------------------------------
		// null out the DCTopologicalNodes on the parent entithy
		// ------------------------------------------     
	    parentEntity.setDCTopologicalNodes(null);
