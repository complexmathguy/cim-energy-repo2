...
public class VoltageCompensatorDynamicsProjector extends VoltageCompensatorDynamicsEntityProjector {
    ...
    /*
     * @param	event AssignExcitationSystemDynamicsToVoltageCompensatorDynamicsEvent
     */
    @EventHandler( payloadType=AssignExcitationSystemDynamicsToVoltageCompensatorDynamicsEvent.class)
    public void handle( AssignExcitationSystemDynamicsToVoltageCompensatorDynamicsEvent event) {
	    LOGGER.info("handling AssignExcitationSystemDynamicsToVoltageCompensatorDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    VoltageCompensatorDynamics entity = assignExcitationSystemDynamics( event.getVoltageCompensatorDynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignExcitationSystemDynamicsFromVoltageCompensatorDynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignExcitationSystemDynamicsFromVoltageCompensatorDynamicsEvent.class)
	public void handle( UnAssignExcitationSystemDynamicsFromVoltageCompensatorDynamicsEvent event) {
	    LOGGER.info("handling UnAssignExcitationSystemDynamicsFromVoltageCompensatorDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    VoltageCompensatorDynamics entity = unAssignExcitationSystemDynamics( event.getVoltageCompensatorDynamicsId() );
