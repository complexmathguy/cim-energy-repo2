...
public class AnalogLimitProjector extends AnalogLimitEntityProjector {
    ...
    /*
     * @param	event AssignLimitSetToAnalogLimitEvent
     */
    @EventHandler( payloadType=AssignLimitSetToAnalogLimitEvent.class)
    public void handle( AssignLimitSetToAnalogLimitEvent event) {
	    LOGGER.info("handling AssignLimitSetToAnalogLimitEvent - " + event );
	    
	    // ------------------------------------------
    	// delegate to addTo 
    	// ------------------------------------------ 
	    AnalogLimit entity = addToLimitSet(event.getAnalogLimitId(), event.getAddTo() );
...
/*
 * @param	event RemoveLimitSetFromAnalogLimitEvent
 */
@EventHandler( payloadType=RemoveLimitSetFromAnalogLimitEvent.class)
public void handle( RemoveLimitSetFromAnalogLimitEvent event) {
    LOGGER.info("handling RemoveLimitSetFromAnalogLimitEvent - " + event );

    AnalogLimit entity = removeFromLimitSet(event.getAnalogLimitId(), event.getRemoveFrom() );
