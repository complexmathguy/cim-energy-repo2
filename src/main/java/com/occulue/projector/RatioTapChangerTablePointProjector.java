...
public class RatioTapChangerTablePointProjector extends RatioTapChangerTablePointEntityProjector {
    ...
    /*
     * @param	event AssignRatioTapChangerTableToRatioTapChangerTablePointEvent
     */
    @EventHandler( payloadType=AssignRatioTapChangerTableToRatioTapChangerTablePointEvent.class)
    public void handle( AssignRatioTapChangerTableToRatioTapChangerTablePointEvent event) {
	    LOGGER.info("handling AssignRatioTapChangerTableToRatioTapChangerTablePointEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    RatioTapChangerTablePoint entity = assignRatioTapChangerTable( event.getRatioTapChangerTablePointId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignRatioTapChangerTableFromRatioTapChangerTablePointEvent
	 */
	@EventHandler( payloadType=UnAssignRatioTapChangerTableFromRatioTapChangerTablePointEvent.class)
	public void handle( UnAssignRatioTapChangerTableFromRatioTapChangerTablePointEvent event) {
	    LOGGER.info("handling UnAssignRatioTapChangerTableFromRatioTapChangerTablePointEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    RatioTapChangerTablePoint entity = unAssignRatioTapChangerTable( event.getRatioTapChangerTablePointId() );
