...
public class NonConformLoadProjector extends NonConformLoadEntityProjector {
    ...
    public void handle( UpdateNonConformLoadEvent event) {
	    ...
	    NonConformLoad entity = new NonConformLoad();
        entity.setNonConformLoadId( event.getNonConformLoadId() );
        entity.setLoadGroup( event.getLoadGroup() );
    ...
    /*
     * @param	event AssignLoadGroupToNonConformLoadEvent
     */
    @EventHandler( payloadType=AssignLoadGroupToNonConformLoadEvent.class)
    public void handle( AssignLoadGroupToNonConformLoadEvent event) {
	    LOGGER.info("handling AssignLoadGroupToNonConformLoadEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    NonConformLoad entity = assignLoadGroup( event.getNonConformLoadId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignLoadGroupFromNonConformLoadEvent
	 */
	@EventHandler( payloadType=UnAssignLoadGroupFromNonConformLoadEvent.class)
	public void handle( UnAssignLoadGroupFromNonConformLoadEvent event) {
	    LOGGER.info("handling UnAssignLoadGroupFromNonConformLoadEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    NonConformLoad entity = unAssignLoadGroup( event.getNonConformLoadId() );
