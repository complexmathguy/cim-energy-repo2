...
public class WindTurbineType1or2DynamicsProjector extends WindTurbineType1or2DynamicsEntityProjector {
    ...
    /*
     * @param	event AssignAsynchronousMachineDynamicsToWindTurbineType1or2DynamicsEvent
     */
    @EventHandler( payloadType=AssignAsynchronousMachineDynamicsToWindTurbineType1or2DynamicsEvent.class)
    public void handle( AssignAsynchronousMachineDynamicsToWindTurbineType1or2DynamicsEvent event) {
	    LOGGER.info("handling AssignAsynchronousMachineDynamicsToWindTurbineType1or2DynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    WindTurbineType1or2Dynamics entity = assignAsynchronousMachineDynamics( event.getWindTurbineType1or2DynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignAsynchronousMachineDynamicsFromWindTurbineType1or2DynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignAsynchronousMachineDynamicsFromWindTurbineType1or2DynamicsEvent.class)
	public void handle( UnAssignAsynchronousMachineDynamicsFromWindTurbineType1or2DynamicsEvent event) {
	    LOGGER.info("handling UnAssignAsynchronousMachineDynamicsFromWindTurbineType1or2DynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindTurbineType1or2Dynamics entity = unAssignAsynchronousMachineDynamics( event.getWindTurbineType1or2DynamicsId() );
    ...
    /*
     * @param	event AssignRemoteInputSignalToWindTurbineType1or2DynamicsEvent
     */
    @EventHandler( payloadType=AssignRemoteInputSignalToWindTurbineType1or2DynamicsEvent.class)
    public void handle( AssignRemoteInputSignalToWindTurbineType1or2DynamicsEvent event) {
	    LOGGER.info("handling AssignRemoteInputSignalToWindTurbineType1or2DynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    WindTurbineType1or2Dynamics entity = assignRemoteInputSignal( event.getWindTurbineType1or2DynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignRemoteInputSignalFromWindTurbineType1or2DynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignRemoteInputSignalFromWindTurbineType1or2DynamicsEvent.class)
	public void handle( UnAssignRemoteInputSignalFromWindTurbineType1or2DynamicsEvent event) {
	    LOGGER.info("handling UnAssignRemoteInputSignalFromWindTurbineType1or2DynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindTurbineType1or2Dynamics entity = unAssignRemoteInputSignal( event.getWindTurbineType1or2DynamicsId() );
