...
public class LineProjector extends LineEntityProjector {
    ...
    /*
     * @param	event AssignRegionToLineEvent
     */
    @EventHandler( payloadType=AssignRegionToLineEvent.class)
    public void handle( AssignRegionToLineEvent event) {
	    LOGGER.info("handling AssignRegionToLineEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    Line entity = assignRegion( event.getLineId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignRegionFromLineEvent
	 */
	@EventHandler( payloadType=UnAssignRegionFromLineEvent.class)
	public void handle( UnAssignRegionFromLineEvent event) {
	    LOGGER.info("handling UnAssignRegionFromLineEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    Line entity = unAssignRegion( event.getLineId() );
