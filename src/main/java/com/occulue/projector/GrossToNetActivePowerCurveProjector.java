...
public class GrossToNetActivePowerCurveProjector extends GrossToNetActivePowerCurveEntityProjector {
    ...
    /*
     * @param	event AssignGeneratingUnitToGrossToNetActivePowerCurveEvent
     */
    @EventHandler( payloadType=AssignGeneratingUnitToGrossToNetActivePowerCurveEvent.class)
    public void handle( AssignGeneratingUnitToGrossToNetActivePowerCurveEvent event) {
	    LOGGER.info("handling AssignGeneratingUnitToGrossToNetActivePowerCurveEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    GrossToNetActivePowerCurve entity = assignGeneratingUnit( event.getGrossToNetActivePowerCurveId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignGeneratingUnitFromGrossToNetActivePowerCurveEvent
	 */
	@EventHandler( payloadType=UnAssignGeneratingUnitFromGrossToNetActivePowerCurveEvent.class)
	public void handle( UnAssignGeneratingUnitFromGrossToNetActivePowerCurveEvent event) {
	    LOGGER.info("handling UnAssignGeneratingUnitFromGrossToNetActivePowerCurveEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    GrossToNetActivePowerCurve entity = unAssignGeneratingUnit( event.getGrossToNetActivePowerCurveId() );
