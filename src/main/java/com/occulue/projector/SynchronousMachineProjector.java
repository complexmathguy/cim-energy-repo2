...
public class SynchronousMachineProjector extends SynchronousMachineEntityProjector {
    ...
    public void handle( UpdateSynchronousMachineEvent event) {
        ...
        entity.setInitialReactiveCapabilityCurve( event.getInitialReactiveCapabilityCurve() );
    ...
    /*
     * @param	event AssignInitialReactiveCapabilityCurveToSynchronousMachineEvent
     */
    @EventHandler( payloadType=AssignInitialReactiveCapabilityCurveToSynchronousMachineEvent.class)
    public void handle( AssignInitialReactiveCapabilityCurveToSynchronousMachineEvent event) {
	    LOGGER.info("handling AssignInitialReactiveCapabilityCurveToSynchronousMachineEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachine entity = assignInitialReactiveCapabilityCurve( event.getSynchronousMachineId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignInitialReactiveCapabilityCurveFromSynchronousMachineEvent
	 */
	@EventHandler( payloadType=UnAssignInitialReactiveCapabilityCurveFromSynchronousMachineEvent.class)
	public void handle( UnAssignInitialReactiveCapabilityCurveFromSynchronousMachineEvent event) {
	    LOGGER.info("handling UnAssignInitialReactiveCapabilityCurveFromSynchronousMachineEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachine entity = unAssignInitialReactiveCapabilityCurve( event.getSynchronousMachineId() );
