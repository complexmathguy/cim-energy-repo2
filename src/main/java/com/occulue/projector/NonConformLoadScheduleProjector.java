...
public class NonConformLoadScheduleProjector extends NonConformLoadScheduleEntityProjector {
    ...
    public void handle( UpdateNonConformLoadScheduleEvent event) {
	    ...
	    NonConformLoadSchedule entity = new NonConformLoadSchedule();
        entity.setNonConformLoadScheduleId( event.getNonConformLoadScheduleId() );
        entity.setNonConformLoadGroup( event.getNonConformLoadGroup() );
    ...
    /*
     * @param	event AssignNonConformLoadGroupToNonConformLoadScheduleEvent
     */
    @EventHandler( payloadType=AssignNonConformLoadGroupToNonConformLoadScheduleEvent.class)
    public void handle( AssignNonConformLoadGroupToNonConformLoadScheduleEvent event) {
	    LOGGER.info("handling AssignNonConformLoadGroupToNonConformLoadScheduleEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    NonConformLoadSchedule entity = assignNonConformLoadGroup( event.getNonConformLoadScheduleId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignNonConformLoadGroupFromNonConformLoadScheduleEvent
	 */
	@EventHandler( payloadType=UnAssignNonConformLoadGroupFromNonConformLoadScheduleEvent.class)
	public void handle( UnAssignNonConformLoadGroupFromNonConformLoadScheduleEvent event) {
	    LOGGER.info("handling UnAssignNonConformLoadGroupFromNonConformLoadScheduleEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    NonConformLoadSchedule entity = unAssignNonConformLoadGroup( event.getNonConformLoadScheduleId() );
