...
public class DCTopologicalIslandProjector extends DCTopologicalIslandEntityProjector {
    ...
    public void handle( UpdateDCTopologicalIslandEvent event) {
	    ...
	    DCTopologicalIsland entity = new DCTopologicalIsland();
        entity.setDCTopologicalIslandId( event.getDCTopologicalIslandId() );
        entity.setDCTopologicalNodes( event.getDCTopologicalNodes() );
    ...
    /*
     * @param	event AssignDCTopologicalNodesToDCTopologicalIslandEvent
     */
    @EventHandler( payloadType=AssignDCTopologicalNodesToDCTopologicalIslandEvent.class)
    public void handle( AssignDCTopologicalNodesToDCTopologicalIslandEvent event) {
	    LOGGER.info("handling AssignDCTopologicalNodesToDCTopologicalIslandEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    DCTopologicalIsland entity = assignDCTopologicalNodes( event.getDCTopologicalIslandId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignDCTopologicalNodesFromDCTopologicalIslandEvent
	 */
	@EventHandler( payloadType=UnAssignDCTopologicalNodesFromDCTopologicalIslandEvent.class)
	public void handle( UnAssignDCTopologicalNodesFromDCTopologicalIslandEvent event) {
	    LOGGER.info("handling UnAssignDCTopologicalNodesFromDCTopologicalIslandEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    DCTopologicalIsland entity = unAssignDCTopologicalNodes( event.getDCTopologicalIslandId() );
