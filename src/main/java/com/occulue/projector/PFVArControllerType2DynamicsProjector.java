...
public class PFVArControllerType2DynamicsProjector extends PFVArControllerType2DynamicsEntityProjector {
    ...
    /*
     * @param	event AssignExcitationSystemDynamicsToPFVArControllerType2DynamicsEvent
     */
    @EventHandler( payloadType=AssignExcitationSystemDynamicsToPFVArControllerType2DynamicsEvent.class)
    public void handle( AssignExcitationSystemDynamicsToPFVArControllerType2DynamicsEvent event) {
	    LOGGER.info("handling AssignExcitationSystemDynamicsToPFVArControllerType2DynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArControllerType2Dynamics entity = assignExcitationSystemDynamics( event.getPFVArControllerType2DynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignExcitationSystemDynamicsFromPFVArControllerType2DynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignExcitationSystemDynamicsFromPFVArControllerType2DynamicsEvent.class)
	public void handle( UnAssignExcitationSystemDynamicsFromPFVArControllerType2DynamicsEvent event) {
	    LOGGER.info("handling UnAssignExcitationSystemDynamicsFromPFVArControllerType2DynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    PFVArControllerType2Dynamics entity = unAssignExcitationSystemDynamics( event.getPFVArControllerType2DynamicsId() );
