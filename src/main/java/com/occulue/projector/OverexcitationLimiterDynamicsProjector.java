...
public class OverexcitationLimiterDynamicsProjector extends OverexcitationLimiterDynamicsEntityProjector {
    ...
    /*
     * @param	event AssignExcitationSystemDynamicsToOverexcitationLimiterDynamicsEvent
     */
    @EventHandler( payloadType=AssignExcitationSystemDynamicsToOverexcitationLimiterDynamicsEvent.class)
    public void handle( AssignExcitationSystemDynamicsToOverexcitationLimiterDynamicsEvent event) {
	    LOGGER.info("handling AssignExcitationSystemDynamicsToOverexcitationLimiterDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    OverexcitationLimiterDynamics entity = assignExcitationSystemDynamics( event.getOverexcitationLimiterDynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignExcitationSystemDynamicsFromOverexcitationLimiterDynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignExcitationSystemDynamicsFromOverexcitationLimiterDynamicsEvent.class)
	public void handle( UnAssignExcitationSystemDynamicsFromOverexcitationLimiterDynamicsEvent event) {
	    LOGGER.info("handling UnAssignExcitationSystemDynamicsFromOverexcitationLimiterDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    OverexcitationLimiterDynamics entity = unAssignExcitationSystemDynamics( event.getOverexcitationLimiterDynamicsId() );
