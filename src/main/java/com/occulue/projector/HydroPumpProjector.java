...
public class HydroPumpProjector extends HydroPumpEntityProjector {
    ...
    public void handle( UpdateHydroPumpEvent event) {
        ...
        entity.setHydroPowerPlant( event.getHydroPowerPlant() );
    ...
    /*
     * @param	event AssignRotatingMachineToHydroPumpEvent
     */
    @EventHandler( payloadType=AssignRotatingMachineToHydroPumpEvent.class)
    public void handle( AssignRotatingMachineToHydroPumpEvent event) {
	    LOGGER.info("handling AssignRotatingMachineToHydroPumpEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    HydroPump entity = assignRotatingMachine( event.getHydroPumpId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignRotatingMachineFromHydroPumpEvent
	 */
	@EventHandler( payloadType=UnAssignRotatingMachineFromHydroPumpEvent.class)
	public void handle( UnAssignRotatingMachineFromHydroPumpEvent event) {
	    LOGGER.info("handling UnAssignRotatingMachineFromHydroPumpEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    HydroPump entity = unAssignRotatingMachine( event.getHydroPumpId() );
    ...
    /*
     * @param	event AssignHydroPowerPlantToHydroPumpEvent
     */
    @EventHandler( payloadType=AssignHydroPowerPlantToHydroPumpEvent.class)
    public void handle( AssignHydroPowerPlantToHydroPumpEvent event) {
	    LOGGER.info("handling AssignHydroPowerPlantToHydroPumpEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    HydroPump entity = assignHydroPowerPlant( event.getHydroPumpId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignHydroPowerPlantFromHydroPumpEvent
	 */
	@EventHandler( payloadType=UnAssignHydroPowerPlantFromHydroPumpEvent.class)
	public void handle( UnAssignHydroPowerPlantFromHydroPumpEvent event) {
	    LOGGER.info("handling UnAssignHydroPowerPlantFromHydroPumpEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    HydroPump entity = unAssignHydroPowerPlant( event.getHydroPumpId() );
