...
public class EquipmentProjector extends EquipmentEntityProjector {
    ...
    public void handle( UpdateEquipmentEvent event) {
	    ...
	    Equipment entity = new Equipment();
        entity.setEquipmentId( event.getEquipmentId() );
        entity.setEquipmentContainer( event.getEquipmentContainer() );
    ...
    /*
     * @param	event AssignEquipmentContainerToEquipmentEvent
     */
    @EventHandler( payloadType=AssignEquipmentContainerToEquipmentEvent.class)
    public void handle( AssignEquipmentContainerToEquipmentEvent event) {
	    LOGGER.info("handling AssignEquipmentContainerToEquipmentEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    Equipment entity = assignEquipmentContainer( event.getEquipmentId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignEquipmentContainerFromEquipmentEvent
	 */
	@EventHandler( payloadType=UnAssignEquipmentContainerFromEquipmentEvent.class)
	public void handle( UnAssignEquipmentContainerFromEquipmentEvent event) {
	    LOGGER.info("handling UnAssignEquipmentContainerFromEquipmentEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    Equipment entity = unAssignEquipmentContainer( event.getEquipmentId() );
