...
public class AccumulatorResetProjector extends AccumulatorResetEntityProjector {
    ...
    public void handle( UpdateAccumulatorResetEvent event) {
	    ...
	    AccumulatorReset entity = new AccumulatorReset();
        entity.setAccumulatorResetId( event.getAccumulatorResetId() );
        entity.setAccumulatorValue( event.getAccumulatorValue() );
    ...
    /*
     * @param	event AssignAccumulatorValueToAccumulatorResetEvent
     */
    @EventHandler( payloadType=AssignAccumulatorValueToAccumulatorResetEvent.class)
    public void handle( AssignAccumulatorValueToAccumulatorResetEvent event) {
	    LOGGER.info("handling AssignAccumulatorValueToAccumulatorResetEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    AccumulatorReset entity = assignAccumulatorValue( event.getAccumulatorResetId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignAccumulatorValueFromAccumulatorResetEvent
	 */
	@EventHandler( payloadType=UnAssignAccumulatorValueFromAccumulatorResetEvent.class)
	public void handle( UnAssignAccumulatorValueFromAccumulatorResetEvent event) {
	    LOGGER.info("handling UnAssignAccumulatorValueFromAccumulatorResetEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    AccumulatorReset entity = unAssignAccumulatorValue( event.getAccumulatorResetId() );
