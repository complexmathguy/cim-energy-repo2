...
public class MeasurementProjector extends MeasurementEntityProjector {
    ...
    public void handle( UpdateMeasurementEvent event) {
        ...
        entity.setUnitMultiplier( event.getUnitMultiplier() );
        entity.setUnitSymbol( event.getUnitSymbol() );
        entity.setPowerSystemResource( event.getPowerSystemResource() );
    ...
    /*
     * @param	event AssignPowerSystemResourceToMeasurementEvent
     */
    @EventHandler( payloadType=AssignPowerSystemResourceToMeasurementEvent.class)
    public void handle( AssignPowerSystemResourceToMeasurementEvent event) {
	    LOGGER.info("handling AssignPowerSystemResourceToMeasurementEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    Measurement entity = assignPowerSystemResource( event.getMeasurementId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignPowerSystemResourceFromMeasurementEvent
	 */
	@EventHandler( payloadType=UnAssignPowerSystemResourceFromMeasurementEvent.class)
	public void handle( UnAssignPowerSystemResourceFromMeasurementEvent event) {
	    LOGGER.info("handling UnAssignPowerSystemResourceFromMeasurementEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    Measurement entity = unAssignPowerSystemResource( event.getMeasurementId() );
    ...
    /*
     * @param	event AssignTerminalToMeasurementEvent
     */
    @EventHandler( payloadType=AssignTerminalToMeasurementEvent.class)
    public void handle( AssignTerminalToMeasurementEvent event) {
	    LOGGER.info("handling AssignTerminalToMeasurementEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    Measurement entity = assignTerminal( event.getMeasurementId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignTerminalFromMeasurementEvent
	 */
	@EventHandler( payloadType=UnAssignTerminalFromMeasurementEvent.class)
	public void handle( UnAssignTerminalFromMeasurementEvent event) {
	    LOGGER.info("handling UnAssignTerminalFromMeasurementEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    Measurement entity = unAssignTerminal( event.getMeasurementId() );
