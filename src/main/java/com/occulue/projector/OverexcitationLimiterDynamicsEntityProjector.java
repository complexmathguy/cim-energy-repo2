...
public class OverexcitationLimiterDynamicsEntityProjector {
     ...
     */
    public OverexcitationLimiterDynamics assignExcitationSystemDynamics( UUID parentId, ExcitationSystemDynamics assignment ) {
	 ...
	 * @return	OverexcitationLimiterDynamics
	 */
	public OverexcitationLimiterDynamics unAssignExcitationSystemDynamics( UUID parentId ) {
		OverexcitationLimiterDynamics parentEntity = repository.findById(parentId).get();
