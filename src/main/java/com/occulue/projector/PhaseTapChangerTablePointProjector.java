...
public class PhaseTapChangerTablePointProjector extends PhaseTapChangerTablePointEntityProjector {
    ...
    public void handle( UpdatePhaseTapChangerTablePointEvent event) {
        ...
        entity.setPhaseTapChangerTable( event.getPhaseTapChangerTable() );
    ...
    /*
     * @param	event AssignPhaseTapChangerTableToPhaseTapChangerTablePointEvent
     */
    @EventHandler( payloadType=AssignPhaseTapChangerTableToPhaseTapChangerTablePointEvent.class)
    public void handle( AssignPhaseTapChangerTableToPhaseTapChangerTablePointEvent event) {
	    LOGGER.info("handling AssignPhaseTapChangerTableToPhaseTapChangerTablePointEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    PhaseTapChangerTablePoint entity = assignPhaseTapChangerTable( event.getPhaseTapChangerTablePointId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignPhaseTapChangerTableFromPhaseTapChangerTablePointEvent
	 */
	@EventHandler( payloadType=UnAssignPhaseTapChangerTableFromPhaseTapChangerTablePointEvent.class)
	public void handle( UnAssignPhaseTapChangerTableFromPhaseTapChangerTablePointEvent event) {
	    LOGGER.info("handling UnAssignPhaseTapChangerTableFromPhaseTapChangerTablePointEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    PhaseTapChangerTablePoint entity = unAssignPhaseTapChangerTable( event.getPhaseTapChangerTablePointId() );
