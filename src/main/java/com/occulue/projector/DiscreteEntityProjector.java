...
public class DiscreteEntityProjector {
     ...
     * @return	Discrete
     */
    public Discrete addToValueAliasSet( UUID parentId, ValueAliasSet addTo ) {
	    LOGGER.info("handling AssignValueAliasSetToDiscreteEvent - " );
     ...
     * @return	Discrete
     */
	public Discrete removeFromValueAliasSet( UUID parentId, ValueAliasSet removeFrom ) {
	    LOGGER.info("handling RemoveValueAliasSetFromDiscreteEvent " );
