...
public class MutualCouplingEntityProjector {
    ...
    /*
     * Assign a Second_Terminal
     * 
     * @param	parentId	UUID
     * @param	assignment 	Terminal 
     * @return	MutualCoupling
     */
    public MutualCoupling assignSecond_Terminal( UUID parentId, Terminal assignment ) {
	    LOGGER.info("assigning Second_Terminal as " + assignment.toString() );

	    MutualCoupling parentEntity = repository.findById( parentId ).get();
	    assignment = TerminalProjector.find(assignment.getTerminalId());
	    
	    // ------------------------------------------
		// assign the Second_Terminal to the parent entity
		// ------------------------------------------ 
	    parentEntity.setSecond_Terminal( assignment );
	...
	/*
	 * Unassign the Second_Terminal
	 * 
	 * @param	parentId		UUID
	 * @return	MutualCoupling
	 */
	public MutualCoupling unAssignSecond_Terminal( UUID parentId ) {
		MutualCoupling parentEntity = repository.findById(parentId).get();

		LOGGER.info("unAssigning Second_Terminal on " + parentEntity.toString() );
		
	    // ------------------------------------------
		// null out the Second_Terminal on the parent entithy
		// ------------------------------------------     
	    parentEntity.setSecond_Terminal(null);
    ...
    /*
     * Assign a First_Terminal
     * 
     * @param	parentId	UUID
     * @param	assignment 	Terminal 
     * @return	MutualCoupling
     */
    public MutualCoupling assignFirst_Terminal( UUID parentId, Terminal assignment ) {
	    LOGGER.info("assigning First_Terminal as " + assignment.toString() );

	    MutualCoupling parentEntity = repository.findById( parentId ).get();
	    assignment = TerminalProjector.find(assignment.getTerminalId());
	    
	    // ------------------------------------------
		// assign the First_Terminal to the parent entity
		// ------------------------------------------ 
	    parentEntity.setFirst_Terminal( assignment );
	...
	/*
	 * Unassign the First_Terminal
	 * 
	 * @param	parentId		UUID
	 * @return	MutualCoupling
	 */
	public MutualCoupling unAssignFirst_Terminal( UUID parentId ) {
		MutualCoupling parentEntity = repository.findById(parentId).get();

		LOGGER.info("unAssigning First_Terminal on " + parentEntity.toString() );
		
	    // ------------------------------------------
		// null out the First_Terminal on the parent entithy
		// ------------------------------------------     
	    parentEntity.setFirst_Terminal(null);
