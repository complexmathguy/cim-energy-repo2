...
public class AccumulatorLimitSetProjector extends AccumulatorLimitSetEntityProjector {
    ...
    /*
     * @param	event AssignMeasurementsToAccumulatorLimitSetEvent
     */
    @EventHandler( payloadType=AssignMeasurementsToAccumulatorLimitSetEvent.class)
    public void handle( AssignMeasurementsToAccumulatorLimitSetEvent event) {
	    LOGGER.info("handling AssignMeasurementsToAccumulatorLimitSetEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    AccumulatorLimitSet entity = assignMeasurements( event.getAccumulatorLimitSetId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignMeasurementsFromAccumulatorLimitSetEvent
	 */
	@EventHandler( payloadType=UnAssignMeasurementsFromAccumulatorLimitSetEvent.class)
	public void handle( UnAssignMeasurementsFromAccumulatorLimitSetEvent event) {
	    LOGGER.info("handling UnAssignMeasurementsFromAccumulatorLimitSetEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    AccumulatorLimitSet entity = unAssignMeasurements( event.getAccumulatorLimitSetId() );
