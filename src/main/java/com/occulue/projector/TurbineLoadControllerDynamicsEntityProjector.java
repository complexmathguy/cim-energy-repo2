...
public class TurbineLoadControllerDynamicsEntityProjector {
     ...
     */
    public TurbineLoadControllerDynamics assignTurbineGovernorDynamics( UUID parentId, TurbineGovernorDynamics assignment ) {
	 ...
	 * @return	TurbineLoadControllerDynamics
	 */
	public TurbineLoadControllerDynamics unAssignTurbineGovernorDynamics( UUID parentId ) {
		TurbineLoadControllerDynamics parentEntity = repository.findById(parentId).get();
