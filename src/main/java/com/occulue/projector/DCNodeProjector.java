...
public class DCNodeProjector extends DCNodeEntityProjector {
    ...
    /*
     * @param	event AssignDCEquipmentContainerToDCNodeEvent
     */
    @EventHandler( payloadType=AssignDCEquipmentContainerToDCNodeEvent.class)
    public void handle( AssignDCEquipmentContainerToDCNodeEvent event) {
	    LOGGER.info("handling AssignDCEquipmentContainerToDCNodeEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    DCNode entity = assignDCEquipmentContainer( event.getDCNodeId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignDCEquipmentContainerFromDCNodeEvent
	 */
	@EventHandler( payloadType=UnAssignDCEquipmentContainerFromDCNodeEvent.class)
	public void handle( UnAssignDCEquipmentContainerFromDCNodeEvent event) {
	    LOGGER.info("handling UnAssignDCEquipmentContainerFromDCNodeEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    DCNode entity = unAssignDCEquipmentContainer( event.getDCNodeId() );
