...
public class BayProjector extends BayEntityProjector {
    ...
    /*
     * @param	event AssignVoltageLevelToBayEvent
     */
    @EventHandler( payloadType=AssignVoltageLevelToBayEvent.class)
    public void handle( AssignVoltageLevelToBayEvent event) {
	    LOGGER.info("handling AssignVoltageLevelToBayEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    Bay entity = assignVoltageLevel( event.getBayId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignVoltageLevelFromBayEvent
	 */
	@EventHandler( payloadType=UnAssignVoltageLevelFromBayEvent.class)
	public void handle( UnAssignVoltageLevelFromBayEvent event) {
	    LOGGER.info("handling UnAssignVoltageLevelFromBayEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    Bay entity = unAssignVoltageLevel( event.getBayId() );
