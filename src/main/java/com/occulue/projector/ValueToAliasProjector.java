...
public class ValueToAliasProjector extends ValueToAliasEntityProjector {
    ...
    /*
     * @param	event AssignValueAliasSetToValueToAliasEvent
     */
    @EventHandler( payloadType=AssignValueAliasSetToValueToAliasEvent.class)
    public void handle( AssignValueAliasSetToValueToAliasEvent event) {
	    LOGGER.info("handling AssignValueAliasSetToValueToAliasEvent - " + event );
	    
	    // ------------------------------------------
    	// delegate to addTo 
    	// ------------------------------------------ 
	    ValueToAlias entity = addToValueAliasSet(event.getValueToAliasId(), event.getAddTo() );
...
/*
 * @param	event RemoveValueAliasSetFromValueToAliasEvent
 */
@EventHandler( payloadType=RemoveValueAliasSetFromValueToAliasEvent.class)
public void handle( RemoveValueAliasSetFromValueToAliasEvent event) {
    LOGGER.info("handling RemoveValueAliasSetFromValueToAliasEvent - " + event );

    ValueToAlias entity = removeFromValueAliasSet(event.getValueToAliasId(), event.getRemoveFrom() );
