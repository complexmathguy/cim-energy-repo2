...
public class SeasonDayTypeScheduleProjector extends SeasonDayTypeScheduleEntityProjector {
    ...
    public void handle( UpdateSeasonDayTypeScheduleEvent event) {
	    ...
	    SeasonDayTypeSchedule entity = new SeasonDayTypeSchedule();
        entity.setSeasonDayTypeScheduleId( event.getSeasonDayTypeScheduleId() );
        entity.setSeason( event.getSeason() );
        entity.setDayType( event.getDayType() );
    ...
    /*
     * @param	event AssignSeasonToSeasonDayTypeScheduleEvent
     */
    @EventHandler( payloadType=AssignSeasonToSeasonDayTypeScheduleEvent.class)
    public void handle( AssignSeasonToSeasonDayTypeScheduleEvent event) {
	    LOGGER.info("handling AssignSeasonToSeasonDayTypeScheduleEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SeasonDayTypeSchedule entity = assignSeason( event.getSeasonDayTypeScheduleId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignSeasonFromSeasonDayTypeScheduleEvent
	 */
	@EventHandler( payloadType=UnAssignSeasonFromSeasonDayTypeScheduleEvent.class)
	public void handle( UnAssignSeasonFromSeasonDayTypeScheduleEvent event) {
	    LOGGER.info("handling UnAssignSeasonFromSeasonDayTypeScheduleEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SeasonDayTypeSchedule entity = unAssignSeason( event.getSeasonDayTypeScheduleId() );
    ...
    /*
     * @param	event AssignDayTypeToSeasonDayTypeScheduleEvent
     */
    @EventHandler( payloadType=AssignDayTypeToSeasonDayTypeScheduleEvent.class)
    public void handle( AssignDayTypeToSeasonDayTypeScheduleEvent event) {
	    LOGGER.info("handling AssignDayTypeToSeasonDayTypeScheduleEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SeasonDayTypeSchedule entity = assignDayType( event.getSeasonDayTypeScheduleId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignDayTypeFromSeasonDayTypeScheduleEvent
	 */
	@EventHandler( payloadType=UnAssignDayTypeFromSeasonDayTypeScheduleEvent.class)
	public void handle( UnAssignDayTypeFromSeasonDayTypeScheduleEvent event) {
	    LOGGER.info("handling UnAssignDayTypeFromSeasonDayTypeScheduleEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SeasonDayTypeSchedule entity = unAssignDayType( event.getSeasonDayTypeScheduleId() );
