...
public class StringMeasurementValueProjector extends StringMeasurementValueEntityProjector {
    ...
    public void handle( UpdateStringMeasurementValueEvent event) {
        ...
        entity.setStringMeasurement( event.getStringMeasurement() );
    ...
    /*
     * @param	event AssignStringMeasurementToStringMeasurementValueEvent
     */
    @EventHandler( payloadType=AssignStringMeasurementToStringMeasurementValueEvent.class)
    public void handle( AssignStringMeasurementToStringMeasurementValueEvent event) {
	    LOGGER.info("handling AssignStringMeasurementToStringMeasurementValueEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    StringMeasurementValue entity = assignStringMeasurement( event.getStringMeasurementValueId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignStringMeasurementFromStringMeasurementValueEvent
	 */
	@EventHandler( payloadType=UnAssignStringMeasurementFromStringMeasurementValueEvent.class)
	public void handle( UnAssignStringMeasurementFromStringMeasurementValueEvent event) {
	    LOGGER.info("handling UnAssignStringMeasurementFromStringMeasurementValueEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    StringMeasurementValue entity = unAssignStringMeasurement( event.getStringMeasurementValueId() );
