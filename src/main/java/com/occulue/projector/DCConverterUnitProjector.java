...
public class DCConverterUnitProjector extends DCConverterUnitEntityProjector {
    ...
    /*
     * @param	event AssignSubstationToDCConverterUnitEvent
     */
    @EventHandler( payloadType=AssignSubstationToDCConverterUnitEvent.class)
    public void handle( AssignSubstationToDCConverterUnitEvent event) {
	    LOGGER.info("handling AssignSubstationToDCConverterUnitEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    DCConverterUnit entity = assignSubstation( event.getDCConverterUnitId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignSubstationFromDCConverterUnitEvent
	 */
	@EventHandler( payloadType=UnAssignSubstationFromDCConverterUnitEvent.class)
	public void handle( UnAssignSubstationFromDCConverterUnitEvent event) {
	    LOGGER.info("handling UnAssignSubstationFromDCConverterUnitEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    DCConverterUnit entity = unAssignSubstation( event.getDCConverterUnitId() );
