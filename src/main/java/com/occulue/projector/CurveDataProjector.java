...
public class CurveDataProjector extends CurveDataEntityProjector {
    ...
    public void handle( UpdateCurveDataEvent event) {
        ...
        entity.setCurve( event.getCurve() );
    ...
    /*
     * @param	event AssignCurveToCurveDataEvent
     */
    @EventHandler( payloadType=AssignCurveToCurveDataEvent.class)
    public void handle( AssignCurveToCurveDataEvent event) {
	    LOGGER.info("handling AssignCurveToCurveDataEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    CurveData entity = assignCurve( event.getCurveDataId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignCurveFromCurveDataEvent
	 */
	@EventHandler( payloadType=UnAssignCurveFromCurveDataEvent.class)
	public void handle( UnAssignCurveFromCurveDataEvent event) {
	    LOGGER.info("handling UnAssignCurveFromCurveDataEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    CurveData entity = unAssignCurve( event.getCurveDataId() );
