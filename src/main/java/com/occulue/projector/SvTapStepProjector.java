...
public class SvTapStepProjector extends SvTapStepEntityProjector {
    ...
    /*
     * @param	event AssignTapChangerToSvTapStepEvent
     */
    @EventHandler( payloadType=AssignTapChangerToSvTapStepEvent.class)
    public void handle( AssignTapChangerToSvTapStepEvent event) {
	    LOGGER.info("handling AssignTapChangerToSvTapStepEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SvTapStep entity = assignTapChanger( event.getSvTapStepId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignTapChangerFromSvTapStepEvent
	 */
	@EventHandler( payloadType=UnAssignTapChangerFromSvTapStepEvent.class)
	public void handle( UnAssignTapChangerFromSvTapStepEvent event) {
	    LOGGER.info("handling UnAssignTapChangerFromSvTapStepEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SvTapStep entity = unAssignTapChanger( event.getSvTapStepId() );
