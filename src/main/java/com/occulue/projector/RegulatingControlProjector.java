...
public class RegulatingControlProjector extends RegulatingControlEntityProjector {
    ...
    /*
     * @param	event AssignTerminalToRegulatingControlEvent
     */
    @EventHandler( payloadType=AssignTerminalToRegulatingControlEvent.class)
    public void handle( AssignTerminalToRegulatingControlEvent event) {
	    LOGGER.info("handling AssignTerminalToRegulatingControlEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    RegulatingControl entity = assignTerminal( event.getRegulatingControlId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignTerminalFromRegulatingControlEvent
	 */
	@EventHandler( payloadType=UnAssignTerminalFromRegulatingControlEvent.class)
	public void handle( UnAssignTerminalFromRegulatingControlEvent event) {
	    LOGGER.info("handling UnAssignTerminalFromRegulatingControlEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    RegulatingControl entity = unAssignTerminal( event.getRegulatingControlId() );
