...
public class ControlAreaProjector extends ControlAreaEntityProjector {
    ...
    public void handle( UpdateControlAreaEvent event) {
        ...
        entity.setControlAreaId( event.getControlAreaId() );
        entity.setType( event.getType() );
        entity.setEnergyArea( event.getEnergyArea() );
    ...
    /*
     * @param	event AssignEnergyAreaToControlAreaEvent
     */
    @EventHandler( payloadType=AssignEnergyAreaToControlAreaEvent.class)
    public void handle( AssignEnergyAreaToControlAreaEvent event) {
	    LOGGER.info("handling AssignEnergyAreaToControlAreaEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    ControlArea entity = assignEnergyArea( event.getControlAreaId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignEnergyAreaFromControlAreaEvent
	 */
	@EventHandler( payloadType=UnAssignEnergyAreaFromControlAreaEvent.class)
	public void handle( UnAssignEnergyAreaFromControlAreaEvent event) {
	    LOGGER.info("handling UnAssignEnergyAreaFromControlAreaEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    ControlArea entity = unAssignEnergyArea( event.getControlAreaId() );
