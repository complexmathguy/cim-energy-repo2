...
public class SvShuntCompensatorSectionsProjector extends SvShuntCompensatorSectionsEntityProjector {
    ...
    public void handle( UpdateSvShuntCompensatorSectionsEvent event) {
        ...
        entity.setShuntCompensator( event.getShuntCompensator() );
    ...
    /*
     * @param	event AssignShuntCompensatorToSvShuntCompensatorSectionsEvent
     */
    @EventHandler( payloadType=AssignShuntCompensatorToSvShuntCompensatorSectionsEvent.class)
    public void handle( AssignShuntCompensatorToSvShuntCompensatorSectionsEvent event) {
	    LOGGER.info("handling AssignShuntCompensatorToSvShuntCompensatorSectionsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SvShuntCompensatorSections entity = assignShuntCompensator( event.getSvShuntCompensatorSectionsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignShuntCompensatorFromSvShuntCompensatorSectionsEvent
	 */
	@EventHandler( payloadType=UnAssignShuntCompensatorFromSvShuntCompensatorSectionsEvent.class)
	public void handle( UnAssignShuntCompensatorFromSvShuntCompensatorSectionsEvent event) {
	    LOGGER.info("handling UnAssignShuntCompensatorFromSvShuntCompensatorSectionsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SvShuntCompensatorSections entity = unAssignShuntCompensator( event.getSvShuntCompensatorSectionsId() );
