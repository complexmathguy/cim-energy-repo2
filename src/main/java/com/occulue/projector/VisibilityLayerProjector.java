...
public class VisibilityLayerProjector extends VisibilityLayerEntityProjector {
    ...
    public void handle( UpdateVisibilityLayerEvent event) {
        ...
        entity.setVisibleObjects( event.getVisibleObjects() );
    ...
    /*
     * @param	event AssignVisibleObjectsToVisibilityLayerEvent
     */
    @EventHandler( payloadType=AssignVisibleObjectsToVisibilityLayerEvent.class)
    public void handle( AssignVisibleObjectsToVisibilityLayerEvent event) {
	    LOGGER.info("handling AssignVisibleObjectsToVisibilityLayerEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    VisibilityLayer entity = assignVisibleObjects( event.getVisibilityLayerId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignVisibleObjectsFromVisibilityLayerEvent
	 */
	@EventHandler( payloadType=UnAssignVisibleObjectsFromVisibilityLayerEvent.class)
	public void handle( UnAssignVisibleObjectsFromVisibilityLayerEvent event) {
	    LOGGER.info("handling UnAssignVisibleObjectsFromVisibilityLayerEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    VisibilityLayer entity = unAssignVisibleObjects( event.getVisibilityLayerId() );
