...
public class SubLoadAreaProjector extends SubLoadAreaEntityProjector {
    ...
    public void handle( UpdateSubLoadAreaEvent event) {
	    ...
	    SubLoadArea entity = new SubLoadArea();
        entity.setSubLoadAreaId( event.getSubLoadAreaId() );
        entity.setLoadArea( event.getLoadArea() );
    ...
    /*
     * @param	event AssignLoadAreaToSubLoadAreaEvent
     */
    @EventHandler( payloadType=AssignLoadAreaToSubLoadAreaEvent.class)
    public void handle( AssignLoadAreaToSubLoadAreaEvent event) {
	    LOGGER.info("handling AssignLoadAreaToSubLoadAreaEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SubLoadArea entity = assignLoadArea( event.getSubLoadAreaId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignLoadAreaFromSubLoadAreaEvent
	 */
	@EventHandler( payloadType=UnAssignLoadAreaFromSubLoadAreaEvent.class)
	public void handle( UnAssignLoadAreaFromSubLoadAreaEvent event) {
	    LOGGER.info("handling UnAssignLoadAreaFromSubLoadAreaEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SubLoadArea entity = unAssignLoadArea( event.getSubLoadAreaId() );
