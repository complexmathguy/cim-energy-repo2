...
public class RatioTapChangerTablePointEntityProjector {
     ...
     */
    public RatioTapChangerTablePoint assignRatioTapChangerTable( UUID parentId, RatioTapChangerTable assignment ) {
	 ...
	 * @return	RatioTapChangerTablePoint
	 */
	public RatioTapChangerTablePoint unAssignRatioTapChangerTable( UUID parentId ) {
		RatioTapChangerTablePoint parentEntity = repository.findById(parentId).get();
