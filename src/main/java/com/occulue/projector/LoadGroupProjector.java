...
public class LoadGroupProjector extends LoadGroupEntityProjector {
    ...
    public void handle( UpdateLoadGroupEvent event) {
	    ...
	    LoadGroup entity = new LoadGroup();
        entity.setLoadGroupId( event.getLoadGroupId() );
        entity.setSubLoadArea( event.getSubLoadArea() );
    ...
    /*
     * @param	event AssignSubLoadAreaToLoadGroupEvent
     */
    @EventHandler( payloadType=AssignSubLoadAreaToLoadGroupEvent.class)
    public void handle( AssignSubLoadAreaToLoadGroupEvent event) {
	    LOGGER.info("handling AssignSubLoadAreaToLoadGroupEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadGroup entity = assignSubLoadArea( event.getLoadGroupId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignSubLoadAreaFromLoadGroupEvent
	 */
	@EventHandler( payloadType=UnAssignSubLoadAreaFromLoadGroupEvent.class)
	public void handle( UnAssignSubLoadAreaFromLoadGroupEvent event) {
	    LOGGER.info("handling UnAssignSubLoadAreaFromLoadGroupEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    LoadGroup entity = unAssignSubLoadArea( event.getLoadGroupId() );
