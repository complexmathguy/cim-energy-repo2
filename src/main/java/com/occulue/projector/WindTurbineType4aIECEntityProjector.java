...
public class WindTurbineType4aIECEntityProjector {
    ...
    /*
     * Assign a WindContPType4aIEC
     * 
     * @param	parentId	UUID
     * @param	assignment 	WindContPType4aIEC 
     * @return	WindTurbineType4aIEC
     */
    public WindTurbineType4aIEC assignWindContPType4aIEC( UUID parentId, WindContPType4aIEC assignment ) {
	    LOGGER.info("assigning WindContPType4aIEC as " + assignment.toString() );

	    WindTurbineType4aIEC parentEntity = repository.findById( parentId ).get();
	    assignment = WindContPType4aIECProjector.find(assignment.getWindContPType4aIECId());
	    
	    // ------------------------------------------
		// assign the WindContPType4aIEC to the parent entity
		// ------------------------------------------ 
	    parentEntity.setWindContPType4aIEC( assignment );
	...
	/*
	 * Unassign the WindContPType4aIEC
	 * 
	 * @param	parentId		UUID
	 * @return	WindTurbineType4aIEC
	 */
	public WindTurbineType4aIEC unAssignWindContPType4aIEC( UUID parentId ) {
		WindTurbineType4aIEC parentEntity = repository.findById(parentId).get();

		LOGGER.info("unAssigning WindContPType4aIEC on " + parentEntity.toString() );
		
	    // ------------------------------------------
		// null out the WindContPType4aIEC on the parent entithy
		// ------------------------------------------     
	    parentEntity.setWindContPType4aIEC(null);
