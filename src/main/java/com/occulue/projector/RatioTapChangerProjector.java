...
public class RatioTapChangerProjector extends RatioTapChangerEntityProjector {
    ...
    public void handle( UpdateRatioTapChangerEvent event) {
        ...
        entity.setRatioTapChangerTable( event.getRatioTapChangerTable() );
    ...
    /*
     * @param	event AssignTransformerEndToRatioTapChangerEvent
     */
    @EventHandler( payloadType=AssignTransformerEndToRatioTapChangerEvent.class)
    public void handle( AssignTransformerEndToRatioTapChangerEvent event) {
	    LOGGER.info("handling AssignTransformerEndToRatioTapChangerEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    RatioTapChanger entity = assignTransformerEnd( event.getRatioTapChangerId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignTransformerEndFromRatioTapChangerEvent
	 */
	@EventHandler( payloadType=UnAssignTransformerEndFromRatioTapChangerEvent.class)
	public void handle( UnAssignTransformerEndFromRatioTapChangerEvent event) {
	    LOGGER.info("handling UnAssignTransformerEndFromRatioTapChangerEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    RatioTapChanger entity = unAssignTransformerEnd( event.getRatioTapChangerId() );
    ...
    /*
     * @param	event AssignRatioTapChangerTableToRatioTapChangerEvent
     */
    @EventHandler( payloadType=AssignRatioTapChangerTableToRatioTapChangerEvent.class)
    public void handle( AssignRatioTapChangerTableToRatioTapChangerEvent event) {
	    LOGGER.info("handling AssignRatioTapChangerTableToRatioTapChangerEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    RatioTapChanger entity = assignRatioTapChangerTable( event.getRatioTapChangerId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignRatioTapChangerTableFromRatioTapChangerEvent
	 */
	@EventHandler( payloadType=UnAssignRatioTapChangerTableFromRatioTapChangerEvent.class)
	public void handle( UnAssignRatioTapChangerTableFromRatioTapChangerEvent event) {
	    LOGGER.info("handling UnAssignRatioTapChangerTableFromRatioTapChangerEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    RatioTapChanger entity = unAssignRatioTapChangerTable( event.getRatioTapChangerId() );
