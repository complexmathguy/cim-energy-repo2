...
public class SvPowerFlowProjector extends SvPowerFlowEntityProjector {
    ...
    /*
     * @param	event AssignTerminalToSvPowerFlowEvent
     */
    @EventHandler( payloadType=AssignTerminalToSvPowerFlowEvent.class)
    public void handle( AssignTerminalToSvPowerFlowEvent event) {
	    LOGGER.info("handling AssignTerminalToSvPowerFlowEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SvPowerFlow entity = assignTerminal( event.getSvPowerFlowId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignTerminalFromSvPowerFlowEvent
	 */
	@EventHandler( payloadType=UnAssignTerminalFromSvPowerFlowEvent.class)
	public void handle( UnAssignTerminalFromSvPowerFlowEvent event) {
	    LOGGER.info("handling UnAssignTerminalFromSvPowerFlowEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SvPowerFlow entity = unAssignTerminal( event.getSvPowerFlowId() );
