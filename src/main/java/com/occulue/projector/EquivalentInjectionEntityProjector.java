...
public class EquivalentInjectionEntityProjector {
    ...
    /*
     * Assign a ReactiveCapabilityCurve
     * 
     * @param	parentId	UUID
     * @param	assignment 	ReactiveCapabilityCurve 
     * @return	EquivalentInjection
     */
    public EquivalentInjection assignReactiveCapabilityCurve( UUID parentId, ReactiveCapabilityCurve assignment ) {
	    LOGGER.info("assigning ReactiveCapabilityCurve as " + assignment.toString() );

	    EquivalentInjection parentEntity = repository.findById( parentId ).get();
	    assignment = ReactiveCapabilityCurveProjector.find(assignment.getReactiveCapabilityCurveId());
	    
	    // ------------------------------------------
		// assign the ReactiveCapabilityCurve to the parent entity
		// ------------------------------------------ 
	    parentEntity.setReactiveCapabilityCurve( assignment );
	...
	/*
	 * Unassign the ReactiveCapabilityCurve
	 * 
	 * @param	parentId		UUID
	 * @return	EquivalentInjection
	 */
	public EquivalentInjection unAssignReactiveCapabilityCurve( UUID parentId ) {
		EquivalentInjection parentEntity = repository.findById(parentId).get();

		LOGGER.info("unAssigning ReactiveCapabilityCurve on " + parentEntity.toString() );
		
	    // ------------------------------------------
		// null out the ReactiveCapabilityCurve on the parent entithy
		// ------------------------------------------     
	    parentEntity.setReactiveCapabilityCurve(null);
