...
public class TopologicalIslandProjector extends TopologicalIslandEntityProjector {
    ...
    public void handle( UpdateTopologicalIslandEvent event) {
	    ...
	    TopologicalIsland entity = new TopologicalIsland();
        entity.setTopologicalIslandId( event.getTopologicalIslandId() );
        entity.setTopologicalNodes( event.getTopologicalNodes() );
        entity.setAngleRefTopologicalNode( event.getAngleRefTopologicalNode() );
    ...
    /*
     * @param	event AssignTopologicalNodesToTopologicalIslandEvent
     */
    @EventHandler( payloadType=AssignTopologicalNodesToTopologicalIslandEvent.class)
    public void handle( AssignTopologicalNodesToTopologicalIslandEvent event) {
	    LOGGER.info("handling AssignTopologicalNodesToTopologicalIslandEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologicalIsland entity = assignTopologicalNodes( event.getTopologicalIslandId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignTopologicalNodesFromTopologicalIslandEvent
	 */
	@EventHandler( payloadType=UnAssignTopologicalNodesFromTopologicalIslandEvent.class)
	public void handle( UnAssignTopologicalNodesFromTopologicalIslandEvent event) {
	    LOGGER.info("handling UnAssignTopologicalNodesFromTopologicalIslandEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    TopologicalIsland entity = unAssignTopologicalNodes( event.getTopologicalIslandId() );
    ...
    /*
     * @param	event AssignAngleRefTopologicalNodeToTopologicalIslandEvent
     */
    @EventHandler( payloadType=AssignAngleRefTopologicalNodeToTopologicalIslandEvent.class)
    public void handle( AssignAngleRefTopologicalNodeToTopologicalIslandEvent event) {
	    LOGGER.info("handling AssignAngleRefTopologicalNodeToTopologicalIslandEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologicalIsland entity = assignAngleRefTopologicalNode( event.getTopologicalIslandId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignAngleRefTopologicalNodeFromTopologicalIslandEvent
	 */
	@EventHandler( payloadType=UnAssignAngleRefTopologicalNodeFromTopologicalIslandEvent.class)
	public void handle( UnAssignAngleRefTopologicalNodeFromTopologicalIslandEvent event) {
	    LOGGER.info("handling UnAssignAngleRefTopologicalNodeFromTopologicalIslandEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    TopologicalIsland entity = unAssignAngleRefTopologicalNode( event.getTopologicalIslandId() );
