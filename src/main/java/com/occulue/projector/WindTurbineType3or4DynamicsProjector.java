...
public class WindTurbineType3or4DynamicsProjector extends WindTurbineType3or4DynamicsEntityProjector {
    ...
    /*
     * @param	event AssignEnergySourceToWindTurbineType3or4DynamicsEvent
     */
    @EventHandler( payloadType=AssignEnergySourceToWindTurbineType3or4DynamicsEvent.class)
    public void handle( AssignEnergySourceToWindTurbineType3or4DynamicsEvent event) {
	    LOGGER.info("handling AssignEnergySourceToWindTurbineType3or4DynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    WindTurbineType3or4Dynamics entity = assignEnergySource( event.getWindTurbineType3or4DynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignEnergySourceFromWindTurbineType3or4DynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignEnergySourceFromWindTurbineType3or4DynamicsEvent.class)
	public void handle( UnAssignEnergySourceFromWindTurbineType3or4DynamicsEvent event) {
	    LOGGER.info("handling UnAssignEnergySourceFromWindTurbineType3or4DynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindTurbineType3or4Dynamics entity = unAssignEnergySource( event.getWindTurbineType3or4DynamicsId() );
    ...
    /*
     * @param	event AssignWindPlantDynamicsToWindTurbineType3or4DynamicsEvent
     */
    @EventHandler( payloadType=AssignWindPlantDynamicsToWindTurbineType3or4DynamicsEvent.class)
    public void handle( AssignWindPlantDynamicsToWindTurbineType3or4DynamicsEvent event) {
	    LOGGER.info("handling AssignWindPlantDynamicsToWindTurbineType3or4DynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    WindTurbineType3or4Dynamics entity = assignWindPlantDynamics( event.getWindTurbineType3or4DynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignWindPlantDynamicsFromWindTurbineType3or4DynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignWindPlantDynamicsFromWindTurbineType3or4DynamicsEvent.class)
	public void handle( UnAssignWindPlantDynamicsFromWindTurbineType3or4DynamicsEvent event) {
	    LOGGER.info("handling UnAssignWindPlantDynamicsFromWindTurbineType3or4DynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindTurbineType3or4Dynamics entity = unAssignWindPlantDynamics( event.getWindTurbineType3or4DynamicsId() );
    ...
    /*
     * @param	event AssignRemoteInputSignalToWindTurbineType3or4DynamicsEvent
     */
    @EventHandler( payloadType=AssignRemoteInputSignalToWindTurbineType3or4DynamicsEvent.class)
    public void handle( AssignRemoteInputSignalToWindTurbineType3or4DynamicsEvent event) {
	    LOGGER.info("handling AssignRemoteInputSignalToWindTurbineType3or4DynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    WindTurbineType3or4Dynamics entity = assignRemoteInputSignal( event.getWindTurbineType3or4DynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignRemoteInputSignalFromWindTurbineType3or4DynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignRemoteInputSignalFromWindTurbineType3or4DynamicsEvent.class)
	public void handle( UnAssignRemoteInputSignalFromWindTurbineType3or4DynamicsEvent event) {
	    LOGGER.info("handling UnAssignRemoteInputSignalFromWindTurbineType3or4DynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindTurbineType3or4Dynamics entity = unAssignRemoteInputSignal( event.getWindTurbineType3or4DynamicsId() );
