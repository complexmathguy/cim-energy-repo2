...
public class DiagramProjector extends DiagramEntityProjector {
    ...
    public void handle( UpdateDiagramEvent event) {
        ...
        entity.setDiagramStyle( event.getDiagramStyle() );
    ...
    /*
     * @param	event AssignDiagramStyleToDiagramEvent
     */
    @EventHandler( payloadType=AssignDiagramStyleToDiagramEvent.class)
    public void handle( AssignDiagramStyleToDiagramEvent event) {
	    LOGGER.info("handling AssignDiagramStyleToDiagramEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    Diagram entity = assignDiagramStyle( event.getDiagramId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignDiagramStyleFromDiagramEvent
	 */
	@EventHandler( payloadType=UnAssignDiagramStyleFromDiagramEvent.class)
	public void handle( UnAssignDiagramStyleFromDiagramEvent event) {
	    LOGGER.info("handling UnAssignDiagramStyleFromDiagramEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    Diagram entity = unAssignDiagramStyle( event.getDiagramId() );
