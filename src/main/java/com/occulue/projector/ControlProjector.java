...
public class ControlProjector extends ControlEntityProjector {
    ...
    /*
     * @param	event AssignPowerSystemResourceToControlEvent
     */
    @EventHandler( payloadType=AssignPowerSystemResourceToControlEvent.class)
    public void handle( AssignPowerSystemResourceToControlEvent event) {
	    LOGGER.info("handling AssignPowerSystemResourceToControlEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    Control entity = assignPowerSystemResource( event.getControlId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignPowerSystemResourceFromControlEvent
	 */
	@EventHandler( payloadType=UnAssignPowerSystemResourceFromControlEvent.class)
	public void handle( UnAssignPowerSystemResourceFromControlEvent event) {
	    LOGGER.info("handling UnAssignPowerSystemResourceFromControlEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    Control entity = unAssignPowerSystemResource( event.getControlId() );
