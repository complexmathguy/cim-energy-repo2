...
public class TapChangerEntityProjector {
    ...
    /*
     * Assign a TapChangerControl
     * 
     * @param	parentId	UUID
     * @param	assignment 	TapChangerControl 
     * @return	TapChanger
     */
    public TapChanger assignTapChangerControl( UUID parentId, TapChangerControl assignment ) {
	    LOGGER.info("assigning TapChangerControl as " + assignment.toString() );

	    TapChanger parentEntity = repository.findById( parentId ).get();
	    assignment = TapChangerControlProjector.find(assignment.getTapChangerControlId());
	    
	    // ------------------------------------------
		// assign the TapChangerControl to the parent entity
		// ------------------------------------------ 
	    parentEntity.setTapChangerControl( assignment );
	...
	/*
	 * Unassign the TapChangerControl
	 * 
	 * @param	parentId		UUID
	 * @return	TapChanger
	 */
	public TapChanger unAssignTapChangerControl( UUID parentId ) {
		TapChanger parentEntity = repository.findById(parentId).get();

		LOGGER.info("unAssigning TapChangerControl on " + parentEntity.toString() );
		
	    // ------------------------------------------
		// null out the TapChangerControl on the parent entithy
		// ------------------------------------------     
	    parentEntity.setTapChangerControl(null);
    ...
    @Autowired
	@Qualifier(value = "tapChangerControl-entity-projector")
	TapChangerControlEntityProjector TapChangerControlProjector;
    @Autowired
