...
public class NonConformLoadEntityProjector {
     ...
     */
    public NonConformLoad assignLoadGroup( UUID parentId, NonConformLoadGroup assignment ) {
	    LOGGER.info("assigning LoadGroup as " + assignment.toString() );
	    ...
	    // ------------------------------------------
		// assign the LoadGroup to the parent entity
		// ------------------------------------------ 
	    parentEntity.setLoadGroup( assignment );
	...
	/*
	 * Unassign the LoadGroup
	 * 
	 * @param	parentId		UUID
	 * @return	NonConformLoad
	 */
	public NonConformLoad unAssignLoadGroup( UUID parentId ) {
		NonConformLoad parentEntity = repository.findById(parentId).get();

		LOGGER.info("unAssigning LoadGroup on " + parentEntity.toString() );
		
	    // ------------------------------------------
		// null out the LoadGroup on the parent entithy
		// ------------------------------------------     
	    parentEntity.setLoadGroup(null);
