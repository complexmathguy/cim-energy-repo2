...
public class TurbineGovernorDynamicsProjector extends TurbineGovernorDynamicsEntityProjector {
    ...
    /*
     * @param	event AssignAsynchronousMachineDynamicsToTurbineGovernorDynamicsEvent
     */
    @EventHandler( payloadType=AssignAsynchronousMachineDynamicsToTurbineGovernorDynamicsEvent.class)
    public void handle( AssignAsynchronousMachineDynamicsToTurbineGovernorDynamicsEvent event) {
	    LOGGER.info("handling AssignAsynchronousMachineDynamicsToTurbineGovernorDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    TurbineGovernorDynamics entity = assignAsynchronousMachineDynamics( event.getTurbineGovernorDynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignAsynchronousMachineDynamicsFromTurbineGovernorDynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignAsynchronousMachineDynamicsFromTurbineGovernorDynamicsEvent.class)
	public void handle( UnAssignAsynchronousMachineDynamicsFromTurbineGovernorDynamicsEvent event) {
	    LOGGER.info("handling UnAssignAsynchronousMachineDynamicsFromTurbineGovernorDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    TurbineGovernorDynamics entity = unAssignAsynchronousMachineDynamics( event.getTurbineGovernorDynamicsId() );
    ...
    /*
     * @param	event AssignSynchronousMachineDynamicsToTurbineGovernorDynamicsEvent
     */
    @EventHandler( payloadType=AssignSynchronousMachineDynamicsToTurbineGovernorDynamicsEvent.class)
    public void handle( AssignSynchronousMachineDynamicsToTurbineGovernorDynamicsEvent event) {
	    LOGGER.info("handling AssignSynchronousMachineDynamicsToTurbineGovernorDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    TurbineGovernorDynamics entity = assignSynchronousMachineDynamics( event.getTurbineGovernorDynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignSynchronousMachineDynamicsFromTurbineGovernorDynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignSynchronousMachineDynamicsFromTurbineGovernorDynamicsEvent.class)
	public void handle( UnAssignSynchronousMachineDynamicsFromTurbineGovernorDynamicsEvent event) {
	    LOGGER.info("handling UnAssignSynchronousMachineDynamicsFromTurbineGovernorDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    TurbineGovernorDynamics entity = unAssignSynchronousMachineDynamics( event.getTurbineGovernorDynamicsId() );
