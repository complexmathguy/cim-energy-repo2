...
public class PowerTransformerEndProjector extends PowerTransformerEndEntityProjector {
    ...
    public void handle( UpdatePowerTransformerEndEvent event) {
        ...
        entity.setPowerTransformer( event.getPowerTransformer() );
    ...
    /*
     * @param	event AssignPowerTransformerToPowerTransformerEndEvent
     */
    @EventHandler( payloadType=AssignPowerTransformerToPowerTransformerEndEvent.class)
    public void handle( AssignPowerTransformerToPowerTransformerEndEvent event) {
	    LOGGER.info("handling AssignPowerTransformerToPowerTransformerEndEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    PowerTransformerEnd entity = assignPowerTransformer( event.getPowerTransformerEndId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignPowerTransformerFromPowerTransformerEndEvent
	 */
	@EventHandler( payloadType=UnAssignPowerTransformerFromPowerTransformerEndEvent.class)
	public void handle( UnAssignPowerTransformerFromPowerTransformerEndEvent event) {
	    LOGGER.info("handling UnAssignPowerTransformerFromPowerTransformerEndEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    PowerTransformerEnd entity = unAssignPowerTransformer( event.getPowerTransformerEndId() );
