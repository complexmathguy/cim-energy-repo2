...
public class UnderexcitationLimiterDynamicsProjector extends UnderexcitationLimiterDynamicsEntityProjector {
    ...
    /*
     * @param	event AssignExcitationSystemDynamicsToUnderexcitationLimiterDynamicsEvent
     */
    @EventHandler( payloadType=AssignExcitationSystemDynamicsToUnderexcitationLimiterDynamicsEvent.class)
    public void handle( AssignExcitationSystemDynamicsToUnderexcitationLimiterDynamicsEvent event) {
	    LOGGER.info("handling AssignExcitationSystemDynamicsToUnderexcitationLimiterDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    UnderexcitationLimiterDynamics entity = assignExcitationSystemDynamics( event.getUnderexcitationLimiterDynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignExcitationSystemDynamicsFromUnderexcitationLimiterDynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignExcitationSystemDynamicsFromUnderexcitationLimiterDynamicsEvent.class)
	public void handle( UnAssignExcitationSystemDynamicsFromUnderexcitationLimiterDynamicsEvent event) {
	    LOGGER.info("handling UnAssignExcitationSystemDynamicsFromUnderexcitationLimiterDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    UnderexcitationLimiterDynamics entity = unAssignExcitationSystemDynamics( event.getUnderexcitationLimiterDynamicsId() );
