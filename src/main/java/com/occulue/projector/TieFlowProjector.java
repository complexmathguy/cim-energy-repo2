...
public class TieFlowProjector extends TieFlowEntityProjector {
    ...
    /*
     * @param	event AssignControlAreaToTieFlowEvent
     */
    @EventHandler( payloadType=AssignControlAreaToTieFlowEvent.class)
    public void handle( AssignControlAreaToTieFlowEvent event) {
	    LOGGER.info("handling AssignControlAreaToTieFlowEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    TieFlow entity = assignControlArea( event.getTieFlowId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignControlAreaFromTieFlowEvent
	 */
	@EventHandler( payloadType=UnAssignControlAreaFromTieFlowEvent.class)
	public void handle( UnAssignControlAreaFromTieFlowEvent event) {
	    LOGGER.info("handling UnAssignControlAreaFromTieFlowEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    TieFlow entity = unAssignControlArea( event.getTieFlowId() );
    ...
    /*
     * @param	event AssignTerminalToTieFlowEvent
     */
    @EventHandler( payloadType=AssignTerminalToTieFlowEvent.class)
    public void handle( AssignTerminalToTieFlowEvent event) {
	    LOGGER.info("handling AssignTerminalToTieFlowEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    TieFlow entity = assignTerminal( event.getTieFlowId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignTerminalFromTieFlowEvent
	 */
	@EventHandler( payloadType=UnAssignTerminalFromTieFlowEvent.class)
	public void handle( UnAssignTerminalFromTieFlowEvent event) {
	    LOGGER.info("handling UnAssignTerminalFromTieFlowEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    TieFlow entity = unAssignTerminal( event.getTieFlowId() );
