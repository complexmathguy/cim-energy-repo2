...
public class AnalogControlProjector extends AnalogControlEntityProjector {
    ...
    public void handle( UpdateAnalogControlEvent event) {
        ...
        entity.setAnalogValue( event.getAnalogValue() );
    ...
    /*
     * @param	event AssignAnalogValueToAnalogControlEvent
     */
    @EventHandler( payloadType=AssignAnalogValueToAnalogControlEvent.class)
    public void handle( AssignAnalogValueToAnalogControlEvent event) {
	    LOGGER.info("handling AssignAnalogValueToAnalogControlEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    AnalogControl entity = assignAnalogValue( event.getAnalogControlId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignAnalogValueFromAnalogControlEvent
	 */
	@EventHandler( payloadType=UnAssignAnalogValueFromAnalogControlEvent.class)
	public void handle( UnAssignAnalogValueFromAnalogControlEvent event) {
	    LOGGER.info("handling UnAssignAnalogValueFromAnalogControlEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    AnalogControl entity = unAssignAnalogValue( event.getAnalogControlId() );
