...
public class PowerTransformerEndEntityProjector {
    ...
    /*
     * Assign a PowerTransformer
     * 
     * @param	parentId	UUID
     * @param	assignment 	PowerTransformer 
     * @return	PowerTransformerEnd
     */
    public PowerTransformerEnd assignPowerTransformer( UUID parentId, PowerTransformer assignment ) {
	    LOGGER.info("assigning PowerTransformer as " + assignment.toString() );

	    PowerTransformerEnd parentEntity = repository.findById( parentId ).get();
	    assignment = PowerTransformerProjector.find(assignment.getPowerTransformerId());
	    
	    // ------------------------------------------
		// assign the PowerTransformer to the parent entity
		// ------------------------------------------ 
	    parentEntity.setPowerTransformer( assignment );
	...
	/*
	 * Unassign the PowerTransformer
	 * 
	 * @param	parentId		UUID
	 * @return	PowerTransformerEnd
	 */
	public PowerTransformerEnd unAssignPowerTransformer( UUID parentId ) {
		PowerTransformerEnd parentEntity = repository.findById(parentId).get();

		LOGGER.info("unAssigning PowerTransformer on " + parentEntity.toString() );
		
	    // ------------------------------------------
		// null out the PowerTransformer on the parent entithy
		// ------------------------------------------     
	    parentEntity.setPowerTransformer(null);
