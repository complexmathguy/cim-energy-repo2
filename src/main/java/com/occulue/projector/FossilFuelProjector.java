...
public class FossilFuelProjector extends FossilFuelEntityProjector {
    ...
    public void handle( UpdateFossilFuelEvent event) {
        ...
        entity.setFossilFuelId( event.getFossilFuelId() );
        entity.setFossilFuelType( event.getFossilFuelType() );
        entity.setThermalGeneratingUnit( event.getThermalGeneratingUnit() );
    ...
    /*
     * @param	event AssignThermalGeneratingUnitToFossilFuelEvent
     */
    @EventHandler( payloadType=AssignThermalGeneratingUnitToFossilFuelEvent.class)
    public void handle( AssignThermalGeneratingUnitToFossilFuelEvent event) {
	    LOGGER.info("handling AssignThermalGeneratingUnitToFossilFuelEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    FossilFuel entity = assignThermalGeneratingUnit( event.getFossilFuelId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignThermalGeneratingUnitFromFossilFuelEvent
	 */
	@EventHandler( payloadType=UnAssignThermalGeneratingUnitFromFossilFuelEvent.class)
	public void handle( UnAssignThermalGeneratingUnitFromFossilFuelEvent event) {
	    LOGGER.info("handling UnAssignThermalGeneratingUnitFromFossilFuelEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    FossilFuel entity = unAssignThermalGeneratingUnit( event.getFossilFuelId() );
