...
public class WindTurbineType3or4IECProjector extends WindTurbineType3or4IECEntityProjector {
    ...
    public void handle( UpdateWindTurbineType3or4IECEvent event) {
        ...
        entity.setWIndContQIEC( event.getWIndContQIEC() );
    ...
    /*
     * @param	event AssignWindProtectionIECToWindTurbineType3or4IECEvent
     */
    @EventHandler( payloadType=AssignWindProtectionIECToWindTurbineType3or4IECEvent.class)
    public void handle( AssignWindProtectionIECToWindTurbineType3or4IECEvent event) {
	    LOGGER.info("handling AssignWindProtectionIECToWindTurbineType3or4IECEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    WindTurbineType3or4IEC entity = assignWindProtectionIEC( event.getWindTurbineType3or4IECId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignWindProtectionIECFromWindTurbineType3or4IECEvent
	 */
	@EventHandler( payloadType=UnAssignWindProtectionIECFromWindTurbineType3or4IECEvent.class)
	public void handle( UnAssignWindProtectionIECFromWindTurbineType3or4IECEvent event) {
	    LOGGER.info("handling UnAssignWindProtectionIECFromWindTurbineType3or4IECEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindTurbineType3or4IEC entity = unAssignWindProtectionIEC( event.getWindTurbineType3or4IECId() );
    ...
    /*
     * @param	event AssignWindContCurrLimIECToWindTurbineType3or4IECEvent
     */
    @EventHandler( payloadType=AssignWindContCurrLimIECToWindTurbineType3or4IECEvent.class)
    public void handle( AssignWindContCurrLimIECToWindTurbineType3or4IECEvent event) {
	    LOGGER.info("handling AssignWindContCurrLimIECToWindTurbineType3or4IECEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    WindTurbineType3or4IEC entity = assignWindContCurrLimIEC( event.getWindTurbineType3or4IECId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignWindContCurrLimIECFromWindTurbineType3or4IECEvent
	 */
	@EventHandler( payloadType=UnAssignWindContCurrLimIECFromWindTurbineType3or4IECEvent.class)
	public void handle( UnAssignWindContCurrLimIECFromWindTurbineType3or4IECEvent event) {
	    LOGGER.info("handling UnAssignWindContCurrLimIECFromWindTurbineType3or4IECEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindTurbineType3or4IEC entity = unAssignWindContCurrLimIEC( event.getWindTurbineType3or4IECId() );
    ...
    /*
     * @param	event AssignWIndContQIECToWindTurbineType3or4IECEvent
     */
    @EventHandler( payloadType=AssignWIndContQIECToWindTurbineType3or4IECEvent.class)
    public void handle( AssignWIndContQIECToWindTurbineType3or4IECEvent event) {
	    LOGGER.info("handling AssignWIndContQIECToWindTurbineType3or4IECEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    WindTurbineType3or4IEC entity = assignWIndContQIEC( event.getWindTurbineType3or4IECId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignWIndContQIECFromWindTurbineType3or4IECEvent
	 */
	@EventHandler( payloadType=UnAssignWIndContQIECFromWindTurbineType3or4IECEvent.class)
	public void handle( UnAssignWIndContQIECFromWindTurbineType3or4IECEvent event) {
	    LOGGER.info("handling UnAssignWIndContQIECFromWindTurbineType3or4IECEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindTurbineType3or4IEC entity = unAssignWIndContQIEC( event.getWindTurbineType3or4IECId() );
