...
public class TopologicalNodeProjector extends TopologicalNodeEntityProjector {
    ...
    public void handle( UpdateTopologicalNodeEvent event) {
        ...
        entity.setConnectivityNodeContainer( event.getConnectivityNodeContainer() );
    ...
    /*
     * @param	event AssignConnectivityNodeContainerToTopologicalNodeEvent
     */
    @EventHandler( payloadType=AssignConnectivityNodeContainerToTopologicalNodeEvent.class)
    public void handle( AssignConnectivityNodeContainerToTopologicalNodeEvent event) {
	    LOGGER.info("handling AssignConnectivityNodeContainerToTopologicalNodeEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologicalNode entity = assignConnectivityNodeContainer( event.getTopologicalNodeId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignConnectivityNodeContainerFromTopologicalNodeEvent
	 */
	@EventHandler( payloadType=UnAssignConnectivityNodeContainerFromTopologicalNodeEvent.class)
	public void handle( UnAssignConnectivityNodeContainerFromTopologicalNodeEvent event) {
	    LOGGER.info("handling UnAssignConnectivityNodeContainerFromTopologicalNodeEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    TopologicalNode entity = unAssignConnectivityNodeContainer( event.getTopologicalNodeId() );
    ...
    /*
     * @param	event AssignBaseVoltageToTopologicalNodeEvent
     */
    @EventHandler( payloadType=AssignBaseVoltageToTopologicalNodeEvent.class)
    public void handle( AssignBaseVoltageToTopologicalNodeEvent event) {
	    LOGGER.info("handling AssignBaseVoltageToTopologicalNodeEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologicalNode entity = assignBaseVoltage( event.getTopologicalNodeId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignBaseVoltageFromTopologicalNodeEvent
	 */
	@EventHandler( payloadType=UnAssignBaseVoltageFromTopologicalNodeEvent.class)
	public void handle( UnAssignBaseVoltageFromTopologicalNodeEvent event) {
	    LOGGER.info("handling UnAssignBaseVoltageFromTopologicalNodeEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    TopologicalNode entity = unAssignBaseVoltage( event.getTopologicalNodeId() );
