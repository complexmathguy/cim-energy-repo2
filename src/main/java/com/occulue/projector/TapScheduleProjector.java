...
public class TapScheduleProjector extends TapScheduleEntityProjector {
    ...
    /*
     * @param	event AssignTapChangerToTapScheduleEvent
     */
    @EventHandler( payloadType=AssignTapChangerToTapScheduleEvent.class)
    public void handle( AssignTapChangerToTapScheduleEvent event) {
	    LOGGER.info("handling AssignTapChangerToTapScheduleEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    TapSchedule entity = assignTapChanger( event.getTapScheduleId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignTapChangerFromTapScheduleEvent
	 */
	@EventHandler( payloadType=UnAssignTapChangerFromTapScheduleEvent.class)
	public void handle( UnAssignTapChangerFromTapScheduleEvent event) {
	    LOGGER.info("handling UnAssignTapChangerFromTapScheduleEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    TapSchedule entity = unAssignTapChanger( event.getTapScheduleId() );
