...
public class ConformLoadProjector extends ConformLoadEntityProjector {
    ...
    /*
     * @param	event AssignLoadGroupToConformLoadEvent
     */
    @EventHandler( payloadType=AssignLoadGroupToConformLoadEvent.class)
    public void handle( AssignLoadGroupToConformLoadEvent event) {
	    LOGGER.info("handling AssignLoadGroupToConformLoadEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    ConformLoad entity = assignLoadGroup( event.getConformLoadId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignLoadGroupFromConformLoadEvent
	 */
	@EventHandler( payloadType=UnAssignLoadGroupFromConformLoadEvent.class)
	public void handle( UnAssignLoadGroupFromConformLoadEvent event) {
	    LOGGER.info("handling UnAssignLoadGroupFromConformLoadEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    ConformLoad entity = unAssignLoadGroup( event.getConformLoadId() );
