...
public class GenICompensationForGenJProjector extends GenICompensationForGenJEntityProjector {
    ...
    public void handle( UpdateGenICompensationForGenJEvent event) {
        ...
        entity.setVcompIEEEType2( event.getVcompIEEEType2() );
    ...
    /*
     * @param	event AssignSynchronousMachineDynamicsToGenICompensationForGenJEvent
     */
    @EventHandler( payloadType=AssignSynchronousMachineDynamicsToGenICompensationForGenJEvent.class)
    public void handle( AssignSynchronousMachineDynamicsToGenICompensationForGenJEvent event) {
	    LOGGER.info("handling AssignSynchronousMachineDynamicsToGenICompensationForGenJEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    GenICompensationForGenJ entity = assignSynchronousMachineDynamics( event.getGenICompensationForGenJId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignSynchronousMachineDynamicsFromGenICompensationForGenJEvent
	 */
	@EventHandler( payloadType=UnAssignSynchronousMachineDynamicsFromGenICompensationForGenJEvent.class)
	public void handle( UnAssignSynchronousMachineDynamicsFromGenICompensationForGenJEvent event) {
	    LOGGER.info("handling UnAssignSynchronousMachineDynamicsFromGenICompensationForGenJEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    GenICompensationForGenJ entity = unAssignSynchronousMachineDynamics( event.getGenICompensationForGenJId() );
    ...
    /*
     * @param	event AssignVcompIEEEType2ToGenICompensationForGenJEvent
     */
    @EventHandler( payloadType=AssignVcompIEEEType2ToGenICompensationForGenJEvent.class)
    public void handle( AssignVcompIEEEType2ToGenICompensationForGenJEvent event) {
	    LOGGER.info("handling AssignVcompIEEEType2ToGenICompensationForGenJEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    GenICompensationForGenJ entity = assignVcompIEEEType2( event.getGenICompensationForGenJId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignVcompIEEEType2FromGenICompensationForGenJEvent
	 */
	@EventHandler( payloadType=UnAssignVcompIEEEType2FromGenICompensationForGenJEvent.class)
	public void handle( UnAssignVcompIEEEType2FromGenICompensationForGenJEvent event) {
	    LOGGER.info("handling UnAssignVcompIEEEType2FromGenICompensationForGenJEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    GenICompensationForGenJ entity = unAssignVcompIEEEType2( event.getGenICompensationForGenJId() );
