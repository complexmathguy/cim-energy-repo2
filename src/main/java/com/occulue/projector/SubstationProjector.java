...
public class SubstationProjector extends SubstationEntityProjector {
    ...
    /*
     * @param	event AssignRegionToSubstationEvent
     */
    @EventHandler( payloadType=AssignRegionToSubstationEvent.class)
    public void handle( AssignRegionToSubstationEvent event) {
	    LOGGER.info("handling AssignRegionToSubstationEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    Substation entity = assignRegion( event.getSubstationId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignRegionFromSubstationEvent
	 */
	@EventHandler( payloadType=UnAssignRegionFromSubstationEvent.class)
	public void handle( UnAssignRegionFromSubstationEvent event) {
	    LOGGER.info("handling UnAssignRegionFromSubstationEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    Substation entity = unAssignRegion( event.getSubstationId() );
