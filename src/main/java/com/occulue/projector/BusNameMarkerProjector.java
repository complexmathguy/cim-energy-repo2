...
public class BusNameMarkerProjector extends BusNameMarkerEntityProjector {
    ...
    public void handle( UpdateBusNameMarkerEvent event) {
        ...
        entity.setReportingGroup( event.getReportingGroup() );
    ...
    /*
     * @param	event AssignReportingGroupToBusNameMarkerEvent
     */
    @EventHandler( payloadType=AssignReportingGroupToBusNameMarkerEvent.class)
    public void handle( AssignReportingGroupToBusNameMarkerEvent event) {
	    LOGGER.info("handling AssignReportingGroupToBusNameMarkerEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    BusNameMarker entity = assignReportingGroup( event.getBusNameMarkerId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignReportingGroupFromBusNameMarkerEvent
	 */
	@EventHandler( payloadType=UnAssignReportingGroupFromBusNameMarkerEvent.class)
	public void handle( UnAssignReportingGroupFromBusNameMarkerEvent event) {
	    LOGGER.info("handling UnAssignReportingGroupFromBusNameMarkerEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    BusNameMarker entity = unAssignReportingGroup( event.getBusNameMarkerId() );
