...
public class DiscreteValueProjector extends DiscreteValueEntityProjector {
    ...
    public void handle( UpdateDiscreteValueEvent event) {
        ...
        entity.setDiscrete( event.getDiscrete() );
    ...
    /*
     * @param	event AssignDiscreteToDiscreteValueEvent
     */
    @EventHandler( payloadType=AssignDiscreteToDiscreteValueEvent.class)
    public void handle( AssignDiscreteToDiscreteValueEvent event) {
	    LOGGER.info("handling AssignDiscreteToDiscreteValueEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscreteValue entity = assignDiscrete( event.getDiscreteValueId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignDiscreteFromDiscreteValueEvent
	 */
	@EventHandler( payloadType=UnAssignDiscreteFromDiscreteValueEvent.class)
	public void handle( UnAssignDiscreteFromDiscreteValueEvent event) {
	    LOGGER.info("handling UnAssignDiscreteFromDiscreteValueEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    DiscreteValue entity = unAssignDiscrete( event.getDiscreteValueId() );
