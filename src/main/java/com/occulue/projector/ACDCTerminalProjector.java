...
public class ACDCTerminalProjector extends ACDCTerminalEntityProjector {
    ...
    /*
     * @param	event AssignBusNameMarkerToACDCTerminalEvent
     */
    @EventHandler( payloadType=AssignBusNameMarkerToACDCTerminalEvent.class)
    public void handle( AssignBusNameMarkerToACDCTerminalEvent event) {
	    LOGGER.info("handling AssignBusNameMarkerToACDCTerminalEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    ACDCTerminal entity = assignBusNameMarker( event.getACDCTerminalId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignBusNameMarkerFromACDCTerminalEvent
	 */
	@EventHandler( payloadType=UnAssignBusNameMarkerFromACDCTerminalEvent.class)
	public void handle( UnAssignBusNameMarkerFromACDCTerminalEvent event) {
	    LOGGER.info("handling UnAssignBusNameMarkerFromACDCTerminalEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    ACDCTerminal entity = unAssignBusNameMarker( event.getACDCTerminalId() );
