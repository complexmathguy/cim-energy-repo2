...
public class PhaseTapChangerProjector extends PhaseTapChangerEntityProjector {
    ...
    /*
     * @param	event AssignTransformerEndToPhaseTapChangerEvent
     */
    @EventHandler( payloadType=AssignTransformerEndToPhaseTapChangerEvent.class)
    public void handle( AssignTransformerEndToPhaseTapChangerEvent event) {
	    LOGGER.info("handling AssignTransformerEndToPhaseTapChangerEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    PhaseTapChanger entity = assignTransformerEnd( event.getPhaseTapChangerId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignTransformerEndFromPhaseTapChangerEvent
	 */
	@EventHandler( payloadType=UnAssignTransformerEndFromPhaseTapChangerEvent.class)
	public void handle( UnAssignTransformerEndFromPhaseTapChangerEvent event) {
	    LOGGER.info("handling UnAssignTransformerEndFromPhaseTapChangerEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    PhaseTapChanger entity = unAssignTransformerEnd( event.getPhaseTapChangerId() );
