...
public class AnalogLimitSetProjector extends AnalogLimitSetEntityProjector {
    ...
    /*
     * @param	event AssignMeasurementsToAnalogLimitSetEvent
     */
    @EventHandler( payloadType=AssignMeasurementsToAnalogLimitSetEvent.class)
    public void handle( AssignMeasurementsToAnalogLimitSetEvent event) {
	    LOGGER.info("handling AssignMeasurementsToAnalogLimitSetEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    AnalogLimitSet entity = assignMeasurements( event.getAnalogLimitSetId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignMeasurementsFromAnalogLimitSetEvent
	 */
	@EventHandler( payloadType=UnAssignMeasurementsFromAnalogLimitSetEvent.class)
	public void handle( UnAssignMeasurementsFromAnalogLimitSetEvent event) {
	    LOGGER.info("handling UnAssignMeasurementsFromAnalogLimitSetEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    AnalogLimitSet entity = unAssignMeasurements( event.getAnalogLimitSetId() );
