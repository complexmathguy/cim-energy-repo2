...
public class ACDCConverterProjector extends ACDCConverterEntityProjector {
    ...
    public void handle( UpdateACDCConverterEvent event) {
        ...
        entity.setPccTerminal( event.getPccTerminal() );
    ...
    /*
     * @param	event AssignPccTerminalToACDCConverterEvent
     */
    @EventHandler( payloadType=AssignPccTerminalToACDCConverterEvent.class)
    public void handle( AssignPccTerminalToACDCConverterEvent event) {
	    LOGGER.info("handling AssignPccTerminalToACDCConverterEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    ACDCConverter entity = assignPccTerminal( event.getACDCConverterId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignPccTerminalFromACDCConverterEvent
	 */
	@EventHandler( payloadType=UnAssignPccTerminalFromACDCConverterEvent.class)
	public void handle( UnAssignPccTerminalFromACDCConverterEvent event) {
	    LOGGER.info("handling UnAssignPccTerminalFromACDCConverterEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    ACDCConverter entity = unAssignPccTerminal( event.getACDCConverterId() );
