...
public class RegulationScheduleProjector extends RegulationScheduleEntityProjector {
    ...
    /*
     * @param	event AssignRegulatingControlToRegulationScheduleEvent
     */
    @EventHandler( payloadType=AssignRegulatingControlToRegulationScheduleEvent.class)
    public void handle( AssignRegulatingControlToRegulationScheduleEvent event) {
	    LOGGER.info("handling AssignRegulatingControlToRegulationScheduleEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    RegulationSchedule entity = assignRegulatingControl( event.getRegulationScheduleId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignRegulatingControlFromRegulationScheduleEvent
	 */
	@EventHandler( payloadType=UnAssignRegulatingControlFromRegulationScheduleEvent.class)
	public void handle( UnAssignRegulatingControlFromRegulationScheduleEvent event) {
	    LOGGER.info("handling UnAssignRegulatingControlFromRegulationScheduleEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    RegulationSchedule entity = unAssignRegulatingControl( event.getRegulationScheduleId() );
