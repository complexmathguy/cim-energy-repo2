...
public class DCLineSegmentProjector extends DCLineSegmentEntityProjector {
    ...
    public void handle( UpdateDCLineSegmentEvent event) {
        ...
        entity.setPerLengthParameter( event.getPerLengthParameter() );
    ...
    /*
     * @param	event AssignPerLengthParameterToDCLineSegmentEvent
     */
    @EventHandler( payloadType=AssignPerLengthParameterToDCLineSegmentEvent.class)
    public void handle( AssignPerLengthParameterToDCLineSegmentEvent event) {
	    LOGGER.info("handling AssignPerLengthParameterToDCLineSegmentEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    DCLineSegment entity = assignPerLengthParameter( event.getDCLineSegmentId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignPerLengthParameterFromDCLineSegmentEvent
	 */
	@EventHandler( payloadType=UnAssignPerLengthParameterFromDCLineSegmentEvent.class)
	public void handle( UnAssignPerLengthParameterFromDCLineSegmentEvent event) {
	    LOGGER.info("handling UnAssignPerLengthParameterFromDCLineSegmentEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    DCLineSegment entity = unAssignPerLengthParameter( event.getDCLineSegmentId() );
