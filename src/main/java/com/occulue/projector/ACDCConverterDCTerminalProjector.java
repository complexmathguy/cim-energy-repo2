...
public class ACDCConverterDCTerminalProjector extends ACDCConverterDCTerminalEntityProjector {
    ...
    public void handle( UpdateACDCConverterDCTerminalEvent event) {
        ...
        entity.setACDCConverterDCTerminalId( event.getACDCConverterDCTerminalId() );
        entity.setPolarity( event.getPolarity() );
        entity.setDCConductingEquipment( event.getDCConductingEquipment() );
    ...
    /*
     * @param	event AssignDCConductingEquipmentToACDCConverterDCTerminalEvent
     */
    @EventHandler( payloadType=AssignDCConductingEquipmentToACDCConverterDCTerminalEvent.class)
    public void handle( AssignDCConductingEquipmentToACDCConverterDCTerminalEvent event) {
	    LOGGER.info("handling AssignDCConductingEquipmentToACDCConverterDCTerminalEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    ACDCConverterDCTerminal entity = assignDCConductingEquipment( event.getACDCConverterDCTerminalId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignDCConductingEquipmentFromACDCConverterDCTerminalEvent
	 */
	@EventHandler( payloadType=UnAssignDCConductingEquipmentFromACDCConverterDCTerminalEvent.class)
	public void handle( UnAssignDCConductingEquipmentFromACDCConverterDCTerminalEvent event) {
	    LOGGER.info("handling UnAssignDCConductingEquipmentFromACDCConverterDCTerminalEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    ACDCConverterDCTerminal entity = unAssignDCConductingEquipment( event.getACDCConverterDCTerminalId() );
