...
public class RaiseLowerCommandProjector extends RaiseLowerCommandEntityProjector {
    ...
    /*
     * @param	event AssignValueAliasSetToRaiseLowerCommandEvent
     */
    @EventHandler( payloadType=AssignValueAliasSetToRaiseLowerCommandEvent.class)
    public void handle( AssignValueAliasSetToRaiseLowerCommandEvent event) {
	    LOGGER.info("handling AssignValueAliasSetToRaiseLowerCommandEvent - " + event );
	    
	    // ------------------------------------------
    	// delegate to addTo 
    	// ------------------------------------------ 
	    RaiseLowerCommand entity = addToValueAliasSet(event.getRaiseLowerCommandId(), event.getAddTo() );
...
/*
 * @param	event RemoveValueAliasSetFromRaiseLowerCommandEvent
 */
@EventHandler( payloadType=RemoveValueAliasSetFromRaiseLowerCommandEvent.class)
public void handle( RemoveValueAliasSetFromRaiseLowerCommandEvent event) {
    LOGGER.info("handling RemoveValueAliasSetFromRaiseLowerCommandEvent - " + event );

    RaiseLowerCommand entity = removeFromValueAliasSet(event.getRaiseLowerCommandId(), event.getRemoveFrom() );
