...
public class SwitchScheduleProjector extends SwitchScheduleEntityProjector {
    ...
    /*
     * @param	event AssignSwitchItToSwitchScheduleEvent
     */
    @EventHandler( payloadType=AssignSwitchItToSwitchScheduleEvent.class)
    public void handle( AssignSwitchItToSwitchScheduleEvent event) {
	    LOGGER.info("handling AssignSwitchItToSwitchScheduleEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SwitchSchedule entity = assignSwitchIt( event.getSwitchScheduleId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignSwitchItFromSwitchScheduleEvent
	 */
	@EventHandler( payloadType=UnAssignSwitchItFromSwitchScheduleEvent.class)
	public void handle( UnAssignSwitchItFromSwitchScheduleEvent event) {
	    LOGGER.info("handling UnAssignSwitchItFromSwitchScheduleEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SwitchSchedule entity = unAssignSwitchIt( event.getSwitchScheduleId() );
