...
public class RegulatingCondEqEntityProjector {
     ...
     */
    public RegulatingCondEq assignRegulatingControl( UUID parentId, RegulatingControl assignment ) {
	 ...
	 * @return	RegulatingCondEq
	 */
	public RegulatingCondEq unAssignRegulatingControl( UUID parentId ) {
		RegulatingCondEq parentEntity = repository.findById(parentId).get();
