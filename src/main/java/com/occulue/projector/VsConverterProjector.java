...
public class VsConverterProjector extends VsConverterEntityProjector {
    ...
    public void handle( UpdateVsConverterEvent event) {
        ...
        entity.setCapabilityCurve( event.getCapabilityCurve() );
    ...
    /*
     * @param	event AssignCapabilityCurveToVsConverterEvent
     */
    @EventHandler( payloadType=AssignCapabilityCurveToVsConverterEvent.class)
    public void handle( AssignCapabilityCurveToVsConverterEvent event) {
	    LOGGER.info("handling AssignCapabilityCurveToVsConverterEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    VsConverter entity = assignCapabilityCurve( event.getVsConverterId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignCapabilityCurveFromVsConverterEvent
	 */
	@EventHandler( payloadType=UnAssignCapabilityCurveFromVsConverterEvent.class)
	public void handle( UnAssignCapabilityCurveFromVsConverterEvent event) {
	    LOGGER.info("handling UnAssignCapabilityCurveFromVsConverterEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    VsConverter entity = unAssignCapabilityCurve( event.getVsConverterId() );
