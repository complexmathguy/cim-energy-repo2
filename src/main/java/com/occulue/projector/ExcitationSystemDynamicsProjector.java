...
public class ExcitationSystemDynamicsProjector extends ExcitationSystemDynamicsEntityProjector {
    ...
    /*
     * @param	event AssignSynchronousMachineDynamicsToExcitationSystemDynamicsEvent
     */
    @EventHandler( payloadType=AssignSynchronousMachineDynamicsToExcitationSystemDynamicsEvent.class)
    public void handle( AssignSynchronousMachineDynamicsToExcitationSystemDynamicsEvent event) {
	    LOGGER.info("handling AssignSynchronousMachineDynamicsToExcitationSystemDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    ExcitationSystemDynamics entity = assignSynchronousMachineDynamics( event.getExcitationSystemDynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignSynchronousMachineDynamicsFromExcitationSystemDynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignSynchronousMachineDynamicsFromExcitationSystemDynamicsEvent.class)
	public void handle( UnAssignSynchronousMachineDynamicsFromExcitationSystemDynamicsEvent event) {
	    LOGGER.info("handling UnAssignSynchronousMachineDynamicsFromExcitationSystemDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    ExcitationSystemDynamics entity = unAssignSynchronousMachineDynamics( event.getExcitationSystemDynamicsId() );
