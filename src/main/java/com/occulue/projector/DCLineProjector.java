...
public class DCLineProjector extends DCLineEntityProjector {
    ...
    /*
     * @param	event AssignRegionToDCLineEvent
     */
    @EventHandler( payloadType=AssignRegionToDCLineEvent.class)
    public void handle( AssignRegionToDCLineEvent event) {
	    LOGGER.info("handling AssignRegionToDCLineEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    DCLine entity = assignRegion( event.getDCLineId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignRegionFromDCLineEvent
	 */
	@EventHandler( payloadType=UnAssignRegionFromDCLineEvent.class)
	public void handle( UnAssignRegionFromDCLineEvent event) {
	    LOGGER.info("handling UnAssignRegionFromDCLineEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    DCLine entity = unAssignRegion( event.getDCLineId() );
