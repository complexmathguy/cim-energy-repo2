...
public class EquivalentEquipmentProjector extends EquivalentEquipmentEntityProjector {
    ...
    public void handle( UpdateEquivalentEquipmentEvent event) {
	    ...
	    EquivalentEquipment entity = new EquivalentEquipment();
        entity.setEquivalentEquipmentId( event.getEquivalentEquipmentId() );
        entity.setEquivalentNetwork( event.getEquivalentNetwork() );
    ...
    /*
     * @param	event AssignEquivalentNetworkToEquivalentEquipmentEvent
     */
    @EventHandler( payloadType=AssignEquivalentNetworkToEquivalentEquipmentEvent.class)
    public void handle( AssignEquivalentNetworkToEquivalentEquipmentEvent event) {
	    LOGGER.info("handling AssignEquivalentNetworkToEquivalentEquipmentEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    EquivalentEquipment entity = assignEquivalentNetwork( event.getEquivalentEquipmentId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignEquivalentNetworkFromEquivalentEquipmentEvent
	 */
	@EventHandler( payloadType=UnAssignEquivalentNetworkFromEquivalentEquipmentEvent.class)
	public void handle( UnAssignEquivalentNetworkFromEquivalentEquipmentEvent event) {
	    LOGGER.info("handling UnAssignEquivalentNetworkFromEquivalentEquipmentEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    EquivalentEquipment entity = unAssignEquivalentNetwork( event.getEquivalentEquipmentId() );
