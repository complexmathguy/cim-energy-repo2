...
public class WindGenTurbineType1IECProjector extends WindGenTurbineType1IECEntityProjector {
    ...
    public void handle( UpdateWindGenTurbineType1IECEvent event) {
	    ...
	    WindGenTurbineType1IEC entity = new WindGenTurbineType1IEC();
        entity.setWindGenTurbineType1IECId( event.getWindGenTurbineType1IECId() );
        entity.setWindAeroConstIEC( event.getWindAeroConstIEC() );
    ...
    /*
     * @param	event AssignWindAeroConstIECToWindGenTurbineType1IECEvent
     */
    @EventHandler( payloadType=AssignWindAeroConstIECToWindGenTurbineType1IECEvent.class)
    public void handle( AssignWindAeroConstIECToWindGenTurbineType1IECEvent event) {
	    LOGGER.info("handling AssignWindAeroConstIECToWindGenTurbineType1IECEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    WindGenTurbineType1IEC entity = assignWindAeroConstIEC( event.getWindGenTurbineType1IECId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignWindAeroConstIECFromWindGenTurbineType1IECEvent
	 */
	@EventHandler( payloadType=UnAssignWindAeroConstIECFromWindGenTurbineType1IECEvent.class)
	public void handle( UnAssignWindAeroConstIECFromWindGenTurbineType1IECEvent event) {
	    LOGGER.info("handling UnAssignWindAeroConstIECFromWindGenTurbineType1IECEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    WindGenTurbineType1IEC entity = unAssignWindAeroConstIEC( event.getWindGenTurbineType1IECId() );
