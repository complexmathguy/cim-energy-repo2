...
public class SubGeographicalRegionProjector extends SubGeographicalRegionEntityProjector {
    ...
    /*
     * @param	event AssignRegionToSubGeographicalRegionEvent
     */
    @EventHandler( payloadType=AssignRegionToSubGeographicalRegionEvent.class)
    public void handle( AssignRegionToSubGeographicalRegionEvent event) {
	    LOGGER.info("handling AssignRegionToSubGeographicalRegionEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SubGeographicalRegion entity = assignRegion( event.getSubGeographicalRegionId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignRegionFromSubGeographicalRegionEvent
	 */
	@EventHandler( payloadType=UnAssignRegionFromSubGeographicalRegionEvent.class)
	public void handle( UnAssignRegionFromSubGeographicalRegionEvent event) {
	    LOGGER.info("handling UnAssignRegionFromSubGeographicalRegionEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SubGeographicalRegion entity = unAssignRegion( event.getSubGeographicalRegionId() );
