...
public class RegularTimePointProjector extends RegularTimePointEntityProjector {
    ...
    public void handle( UpdateRegularTimePointEvent event) {
        ...
        entity.setIntervalSchedule( event.getIntervalSchedule() );
    ...
    /*
     * @param	event AssignIntervalScheduleToRegularTimePointEvent
     */
    @EventHandler( payloadType=AssignIntervalScheduleToRegularTimePointEvent.class)
    public void handle( AssignIntervalScheduleToRegularTimePointEvent event) {
	    LOGGER.info("handling AssignIntervalScheduleToRegularTimePointEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    RegularTimePoint entity = assignIntervalSchedule( event.getRegularTimePointId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignIntervalScheduleFromRegularTimePointEvent
	 */
	@EventHandler( payloadType=UnAssignIntervalScheduleFromRegularTimePointEvent.class)
	public void handle( UnAssignIntervalScheduleFromRegularTimePointEvent event) {
	    LOGGER.info("handling UnAssignIntervalScheduleFromRegularTimePointEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    RegularTimePoint entity = unAssignIntervalSchedule( event.getRegularTimePointId() );
