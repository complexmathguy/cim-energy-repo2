...
public class AsynchronousMachineDynamicsProjector extends AsynchronousMachineDynamicsEntityProjector {
    ...
    public void handle( UpdateAsynchronousMachineDynamicsEvent event) {
	    ...
	    AsynchronousMachineDynamics entity = new AsynchronousMachineDynamics();
        entity.setAsynchronousMachineDynamicsId( event.getAsynchronousMachineDynamicsId() );
        entity.setAsynchronousMachine( event.getAsynchronousMachine() );
    ...
    /*
     * @param	event AssignAsynchronousMachineToAsynchronousMachineDynamicsEvent
     */
    @EventHandler( payloadType=AssignAsynchronousMachineToAsynchronousMachineDynamicsEvent.class)
    public void handle( AssignAsynchronousMachineToAsynchronousMachineDynamicsEvent event) {
	    LOGGER.info("handling AssignAsynchronousMachineToAsynchronousMachineDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    AsynchronousMachineDynamics entity = assignAsynchronousMachine( event.getAsynchronousMachineDynamicsId(), event.getAssignment() );
	...
	/*
	 * @param	event UnAssignAsynchronousMachineFromAsynchronousMachineDynamicsEvent
	 */
	@EventHandler( payloadType=UnAssignAsynchronousMachineFromAsynchronousMachineDynamicsEvent.class)
	public void handle( UnAssignAsynchronousMachineFromAsynchronousMachineDynamicsEvent event) {
	    LOGGER.info("handling UnAssignAsynchronousMachineFromAsynchronousMachineDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    AsynchronousMachineDynamics entity = unAssignAsynchronousMachine( event.getAsynchronousMachineDynamicsId() );
