...
public class WindDynamicsLookupTableTest{
	...
	protected UpdateWindDynamicsLookupTableCommand generateUpdateCommand() {
	        UpdateWindDynamicsLookupTableCommand command = new UpdateWindDynamicsLookupTableCommand( null,  null,  WindLookupTableFunctionKind.values()[0],  null,  null,  null,  null,  null,  null );
