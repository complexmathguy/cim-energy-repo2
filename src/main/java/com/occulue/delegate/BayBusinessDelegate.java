...
//************************************************************************
    ...
    */
    ...
    /**
     * assign VoltageLevel on Bay
     * @param		command AssignVoltageLevelToBayCommand	
     * @exception	ProcessingException
     */     
	public void assignVoltageLevel( AssignVoltageLevelToBayCommand command ) throws ProcessingException {
		...
		UUID childId = command.getAssignment().getVoltageLevelId();
		VoltageLevel child = null;
		...
		try {
			...
			final String msg = "Failed to get VoltageLevel using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignVoltageLevel( UnAssignVoltageLevelFromBayCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign VoltageLevel on Bay";
