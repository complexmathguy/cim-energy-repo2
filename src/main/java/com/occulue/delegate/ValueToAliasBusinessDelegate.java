...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToValueAliasSet( AssignValueAliasSetToValueToAliasCommand command ) throws ProcessingException {
		...
		try {		
			...
			final String msg = "Failed to add a ValueAliasSet as ValueAliasSet to ValueToAlias" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromValueAliasSet( RemoveValueAliasSetFromValueToAliasCommand command ) throws ProcessingException {		
