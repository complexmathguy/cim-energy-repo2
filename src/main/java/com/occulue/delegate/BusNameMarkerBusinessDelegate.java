...
//************************************************************************
    ...
    */
    ...
    /**
     * assign ReportingGroup on BusNameMarker
     * @param		command AssignReportingGroupToBusNameMarkerCommand	
     * @exception	ProcessingException
     */     
	public void assignReportingGroup( AssignReportingGroupToBusNameMarkerCommand command ) throws ProcessingException {
		...
		ReportingGroupBusinessDelegate childDelegate 	= ReportingGroupBusinessDelegate.getReportingGroupInstance();
		BusNameMarkerBusinessDelegate parentDelegate = BusNameMarkerBusinessDelegate.getBusNameMarkerInstance();			
		UUID childId = command.getAssignment().getReportingGroupId();
		ReportingGroup child = null;
		...
		try {
			...
			final String msg = "Failed to get ReportingGroup using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignReportingGroup( UnAssignReportingGroupFromBusNameMarkerCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign ReportingGroup on BusNameMarker";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
