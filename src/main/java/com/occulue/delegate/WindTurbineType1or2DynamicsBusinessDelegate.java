...
//************************************************************************
    ...
    */
    ...
    /**
     * assign AsynchronousMachineDynamics on WindTurbineType1or2Dynamics
     * @param		command AssignAsynchronousMachineDynamicsToWindTurbineType1or2DynamicsCommand	
     * @exception	ProcessingException
     */     
	public void assignAsynchronousMachineDynamics( AssignAsynchronousMachineDynamicsToWindTurbineType1or2DynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignAsynchronousMachineDynamics( UnAssignAsynchronousMachineDynamicsFromWindTurbineType1or2DynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign AsynchronousMachineDynamics on WindTurbineType1or2Dynamics";
    ...
    /**
     * assign RemoteInputSignal on WindTurbineType1or2Dynamics
     * @param		command AssignRemoteInputSignalToWindTurbineType1or2DynamicsCommand	
     * @exception	ProcessingException
     */     
	public void assignRemoteInputSignal( AssignRemoteInputSignalToWindTurbineType1or2DynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignRemoteInputSignal( UnAssignRemoteInputSignalFromWindTurbineType1or2DynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign RemoteInputSignal on WindTurbineType1or2Dynamics";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
