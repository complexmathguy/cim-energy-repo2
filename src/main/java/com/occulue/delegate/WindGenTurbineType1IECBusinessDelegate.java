...
//************************************************************************
    ...
    */
    ...
    /**
     * assign WindAeroConstIEC on WindGenTurbineType1IEC
     * @param		command AssignWindAeroConstIECToWindGenTurbineType1IECCommand	
     * @exception	ProcessingException
     */     
	public void assignWindAeroConstIEC( AssignWindAeroConstIECToWindGenTurbineType1IECCommand command ) throws ProcessingException {
		...
		WindAeroConstIECBusinessDelegate childDelegate 	= WindAeroConstIECBusinessDelegate.getWindAeroConstIECInstance();
		...
		UUID childId = command.getAssignment().getWindAeroConstIECId();
		WindAeroConstIEC child = null;
		...
		try {
			...
			final String msg = "Failed to get WindAeroConstIEC using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignWindAeroConstIEC( UnAssignWindAeroConstIECFromWindGenTurbineType1IECCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign WindAeroConstIEC on WindGenTurbineType1IEC";
