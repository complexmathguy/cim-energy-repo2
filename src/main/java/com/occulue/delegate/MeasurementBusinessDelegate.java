...
//************************************************************************
    ...
    */
    ...
    /**
     * assign PowerSystemResource on Measurement
     * @param		command AssignPowerSystemResourceToMeasurementCommand	
     * @exception	ProcessingException
     */     
	public void assignPowerSystemResource( AssignPowerSystemResourceToMeasurementCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignPowerSystemResource( UnAssignPowerSystemResourceFromMeasurementCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign PowerSystemResource on Measurement";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
    ...
    /**
     * assign Terminal on Measurement
     * @param		command AssignTerminalToMeasurementCommand	
     * @exception	ProcessingException
     */     
	public void assignTerminal( AssignTerminalToMeasurementCommand command ) throws ProcessingException {
		...
		MeasurementBusinessDelegate parentDelegate = MeasurementBusinessDelegate.getMeasurementInstance();			
		UUID childId = command.getAssignment().getACDCTerminalId();
		ACDCTerminal child = null;
		...
		try {
			...
			final String msg = "Failed to get ACDCTerminal using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignTerminal( UnAssignTerminalFromMeasurementCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Terminal on Measurement";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
