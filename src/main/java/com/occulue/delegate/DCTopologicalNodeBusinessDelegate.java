...
//************************************************************************
    ...
    */
    ...
    /**
     * assign DCEquipmentContainer on DCTopologicalNode
     * @param		command AssignDCEquipmentContainerToDCTopologicalNodeCommand	
     * @exception	ProcessingException
     */     
	public void assignDCEquipmentContainer( AssignDCEquipmentContainerToDCTopologicalNodeCommand command ) throws ProcessingException {
		...
		DCEquipmentContainerBusinessDelegate childDelegate 	= DCEquipmentContainerBusinessDelegate.getDCEquipmentContainerInstance();
		DCTopologicalNodeBusinessDelegate parentDelegate = DCTopologicalNodeBusinessDelegate.getDCTopologicalNodeInstance();			
		UUID childId = command.getAssignment().getDCEquipmentContainerId();
		DCEquipmentContainer child = null;
		...
		try {
			...
			final String msg = "Failed to get DCEquipmentContainer using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignDCEquipmentContainer( UnAssignDCEquipmentContainerFromDCTopologicalNodeCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign DCEquipmentContainer on DCTopologicalNode";
