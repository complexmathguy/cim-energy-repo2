...
//************************************************************************
    ...
    */
    ...
    /**
     * assign Discrete on DiscreteValue
     * @param		command AssignDiscreteToDiscreteValueCommand	
     * @exception	ProcessingException
     */     
	public void assignDiscrete( AssignDiscreteToDiscreteValueCommand command ) throws ProcessingException {
		...
		DiscreteValueBusinessDelegate parentDelegate = DiscreteValueBusinessDelegate.getDiscreteValueInstance();			
		UUID childId = command.getAssignment().getDiscreteId();
		Discrete child = null;
		...
		try {
			...
			final String msg = "Failed to get Discrete using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignDiscrete( UnAssignDiscreteFromDiscreteValueCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Discrete on DiscreteValue";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
