...
//************************************************************************
    ...
    */
    ...
    /**
     * add ValueAliasSet to ValueAliasSet 
     * @param		command AssignValueAliasSetToCommandCommand
     * @exception	ProcessingException
     */     
	public void addToValueAliasSet( AssignValueAliasSetToCommandCommand command ) throws ProcessingException {
		...
		ValueAliasSetBusinessDelegate childDelegate 	= ValueAliasSetBusinessDelegate.getValueAliasSetInstance();
		CommandBusinessDelegate parentDelegate = CommandBusinessDelegate.getCommandInstance();		
		UUID childId = command.getAddTo().getValueAliasSetId();
		...
		try {		
			...
			final String msg = "Failed to add a ValueAliasSet as ValueAliasSet to Command" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
    ...
    /**
     * remove ValueAliasSet from ValueAliasSet
     * @param		command RemoveValueAliasSetFromCommandCommand
     * @exception	ProcessingException
     */     	
	public void removeFromValueAliasSet( RemoveValueAliasSetFromCommandCommand command ) throws ProcessingException {		
		
		ValueAliasSetBusinessDelegate childDelegate 	= ValueAliasSetBusinessDelegate.getValueAliasSetInstance();
		UUID childId = command.getRemoveFrom().getValueAliasSetId();
    ...
    /**
     * add DiscreteValue to DiscreteValue 
     * @param		command AssignDiscreteValueToCommandCommand
     * @exception	ProcessingException
     */     
	public void addToDiscreteValue( AssignDiscreteValueToCommandCommand command ) throws ProcessingException {
		...
		try {		
			...
			final String msg = "Failed to add a DiscreteValue as DiscreteValue to Command" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
    ...
    /**
     * remove DiscreteValue from DiscreteValue
     * @param		command RemoveDiscreteValueFromCommandCommand
     * @exception	ProcessingException
     */     	
	public void removeFromDiscreteValue( RemoveDiscreteValueFromCommandCommand command ) throws ProcessingException {		
