...
//************************************************************************
    ...
    */
    ...
    /**
     * assign WindProtectionIEC on WindTurbineType1or2IEC
     * @param		command AssignWindProtectionIECToWindTurbineType1or2IECCommand	
     * @exception	ProcessingException
     */     
	public void assignWindProtectionIEC( AssignWindProtectionIECToWindTurbineType1or2IECCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignWindProtectionIEC( UnAssignWindProtectionIECFromWindTurbineType1or2IECCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign WindProtectionIEC on WindTurbineType1or2IEC";
    ...
    /**
     * assign WindMechIEC on WindTurbineType1or2IEC
     * @param		command AssignWindMechIECToWindTurbineType1or2IECCommand	
     * @exception	ProcessingException
     */     
	public void assignWindMechIEC( AssignWindMechIECToWindTurbineType1or2IECCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignWindMechIEC( UnAssignWindMechIECFromWindTurbineType1or2IECCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign WindMechIEC on WindTurbineType1or2IEC";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
