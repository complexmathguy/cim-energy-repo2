...
//************************************************************************
    ...
    */
    ...
    /**
     * assign Measurements on AccumulatorLimitSet
     * @param		command AssignMeasurementsToAccumulatorLimitSetCommand	
     * @exception	ProcessingException
     */     
	public void assignMeasurements( AssignMeasurementsToAccumulatorLimitSetCommand command ) throws ProcessingException {
		...
		AccumulatorBusinessDelegate childDelegate 	= AccumulatorBusinessDelegate.getAccumulatorInstance();
		AccumulatorLimitSetBusinessDelegate parentDelegate = AccumulatorLimitSetBusinessDelegate.getAccumulatorLimitSetInstance();			
		UUID childId = command.getAssignment().getAccumulatorId();
		Accumulator child = null;
		...
		try {
			...
			final String msg = "Failed to get Accumulator using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignMeasurements( UnAssignMeasurementsFromAccumulatorLimitSetCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Measurements on AccumulatorLimitSet";
