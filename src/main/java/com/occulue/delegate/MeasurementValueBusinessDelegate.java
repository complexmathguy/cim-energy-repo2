...
//************************************************************************
    ...
    */
    ...
    /**
     * assign MeasurementValueSource on MeasurementValue
     * @param		command AssignMeasurementValueSourceToMeasurementValueCommand	
     * @exception	ProcessingException
     */     
	public void assignMeasurementValueSource( AssignMeasurementValueSourceToMeasurementValueCommand command ) throws ProcessingException {
		...
		MeasurementValueSourceBusinessDelegate childDelegate 	= MeasurementValueSourceBusinessDelegate.getMeasurementValueSourceInstance();
		MeasurementValueBusinessDelegate parentDelegate = MeasurementValueBusinessDelegate.getMeasurementValueInstance();			
		UUID childId = command.getAssignment().getMeasurementValueSourceId();
		MeasurementValueSource child = null;
		...
		try {
			...
			final String msg = "Failed to get MeasurementValueSource using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignMeasurementValueSource( UnAssignMeasurementValueSourceFromMeasurementValueCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign MeasurementValueSource on MeasurementValue";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
