...
//************************************************************************
    ...
    */
    ...
    /**
     * assign TapChangerControl on TapChanger
     * @param		command AssignTapChangerControlToTapChangerCommand	
     * @exception	ProcessingException
     */     
	public void assignTapChangerControl( AssignTapChangerControlToTapChangerCommand command ) throws ProcessingException {
		...
		TapChangerControlBusinessDelegate childDelegate 	= TapChangerControlBusinessDelegate.getTapChangerControlInstance();
		TapChangerBusinessDelegate parentDelegate = TapChangerBusinessDelegate.getTapChangerInstance();			
		UUID childId = command.getAssignment().getTapChangerControlId();
		TapChangerControl child = null;
		...
		try {
			...
			final String msg = "Failed to get TapChangerControl using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignTapChangerControl( UnAssignTapChangerControlFromTapChangerCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign TapChangerControl on TapChanger";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
