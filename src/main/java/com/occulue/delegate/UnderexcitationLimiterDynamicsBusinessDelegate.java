...
//************************************************************************
    ...
    */
    ...
    /**
     * assign ExcitationSystemDynamics on UnderexcitationLimiterDynamics
     * @param		command AssignExcitationSystemDynamicsToUnderexcitationLimiterDynamicsCommand	
     * @exception	ProcessingException
     */     
	public void assignExcitationSystemDynamics( AssignExcitationSystemDynamicsToUnderexcitationLimiterDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignExcitationSystemDynamics( UnAssignExcitationSystemDynamicsFromUnderexcitationLimiterDynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign ExcitationSystemDynamics on UnderexcitationLimiterDynamics";
