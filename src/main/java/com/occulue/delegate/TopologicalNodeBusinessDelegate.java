...
//************************************************************************
    ...
    */
    ...
    /**
     * assign ConnectivityNodeContainer on TopologicalNode
     * @param		command AssignConnectivityNodeContainerToTopologicalNodeCommand	
     * @exception	ProcessingException
     */     
	public void assignConnectivityNodeContainer( AssignConnectivityNodeContainerToTopologicalNodeCommand command ) throws ProcessingException {
		...
		ConnectivityNodeContainerBusinessDelegate childDelegate 	= ConnectivityNodeContainerBusinessDelegate.getConnectivityNodeContainerInstance();
		TopologicalNodeBusinessDelegate parentDelegate = TopologicalNodeBusinessDelegate.getTopologicalNodeInstance();			
		UUID childId = command.getAssignment().getConnectivityNodeContainerId();
		ConnectivityNodeContainer child = null;
		...
		try {
			...
			final String msg = "Failed to get ConnectivityNodeContainer using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignConnectivityNodeContainer( UnAssignConnectivityNodeContainerFromTopologicalNodeCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign ConnectivityNodeContainer on TopologicalNode";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
    ...
    /**
     * assign BaseVoltage on TopologicalNode
     * @param		command AssignBaseVoltageToTopologicalNodeCommand	
     * @exception	ProcessingException
     */     
	public void assignBaseVoltage( AssignBaseVoltageToTopologicalNodeCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignBaseVoltage( UnAssignBaseVoltageFromTopologicalNodeCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign BaseVoltage on TopologicalNode";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
