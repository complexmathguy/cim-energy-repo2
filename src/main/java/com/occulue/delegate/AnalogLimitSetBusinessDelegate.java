...
//************************************************************************
    ...
    */
    ...
    /**
     * assign Measurements on AnalogLimitSet
     * @param		command AssignMeasurementsToAnalogLimitSetCommand	
     * @exception	ProcessingException
     */     
	public void assignMeasurements( AssignMeasurementsToAnalogLimitSetCommand command ) throws ProcessingException {
		...
		AnalogBusinessDelegate childDelegate 	= AnalogBusinessDelegate.getAnalogInstance();
		AnalogLimitSetBusinessDelegate parentDelegate = AnalogLimitSetBusinessDelegate.getAnalogLimitSetInstance();			
		UUID childId = command.getAssignment().getAnalogId();
		Analog child = null;
		...
		try {
			...
			final String msg = "Failed to get Analog using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignMeasurements( UnAssignMeasurementsFromAnalogLimitSetCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Measurements on AnalogLimitSet";
