...
//************************************************************************
    ...
    */
    ...
    /**
     * assign Region on Substation
     * @param		command AssignRegionToSubstationCommand	
     * @exception	ProcessingException
     */     
	public void assignRegion( AssignRegionToSubstationCommand command ) throws ProcessingException {
		...
		UUID childId = command.getAssignment().getSubGeographicalRegionId();
		SubGeographicalRegion child = null;
		...
		try {
			...
			final String msg = "Failed to get SubGeographicalRegion using id " + childId;
    ...
    /**
     * unAssign Region on Substation
     * @param		command UnAssignRegionFromSubstationCommand
     * @exception	ProcessingException
     */     
	public void unAssignRegion( UnAssignRegionFromSubstationCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Region on Substation";
