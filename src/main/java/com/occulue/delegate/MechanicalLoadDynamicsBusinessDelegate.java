...
//************************************************************************
    ...
    */
    ...
    /**
     * assign SynchronousMachineDynamics on MechanicalLoadDynamics
     * @param		command AssignSynchronousMachineDynamicsToMechanicalLoadDynamicsCommand	
     * @exception	ProcessingException
     */     
	public void assignSynchronousMachineDynamics( AssignSynchronousMachineDynamicsToMechanicalLoadDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignSynchronousMachineDynamics( UnAssignSynchronousMachineDynamicsFromMechanicalLoadDynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign SynchronousMachineDynamics on MechanicalLoadDynamics";
    ...
    /**
     * assign AsynchronousMachineDynamics on MechanicalLoadDynamics
     * @param		command AssignAsynchronousMachineDynamicsToMechanicalLoadDynamicsCommand	
     * @exception	ProcessingException
     */     
	public void assignAsynchronousMachineDynamics( AssignAsynchronousMachineDynamicsToMechanicalLoadDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignAsynchronousMachineDynamics( UnAssignAsynchronousMachineDynamicsFromMechanicalLoadDynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign AsynchronousMachineDynamics on MechanicalLoadDynamics";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
