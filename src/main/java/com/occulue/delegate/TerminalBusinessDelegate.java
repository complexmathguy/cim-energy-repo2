...
//************************************************************************
    ...
    */
    ...
    /**
     * assign ConductingEquipment on Terminal
     * @param		command AssignConductingEquipmentToTerminalCommand	
     * @exception	ProcessingException
     */     
	public void assignConductingEquipment( AssignConductingEquipmentToTerminalCommand command ) throws ProcessingException {
		...
		ConductingEquipmentBusinessDelegate childDelegate 	= ConductingEquipmentBusinessDelegate.getConductingEquipmentInstance();
		TerminalBusinessDelegate parentDelegate = TerminalBusinessDelegate.getTerminalInstance();			
		UUID childId = command.getAssignment().getConductingEquipmentId();
		ConductingEquipment child = null;
		...
		try {
			...
			final String msg = "Failed to get ConductingEquipment using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignConductingEquipment( UnAssignConductingEquipmentFromTerminalCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign ConductingEquipment on Terminal";
