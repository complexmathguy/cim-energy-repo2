...
//************************************************************************
    ...
    */
    ...
    /**
     * assign ConformLoadGroup on ConformLoadSchedule
     * @param		command AssignConformLoadGroupToConformLoadScheduleCommand	
     * @exception	ProcessingException
     */     
	public void assignConformLoadGroup( AssignConformLoadGroupToConformLoadScheduleCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignConformLoadGroup( UnAssignConformLoadGroupFromConformLoadScheduleCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign ConformLoadGroup on ConformLoadSchedule";
