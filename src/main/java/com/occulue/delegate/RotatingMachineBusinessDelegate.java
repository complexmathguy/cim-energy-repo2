...
//************************************************************************
    ...
    */
    ...
    /**
     * assign GeneratingUnit on RotatingMachine
     * @param		command AssignGeneratingUnitToRotatingMachineCommand	
     * @exception	ProcessingException
     */     
	public void assignGeneratingUnit( AssignGeneratingUnitToRotatingMachineCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignGeneratingUnit( UnAssignGeneratingUnitFromRotatingMachineCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign GeneratingUnit on RotatingMachine";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
