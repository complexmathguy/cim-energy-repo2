...
//************************************************************************
    ...
    */
    ...
    /**
     * assign RotatingMachine on HydroPump
     * @param		command AssignRotatingMachineToHydroPumpCommand	
     * @exception	ProcessingException
     */     
	public void assignRotatingMachine( AssignRotatingMachineToHydroPumpCommand command ) throws ProcessingException {
		...
		UUID childId = command.getAssignment().getRotatingMachineId();
		RotatingMachine child = null;
		...
		try {
			...
			final String msg = "Failed to get RotatingMachine using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignRotatingMachine( UnAssignRotatingMachineFromHydroPumpCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign RotatingMachine on HydroPump";
    ...
    /**
     * assign HydroPowerPlant on HydroPump
     * @param		command AssignHydroPowerPlantToHydroPumpCommand	
     * @exception	ProcessingException
     */     
	public void assignHydroPowerPlant( AssignHydroPowerPlantToHydroPumpCommand command ) throws ProcessingException {
		...
		HydroPowerPlantBusinessDelegate childDelegate 	= HydroPowerPlantBusinessDelegate.getHydroPowerPlantInstance();
		HydroPumpBusinessDelegate parentDelegate = HydroPumpBusinessDelegate.getHydroPumpInstance();			
		UUID childId = command.getAssignment().getHydroPowerPlantId();
		HydroPowerPlant child = null;
		...
		try {
			...
			final String msg = "Failed to get HydroPowerPlant using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignHydroPowerPlant( UnAssignHydroPowerPlantFromHydroPumpCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign HydroPowerPlant on HydroPump";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
