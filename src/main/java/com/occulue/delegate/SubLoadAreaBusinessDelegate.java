...
//************************************************************************
    ...
    */
    ...
    /**
     * assign LoadArea on SubLoadArea
     * @param		command AssignLoadAreaToSubLoadAreaCommand	
     * @exception	ProcessingException
     */     
	public void assignLoadArea( AssignLoadAreaToSubLoadAreaCommand command ) throws ProcessingException {
		...
		LoadAreaBusinessDelegate childDelegate 	= LoadAreaBusinessDelegate.getLoadAreaInstance();
		SubLoadAreaBusinessDelegate parentDelegate = SubLoadAreaBusinessDelegate.getSubLoadAreaInstance();			
		UUID childId = command.getAssignment().getLoadAreaId();
		LoadArea child = null;
		...
		try {
			...
			final String msg = "Failed to get LoadArea using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignLoadArea( UnAssignLoadAreaFromSubLoadAreaCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign LoadArea on SubLoadArea";
