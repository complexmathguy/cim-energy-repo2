...
//************************************************************************
    ...
    */
    ...
    /**
     * assign StringMeasurement on StringMeasurementValue
     * @param		command AssignStringMeasurementToStringMeasurementValueCommand	
     * @exception	ProcessingException
     */     
	public void assignStringMeasurement( AssignStringMeasurementToStringMeasurementValueCommand command ) throws ProcessingException {
		...
		StringMeasurementBusinessDelegate childDelegate 	= StringMeasurementBusinessDelegate.getStringMeasurementInstance();
		StringMeasurementValueBusinessDelegate parentDelegate = StringMeasurementValueBusinessDelegate.getStringMeasurementValueInstance();			
		UUID childId = command.getAssignment().getStringMeasurementId();
		StringMeasurement child = null;
		...
		try {
			...
			final String msg = "Failed to get StringMeasurement using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignStringMeasurement( UnAssignStringMeasurementFromStringMeasurementValueCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign StringMeasurement on StringMeasurementValue";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
