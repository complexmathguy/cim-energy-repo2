...
//************************************************************************
    ...
    */
    ...
    /**
     * assign PhaseTapChangerTable on PhaseTapChangerTabular
     * @param		command AssignPhaseTapChangerTableToPhaseTapChangerTabularCommand	
     * @exception	ProcessingException
     */     
	public void assignPhaseTapChangerTable( AssignPhaseTapChangerTableToPhaseTapChangerTabularCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignPhaseTapChangerTable( UnAssignPhaseTapChangerTableFromPhaseTapChangerTabularCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign PhaseTapChangerTable on PhaseTapChangerTabular";
