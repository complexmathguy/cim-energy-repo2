...
//************************************************************************
    ...
    */
    ...
    /**
     * assign InitialReactiveCapabilityCurve on SynchronousMachine
     * @param		command AssignInitialReactiveCapabilityCurveToSynchronousMachineCommand	
     * @exception	ProcessingException
     */     
	public void assignInitialReactiveCapabilityCurve( AssignInitialReactiveCapabilityCurveToSynchronousMachineCommand command ) throws ProcessingException {
		...
		ReactiveCapabilityCurveBusinessDelegate childDelegate 	= ReactiveCapabilityCurveBusinessDelegate.getReactiveCapabilityCurveInstance();
		SynchronousMachineBusinessDelegate parentDelegate = SynchronousMachineBusinessDelegate.getSynchronousMachineInstance();			
		UUID childId = command.getAssignment().getReactiveCapabilityCurveId();
		ReactiveCapabilityCurve child = null;
		...
		try {
			...
			final String msg = "Failed to get ReactiveCapabilityCurve using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignInitialReactiveCapabilityCurve( UnAssignInitialReactiveCapabilityCurveFromSynchronousMachineCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign InitialReactiveCapabilityCurve on SynchronousMachine";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
