...
//************************************************************************
    ...
    */
    ...
    /**
     * add AnalogLimitSet to LimitSet 
     * @param		command AssignLimitSetToAnalogLimitCommand
     * @exception	ProcessingException
     */     
	public void addToLimitSet( AssignLimitSetToAnalogLimitCommand command ) throws ProcessingException {
		...
		try {		
			...
			final String msg = "Failed to add a AnalogLimitSet as LimitSet to AnalogLimit" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
    ...
    /**
     * remove AnalogLimitSet from LimitSet
     * @param		command RemoveLimitSetFromAnalogLimitCommand
     * @exception	ProcessingException
     */     	
	public void removeFromLimitSet( RemoveLimitSetFromAnalogLimitCommand command ) throws ProcessingException {		
