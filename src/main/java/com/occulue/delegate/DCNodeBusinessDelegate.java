...
//************************************************************************
    ...
    */
    ...
    /**
     * assign DCEquipmentContainer on DCNode
     * @param		command AssignDCEquipmentContainerToDCNodeCommand	
     * @exception	ProcessingException
     */     
	public void assignDCEquipmentContainer( AssignDCEquipmentContainerToDCNodeCommand command ) throws ProcessingException {
    ...
    /**
     * unAssign DCEquipmentContainer on DCNode
     * @param		command UnAssignDCEquipmentContainerFromDCNodeCommand
     * @exception	ProcessingException
     */     
	public void unAssignDCEquipmentContainer( UnAssignDCEquipmentContainerFromDCNodeCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign DCEquipmentContainer on DCNode";
