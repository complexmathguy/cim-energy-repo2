...
//************************************************************************
    ...
    */
    ...
    /**
     * assign PhaseTapChangerTable on PhaseTapChangerTablePoint
     * @param		command AssignPhaseTapChangerTableToPhaseTapChangerTablePointCommand	
     * @exception	ProcessingException
     */     
	public void assignPhaseTapChangerTable( AssignPhaseTapChangerTableToPhaseTapChangerTablePointCommand command ) throws ProcessingException {
		...
		PhaseTapChangerTableBusinessDelegate childDelegate 	= PhaseTapChangerTableBusinessDelegate.getPhaseTapChangerTableInstance();
		PhaseTapChangerTablePointBusinessDelegate parentDelegate = PhaseTapChangerTablePointBusinessDelegate.getPhaseTapChangerTablePointInstance();			
		UUID childId = command.getAssignment().getPhaseTapChangerTableId();
		PhaseTapChangerTable child = null;
		...
		try {
			...
			final String msg = "Failed to get PhaseTapChangerTable using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignPhaseTapChangerTable( UnAssignPhaseTapChangerTableFromPhaseTapChangerTablePointCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign PhaseTapChangerTable on PhaseTapChangerTablePoint";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
