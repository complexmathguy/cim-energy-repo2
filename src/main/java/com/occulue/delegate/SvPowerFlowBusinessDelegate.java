...
//************************************************************************
    ...
    */
    ...
    /**
     * assign Terminal on SvPowerFlow
     * @param		command AssignTerminalToSvPowerFlowCommand	
     * @exception	ProcessingException
     */     
	public void assignTerminal( AssignTerminalToSvPowerFlowCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignTerminal( UnAssignTerminalFromSvPowerFlowCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Terminal on SvPowerFlow";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
