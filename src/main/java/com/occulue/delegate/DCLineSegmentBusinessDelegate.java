...
//************************************************************************
    ...
    */
    ...
    /**
     * assign PerLengthParameter on DCLineSegment
     * @param		command AssignPerLengthParameterToDCLineSegmentCommand	
     * @exception	ProcessingException
     */     
	public void assignPerLengthParameter( AssignPerLengthParameterToDCLineSegmentCommand command ) throws ProcessingException {
		...
		PerLengthDCLineParameterBusinessDelegate childDelegate 	= PerLengthDCLineParameterBusinessDelegate.getPerLengthDCLineParameterInstance();
		DCLineSegmentBusinessDelegate parentDelegate = DCLineSegmentBusinessDelegate.getDCLineSegmentInstance();			
		UUID childId = command.getAssignment().getPerLengthDCLineParameterId();
		PerLengthDCLineParameter child = null;
		...
		try {
			...
			final String msg = "Failed to get PerLengthDCLineParameter using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
    ...
    /**
     * unAssign PerLengthParameter on DCLineSegment
     * @param		command UnAssignPerLengthParameterFromDCLineSegmentCommand
     * @exception	ProcessingException
     */     
	public void unAssignPerLengthParameter( UnAssignPerLengthParameterFromDCLineSegmentCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign PerLengthParameter on DCLineSegment";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
