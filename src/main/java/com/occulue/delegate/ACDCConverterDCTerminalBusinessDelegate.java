...
//************************************************************************
    ...
    */
    ...
    /**
     * assign DCConductingEquipment on ACDCConverterDCTerminal
     * @param		command AssignDCConductingEquipmentToACDCConverterDCTerminalCommand	
     * @exception	ProcessingException
     */     
	public void assignDCConductingEquipment( AssignDCConductingEquipmentToACDCConverterDCTerminalCommand command ) throws ProcessingException {
		...
		UUID childId = command.getAssignment().getACDCConverterId();
		ACDCConverter child = null;
		...
		try {
			...
			final String msg = "Failed to get ACDCConverter using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignDCConductingEquipment( UnAssignDCConductingEquipmentFromACDCConverterDCTerminalCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign DCConductingEquipment on ACDCConverterDCTerminal";
