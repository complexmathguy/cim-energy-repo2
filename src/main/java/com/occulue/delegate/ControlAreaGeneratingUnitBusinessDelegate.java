...
//************************************************************************
    ...
    */
    ...
    /**
     * assign ControlArea on ControlAreaGeneratingUnit
     * @param		command AssignControlAreaToControlAreaGeneratingUnitCommand	
     * @exception	ProcessingException
     */     
	public void assignControlArea( AssignControlAreaToControlAreaGeneratingUnitCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignControlArea( UnAssignControlAreaFromControlAreaGeneratingUnitCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign ControlArea on ControlAreaGeneratingUnit";
    ...
    /**
     * assign GeneratingUnit on ControlAreaGeneratingUnit
     * @param		command AssignGeneratingUnitToControlAreaGeneratingUnitCommand	
     * @exception	ProcessingException
     */     
	public void assignGeneratingUnit( AssignGeneratingUnitToControlAreaGeneratingUnitCommand command ) throws ProcessingException {
		...
		GeneratingUnitBusinessDelegate childDelegate 	= GeneratingUnitBusinessDelegate.getGeneratingUnitInstance();
		ControlAreaGeneratingUnitBusinessDelegate parentDelegate = ControlAreaGeneratingUnitBusinessDelegate.getControlAreaGeneratingUnitInstance();			
		UUID childId = command.getAssignment().getGeneratingUnitId();
		GeneratingUnit child = null;
		...
		try {
			...
			final String msg = "Failed to get GeneratingUnit using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignGeneratingUnit( UnAssignGeneratingUnitFromControlAreaGeneratingUnitCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign GeneratingUnit on ControlAreaGeneratingUnit";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
