...
//************************************************************************
    ...
    */
    ...
    /**
     * assign PccTerminal on ACDCConverter
     * @param		command AssignPccTerminalToACDCConverterCommand	
     * @exception	ProcessingException
     */     
	public void assignPccTerminal( AssignPccTerminalToACDCConverterCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignPccTerminal( UnAssignPccTerminalFromACDCConverterCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign PccTerminal on ACDCConverter";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
