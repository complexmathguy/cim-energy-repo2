...
//************************************************************************
    ...
    */
    ...
    /**
     * assign SwitchIt on SwitchSchedule
     * @param		command AssignSwitchItToSwitchScheduleCommand	
     * @exception	ProcessingException
     */     
	public void assignSwitchIt( AssignSwitchItToSwitchScheduleCommand command ) throws ProcessingException {
		...
		SwitchProxyBusinessDelegate childDelegate 	= SwitchProxyBusinessDelegate.getSwitchProxyInstance();
		SwitchScheduleBusinessDelegate parentDelegate = SwitchScheduleBusinessDelegate.getSwitchScheduleInstance();			
		UUID childId = command.getAssignment().getSwitchProxyId();
		SwitchProxy child = null;
		...
		try {
			...
			final String msg = "Failed to get SwitchProxy using id " + childId;
    ...
    /**
     * unAssign SwitchIt on SwitchSchedule
     * @param		command UnAssignSwitchItFromSwitchScheduleCommand
     * @exception	ProcessingException
     */     
	public void unAssignSwitchIt( UnAssignSwitchItFromSwitchScheduleCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign SwitchIt on SwitchSchedule";
