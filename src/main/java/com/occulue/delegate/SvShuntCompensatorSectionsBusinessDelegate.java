...
//************************************************************************
    ...
    */
    ...
    /**
     * assign ShuntCompensator on SvShuntCompensatorSections
     * @param		command AssignShuntCompensatorToSvShuntCompensatorSectionsCommand	
     * @exception	ProcessingException
     */     
	public void assignShuntCompensator( AssignShuntCompensatorToSvShuntCompensatorSectionsCommand command ) throws ProcessingException {
		...
		ShuntCompensatorBusinessDelegate childDelegate 	= ShuntCompensatorBusinessDelegate.getShuntCompensatorInstance();
		SvShuntCompensatorSectionsBusinessDelegate parentDelegate = SvShuntCompensatorSectionsBusinessDelegate.getSvShuntCompensatorSectionsInstance();			
		UUID childId = command.getAssignment().getShuntCompensatorId();
		ShuntCompensator child = null;
		...
		try {
			...
			final String msg = "Failed to get ShuntCompensator using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignShuntCompensator( UnAssignShuntCompensatorFromSvShuntCompensatorSectionsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign ShuntCompensator on SvShuntCompensatorSections";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
