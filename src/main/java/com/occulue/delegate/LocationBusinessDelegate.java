...
//************************************************************************
    ...
    */
    ...
    /**
     * assign PowerSystemResources on Location
     * @param		command AssignPowerSystemResourcesToLocationCommand	
     * @exception	ProcessingException
     */     
	public void assignPowerSystemResources( AssignPowerSystemResourcesToLocationCommand command ) throws ProcessingException {
		...
		PowerSystemResourceBusinessDelegate childDelegate 	= PowerSystemResourceBusinessDelegate.getPowerSystemResourceInstance();
		LocationBusinessDelegate parentDelegate = LocationBusinessDelegate.getLocationInstance();			
		UUID childId = command.getAssignment().getPowerSystemResourceId();
		PowerSystemResource child = null;
		...
		try {
			...
			final String msg = "Failed to get PowerSystemResource using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignPowerSystemResources( UnAssignPowerSystemResourcesFromLocationCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign PowerSystemResources on Location";
    ...
    /**
     * assign CoordinateSystem on Location
     * @param		command AssignCoordinateSystemToLocationCommand	
     * @exception	ProcessingException
     */     
	public void assignCoordinateSystem( AssignCoordinateSystemToLocationCommand command ) throws ProcessingException {
		...
		CoordinateSystemBusinessDelegate childDelegate 	= CoordinateSystemBusinessDelegate.getCoordinateSystemInstance();
		LocationBusinessDelegate parentDelegate = LocationBusinessDelegate.getLocationInstance();			
		UUID childId = command.getAssignment().getCoordinateSystemId();
		CoordinateSystem child = null;
		...
		try {
			...
			final String msg = "Failed to get CoordinateSystem using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignCoordinateSystem( UnAssignCoordinateSystemFromLocationCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign CoordinateSystem on Location";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
