...
//************************************************************************
    ...
    */
    ...
    /**
     * assign PowerSystemResource on Control
     * @param		command AssignPowerSystemResourceToControlCommand	
     * @exception	ProcessingException
     */     
	public void assignPowerSystemResource( AssignPowerSystemResourceToControlCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignPowerSystemResource( UnAssignPowerSystemResourceFromControlCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign PowerSystemResource on Control";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
