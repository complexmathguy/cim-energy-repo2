...
//************************************************************************
    ...
    */
    ...
    /**
     * assign EquipmentContainer on Equipment
     * @param		command AssignEquipmentContainerToEquipmentCommand	
     * @exception	ProcessingException
     */     
	public void assignEquipmentContainer( AssignEquipmentContainerToEquipmentCommand command ) throws ProcessingException {
		...
		EquipmentContainerBusinessDelegate childDelegate 	= EquipmentContainerBusinessDelegate.getEquipmentContainerInstance();
		EquipmentBusinessDelegate parentDelegate = EquipmentBusinessDelegate.getEquipmentInstance();			
		UUID childId = command.getAssignment().getEquipmentContainerId();
		EquipmentContainer child = null;
		...
		try {
			...
			final String msg = "Failed to get EquipmentContainer using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignEquipmentContainer( UnAssignEquipmentContainerFromEquipmentCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign EquipmentContainer on Equipment";
