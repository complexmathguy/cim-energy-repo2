...
//************************************************************************
    ...
    */
    ...
    /**
     * assign WindMechIEC on WindTurbineType4bIEC
     * @param		command AssignWindMechIECToWindTurbineType4bIECCommand	
     * @exception	ProcessingException
     */     
	public void assignWindMechIEC( AssignWindMechIECToWindTurbineType4bIECCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignWindMechIEC( UnAssignWindMechIECFromWindTurbineType4bIECCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign WindMechIEC on WindTurbineType4bIEC";
    ...
    /**
     * assign WindContPType4bIEC on WindTurbineType4bIEC
     * @param		command AssignWindContPType4bIECToWindTurbineType4bIECCommand	
     * @exception	ProcessingException
     */     
	public void assignWindContPType4bIEC( AssignWindContPType4bIECToWindTurbineType4bIECCommand command ) throws ProcessingException {
		...
		WindContPType4bIECBusinessDelegate childDelegate 	= WindContPType4bIECBusinessDelegate.getWindContPType4bIECInstance();
		WindTurbineType4bIECBusinessDelegate parentDelegate = WindTurbineType4bIECBusinessDelegate.getWindTurbineType4bIECInstance();			
		UUID childId = command.getAssignment().getWindContPType4bIECId();
		WindContPType4bIEC child = null;
		...
		try {
			...
			final String msg = "Failed to get WindContPType4bIEC using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignWindContPType4bIEC( UnAssignWindContPType4bIECFromWindTurbineType4bIECCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign WindContPType4bIEC on WindTurbineType4bIEC";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
