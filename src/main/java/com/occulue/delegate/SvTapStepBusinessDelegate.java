...
//************************************************************************
    ...
    */
    ...
    /**
     * assign TapChanger on SvTapStep
     * @param		command AssignTapChangerToSvTapStepCommand	
     * @exception	ProcessingException
     */     
	public void assignTapChanger( AssignTapChangerToSvTapStepCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignTapChanger( UnAssignTapChangerFromSvTapStepCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign TapChanger on SvTapStep";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
