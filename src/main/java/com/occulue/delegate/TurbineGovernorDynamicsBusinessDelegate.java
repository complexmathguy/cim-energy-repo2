...
//************************************************************************
    ...
    */
    ...
    /**
     * assign AsynchronousMachineDynamics on TurbineGovernorDynamics
     * @param		command AssignAsynchronousMachineDynamicsToTurbineGovernorDynamicsCommand	
     * @exception	ProcessingException
     */     
	public void assignAsynchronousMachineDynamics( AssignAsynchronousMachineDynamicsToTurbineGovernorDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignAsynchronousMachineDynamics( UnAssignAsynchronousMachineDynamicsFromTurbineGovernorDynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign AsynchronousMachineDynamics on TurbineGovernorDynamics";
    ...
    /**
     * assign SynchronousMachineDynamics on TurbineGovernorDynamics
     * @param		command AssignSynchronousMachineDynamicsToTurbineGovernorDynamicsCommand	
     * @exception	ProcessingException
     */     
	public void assignSynchronousMachineDynamics( AssignSynchronousMachineDynamicsToTurbineGovernorDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignSynchronousMachineDynamics( UnAssignSynchronousMachineDynamicsFromTurbineGovernorDynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign SynchronousMachineDynamics on TurbineGovernorDynamics";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
