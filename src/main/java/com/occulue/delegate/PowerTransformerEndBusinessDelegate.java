...
//************************************************************************
    ...
    */
    ...
    /**
     * assign PowerTransformer on PowerTransformerEnd
     * @param		command AssignPowerTransformerToPowerTransformerEndCommand	
     * @exception	ProcessingException
     */     
	public void assignPowerTransformer( AssignPowerTransformerToPowerTransformerEndCommand command ) throws ProcessingException {
		...
		PowerTransformerBusinessDelegate childDelegate 	= PowerTransformerBusinessDelegate.getPowerTransformerInstance();
		PowerTransformerEndBusinessDelegate parentDelegate = PowerTransformerEndBusinessDelegate.getPowerTransformerEndInstance();			
		UUID childId = command.getAssignment().getPowerTransformerId();
		PowerTransformer child = null;
		...
		try {
			...
			final String msg = "Failed to get PowerTransformer using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignPowerTransformer( UnAssignPowerTransformerFromPowerTransformerEndCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign PowerTransformer on PowerTransformerEnd";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
