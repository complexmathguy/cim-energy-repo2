...
//************************************************************************
    ...
    */
    ...
    /**
     * assign ExcitationSystemDynamics on OverexcitationLimiterDynamics
     * @param		command AssignExcitationSystemDynamicsToOverexcitationLimiterDynamicsCommand	
     * @exception	ProcessingException
     */     
	public void assignExcitationSystemDynamics( AssignExcitationSystemDynamicsToOverexcitationLimiterDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignExcitationSystemDynamics( UnAssignExcitationSystemDynamicsFromOverexcitationLimiterDynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign ExcitationSystemDynamics on OverexcitationLimiterDynamics";
