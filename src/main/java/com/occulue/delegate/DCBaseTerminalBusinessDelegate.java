...
//************************************************************************
    ...
    */
    ...
    /**
     * assign DCNode on DCBaseTerminal
     * @param		command AssignDCNodeToDCBaseTerminalCommand	
     * @exception	ProcessingException
     */     
	public void assignDCNode( AssignDCNodeToDCBaseTerminalCommand command ) throws ProcessingException {
		...
		UUID childId = command.getAssignment().getDCNodeId();
		DCNode child = null;
		...
		try {
			...
			final String msg = "Failed to get DCNode using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignDCNode( UnAssignDCNodeFromDCBaseTerminalCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign DCNode on DCBaseTerminal";
