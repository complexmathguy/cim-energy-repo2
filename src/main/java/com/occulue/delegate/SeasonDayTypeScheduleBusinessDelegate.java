...
//************************************************************************
    ...
    */
    ...
    /**
     * assign Season on SeasonDayTypeSchedule
     * @param		command AssignSeasonToSeasonDayTypeScheduleCommand	
     * @exception	ProcessingException
     */     
	public void assignSeason( AssignSeasonToSeasonDayTypeScheduleCommand command ) throws ProcessingException {
		...
		SeasonBusinessDelegate childDelegate 	= SeasonBusinessDelegate.getSeasonInstance();
		...
		UUID childId = command.getAssignment().getSeasonId();
		Season child = null;
		...
		try {
			...
			final String msg = "Failed to get Season using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignSeason( UnAssignSeasonFromSeasonDayTypeScheduleCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Season on SeasonDayTypeSchedule";
    ...
    /**
     * assign DayType on SeasonDayTypeSchedule
     * @param		command AssignDayTypeToSeasonDayTypeScheduleCommand	
     * @exception	ProcessingException
     */     
	public void assignDayType( AssignDayTypeToSeasonDayTypeScheduleCommand command ) throws ProcessingException {
		...
		DayTypeBusinessDelegate childDelegate 	= DayTypeBusinessDelegate.getDayTypeInstance();
		SeasonDayTypeScheduleBusinessDelegate parentDelegate = SeasonDayTypeScheduleBusinessDelegate.getSeasonDayTypeScheduleInstance();			
		UUID childId = command.getAssignment().getDayTypeId();
		DayType child = null;
		...
		try {
			...
			final String msg = "Failed to get DayType using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignDayType( UnAssignDayTypeFromSeasonDayTypeScheduleCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign DayType on SeasonDayTypeSchedule";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
