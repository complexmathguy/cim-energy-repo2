...
//************************************************************************
    ...
    */
    ...
    /**
     * assign DCTopologicalNodes on DCTopologicalIsland
     * @param		command AssignDCTopologicalNodesToDCTopologicalIslandCommand	
     * @exception	ProcessingException
     */     
	public void assignDCTopologicalNodes( AssignDCTopologicalNodesToDCTopologicalIslandCommand command ) throws ProcessingException {
		...
		UUID childId = command.getAssignment().getDCTopologicalNodeId();
		DCTopologicalNode child = null;
		...
		try {
			...
			final String msg = "Failed to get DCTopologicalNode using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignDCTopologicalNodes( UnAssignDCTopologicalNodesFromDCTopologicalIslandCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign DCTopologicalNodes on DCTopologicalIsland";
