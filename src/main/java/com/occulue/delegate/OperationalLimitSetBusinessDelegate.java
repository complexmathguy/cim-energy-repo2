...
//************************************************************************
    ...
    */
    ...
    /**
     * assign Equipment on OperationalLimitSet
     * @param		command AssignEquipmentToOperationalLimitSetCommand	
     * @exception	ProcessingException
     */     
	public void assignEquipment( AssignEquipmentToOperationalLimitSetCommand command ) throws ProcessingException {
		...
		UUID childId = command.getAssignment().getEquipmentId();
		Equipment child = null;
		...
		try {
			...
			final String msg = "Failed to get Equipment using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignEquipment( UnAssignEquipmentFromOperationalLimitSetCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Equipment on OperationalLimitSet";
    ...
    /**
     * assign Terminal on OperationalLimitSet
     * @param		command AssignTerminalToOperationalLimitSetCommand	
     * @exception	ProcessingException
     */     
	public void assignTerminal( AssignTerminalToOperationalLimitSetCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignTerminal( UnAssignTerminalFromOperationalLimitSetCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Terminal on OperationalLimitSet";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
