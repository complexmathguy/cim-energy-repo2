...
//************************************************************************
    ...
    */
    ...
    /**
     * assign TopologicalNode on SvVoltage
     * @param		command AssignTopologicalNodeToSvVoltageCommand	
     * @exception	ProcessingException
     */     
	public void assignTopologicalNode( AssignTopologicalNodeToSvVoltageCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignTopologicalNode( UnAssignTopologicalNodeFromSvVoltageCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign TopologicalNode on SvVoltage";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
