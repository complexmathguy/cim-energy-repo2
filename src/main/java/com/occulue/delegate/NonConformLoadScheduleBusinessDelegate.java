...
//************************************************************************
    ...
    */
    ...
    /**
     * assign NonConformLoadGroup on NonConformLoadSchedule
     * @param		command AssignNonConformLoadGroupToNonConformLoadScheduleCommand	
     * @exception	ProcessingException
     */     
	public void assignNonConformLoadGroup( AssignNonConformLoadGroupToNonConformLoadScheduleCommand command ) throws ProcessingException {
		...
		NonConformLoadGroupBusinessDelegate childDelegate 	= NonConformLoadGroupBusinessDelegate.getNonConformLoadGroupInstance();
		...
		UUID childId = command.getAssignment().getNonConformLoadGroupId();
		NonConformLoadGroup child = null;
		...
		try {
			...
			final String msg = "Failed to get NonConformLoadGroup using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignNonConformLoadGroup( UnAssignNonConformLoadGroupFromNonConformLoadScheduleCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign NonConformLoadGroup on NonConformLoadSchedule";
