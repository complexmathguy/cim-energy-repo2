...
//************************************************************************
    ...
    */
    ...
    /**
     * assign TapChanger on TapSchedule
     * @param		command AssignTapChangerToTapScheduleCommand	
     * @exception	ProcessingException
     */     
	public void assignTapChanger( AssignTapChangerToTapScheduleCommand command ) throws ProcessingException {
		...
		UUID childId = command.getAssignment().getTapChangerId();
		TapChanger child = null;
		...
		try {
			...
			final String msg = "Failed to get TapChanger using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignTapChanger( UnAssignTapChangerFromTapScheduleCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign TapChanger on TapSchedule";
