...
//************************************************************************
    ...
    */
    ...
    /**
     * assign Analog on AnalogValue
     * @param		command AssignAnalogToAnalogValueCommand	
     * @exception	ProcessingException
     */     
	public void assignAnalog( AssignAnalogToAnalogValueCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignAnalog( UnAssignAnalogFromAnalogValueCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Analog on AnalogValue";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
