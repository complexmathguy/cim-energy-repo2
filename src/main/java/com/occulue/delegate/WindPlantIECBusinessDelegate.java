...
//************************************************************************
    ...
    */
    ...
    /**
     * assign WindPlantFreqPcontrolIEC on WindPlantIEC
     * @param		command AssignWindPlantFreqPcontrolIECToWindPlantIECCommand	
     * @exception	ProcessingException
     */     
	public void assignWindPlantFreqPcontrolIEC( AssignWindPlantFreqPcontrolIECToWindPlantIECCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignWindPlantFreqPcontrolIEC( UnAssignWindPlantFreqPcontrolIECFromWindPlantIECCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign WindPlantFreqPcontrolIEC on WindPlantIEC";
    ...
    /**
     * assign WindPlantReactiveControlIEC on WindPlantIEC
     * @param		command AssignWindPlantReactiveControlIECToWindPlantIECCommand	
     * @exception	ProcessingException
     */     
	public void assignWindPlantReactiveControlIEC( AssignWindPlantReactiveControlIECToWindPlantIECCommand command ) throws ProcessingException {
		...
		WindPlantReactiveControlIECBusinessDelegate childDelegate 	= WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance();
		WindPlantIECBusinessDelegate parentDelegate = WindPlantIECBusinessDelegate.getWindPlantIECInstance();			
		UUID childId = command.getAssignment().getWindPlantReactiveControlIECId();
		WindPlantReactiveControlIEC child = null;
		...
		try {
			...
			final String msg = "Failed to get WindPlantReactiveControlIEC using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignWindPlantReactiveControlIEC( UnAssignWindPlantReactiveControlIECFromWindPlantIECCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign WindPlantReactiveControlIEC on WindPlantIEC";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
