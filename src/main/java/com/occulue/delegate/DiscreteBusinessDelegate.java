...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToValueAliasSet( AssignValueAliasSetToDiscreteCommand command ) throws ProcessingException {
		...
		try {		
			...
			final String msg = "Failed to add a ValueAliasSet as ValueAliasSet to Discrete" ; 
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromValueAliasSet( RemoveValueAliasSetFromDiscreteCommand command ) throws ProcessingException {		
