...
//************************************************************************
    ...
    */
    ...
    /**
     * assign Region on DCLine
     * @param		command AssignRegionToDCLineCommand	
     * @exception	ProcessingException
     */     
	public void assignRegion( AssignRegionToDCLineCommand command ) throws ProcessingException {
    ...
    /**
     * unAssign Region on DCLine
     * @param		command UnAssignRegionFromDCLineCommand
     * @exception	ProcessingException
     */     
	public void unAssignRegion( UnAssignRegionFromDCLineCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Region on DCLine";
