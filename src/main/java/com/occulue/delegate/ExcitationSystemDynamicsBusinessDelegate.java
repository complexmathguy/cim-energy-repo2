...
//************************************************************************
    ...
    */
    ...
    /**
     * assign SynchronousMachineDynamics on ExcitationSystemDynamics
     * @param		command AssignSynchronousMachineDynamicsToExcitationSystemDynamicsCommand	
     * @exception	ProcessingException
     */     
	public void assignSynchronousMachineDynamics( AssignSynchronousMachineDynamicsToExcitationSystemDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignSynchronousMachineDynamics( UnAssignSynchronousMachineDynamicsFromExcitationSystemDynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign SynchronousMachineDynamics on ExcitationSystemDynamics";
