...
//************************************************************************
    ...
    */
    ...
    /**
     * assign GeneratingUnit on GrossToNetActivePowerCurve
     * @param		command AssignGeneratingUnitToGrossToNetActivePowerCurveCommand	
     * @exception	ProcessingException
     */     
	public void assignGeneratingUnit( AssignGeneratingUnitToGrossToNetActivePowerCurveCommand command ) throws ProcessingException {
    ...
    /**
     * unAssign GeneratingUnit on GrossToNetActivePowerCurve
     * @param		command UnAssignGeneratingUnitFromGrossToNetActivePowerCurveCommand
     * @exception	ProcessingException
     */     
	public void unAssignGeneratingUnit( UnAssignGeneratingUnitFromGrossToNetActivePowerCurveCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign GeneratingUnit on GrossToNetActivePowerCurve";
