...
//************************************************************************
    ...
    */
    ...
    /**
     * assign Terminal on RegulatingControl
     * @param		command AssignTerminalToRegulatingControlCommand	
     * @exception	ProcessingException
     */     
	public void assignTerminal( AssignTerminalToRegulatingControlCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignTerminal( UnAssignTerminalFromRegulatingControlCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Terminal on RegulatingControl";
