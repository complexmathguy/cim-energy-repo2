...
//************************************************************************
    ...
    */
    ...
    /**
     * assign SynchronousMachine on SynchronousMachineDynamics
     * @param		command AssignSynchronousMachineToSynchronousMachineDynamicsCommand	
     * @exception	ProcessingException
     */     
	public void assignSynchronousMachine( AssignSynchronousMachineToSynchronousMachineDynamicsCommand command ) throws ProcessingException {
		...
		UUID childId = command.getAssignment().getSynchronousMachineId();
		SynchronousMachine child = null;
		...
		try {
			...
			final String msg = "Failed to get SynchronousMachine using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignSynchronousMachine( UnAssignSynchronousMachineFromSynchronousMachineDynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign SynchronousMachine on SynchronousMachineDynamics";
