...
//************************************************************************
    ...
    */
    ...
    /**
     * assign SubLoadArea on LoadGroup
     * @param		command AssignSubLoadAreaToLoadGroupCommand	
     * @exception	ProcessingException
     */     
	public void assignSubLoadArea( AssignSubLoadAreaToLoadGroupCommand command ) throws ProcessingException {
		...
		UUID childId = command.getAssignment().getSubLoadAreaId();
		SubLoadArea child = null;
		...
		try {
			...
			final String msg = "Failed to get SubLoadArea using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignSubLoadArea( UnAssignSubLoadAreaFromLoadGroupCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign SubLoadArea on LoadGroup";
