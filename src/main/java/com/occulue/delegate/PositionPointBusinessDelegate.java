...
//************************************************************************
    ...
    */
    ...
    /**
     * assign Location on PositionPoint
     * @param		command AssignLocationToPositionPointCommand	
     * @exception	ProcessingException
     */     
	public void assignLocation( AssignLocationToPositionPointCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignLocation( UnAssignLocationFromPositionPointCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Location on PositionPoint";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
