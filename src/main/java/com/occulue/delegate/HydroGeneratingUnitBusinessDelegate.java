...
//************************************************************************
    ...
    */
    ...
    /**
     * assign HydroPowerPlant on HydroGeneratingUnit
     * @param		command AssignHydroPowerPlantToHydroGeneratingUnitCommand	
     * @exception	ProcessingException
     */     
	public void assignHydroPowerPlant( AssignHydroPowerPlantToHydroGeneratingUnitCommand command ) throws ProcessingException {
    ...
    /**
     * unAssign HydroPowerPlant on HydroGeneratingUnit
     * @param		command UnAssignHydroPowerPlantFromHydroGeneratingUnitCommand
     * @exception	ProcessingException
     */     
	public void unAssignHydroPowerPlant( UnAssignHydroPowerPlantFromHydroGeneratingUnitCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign HydroPowerPlant on HydroGeneratingUnit";
