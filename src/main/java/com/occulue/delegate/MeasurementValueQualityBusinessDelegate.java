...
//************************************************************************
    ...
    */
    ...
    /**
     * assign MeasurementValue on MeasurementValueQuality
     * @param		command AssignMeasurementValueToMeasurementValueQualityCommand	
     * @exception	ProcessingException
     */     
	public void assignMeasurementValue( AssignMeasurementValueToMeasurementValueQualityCommand command ) throws ProcessingException {
		...
		UUID childId = command.getAssignment().getMeasurementValueId();
		MeasurementValue child = null;
		...
		try {
			...
			final String msg = "Failed to get MeasurementValue using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignMeasurementValue( UnAssignMeasurementValueFromMeasurementValueQualityCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign MeasurementValue on MeasurementValueQuality";
