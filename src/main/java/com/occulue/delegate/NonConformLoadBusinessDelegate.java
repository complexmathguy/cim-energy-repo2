...
//************************************************************************
    ...
    */
    ...
    /**
     * assign LoadGroup on NonConformLoad
     * @param		command AssignLoadGroupToNonConformLoadCommand	
     * @exception	ProcessingException
     */     
	public void assignLoadGroup( AssignLoadGroupToNonConformLoadCommand command ) throws ProcessingException {
    ...
    /**
     * unAssign LoadGroup on NonConformLoad
     * @param		command UnAssignLoadGroupFromNonConformLoadCommand
     * @exception	ProcessingException
     */     
	public void unAssignLoadGroup( UnAssignLoadGroupFromNonConformLoadCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign LoadGroup on NonConformLoad";
