...
//************************************************************************
    ...
    */
    ...
    /**
     * assign Accumulator on AccumulatorValue
     * @param		command AssignAccumulatorToAccumulatorValueCommand	
     * @exception	ProcessingException
     */     
	public void assignAccumulator( AssignAccumulatorToAccumulatorValueCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignAccumulator( UnAssignAccumulatorFromAccumulatorValueCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Accumulator on AccumulatorValue";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
