...
//************************************************************************
    ...
    */
    ...
    /**
     * assign TopologicalNodes on TopologicalIsland
     * @param		command AssignTopologicalNodesToTopologicalIslandCommand	
     * @exception	ProcessingException
     */     
	public void assignTopologicalNodes( AssignTopologicalNodesToTopologicalIslandCommand command ) throws ProcessingException {
		...
		UUID childId = command.getAssignment().getTopologicalNodeId();
		TopologicalNode child = null;
		...
		try {
			...
			final String msg = "Failed to get TopologicalNode using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignTopologicalNodes( UnAssignTopologicalNodesFromTopologicalIslandCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign TopologicalNodes on TopologicalIsland";
    ...
    /**
     * assign AngleRefTopologicalNode on TopologicalIsland
     * @param		command AssignAngleRefTopologicalNodeToTopologicalIslandCommand	
     * @exception	ProcessingException
     */     
	public void assignAngleRefTopologicalNode( AssignAngleRefTopologicalNodeToTopologicalIslandCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignAngleRefTopologicalNode( UnAssignAngleRefTopologicalNodeFromTopologicalIslandCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign AngleRefTopologicalNode on TopologicalIsland";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
