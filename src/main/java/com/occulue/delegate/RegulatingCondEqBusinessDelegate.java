...
//************************************************************************
    ...
    */
    ...
    /**
     * assign RegulatingControl on RegulatingCondEq
     * @param		command AssignRegulatingControlToRegulatingCondEqCommand	
     * @exception	ProcessingException
     */     
	public void assignRegulatingControl( AssignRegulatingControlToRegulatingCondEqCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignRegulatingControl( UnAssignRegulatingControlFromRegulatingCondEqCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign RegulatingControl on RegulatingCondEq";
