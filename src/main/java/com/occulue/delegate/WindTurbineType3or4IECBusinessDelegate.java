...
//************************************************************************
    ...
    */
    ...
    /**
     * assign WindProtectionIEC on WindTurbineType3or4IEC
     * @param		command AssignWindProtectionIECToWindTurbineType3or4IECCommand	
     * @exception	ProcessingException
     */     
	public void assignWindProtectionIEC( AssignWindProtectionIECToWindTurbineType3or4IECCommand command ) throws ProcessingException {
		...
		WindProtectionIECBusinessDelegate childDelegate 	= WindProtectionIECBusinessDelegate.getWindProtectionIECInstance();
		...
		UUID childId = command.getAssignment().getWindProtectionIECId();
		WindProtectionIEC child = null;
		...
		try {
			...
			final String msg = "Failed to get WindProtectionIEC using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignWindProtectionIEC( UnAssignWindProtectionIECFromWindTurbineType3or4IECCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign WindProtectionIEC on WindTurbineType3or4IEC";
    ...
    /**
     * assign WindContCurrLimIEC on WindTurbineType3or4IEC
     * @param		command AssignWindContCurrLimIECToWindTurbineType3or4IECCommand	
     * @exception	ProcessingException
     */     
	public void assignWindContCurrLimIEC( AssignWindContCurrLimIECToWindTurbineType3or4IECCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignWindContCurrLimIEC( UnAssignWindContCurrLimIECFromWindTurbineType3or4IECCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign WindContCurrLimIEC on WindTurbineType3or4IEC";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
    ...
    /**
     * assign WIndContQIEC on WindTurbineType3or4IEC
     * @param		command AssignWIndContQIECToWindTurbineType3or4IECCommand	
     * @exception	ProcessingException
     */     
	public void assignWIndContQIEC( AssignWIndContQIECToWindTurbineType3or4IECCommand command ) throws ProcessingException {
		...
		WindContQIECBusinessDelegate childDelegate 	= WindContQIECBusinessDelegate.getWindContQIECInstance();
		WindTurbineType3or4IECBusinessDelegate parentDelegate = WindTurbineType3or4IECBusinessDelegate.getWindTurbineType3or4IECInstance();			
		UUID childId = command.getAssignment().getWindContQIECId();
		WindContQIEC child = null;
		...
		try {
			...
			final String msg = "Failed to get WindContQIEC using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignWIndContQIEC( UnAssignWIndContQIECFromWindTurbineType3or4IECCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign WIndContQIEC on WindTurbineType3or4IEC";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
