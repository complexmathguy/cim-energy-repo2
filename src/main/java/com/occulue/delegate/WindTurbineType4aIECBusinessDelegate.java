...
//************************************************************************
    ...
    */
    ...
    /**
     * assign WindContPType4aIEC on WindTurbineType4aIEC
     * @param		command AssignWindContPType4aIECToWindTurbineType4aIECCommand	
     * @exception	ProcessingException
     */     
	public void assignWindContPType4aIEC( AssignWindContPType4aIECToWindTurbineType4aIECCommand command ) throws ProcessingException {
		...
		WindContPType4aIECBusinessDelegate childDelegate 	= WindContPType4aIECBusinessDelegate.getWindContPType4aIECInstance();
		WindTurbineType4aIECBusinessDelegate parentDelegate = WindTurbineType4aIECBusinessDelegate.getWindTurbineType4aIECInstance();			
		UUID childId = command.getAssignment().getWindContPType4aIECId();
		WindContPType4aIEC child = null;
		...
		try {
			...
			final String msg = "Failed to get WindContPType4aIEC using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignWindContPType4aIEC( UnAssignWindContPType4aIECFromWindTurbineType4aIECCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign WindContPType4aIEC on WindTurbineType4aIEC";
