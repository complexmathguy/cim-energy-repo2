...
//************************************************************************
    ...
    */
    ...
    /**
     * assign TopologicalNode on SvInjection
     * @param		command AssignTopologicalNodeToSvInjectionCommand	
     * @exception	ProcessingException
     */     
	public void assignTopologicalNode( AssignTopologicalNodeToSvInjectionCommand command ) throws ProcessingException {
    ...
    /**
     * unAssign TopologicalNode on SvInjection
     * @param		command UnAssignTopologicalNodeFromSvInjectionCommand
     * @exception	ProcessingException
     */     
	public void unAssignTopologicalNode( UnAssignTopologicalNodeFromSvInjectionCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign TopologicalNode on SvInjection";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
