...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void addToValueAliasSet( AssignValueAliasSetToRaiseLowerCommandCommand command ) throws ProcessingException {
		...
		try {		
			...
			final String msg = "Failed to add a ValueAliasSet as ValueAliasSet to RaiseLowerCommand" ; 
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromValueAliasSet( RemoveValueAliasSetFromRaiseLowerCommandCommand command ) throws ProcessingException {		
