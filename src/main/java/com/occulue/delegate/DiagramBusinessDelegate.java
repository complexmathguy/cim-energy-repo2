...
//************************************************************************
    ...
    */
    ...
    /**
     * assign DiagramStyle on Diagram
     * @param		command AssignDiagramStyleToDiagramCommand	
     * @exception	ProcessingException
     */     
	public void assignDiagramStyle( AssignDiagramStyleToDiagramCommand command ) throws ProcessingException {
		...
		DiagramStyleBusinessDelegate childDelegate 	= DiagramStyleBusinessDelegate.getDiagramStyleInstance();
		DiagramBusinessDelegate parentDelegate = DiagramBusinessDelegate.getDiagramInstance();			
		UUID childId = command.getAssignment().getDiagramStyleId();
		DiagramStyle child = null;
		...
		try {
			...
			final String msg = "Failed to get DiagramStyle using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignDiagramStyle( UnAssignDiagramStyleFromDiagramCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign DiagramStyle on Diagram";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
