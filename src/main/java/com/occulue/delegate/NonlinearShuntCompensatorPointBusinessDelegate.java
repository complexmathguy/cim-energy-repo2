...
//************************************************************************
    ...
    */
    ...
    /**
     * assign NonlinearShuntCompensator on NonlinearShuntCompensatorPoint
     * @param		command AssignNonlinearShuntCompensatorToNonlinearShuntCompensatorPointCommand	
     * @exception	ProcessingException
     */     
	public void assignNonlinearShuntCompensator( AssignNonlinearShuntCompensatorToNonlinearShuntCompensatorPointCommand command ) throws ProcessingException {
		...
		NonlinearShuntCompensatorBusinessDelegate childDelegate 	= NonlinearShuntCompensatorBusinessDelegate.getNonlinearShuntCompensatorInstance();
		NonlinearShuntCompensatorPointBusinessDelegate parentDelegate = NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance();			
		UUID childId = command.getAssignment().getNonlinearShuntCompensatorId();
		NonlinearShuntCompensator child = null;
		...
		try {
			...
			final String msg = "Failed to get NonlinearShuntCompensator using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignNonlinearShuntCompensator( UnAssignNonlinearShuntCompensatorFromNonlinearShuntCompensatorPointCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign NonlinearShuntCompensator on NonlinearShuntCompensatorPoint";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
