...
//************************************************************************
    ...
    */
    ...
    /**
     * assign BusNameMarker on ACDCTerminal
     * @param		command AssignBusNameMarkerToACDCTerminalCommand	
     * @exception	ProcessingException
     */     
	public void assignBusNameMarker( AssignBusNameMarkerToACDCTerminalCommand command ) throws ProcessingException {
		...
		ACDCTerminalBusinessDelegate parentDelegate = ACDCTerminalBusinessDelegate.getACDCTerminalInstance();			
		UUID childId = command.getAssignment().getBusNameMarkerId();
		BusNameMarker child = null;
		...
		try {
			...
			final String msg = "Failed to get BusNameMarker using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignBusNameMarker( UnAssignBusNameMarkerFromACDCTerminalCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign BusNameMarker on ACDCTerminal";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
