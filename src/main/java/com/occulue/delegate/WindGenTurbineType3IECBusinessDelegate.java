...
//************************************************************************
    ...
    */
    ...
    /**
     * assign WindMechIEC on WindGenTurbineType3IEC
     * @param		command AssignWindMechIECToWindGenTurbineType3IECCommand	
     * @exception	ProcessingException
     */     
	public void assignWindMechIEC( AssignWindMechIECToWindGenTurbineType3IECCommand command ) throws ProcessingException {
		...
		WindMechIECBusinessDelegate childDelegate 	= WindMechIECBusinessDelegate.getWindMechIECInstance();
		WindGenTurbineType3IECBusinessDelegate parentDelegate = WindGenTurbineType3IECBusinessDelegate.getWindGenTurbineType3IECInstance();			
		UUID childId = command.getAssignment().getWindMechIECId();
		WindMechIEC child = null;
		...
		try {
			...
			final String msg = "Failed to get WindMechIEC using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignWindMechIEC( UnAssignWindMechIECFromWindGenTurbineType3IECCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign WindMechIEC on WindGenTurbineType3IEC";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
    ...
    /**
     * assign WindContPitchAngleIEC on WindGenTurbineType3IEC
     * @param		command AssignWindContPitchAngleIECToWindGenTurbineType3IECCommand	
     * @exception	ProcessingException
     */     
	public void assignWindContPitchAngleIEC( AssignWindContPitchAngleIECToWindGenTurbineType3IECCommand command ) throws ProcessingException {
		...
		WindContPitchAngleIECBusinessDelegate childDelegate 	= WindContPitchAngleIECBusinessDelegate.getWindContPitchAngleIECInstance();
		WindGenTurbineType3IECBusinessDelegate parentDelegate = WindGenTurbineType3IECBusinessDelegate.getWindGenTurbineType3IECInstance();			
		UUID childId = command.getAssignment().getWindContPitchAngleIECId();
		WindContPitchAngleIEC child = null;
		...
		try {
			...
			final String msg = "Failed to get WindContPitchAngleIEC using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignWindContPitchAngleIEC( UnAssignWindContPitchAngleIECFromWindGenTurbineType3IECCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign WindContPitchAngleIEC on WindGenTurbineType3IEC";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
    ...
    /**
     * assign WindAeroLinearIEC on WindGenTurbineType3IEC
     * @param		command AssignWindAeroLinearIECToWindGenTurbineType3IECCommand	
     * @exception	ProcessingException
     */     
	public void assignWindAeroLinearIEC( AssignWindAeroLinearIECToWindGenTurbineType3IECCommand command ) throws ProcessingException {
		...
		WindAeroLinearIECBusinessDelegate childDelegate 	= WindAeroLinearIECBusinessDelegate.getWindAeroLinearIECInstance();
		WindGenTurbineType3IECBusinessDelegate parentDelegate = WindGenTurbineType3IECBusinessDelegate.getWindGenTurbineType3IECInstance();			
		UUID childId = command.getAssignment().getWindAeroLinearIECId();
		WindAeroLinearIEC child = null;
		...
		try {
			...
			final String msg = "Failed to get WindAeroLinearIEC using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignWindAeroLinearIEC( UnAssignWindAeroLinearIECFromWindGenTurbineType3IECCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign WindAeroLinearIEC on WindGenTurbineType3IEC";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
    ...
    /**
     * assign WindContPType3IEC on WindGenTurbineType3IEC
     * @param		command AssignWindContPType3IECToWindGenTurbineType3IECCommand	
     * @exception	ProcessingException
     */     
	public void assignWindContPType3IEC( AssignWindContPType3IECToWindGenTurbineType3IECCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignWindContPType3IEC( UnAssignWindContPType3IECFromWindGenTurbineType3IECCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign WindContPType3IEC on WindGenTurbineType3IEC";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
