...
//************************************************************************
    ...
    */
    ...
    /**
     * assign VisibleObjects on VisibilityLayer
     * @param		command AssignVisibleObjectsToVisibilityLayerCommand	
     * @exception	ProcessingException
     */     
	public void assignVisibleObjects( AssignVisibleObjectsToVisibilityLayerCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignVisibleObjects( UnAssignVisibleObjectsFromVisibilityLayerCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign VisibleObjects on VisibilityLayer";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
