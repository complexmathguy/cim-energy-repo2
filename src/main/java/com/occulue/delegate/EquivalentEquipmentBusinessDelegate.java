...
//************************************************************************
    ...
    */
    ...
    /**
     * assign EquivalentNetwork on EquivalentEquipment
     * @param		command AssignEquivalentNetworkToEquivalentEquipmentCommand	
     * @exception	ProcessingException
     */     
	public void assignEquivalentNetwork( AssignEquivalentNetworkToEquivalentEquipmentCommand command ) throws ProcessingException {
		...
		EquivalentNetworkBusinessDelegate childDelegate 	= EquivalentNetworkBusinessDelegate.getEquivalentNetworkInstance();
		EquivalentEquipmentBusinessDelegate parentDelegate = EquivalentEquipmentBusinessDelegate.getEquivalentEquipmentInstance();			
		UUID childId = command.getAssignment().getEquivalentNetworkId();
		EquivalentNetwork child = null;
		...
		try {
			...
			final String msg = "Failed to get EquivalentNetwork using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignEquivalentNetwork( UnAssignEquivalentNetworkFromEquivalentEquipmentCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign EquivalentNetwork on EquivalentEquipment";
