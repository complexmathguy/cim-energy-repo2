...
//************************************************************************
    ...
    */
    ...
    /**
     * add AccumulatorLimitSet to LimitSet 
     * @param		command AssignLimitSetToAccumulatorLimitCommand
     * @exception	ProcessingException
     */     
	public void addToLimitSet( AssignLimitSetToAccumulatorLimitCommand command ) throws ProcessingException {
		...
		try {		
			...
			final String msg = "Failed to add a AccumulatorLimitSet as LimitSet to AccumulatorLimit" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
    ...
    /**
     * remove AccumulatorLimitSet from LimitSet
     * @param		command RemoveLimitSetFromAccumulatorLimitCommand
     * @exception	ProcessingException
     */     	
	public void removeFromLimitSet( RemoveLimitSetFromAccumulatorLimitCommand command ) throws ProcessingException {		
