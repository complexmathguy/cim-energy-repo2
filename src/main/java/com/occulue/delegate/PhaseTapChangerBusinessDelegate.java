...
//************************************************************************
    ...
    */
    ...
    /**
     * assign TransformerEnd on PhaseTapChanger
     * @param		command AssignTransformerEndToPhaseTapChangerCommand	
     * @exception	ProcessingException
     */     
	public void assignTransformerEnd( AssignTransformerEndToPhaseTapChangerCommand command ) throws ProcessingException {
    ...
    /**
     * unAssign TransformerEnd on PhaseTapChanger
     * @param		command UnAssignTransformerEndFromPhaseTapChangerCommand
     * @exception	ProcessingException
     */     
	public void unAssignTransformerEnd( UnAssignTransformerEndFromPhaseTapChangerCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign TransformerEnd on PhaseTapChanger";
