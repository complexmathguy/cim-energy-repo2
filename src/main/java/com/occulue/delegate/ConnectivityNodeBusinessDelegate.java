...
//************************************************************************
    ...
    */
    ...
    /**
     * assign ConnectivityNodeContainer on ConnectivityNode
     * @param		command AssignConnectivityNodeContainerToConnectivityNodeCommand	
     * @exception	ProcessingException
     */     
	public void assignConnectivityNodeContainer( AssignConnectivityNodeContainerToConnectivityNodeCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignConnectivityNodeContainer( UnAssignConnectivityNodeContainerFromConnectivityNodeCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign ConnectivityNodeContainer on ConnectivityNode";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
