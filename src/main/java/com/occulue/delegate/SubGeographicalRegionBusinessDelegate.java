...
//************************************************************************
    ...
    */
    ...
    /**
     * assign Region on SubGeographicalRegion
     * @param		command AssignRegionToSubGeographicalRegionCommand	
     * @exception	ProcessingException
     */     
	public void assignRegion( AssignRegionToSubGeographicalRegionCommand command ) throws ProcessingException {
		...
		GeographicalRegionBusinessDelegate childDelegate 	= GeographicalRegionBusinessDelegate.getGeographicalRegionInstance();
		...
		UUID childId = command.getAssignment().getGeographicalRegionId();
		GeographicalRegion child = null;
		...
		try {
			...
			final String msg = "Failed to get GeographicalRegion using id " + childId;
    ...
    /**
     * unAssign Region on SubGeographicalRegion
     * @param		command UnAssignRegionFromSubGeographicalRegionCommand
     * @exception	ProcessingException
     */     
	public void unAssignRegion( UnAssignRegionFromSubGeographicalRegionCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Region on SubGeographicalRegion";
