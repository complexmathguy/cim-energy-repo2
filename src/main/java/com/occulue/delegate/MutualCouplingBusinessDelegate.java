...
//************************************************************************
    ...
    */
    ...
    /**
     * assign Second_Terminal on MutualCoupling
     * @param		command AssignSecond_TerminalToMutualCouplingCommand	
     * @exception	ProcessingException
     */     
	public void assignSecond_Terminal( AssignSecond_TerminalToMutualCouplingCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignSecond_Terminal( UnAssignSecond_TerminalFromMutualCouplingCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Second_Terminal on MutualCoupling";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
    ...
    /**
     * assign First_Terminal on MutualCoupling
     * @param		command AssignFirst_TerminalToMutualCouplingCommand	
     * @exception	ProcessingException
     */     
	public void assignFirst_Terminal( AssignFirst_TerminalToMutualCouplingCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignFirst_Terminal( UnAssignFirst_TerminalFromMutualCouplingCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign First_Terminal on MutualCoupling";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
