...
//************************************************************************
    ...
    */
    ...
    /**
     * assign LoadAggregate on LoadStatic
     * @param		command AssignLoadAggregateToLoadStaticCommand	
     * @exception	ProcessingException
     */     
	public void assignLoadAggregate( AssignLoadAggregateToLoadStaticCommand command ) throws ProcessingException {
		...
		LoadAggregateBusinessDelegate childDelegate 	= LoadAggregateBusinessDelegate.getLoadAggregateInstance();
		LoadStaticBusinessDelegate parentDelegate = LoadStaticBusinessDelegate.getLoadStaticInstance();			
		UUID childId = command.getAssignment().getLoadAggregateId();
		LoadAggregate child = null;
		...
		try {
			...
			final String msg = "Failed to get LoadAggregate using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignLoadAggregate( UnAssignLoadAggregateFromLoadStaticCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign LoadAggregate on LoadStatic";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
