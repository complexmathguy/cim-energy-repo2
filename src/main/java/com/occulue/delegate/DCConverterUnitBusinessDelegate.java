...
//************************************************************************
    ...
    */
    ...
    /**
     * assign Substation on DCConverterUnit
     * @param		command AssignSubstationToDCConverterUnitCommand	
     * @exception	ProcessingException
     */     
	public void assignSubstation( AssignSubstationToDCConverterUnitCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignSubstation( UnAssignSubstationFromDCConverterUnitCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Substation on DCConverterUnit";
