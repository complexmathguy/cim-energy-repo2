...
//************************************************************************
    ...
    */
    ...
    /**
     * assign DCConductingEquipment on DCTerminal
     * @param		command AssignDCConductingEquipmentToDCTerminalCommand	
     * @exception	ProcessingException
     */     
	public void assignDCConductingEquipment( AssignDCConductingEquipmentToDCTerminalCommand command ) throws ProcessingException {
		...
		DCConductingEquipmentBusinessDelegate childDelegate 	= DCConductingEquipmentBusinessDelegate.getDCConductingEquipmentInstance();
		DCTerminalBusinessDelegate parentDelegate = DCTerminalBusinessDelegate.getDCTerminalInstance();			
		UUID childId = command.getAssignment().getDCConductingEquipmentId();
		DCConductingEquipment child = null;
		...
		try {
			...
			final String msg = "Failed to get DCConductingEquipment using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignDCConductingEquipment( UnAssignDCConductingEquipmentFromDCTerminalCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign DCConductingEquipment on DCTerminal";
