...
//************************************************************************
    ...
    */
    ...
    /**
     * assign ConductingEquipment on SvStatus
     * @param		command AssignConductingEquipmentToSvStatusCommand	
     * @exception	ProcessingException
     */     
	public void assignConductingEquipment( AssignConductingEquipmentToSvStatusCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignConductingEquipment( UnAssignConductingEquipmentFromSvStatusCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign ConductingEquipment on SvStatus";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
