...
//************************************************************************
    ...
    */
    ...
    /**
     * assign WindContRotorRIEC on WindGenTurbineType2IEC
     * @param		command AssignWindContRotorRIECToWindGenTurbineType2IECCommand	
     * @exception	ProcessingException
     */     
	public void assignWindContRotorRIEC( AssignWindContRotorRIECToWindGenTurbineType2IECCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignWindContRotorRIEC( UnAssignWindContRotorRIECFromWindGenTurbineType2IECCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign WindContRotorRIEC on WindGenTurbineType2IEC";
    ...
    /**
     * assign WindPitchContEmulIEC on WindGenTurbineType2IEC
     * @param		command AssignWindPitchContEmulIECToWindGenTurbineType2IECCommand	
     * @exception	ProcessingException
     */     
	public void assignWindPitchContEmulIEC( AssignWindPitchContEmulIECToWindGenTurbineType2IECCommand command ) throws ProcessingException {
		...
		WindPitchContEmulIECBusinessDelegate childDelegate 	= WindPitchContEmulIECBusinessDelegate.getWindPitchContEmulIECInstance();
		WindGenTurbineType2IECBusinessDelegate parentDelegate = WindGenTurbineType2IECBusinessDelegate.getWindGenTurbineType2IECInstance();			
		UUID childId = command.getAssignment().getWindPitchContEmulIECId();
		WindPitchContEmulIEC child = null;
		...
		try {
			...
			final String msg = "Failed to get WindPitchContEmulIEC using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignWindPitchContEmulIEC( UnAssignWindPitchContEmulIECFromWindGenTurbineType2IECCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign WindPitchContEmulIEC on WindGenTurbineType2IEC";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
