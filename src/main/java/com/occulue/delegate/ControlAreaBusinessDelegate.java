...
//************************************************************************
    ...
    */
    ...
    /**
     * assign EnergyArea on ControlArea
     * @param		command AssignEnergyAreaToControlAreaCommand	
     * @exception	ProcessingException
     */     
	public void assignEnergyArea( AssignEnergyAreaToControlAreaCommand command ) throws ProcessingException {
		...
		EnergyAreaBusinessDelegate childDelegate 	= EnergyAreaBusinessDelegate.getEnergyAreaInstance();
		ControlAreaBusinessDelegate parentDelegate = ControlAreaBusinessDelegate.getControlAreaInstance();			
		UUID childId = command.getAssignment().getEnergyAreaId();
		EnergyArea child = null;
		...
		try {
			...
			final String msg = "Failed to get EnergyArea using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignEnergyArea( UnAssignEnergyAreaFromControlAreaCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign EnergyArea on ControlArea";
