...
//************************************************************************
    ...
    */
    ...
    /**
     * assign ControlArea on TieFlow
     * @param		command AssignControlAreaToTieFlowCommand	
     * @exception	ProcessingException
     */     
	public void assignControlArea( AssignControlAreaToTieFlowCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignControlArea( UnAssignControlAreaFromTieFlowCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign ControlArea on TieFlow";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
    ...
    /**
     * assign Terminal on TieFlow
     * @param		command AssignTerminalToTieFlowCommand	
     * @exception	ProcessingException
     */     
	public void assignTerminal( AssignTerminalToTieFlowCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignTerminal( UnAssignTerminalFromTieFlowCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Terminal on TieFlow";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
