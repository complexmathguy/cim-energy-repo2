...
//************************************************************************
    ...
    */
    ...
    /**
     * assign ThermalGeneratingUnit on FossilFuel
     * @param		command AssignThermalGeneratingUnitToFossilFuelCommand	
     * @exception	ProcessingException
     */     
	public void assignThermalGeneratingUnit( AssignThermalGeneratingUnitToFossilFuelCommand command ) throws ProcessingException {
		...
		ThermalGeneratingUnitBusinessDelegate childDelegate 	= ThermalGeneratingUnitBusinessDelegate.getThermalGeneratingUnitInstance();
		FossilFuelBusinessDelegate parentDelegate = FossilFuelBusinessDelegate.getFossilFuelInstance();			
		UUID childId = command.getAssignment().getThermalGeneratingUnitId();
		ThermalGeneratingUnit child = null;
		...
		try {
			...
			final String msg = "Failed to get ThermalGeneratingUnit using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignThermalGeneratingUnit( UnAssignThermalGeneratingUnitFromFossilFuelCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign ThermalGeneratingUnit on FossilFuel";
