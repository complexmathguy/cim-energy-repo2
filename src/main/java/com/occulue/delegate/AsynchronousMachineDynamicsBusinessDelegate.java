...
//************************************************************************
    ...
    */
    ...
    /**
     * assign AsynchronousMachine on AsynchronousMachineDynamics
     * @param		command AssignAsynchronousMachineToAsynchronousMachineDynamicsCommand	
     * @exception	ProcessingException
     */     
	public void assignAsynchronousMachine( AssignAsynchronousMachineToAsynchronousMachineDynamicsCommand command ) throws ProcessingException {
		...
		AsynchronousMachineBusinessDelegate childDelegate 	= AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance();
		...
		UUID childId = command.getAssignment().getAsynchronousMachineId();
		AsynchronousMachine child = null;
		...
		try {
			...
			final String msg = "Failed to get AsynchronousMachine using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignAsynchronousMachine( UnAssignAsynchronousMachineFromAsynchronousMachineDynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign AsynchronousMachine on AsynchronousMachineDynamics";
