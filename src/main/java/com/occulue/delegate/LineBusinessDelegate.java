...
//************************************************************************
    ...
    */
    ...
    /**
     * assign Region on Line
     * @param		command AssignRegionToLineCommand	
     * @exception	ProcessingException
     */     
	public void assignRegion( AssignRegionToLineCommand command ) throws ProcessingException {
    ...
    /**
     * unAssign Region on Line
     * @param		command UnAssignRegionFromLineCommand
     * @exception	ProcessingException
     */     
	public void unAssignRegion( UnAssignRegionFromLineCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Region on Line";
