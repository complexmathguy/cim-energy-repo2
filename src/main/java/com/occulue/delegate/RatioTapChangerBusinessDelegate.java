...
//************************************************************************
    ...
    */
    ...
    /**
     * assign TransformerEnd on RatioTapChanger
     * @param		command AssignTransformerEndToRatioTapChangerCommand	
     * @exception	ProcessingException
     */     
	public void assignTransformerEnd( AssignTransformerEndToRatioTapChangerCommand command ) throws ProcessingException {
		...
		RatioTapChangerBusinessDelegate parentDelegate = RatioTapChangerBusinessDelegate.getRatioTapChangerInstance();			
		UUID childId = command.getAssignment().getTransformerEndId();
		TransformerEnd child = null;
		...
		try {
			...
			final String msg = "Failed to get TransformerEnd using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignTransformerEnd( UnAssignTransformerEndFromRatioTapChangerCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign TransformerEnd on RatioTapChanger";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
    ...
    /**
     * assign RatioTapChangerTable on RatioTapChanger
     * @param		command AssignRatioTapChangerTableToRatioTapChangerCommand	
     * @exception	ProcessingException
     */     
	public void assignRatioTapChangerTable( AssignRatioTapChangerTableToRatioTapChangerCommand command ) throws ProcessingException {
		...
		RatioTapChangerTableBusinessDelegate childDelegate 	= RatioTapChangerTableBusinessDelegate.getRatioTapChangerTableInstance();
		RatioTapChangerBusinessDelegate parentDelegate = RatioTapChangerBusinessDelegate.getRatioTapChangerInstance();			
		UUID childId = command.getAssignment().getRatioTapChangerTableId();
		RatioTapChangerTable child = null;
		...
		try {
			...
			final String msg = "Failed to get RatioTapChangerTable using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignRatioTapChangerTable( UnAssignRatioTapChangerTableFromRatioTapChangerCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign RatioTapChangerTable on RatioTapChanger";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
