...
//************************************************************************
    ...
    */
    ...
    /**
     * assign ExcitationSystemDynamics on VoltageCompensatorDynamics
     * @param		command AssignExcitationSystemDynamicsToVoltageCompensatorDynamicsCommand	
     * @exception	ProcessingException
     */     
	public void assignExcitationSystemDynamics( AssignExcitationSystemDynamicsToVoltageCompensatorDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignExcitationSystemDynamics( UnAssignExcitationSystemDynamicsFromVoltageCompensatorDynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign ExcitationSystemDynamics on VoltageCompensatorDynamics";
