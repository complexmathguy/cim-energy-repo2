...
//************************************************************************
    ...
    */
    ...
    /**
     * assign AnalogValue on AnalogControl
     * @param		command AssignAnalogValueToAnalogControlCommand	
     * @exception	ProcessingException
     */     
	public void assignAnalogValue( AssignAnalogValueToAnalogControlCommand command ) throws ProcessingException {
		...
		AnalogControlBusinessDelegate parentDelegate = AnalogControlBusinessDelegate.getAnalogControlInstance();			
		UUID childId = command.getAssignment().getAnalogValueId();
		AnalogValue child = null;
		...
		try {
			...
			final String msg = "Failed to get AnalogValue using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignAnalogValue( UnAssignAnalogValueFromAnalogControlCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign AnalogValue on AnalogControl";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
