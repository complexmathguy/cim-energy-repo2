...
//************************************************************************
    ...
    */
    ...
    /**
     * assign AccumulatorValue on AccumulatorReset
     * @param		command AssignAccumulatorValueToAccumulatorResetCommand	
     * @exception	ProcessingException
     */     
	public void assignAccumulatorValue( AssignAccumulatorValueToAccumulatorResetCommand command ) throws ProcessingException {
		...
		UUID childId = command.getAssignment().getAccumulatorValueId();
		AccumulatorValue child = null;
		...
		try {
			...
			final String msg = "Failed to get AccumulatorValue using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignAccumulatorValue( UnAssignAccumulatorValueFromAccumulatorResetCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign AccumulatorValue on AccumulatorReset";
