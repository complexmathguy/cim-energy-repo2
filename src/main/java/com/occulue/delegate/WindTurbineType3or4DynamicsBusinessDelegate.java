...
//************************************************************************
    ...
    */
    ...
    /**
     * assign EnergySource on WindTurbineType3or4Dynamics
     * @param		command AssignEnergySourceToWindTurbineType3or4DynamicsCommand	
     * @exception	ProcessingException
     */     
	public void assignEnergySource( AssignEnergySourceToWindTurbineType3or4DynamicsCommand command ) throws ProcessingException {
		...
		UUID childId = command.getAssignment().getEnergySourceId();
		EnergySource child = null;
		...
		try {
			...
			final String msg = "Failed to get EnergySource using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignEnergySource( UnAssignEnergySourceFromWindTurbineType3or4DynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign EnergySource on WindTurbineType3or4Dynamics";
    ...
    /**
     * assign WindPlantDynamics on WindTurbineType3or4Dynamics
     * @param		command AssignWindPlantDynamicsToWindTurbineType3or4DynamicsCommand	
     * @exception	ProcessingException
     */     
	public void assignWindPlantDynamics( AssignWindPlantDynamicsToWindTurbineType3or4DynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignWindPlantDynamics( UnAssignWindPlantDynamicsFromWindTurbineType3or4DynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign WindPlantDynamics on WindTurbineType3or4Dynamics";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
    ...
    /**
     * assign RemoteInputSignal on WindTurbineType3or4Dynamics
     * @param		command AssignRemoteInputSignalToWindTurbineType3or4DynamicsCommand	
     * @exception	ProcessingException
     */     
	public void assignRemoteInputSignal( AssignRemoteInputSignalToWindTurbineType3or4DynamicsCommand command ) throws ProcessingException {
		...
		WindTurbineType3or4DynamicsBusinessDelegate parentDelegate = WindTurbineType3or4DynamicsBusinessDelegate.getWindTurbineType3or4DynamicsInstance();			
		UUID childId = command.getAssignment().getRemoteInputSignalId();
		RemoteInputSignal child = null;
		...
		try {
			...
			final String msg = "Failed to get RemoteInputSignal using id " + childId;
			LOGGER.log( Level.WARNING,  msg );
			throw new ProcessingException( msg, exc );
        }
	}
     ...
     * @exception	ProcessingException
     */     
	public void unAssignRemoteInputSignal( UnAssignRemoteInputSignalFromWindTurbineType3or4DynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign RemoteInputSignal on WindTurbineType3or4Dynamics";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
