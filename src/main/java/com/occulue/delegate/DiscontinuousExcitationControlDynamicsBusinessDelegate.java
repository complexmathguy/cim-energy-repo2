...
//************************************************************************
    ...
    */
    ...
    /**
     * assign ExcitationSystemDynamics on DiscontinuousExcitationControlDynamics
     * @param		command AssignExcitationSystemDynamicsToDiscontinuousExcitationControlDynamicsCommand	
     * @exception	ProcessingException
     */     
	public void assignExcitationSystemDynamics( AssignExcitationSystemDynamicsToDiscontinuousExcitationControlDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignExcitationSystemDynamics( UnAssignExcitationSystemDynamicsFromDiscontinuousExcitationControlDynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign ExcitationSystemDynamics on DiscontinuousExcitationControlDynamics";
