...
//************************************************************************
    ...
    */
    ...
    /**
     * assign RemoteInputSignal on WindPlantDynamics
     * @param		command AssignRemoteInputSignalToWindPlantDynamicsCommand	
     * @exception	ProcessingException
     */     
	public void assignRemoteInputSignal( AssignRemoteInputSignalToWindPlantDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignRemoteInputSignal( UnAssignRemoteInputSignalFromWindPlantDynamicsCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign RemoteInputSignal on WindPlantDynamics";
