...
//************************************************************************
    ...
    */
    ...
    /**
     * assign EnergySchedulingType on EnergySource
     * @param		command AssignEnergySchedulingTypeToEnergySourceCommand	
     * @exception	ProcessingException
     */     
	public void assignEnergySchedulingType( AssignEnergySchedulingTypeToEnergySourceCommand command ) throws ProcessingException {
		...
		EnergySchedulingTypeBusinessDelegate childDelegate 	= EnergySchedulingTypeBusinessDelegate.getEnergySchedulingTypeInstance();
		EnergySourceBusinessDelegate parentDelegate = EnergySourceBusinessDelegate.getEnergySourceInstance();			
		UUID childId = command.getAssignment().getEnergySchedulingTypeId();
		EnergySchedulingType child = null;
		...
		try {
			...
			final String msg = "Failed to get EnergySchedulingType using id " + childId;
     ...
     * @exception	ProcessingException
     */     
	public void unAssignEnergySchedulingType( UnAssignEnergySchedulingTypeFromEnergySourceCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign EnergySchedulingType on EnergySource";
