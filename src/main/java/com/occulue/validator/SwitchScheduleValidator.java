...
//		Assert.isNull( switchSchedule.getSwitchScheduleId(), "CreateSwitchScheduleCommand identifier should be null" );
	...
	/**
	 * handles assign SwitchIt validation for a SwitchSchedule
	 * 
	 * @param	command AssignSwitchItToSwitchScheduleCommand
	 */	
	public void validate( AssignSwitchItToSwitchScheduleCommand command ) throws Exception {
		Assert.notNull( command, "AssignSwitchItToSwitchScheduleCommand should not be null" );
		Assert.notNull( command.getSwitchScheduleId(), "AssignSwitchItToSwitchScheduleCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSwitchItToSwitchScheduleCommand assignment should not be null" );
	}

	/**
	 * handles unassign SwitchIt validation for a SwitchSchedule
	 * 
	 * @param	command UnAssignSwitchItFromSwitchScheduleCommand
	 */	
	public void validate( UnAssignSwitchItFromSwitchScheduleCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignSwitchItFromSwitchScheduleCommand should not be null" );
		Assert.notNull( command.getSwitchScheduleId(), "UnAssignSwitchItFromSwitchScheduleCommand identifier should not be null" );
	}
