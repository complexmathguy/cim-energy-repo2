...
//		Assert.isNull( regulatingControl.getRegulatingControlId(), "CreateRegulatingControlCommand identifier should be null" );
	...
	/**
	 * handles assign Terminal validation for a RegulatingControl
	 * 
	 * @param	command AssignTerminalToRegulatingControlCommand
	 */	
	public void validate( AssignTerminalToRegulatingControlCommand command ) throws Exception {
		Assert.notNull( command, "AssignTerminalToRegulatingControlCommand should not be null" );
		Assert.notNull( command.getRegulatingControlId(), "AssignTerminalToRegulatingControlCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTerminalToRegulatingControlCommand assignment should not be null" );
	}

	/**
	 * handles unassign Terminal validation for a RegulatingControl
	 * 
	 * @param	command UnAssignTerminalFromRegulatingControlCommand
	 */	
	public void validate( UnAssignTerminalFromRegulatingControlCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignTerminalFromRegulatingControlCommand should not be null" );
		Assert.notNull( command.getRegulatingControlId(), "UnAssignTerminalFromRegulatingControlCommand identifier should not be null" );
	}
