...
//		Assert.isNull( loadMotor.getLoadMotorId(), "CreateLoadMotorCommand identifier should be null" );
	...
	/**
	 * handles assign LoadAggregate validation for a LoadMotor
	 * 
	 * @param	command AssignLoadAggregateToLoadMotorCommand
	 */	
	public void validate( AssignLoadAggregateToLoadMotorCommand command ) throws Exception {
		Assert.notNull( command, "AssignLoadAggregateToLoadMotorCommand should not be null" );
		Assert.notNull( command.getLoadMotorId(), "AssignLoadAggregateToLoadMotorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignLoadAggregateToLoadMotorCommand assignment should not be null" );
	}

	/**
	 * handles unassign LoadAggregate validation for a LoadMotor
	 * 
	 * @param	command UnAssignLoadAggregateFromLoadMotorCommand
	 */	
	public void validate( UnAssignLoadAggregateFromLoadMotorCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignLoadAggregateFromLoadMotorCommand should not be null" );
		Assert.notNull( command.getLoadMotorId(), "UnAssignLoadAggregateFromLoadMotorCommand identifier should not be null" );
	}
