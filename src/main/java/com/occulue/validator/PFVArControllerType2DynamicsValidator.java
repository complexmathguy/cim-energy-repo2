...
//		Assert.isNull( pFVArControllerType2Dynamics.getPFVArControllerType2DynamicsId(), "CreatePFVArControllerType2DynamicsCommand identifier should be null" );
	...
	/**
	 * handles assign ExcitationSystemDynamics validation for a PFVArControllerType2Dynamics
	 * 
	 * @param	command AssignExcitationSystemDynamicsToPFVArControllerType2DynamicsCommand
	 */	
	public void validate( AssignExcitationSystemDynamicsToPFVArControllerType2DynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignExcitationSystemDynamicsToPFVArControllerType2DynamicsCommand should not be null" );
		Assert.notNull( command.getPFVArControllerType2DynamicsId(), "AssignExcitationSystemDynamicsToPFVArControllerType2DynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignExcitationSystemDynamicsToPFVArControllerType2DynamicsCommand assignment should not be null" );
	}

	/**
	 * handles unassign ExcitationSystemDynamics validation for a PFVArControllerType2Dynamics
	 * 
	 * @param	command UnAssignExcitationSystemDynamicsFromPFVArControllerType2DynamicsCommand
	 */	
	public void validate( UnAssignExcitationSystemDynamicsFromPFVArControllerType2DynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignExcitationSystemDynamicsFromPFVArControllerType2DynamicsCommand should not be null" );
		Assert.notNull( command.getPFVArControllerType2DynamicsId(), "UnAssignExcitationSystemDynamicsFromPFVArControllerType2DynamicsCommand identifier should not be null" );
	}
