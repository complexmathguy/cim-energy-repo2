...
//		Assert.isNull( dCTopologicalNode.getDCTopologicalNodeId(), "CreateDCTopologicalNodeCommand identifier should be null" );
	...
	/**
	 * handles assign DCEquipmentContainer validation for a DCTopologicalNode
	 * 
	 * @param	command AssignDCEquipmentContainerToDCTopologicalNodeCommand
	 */	
	public void validate( AssignDCEquipmentContainerToDCTopologicalNodeCommand command ) throws Exception {
		Assert.notNull( command, "AssignDCEquipmentContainerToDCTopologicalNodeCommand should not be null" );
		Assert.notNull( command.getDCTopologicalNodeId(), "AssignDCEquipmentContainerToDCTopologicalNodeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDCEquipmentContainerToDCTopologicalNodeCommand assignment should not be null" );
	}

	/**
	 * handles unassign DCEquipmentContainer validation for a DCTopologicalNode
	 * 
	 * @param	command UnAssignDCEquipmentContainerFromDCTopologicalNodeCommand
	 */	
	public void validate( UnAssignDCEquipmentContainerFromDCTopologicalNodeCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignDCEquipmentContainerFromDCTopologicalNodeCommand should not be null" );
		Assert.notNull( command.getDCTopologicalNodeId(), "UnAssignDCEquipmentContainerFromDCTopologicalNodeCommand identifier should not be null" );
	}
