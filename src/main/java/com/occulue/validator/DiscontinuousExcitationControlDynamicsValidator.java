...
//		Assert.isNull( discontinuousExcitationControlDynamics.getDiscontinuousExcitationControlDynamicsId(), "CreateDiscontinuousExcitationControlDynamicsCommand identifier should be null" );
	...
	/**
	 * handles assign ExcitationSystemDynamics validation for a DiscontinuousExcitationControlDynamics
	 * 
	 * @param	command AssignExcitationSystemDynamicsToDiscontinuousExcitationControlDynamicsCommand
	 */	
	public void validate( AssignExcitationSystemDynamicsToDiscontinuousExcitationControlDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignExcitationSystemDynamicsToDiscontinuousExcitationControlDynamicsCommand should not be null" );
		Assert.notNull( command.getDiscontinuousExcitationControlDynamicsId(), "AssignExcitationSystemDynamicsToDiscontinuousExcitationControlDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignExcitationSystemDynamicsToDiscontinuousExcitationControlDynamicsCommand assignment should not be null" );
	}

	/**
	 * handles unassign ExcitationSystemDynamics validation for a DiscontinuousExcitationControlDynamics
	 * 
	 * @param	command UnAssignExcitationSystemDynamicsFromDiscontinuousExcitationControlDynamicsCommand
	 */	
	public void validate( UnAssignExcitationSystemDynamicsFromDiscontinuousExcitationControlDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignExcitationSystemDynamicsFromDiscontinuousExcitationControlDynamicsCommand should not be null" );
		Assert.notNull( command.getDiscontinuousExcitationControlDynamicsId(), "UnAssignExcitationSystemDynamicsFromDiscontinuousExcitationControlDynamicsCommand identifier should not be null" );
	}
