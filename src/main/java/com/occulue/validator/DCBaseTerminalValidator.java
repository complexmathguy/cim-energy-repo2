...
//		Assert.isNull( dCBaseTerminal.getDCBaseTerminalId(), "CreateDCBaseTerminalCommand identifier should be null" );
	...
	/**
	 * handles assign DCNode validation for a DCBaseTerminal
	 * 
	 * @param	command AssignDCNodeToDCBaseTerminalCommand
	 */	
	public void validate( AssignDCNodeToDCBaseTerminalCommand command ) throws Exception {
		Assert.notNull( command, "AssignDCNodeToDCBaseTerminalCommand should not be null" );
		Assert.notNull( command.getDCBaseTerminalId(), "AssignDCNodeToDCBaseTerminalCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDCNodeToDCBaseTerminalCommand assignment should not be null" );
	}

	/**
	 * handles unassign DCNode validation for a DCBaseTerminal
	 * 
	 * @param	command UnAssignDCNodeFromDCBaseTerminalCommand
	 */	
	public void validate( UnAssignDCNodeFromDCBaseTerminalCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignDCNodeFromDCBaseTerminalCommand should not be null" );
		Assert.notNull( command.getDCBaseTerminalId(), "UnAssignDCNodeFromDCBaseTerminalCommand identifier should not be null" );
	}
