...
//		Assert.isNull( synchronousMachineDynamics.getSynchronousMachineDynamicsId(), "CreateSynchronousMachineDynamicsCommand identifier should be null" );
	...
	/**
	 * handles assign SynchronousMachine validation for a SynchronousMachineDynamics
	 * 
	 * @param	command AssignSynchronousMachineToSynchronousMachineDynamicsCommand
	 */	
	public void validate( AssignSynchronousMachineToSynchronousMachineDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignSynchronousMachineToSynchronousMachineDynamicsCommand should not be null" );
		Assert.notNull( command.getSynchronousMachineDynamicsId(), "AssignSynchronousMachineToSynchronousMachineDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSynchronousMachineToSynchronousMachineDynamicsCommand assignment should not be null" );
	}

	/**
	 * handles unassign SynchronousMachine validation for a SynchronousMachineDynamics
	 * 
	 * @param	command UnAssignSynchronousMachineFromSynchronousMachineDynamicsCommand
	 */	
	public void validate( UnAssignSynchronousMachineFromSynchronousMachineDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignSynchronousMachineFromSynchronousMachineDynamicsCommand should not be null" );
		Assert.notNull( command.getSynchronousMachineDynamicsId(), "UnAssignSynchronousMachineFromSynchronousMachineDynamicsCommand identifier should not be null" );
	}
