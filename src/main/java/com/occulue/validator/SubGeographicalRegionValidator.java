...
//		Assert.isNull( subGeographicalRegion.getSubGeographicalRegionId(), "CreateSubGeographicalRegionCommand identifier should be null" );
	...
	/**
	 * handles assign Region validation for a SubGeographicalRegion
	 * 
	 * @param	command AssignRegionToSubGeographicalRegionCommand
	 */	
	public void validate( AssignRegionToSubGeographicalRegionCommand command ) throws Exception {
		Assert.notNull( command, "AssignRegionToSubGeographicalRegionCommand should not be null" );
		Assert.notNull( command.getSubGeographicalRegionId(), "AssignRegionToSubGeographicalRegionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRegionToSubGeographicalRegionCommand assignment should not be null" );
	}

	/**
	 * handles unassign Region validation for a SubGeographicalRegion
	 * 
	 * @param	command UnAssignRegionFromSubGeographicalRegionCommand
	 */	
	public void validate( UnAssignRegionFromSubGeographicalRegionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignRegionFromSubGeographicalRegionCommand should not be null" );
		Assert.notNull( command.getSubGeographicalRegionId(), "UnAssignRegionFromSubGeographicalRegionCommand identifier should not be null" );
	}
