...
//		Assert.isNull( equivalentEquipment.getEquivalentEquipmentId(), "CreateEquivalentEquipmentCommand identifier should be null" );
	...
	/**
	 * handles assign EquivalentNetwork validation for a EquivalentEquipment
	 * 
	 * @param	command AssignEquivalentNetworkToEquivalentEquipmentCommand
	 */	
	public void validate( AssignEquivalentNetworkToEquivalentEquipmentCommand command ) throws Exception {
		Assert.notNull( command, "AssignEquivalentNetworkToEquivalentEquipmentCommand should not be null" );
		Assert.notNull( command.getEquivalentEquipmentId(), "AssignEquivalentNetworkToEquivalentEquipmentCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEquivalentNetworkToEquivalentEquipmentCommand assignment should not be null" );
	}

	/**
	 * handles unassign EquivalentNetwork validation for a EquivalentEquipment
	 * 
	 * @param	command UnAssignEquivalentNetworkFromEquivalentEquipmentCommand
	 */	
	public void validate( UnAssignEquivalentNetworkFromEquivalentEquipmentCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignEquivalentNetworkFromEquivalentEquipmentCommand should not be null" );
		Assert.notNull( command.getEquivalentEquipmentId(), "UnAssignEquivalentNetworkFromEquivalentEquipmentCommand identifier should not be null" );
	}
