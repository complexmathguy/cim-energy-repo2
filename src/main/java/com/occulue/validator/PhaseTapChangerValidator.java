...
//		Assert.isNull( phaseTapChanger.getPhaseTapChangerId(), "CreatePhaseTapChangerCommand identifier should be null" );
	...
	/**
	 * handles assign TransformerEnd validation for a PhaseTapChanger
	 * 
	 * @param	command AssignTransformerEndToPhaseTapChangerCommand
	 */	
	public void validate( AssignTransformerEndToPhaseTapChangerCommand command ) throws Exception {
		Assert.notNull( command, "AssignTransformerEndToPhaseTapChangerCommand should not be null" );
		Assert.notNull( command.getPhaseTapChangerId(), "AssignTransformerEndToPhaseTapChangerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTransformerEndToPhaseTapChangerCommand assignment should not be null" );
	}

	/**
	 * handles unassign TransformerEnd validation for a PhaseTapChanger
	 * 
	 * @param	command UnAssignTransformerEndFromPhaseTapChangerCommand
	 */	
	public void validate( UnAssignTransformerEndFromPhaseTapChangerCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignTransformerEndFromPhaseTapChangerCommand should not be null" );
		Assert.notNull( command.getPhaseTapChangerId(), "UnAssignTransformerEndFromPhaseTapChangerCommand identifier should not be null" );
	}
