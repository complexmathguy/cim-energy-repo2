...
//		Assert.isNull( accumulatorReset.getAccumulatorResetId(), "CreateAccumulatorResetCommand identifier should be null" );
	...
	/**
	 * handles assign AccumulatorValue validation for a AccumulatorReset
	 * 
	 * @param	command AssignAccumulatorValueToAccumulatorResetCommand
	 */	
	public void validate( AssignAccumulatorValueToAccumulatorResetCommand command ) throws Exception {
		Assert.notNull( command, "AssignAccumulatorValueToAccumulatorResetCommand should not be null" );
		Assert.notNull( command.getAccumulatorResetId(), "AssignAccumulatorValueToAccumulatorResetCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAccumulatorValueToAccumulatorResetCommand assignment should not be null" );
	}

	/**
	 * handles unassign AccumulatorValue validation for a AccumulatorReset
	 * 
	 * @param	command UnAssignAccumulatorValueFromAccumulatorResetCommand
	 */	
	public void validate( UnAssignAccumulatorValueFromAccumulatorResetCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignAccumulatorValueFromAccumulatorResetCommand should not be null" );
		Assert.notNull( command.getAccumulatorResetId(), "UnAssignAccumulatorValueFromAccumulatorResetCommand identifier should not be null" );
	}
