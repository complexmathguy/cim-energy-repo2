...
//		Assert.isNull( regulatingCondEq.getRegulatingCondEqId(), "CreateRegulatingCondEqCommand identifier should be null" );
	...
	/**
	 * handles assign RegulatingControl validation for a RegulatingCondEq
	 * 
	 * @param	command AssignRegulatingControlToRegulatingCondEqCommand
	 */	
	public void validate( AssignRegulatingControlToRegulatingCondEqCommand command ) throws Exception {
		Assert.notNull( command, "AssignRegulatingControlToRegulatingCondEqCommand should not be null" );
		Assert.notNull( command.getRegulatingCondEqId(), "AssignRegulatingControlToRegulatingCondEqCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRegulatingControlToRegulatingCondEqCommand assignment should not be null" );
	}

	/**
	 * handles unassign RegulatingControl validation for a RegulatingCondEq
	 * 
	 * @param	command UnAssignRegulatingControlFromRegulatingCondEqCommand
	 */	
	public void validate( UnAssignRegulatingControlFromRegulatingCondEqCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignRegulatingControlFromRegulatingCondEqCommand should not be null" );
		Assert.notNull( command.getRegulatingCondEqId(), "UnAssignRegulatingControlFromRegulatingCondEqCommand identifier should not be null" );
	}
