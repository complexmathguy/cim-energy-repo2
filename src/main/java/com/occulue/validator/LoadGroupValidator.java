...
//		Assert.isNull( loadGroup.getLoadGroupId(), "CreateLoadGroupCommand identifier should be null" );
	...
	/**
	 * handles assign SubLoadArea validation for a LoadGroup
	 * 
	 * @param	command AssignSubLoadAreaToLoadGroupCommand
	 */	
	public void validate( AssignSubLoadAreaToLoadGroupCommand command ) throws Exception {
		Assert.notNull( command, "AssignSubLoadAreaToLoadGroupCommand should not be null" );
		Assert.notNull( command.getLoadGroupId(), "AssignSubLoadAreaToLoadGroupCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSubLoadAreaToLoadGroupCommand assignment should not be null" );
	}

	/**
	 * handles unassign SubLoadArea validation for a LoadGroup
	 * 
	 * @param	command UnAssignSubLoadAreaFromLoadGroupCommand
	 */	
	public void validate( UnAssignSubLoadAreaFromLoadGroupCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignSubLoadAreaFromLoadGroupCommand should not be null" );
		Assert.notNull( command.getLoadGroupId(), "UnAssignSubLoadAreaFromLoadGroupCommand identifier should not be null" );
	}
