...
//		Assert.isNull( substation.getSubstationId(), "CreateSubstationCommand identifier should be null" );
	...
	/**
	 * handles assign Region validation for a Substation
	 * 
	 * @param	command AssignRegionToSubstationCommand
	 */	
	public void validate( AssignRegionToSubstationCommand command ) throws Exception {
		Assert.notNull( command, "AssignRegionToSubstationCommand should not be null" );
		Assert.notNull( command.getSubstationId(), "AssignRegionToSubstationCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRegionToSubstationCommand assignment should not be null" );
	}

	/**
	 * handles unassign Region validation for a Substation
	 * 
	 * @param	command UnAssignRegionFromSubstationCommand
	 */	
	public void validate( UnAssignRegionFromSubstationCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignRegionFromSubstationCommand should not be null" );
		Assert.notNull( command.getSubstationId(), "UnAssignRegionFromSubstationCommand identifier should not be null" );
	}
