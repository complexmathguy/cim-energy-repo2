...
//		Assert.isNull( nonConformLoadSchedule.getNonConformLoadScheduleId(), "CreateNonConformLoadScheduleCommand identifier should be null" );
	...
	/**
	 * handles assign NonConformLoadGroup validation for a NonConformLoadSchedule
	 * 
	 * @param	command AssignNonConformLoadGroupToNonConformLoadScheduleCommand
	 */	
	public void validate( AssignNonConformLoadGroupToNonConformLoadScheduleCommand command ) throws Exception {
		Assert.notNull( command, "AssignNonConformLoadGroupToNonConformLoadScheduleCommand should not be null" );
		Assert.notNull( command.getNonConformLoadScheduleId(), "AssignNonConformLoadGroupToNonConformLoadScheduleCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNonConformLoadGroupToNonConformLoadScheduleCommand assignment should not be null" );
	}

	/**
	 * handles unassign NonConformLoadGroup validation for a NonConformLoadSchedule
	 * 
	 * @param	command UnAssignNonConformLoadGroupFromNonConformLoadScheduleCommand
	 */	
	public void validate( UnAssignNonConformLoadGroupFromNonConformLoadScheduleCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignNonConformLoadGroupFromNonConformLoadScheduleCommand should not be null" );
		Assert.notNull( command.getNonConformLoadScheduleId(), "UnAssignNonConformLoadGroupFromNonConformLoadScheduleCommand identifier should not be null" );
	}
