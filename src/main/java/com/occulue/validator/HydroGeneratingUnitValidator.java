...
//		Assert.isNull( hydroGeneratingUnit.getHydroGeneratingUnitId(), "CreateHydroGeneratingUnitCommand identifier should be null" );
	...
	/**
	 * handles assign HydroPowerPlant validation for a HydroGeneratingUnit
	 * 
	 * @param	command AssignHydroPowerPlantToHydroGeneratingUnitCommand
	 */	
	public void validate( AssignHydroPowerPlantToHydroGeneratingUnitCommand command ) throws Exception {
		Assert.notNull( command, "AssignHydroPowerPlantToHydroGeneratingUnitCommand should not be null" );
		Assert.notNull( command.getHydroGeneratingUnitId(), "AssignHydroPowerPlantToHydroGeneratingUnitCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignHydroPowerPlantToHydroGeneratingUnitCommand assignment should not be null" );
	}

	/**
	 * handles unassign HydroPowerPlant validation for a HydroGeneratingUnit
	 * 
	 * @param	command UnAssignHydroPowerPlantFromHydroGeneratingUnitCommand
	 */	
	public void validate( UnAssignHydroPowerPlantFromHydroGeneratingUnitCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignHydroPowerPlantFromHydroGeneratingUnitCommand should not be null" );
		Assert.notNull( command.getHydroGeneratingUnitId(), "UnAssignHydroPowerPlantFromHydroGeneratingUnitCommand identifier should not be null" );
	}
