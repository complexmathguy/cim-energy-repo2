...
//		Assert.isNull( loadStatic.getLoadStaticId(), "CreateLoadStaticCommand identifier should be null" );
	...
	/**
	 * handles assign LoadAggregate validation for a LoadStatic
	 * 
	 * @param	command AssignLoadAggregateToLoadStaticCommand
	 */	
	public void validate( AssignLoadAggregateToLoadStaticCommand command ) throws Exception {
		Assert.notNull( command, "AssignLoadAggregateToLoadStaticCommand should not be null" );
		Assert.notNull( command.getLoadStaticId(), "AssignLoadAggregateToLoadStaticCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignLoadAggregateToLoadStaticCommand assignment should not be null" );
	}

	/**
	 * handles unassign LoadAggregate validation for a LoadStatic
	 * 
	 * @param	command UnAssignLoadAggregateFromLoadStaticCommand
	 */	
	public void validate( UnAssignLoadAggregateFromLoadStaticCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignLoadAggregateFromLoadStaticCommand should not be null" );
		Assert.notNull( command.getLoadStaticId(), "UnAssignLoadAggregateFromLoadStaticCommand identifier should not be null" );
	}
