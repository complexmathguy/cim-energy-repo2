...
//		Assert.isNull( synchronousMachine.getSynchronousMachineId(), "CreateSynchronousMachineCommand identifier should be null" );
	...
	/**
	 * handles assign InitialReactiveCapabilityCurve validation for a SynchronousMachine
	 * 
	 * @param	command AssignInitialReactiveCapabilityCurveToSynchronousMachineCommand
	 */	
	public void validate( AssignInitialReactiveCapabilityCurveToSynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "AssignInitialReactiveCapabilityCurveToSynchronousMachineCommand should not be null" );
		Assert.notNull( command.getSynchronousMachineId(), "AssignInitialReactiveCapabilityCurveToSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignInitialReactiveCapabilityCurveToSynchronousMachineCommand assignment should not be null" );
	}

	/**
	 * handles unassign InitialReactiveCapabilityCurve validation for a SynchronousMachine
	 * 
	 * @param	command UnAssignInitialReactiveCapabilityCurveFromSynchronousMachineCommand
	 */	
	public void validate( UnAssignInitialReactiveCapabilityCurveFromSynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignInitialReactiveCapabilityCurveFromSynchronousMachineCommand should not be null" );
		Assert.notNull( command.getSynchronousMachineId(), "UnAssignInitialReactiveCapabilityCurveFromSynchronousMachineCommand identifier should not be null" );
	}
