...
//		Assert.isNull( analogLimitSet.getAnalogLimitSetId(), "CreateAnalogLimitSetCommand identifier should be null" );
	...
	/**
	 * handles assign Measurements validation for a AnalogLimitSet
	 * 
	 * @param	command AssignMeasurementsToAnalogLimitSetCommand
	 */	
	public void validate( AssignMeasurementsToAnalogLimitSetCommand command ) throws Exception {
		Assert.notNull( command, "AssignMeasurementsToAnalogLimitSetCommand should not be null" );
		Assert.notNull( command.getAnalogLimitSetId(), "AssignMeasurementsToAnalogLimitSetCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMeasurementsToAnalogLimitSetCommand assignment should not be null" );
	}

	/**
	 * handles unassign Measurements validation for a AnalogLimitSet
	 * 
	 * @param	command UnAssignMeasurementsFromAnalogLimitSetCommand
	 */	
	public void validate( UnAssignMeasurementsFromAnalogLimitSetCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignMeasurementsFromAnalogLimitSetCommand should not be null" );
		Assert.notNull( command.getAnalogLimitSetId(), "UnAssignMeasurementsFromAnalogLimitSetCommand identifier should not be null" );
	}
