...
//		Assert.isNull( windGenTurbineType1IEC.getWindGenTurbineType1IECId(), "CreateWindGenTurbineType1IECCommand identifier should be null" );
	...
	/**
	 * handles assign WindAeroConstIEC validation for a WindGenTurbineType1IEC
	 * 
	 * @param	command AssignWindAeroConstIECToWindGenTurbineType1IECCommand
	 */	
	public void validate( AssignWindAeroConstIECToWindGenTurbineType1IECCommand command ) throws Exception {
		Assert.notNull( command, "AssignWindAeroConstIECToWindGenTurbineType1IECCommand should not be null" );
		Assert.notNull( command.getWindGenTurbineType1IECId(), "AssignWindAeroConstIECToWindGenTurbineType1IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWindAeroConstIECToWindGenTurbineType1IECCommand assignment should not be null" );
	}

	/**
	 * handles unassign WindAeroConstIEC validation for a WindGenTurbineType1IEC
	 * 
	 * @param	command UnAssignWindAeroConstIECFromWindGenTurbineType1IECCommand
	 */	
	public void validate( UnAssignWindAeroConstIECFromWindGenTurbineType1IECCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignWindAeroConstIECFromWindGenTurbineType1IECCommand should not be null" );
		Assert.notNull( command.getWindGenTurbineType1IECId(), "UnAssignWindAeroConstIECFromWindGenTurbineType1IECCommand identifier should not be null" );
	}
