...
//		Assert.isNull( voltageCompensatorDynamics.getVoltageCompensatorDynamicsId(), "CreateVoltageCompensatorDynamicsCommand identifier should be null" );
	...
	/**
	 * handles assign ExcitationSystemDynamics validation for a VoltageCompensatorDynamics
	 * 
	 * @param	command AssignExcitationSystemDynamicsToVoltageCompensatorDynamicsCommand
	 */	
	public void validate( AssignExcitationSystemDynamicsToVoltageCompensatorDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignExcitationSystemDynamicsToVoltageCompensatorDynamicsCommand should not be null" );
		Assert.notNull( command.getVoltageCompensatorDynamicsId(), "AssignExcitationSystemDynamicsToVoltageCompensatorDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignExcitationSystemDynamicsToVoltageCompensatorDynamicsCommand assignment should not be null" );
	}

	/**
	 * handles unassign ExcitationSystemDynamics validation for a VoltageCompensatorDynamics
	 * 
	 * @param	command UnAssignExcitationSystemDynamicsFromVoltageCompensatorDynamicsCommand
	 */	
	public void validate( UnAssignExcitationSystemDynamicsFromVoltageCompensatorDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignExcitationSystemDynamicsFromVoltageCompensatorDynamicsCommand should not be null" );
		Assert.notNull( command.getVoltageCompensatorDynamicsId(), "UnAssignExcitationSystemDynamicsFromVoltageCompensatorDynamicsCommand identifier should not be null" );
	}
