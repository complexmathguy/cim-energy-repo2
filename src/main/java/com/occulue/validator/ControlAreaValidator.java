...
//		Assert.isNull( controlArea.getControlAreaId(), "CreateControlAreaCommand identifier should be null" );
	...
	/**
	 * handles assign EnergyArea validation for a ControlArea
	 * 
	 * @param	command AssignEnergyAreaToControlAreaCommand
	 */	
	public void validate( AssignEnergyAreaToControlAreaCommand command ) throws Exception {
		Assert.notNull( command, "AssignEnergyAreaToControlAreaCommand should not be null" );
		Assert.notNull( command.getControlAreaId(), "AssignEnergyAreaToControlAreaCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEnergyAreaToControlAreaCommand assignment should not be null" );
	}

	/**
	 * handles unassign EnergyArea validation for a ControlArea
	 * 
	 * @param	command UnAssignEnergyAreaFromControlAreaCommand
	 */	
	public void validate( UnAssignEnergyAreaFromControlAreaCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignEnergyAreaFromControlAreaCommand should not be null" );
		Assert.notNull( command.getControlAreaId(), "UnAssignEnergyAreaFromControlAreaCommand identifier should not be null" );
	}
