...
//		Assert.isNull( powerTransformerEnd.getPowerTransformerEndId(), "CreatePowerTransformerEndCommand identifier should be null" );
	...
	/**
	 * handles assign PowerTransformer validation for a PowerTransformerEnd
	 * 
	 * @param	command AssignPowerTransformerToPowerTransformerEndCommand
	 */	
	public void validate( AssignPowerTransformerToPowerTransformerEndCommand command ) throws Exception {
		Assert.notNull( command, "AssignPowerTransformerToPowerTransformerEndCommand should not be null" );
		Assert.notNull( command.getPowerTransformerEndId(), "AssignPowerTransformerToPowerTransformerEndCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPowerTransformerToPowerTransformerEndCommand assignment should not be null" );
	}

	/**
	 * handles unassign PowerTransformer validation for a PowerTransformerEnd
	 * 
	 * @param	command UnAssignPowerTransformerFromPowerTransformerEndCommand
	 */	
	public void validate( UnAssignPowerTransformerFromPowerTransformerEndCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignPowerTransformerFromPowerTransformerEndCommand should not be null" );
		Assert.notNull( command.getPowerTransformerEndId(), "UnAssignPowerTransformerFromPowerTransformerEndCommand identifier should not be null" );
	}
