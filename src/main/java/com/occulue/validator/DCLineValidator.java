...
//		Assert.isNull( dCLine.getDCLineId(), "CreateDCLineCommand identifier should be null" );
	...
	/**
	 * handles assign Region validation for a DCLine
	 * 
	 * @param	command AssignRegionToDCLineCommand
	 */	
	public void validate( AssignRegionToDCLineCommand command ) throws Exception {
		Assert.notNull( command, "AssignRegionToDCLineCommand should not be null" );
		Assert.notNull( command.getDCLineId(), "AssignRegionToDCLineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRegionToDCLineCommand assignment should not be null" );
	}

	/**
	 * handles unassign Region validation for a DCLine
	 * 
	 * @param	command UnAssignRegionFromDCLineCommand
	 */	
	public void validate( UnAssignRegionFromDCLineCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignRegionFromDCLineCommand should not be null" );
		Assert.notNull( command.getDCLineId(), "UnAssignRegionFromDCLineCommand identifier should not be null" );
	}
