...
//		Assert.isNull( pFVArControllerType1Dynamics.getPFVArControllerType1DynamicsId(), "CreatePFVArControllerType1DynamicsCommand identifier should be null" );
	...
	/**
	 * handles assign ExcitationSystemDynamics validation for a PFVArControllerType1Dynamics
	 * 
	 * @param	command AssignExcitationSystemDynamicsToPFVArControllerType1DynamicsCommand
	 */	
	public void validate( AssignExcitationSystemDynamicsToPFVArControllerType1DynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignExcitationSystemDynamicsToPFVArControllerType1DynamicsCommand should not be null" );
		Assert.notNull( command.getPFVArControllerType1DynamicsId(), "AssignExcitationSystemDynamicsToPFVArControllerType1DynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignExcitationSystemDynamicsToPFVArControllerType1DynamicsCommand assignment should not be null" );
	}

	/**
	 * handles unassign ExcitationSystemDynamics validation for a PFVArControllerType1Dynamics
	 * 
	 * @param	command UnAssignExcitationSystemDynamicsFromPFVArControllerType1DynamicsCommand
	 */	
	public void validate( UnAssignExcitationSystemDynamicsFromPFVArControllerType1DynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignExcitationSystemDynamicsFromPFVArControllerType1DynamicsCommand should not be null" );
		Assert.notNull( command.getPFVArControllerType1DynamicsId(), "UnAssignExcitationSystemDynamicsFromPFVArControllerType1DynamicsCommand identifier should not be null" );
	}
