...
//		Assert.isNull( powerSystemStabilizerDynamics.getPowerSystemStabilizerDynamicsId(), "CreatePowerSystemStabilizerDynamicsCommand identifier should be null" );
	...
	/**
	 * handles assign ExcitationSystemDynamics validation for a PowerSystemStabilizerDynamics
	 * 
	 * @param	command AssignExcitationSystemDynamicsToPowerSystemStabilizerDynamicsCommand
	 */	
	public void validate( AssignExcitationSystemDynamicsToPowerSystemStabilizerDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignExcitationSystemDynamicsToPowerSystemStabilizerDynamicsCommand should not be null" );
		Assert.notNull( command.getPowerSystemStabilizerDynamicsId(), "AssignExcitationSystemDynamicsToPowerSystemStabilizerDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignExcitationSystemDynamicsToPowerSystemStabilizerDynamicsCommand assignment should not be null" );
	}

	/**
	 * handles unassign ExcitationSystemDynamics validation for a PowerSystemStabilizerDynamics
	 * 
	 * @param	command UnAssignExcitationSystemDynamicsFromPowerSystemStabilizerDynamicsCommand
	 */	
	public void validate( UnAssignExcitationSystemDynamicsFromPowerSystemStabilizerDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignExcitationSystemDynamicsFromPowerSystemStabilizerDynamicsCommand should not be null" );
		Assert.notNull( command.getPowerSystemStabilizerDynamicsId(), "UnAssignExcitationSystemDynamicsFromPowerSystemStabilizerDynamicsCommand identifier should not be null" );
	}
