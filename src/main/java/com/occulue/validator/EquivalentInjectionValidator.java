...
//		Assert.isNull( equivalentInjection.getEquivalentInjectionId(), "CreateEquivalentInjectionCommand identifier should be null" );
	...
	/**
	 * handles assign ReactiveCapabilityCurve validation for a EquivalentInjection
	 * 
	 * @param	command AssignReactiveCapabilityCurveToEquivalentInjectionCommand
	 */	
	public void validate( AssignReactiveCapabilityCurveToEquivalentInjectionCommand command ) throws Exception {
		Assert.notNull( command, "AssignReactiveCapabilityCurveToEquivalentInjectionCommand should not be null" );
		Assert.notNull( command.getEquivalentInjectionId(), "AssignReactiveCapabilityCurveToEquivalentInjectionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignReactiveCapabilityCurveToEquivalentInjectionCommand assignment should not be null" );
	}

	/**
	 * handles unassign ReactiveCapabilityCurve validation for a EquivalentInjection
	 * 
	 * @param	command UnAssignReactiveCapabilityCurveFromEquivalentInjectionCommand
	 */	
	public void validate( UnAssignReactiveCapabilityCurveFromEquivalentInjectionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignReactiveCapabilityCurveFromEquivalentInjectionCommand should not be null" );
		Assert.notNull( command.getEquivalentInjectionId(), "UnAssignReactiveCapabilityCurveFromEquivalentInjectionCommand identifier should not be null" );
	}
