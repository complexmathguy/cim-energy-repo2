...
//		Assert.isNull( measurementValueQuality.getMeasurementValueQualityId(), "CreateMeasurementValueQualityCommand identifier should be null" );
	...
	/**
	 * handles assign MeasurementValue validation for a MeasurementValueQuality
	 * 
	 * @param	command AssignMeasurementValueToMeasurementValueQualityCommand
	 */	
	public void validate( AssignMeasurementValueToMeasurementValueQualityCommand command ) throws Exception {
		Assert.notNull( command, "AssignMeasurementValueToMeasurementValueQualityCommand should not be null" );
		Assert.notNull( command.getMeasurementValueQualityId(), "AssignMeasurementValueToMeasurementValueQualityCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMeasurementValueToMeasurementValueQualityCommand assignment should not be null" );
	}

	/**
	 * handles unassign MeasurementValue validation for a MeasurementValueQuality
	 * 
	 * @param	command UnAssignMeasurementValueFromMeasurementValueQualityCommand
	 */	
	public void validate( UnAssignMeasurementValueFromMeasurementValueQualityCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignMeasurementValueFromMeasurementValueQualityCommand should not be null" );
		Assert.notNull( command.getMeasurementValueQualityId(), "UnAssignMeasurementValueFromMeasurementValueQualityCommand identifier should not be null" );
	}
