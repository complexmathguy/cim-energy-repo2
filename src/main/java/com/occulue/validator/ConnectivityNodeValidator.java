...
//		Assert.isNull( connectivityNode.getConnectivityNodeId(), "CreateConnectivityNodeCommand identifier should be null" );
	...
	/**
	 * handles assign ConnectivityNodeContainer validation for a ConnectivityNode
	 * 
	 * @param	command AssignConnectivityNodeContainerToConnectivityNodeCommand
	 */	
	public void validate( AssignConnectivityNodeContainerToConnectivityNodeCommand command ) throws Exception {
		Assert.notNull( command, "AssignConnectivityNodeContainerToConnectivityNodeCommand should not be null" );
		Assert.notNull( command.getConnectivityNodeId(), "AssignConnectivityNodeContainerToConnectivityNodeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignConnectivityNodeContainerToConnectivityNodeCommand assignment should not be null" );
	}

	/**
	 * handles unassign ConnectivityNodeContainer validation for a ConnectivityNode
	 * 
	 * @param	command UnAssignConnectivityNodeContainerFromConnectivityNodeCommand
	 */	
	public void validate( UnAssignConnectivityNodeContainerFromConnectivityNodeCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignConnectivityNodeContainerFromConnectivityNodeCommand should not be null" );
		Assert.notNull( command.getConnectivityNodeId(), "UnAssignConnectivityNodeContainerFromConnectivityNodeCommand identifier should not be null" );
	}
