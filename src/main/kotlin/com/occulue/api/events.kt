...
data class AssignPccTerminalToACDCConverterEvent(@Id val aCDCConverterId: UUID, val assignment: Terminal )
data class UnAssignPccTerminalFromACDCConverterEvent(@Id val aCDCConverterId: UUID? = null )
...
data class UpdateACDCConverterDCTerminalEvent(
    @Id var aCDCConverterDCTerminalId: UUID? = null,
    @Enumerated(EnumType.STRING) var polarity: DCPolarityKind,
    var dCConductingEquipment: ACDCConverter
)

data class DeleteACDCConverterDCTerminalEvent(@Id val aCDCConverterDCTerminalId: UUID? = null)

// single association events
data class AssignDCConductingEquipmentToACDCConverterDCTerminalEvent(@Id val aCDCConverterDCTerminalId: UUID, val assignment: ACDCConverter )
data class UnAssignDCConductingEquipmentFromACDCConverterDCTerminalEvent(@Id val aCDCConverterDCTerminalId: UUID? = null )
...
data class UpdateACDCTerminalEvent(
    ...
    var busNameMarker: BusNameMarker
)
...
data class AssignBusNameMarkerToACDCTerminalEvent(@Id val aCDCTerminalId: UUID, val assignment: BusNameMarker )
data class UnAssignBusNameMarkerFromACDCTerminalEvent(@Id val aCDCTerminalId: UUID? = null )
...
data class UpdateAccumulatorLimitEvent(
    ...
    var limitSet:  Set<AccumulatorLimitSet>
)
...
// multiple association events
data class AssignLimitSetToAccumulatorLimitEvent(@Id val accumulatorLimitId: UUID, val addTo: AccumulatorLimitSet )
data class RemoveLimitSetFromAccumulatorLimitEvent(@Id val accumulatorLimitId: UUID, val removeFrom: AccumulatorLimitSet )
...
data class UpdateAccumulatorLimitSetEvent(
    ...
    var measurements: Accumulator
)

data class DeleteAccumulatorLimitSetEvent(@Id val accumulatorLimitSetId: UUID? = null)

// single association events
data class AssignMeasurementsToAccumulatorLimitSetEvent(@Id val accumulatorLimitSetId: UUID, val assignment: Accumulator )
data class UnAssignMeasurementsFromAccumulatorLimitSetEvent(@Id val accumulatorLimitSetId: UUID? = null )
...
data class UpdateAccumulatorResetEvent(
    ...
    var accumulatorValue: AccumulatorValue
)

data class DeleteAccumulatorResetEvent(@Id val accumulatorResetId: UUID? = null)

// single association events
data class AssignAccumulatorValueToAccumulatorResetEvent(@Id val accumulatorResetId: UUID, val assignment: AccumulatorValue )
data class UnAssignAccumulatorValueFromAccumulatorResetEvent(@Id val accumulatorResetId: UUID? = null )
...
data class AssignAccumulatorToAccumulatorValueEvent(@Id val accumulatorValueId: UUID, val assignment: Accumulator )
data class UnAssignAccumulatorFromAccumulatorValueEvent(@Id val accumulatorValueId: UUID? = null )
...
data class AssignAnalogValueToAnalogControlEvent(@Id val analogControlId: UUID, val assignment: AnalogValue )
data class UnAssignAnalogValueFromAnalogControlEvent(@Id val analogControlId: UUID? = null )
...
data class UpdateAnalogLimitEvent(
    ...
    var limitSet:  Set<AnalogLimitSet>
)
...
// multiple association events
data class AssignLimitSetToAnalogLimitEvent(@Id val analogLimitId: UUID, val addTo: AnalogLimitSet )
data class RemoveLimitSetFromAnalogLimitEvent(@Id val analogLimitId: UUID, val removeFrom: AnalogLimitSet )
...
data class UpdateAnalogLimitSetEvent(
    ...
    var measurements: Analog
)

data class DeleteAnalogLimitSetEvent(@Id val analogLimitSetId: UUID? = null)

// single association events
data class AssignMeasurementsToAnalogLimitSetEvent(@Id val analogLimitSetId: UUID, val assignment: Analog )
data class UnAssignMeasurementsFromAnalogLimitSetEvent(@Id val analogLimitSetId: UUID? = null )
...
data class AssignAnalogToAnalogValueEvent(@Id val analogValueId: UUID, val assignment: Analog )
data class UnAssignAnalogFromAnalogValueEvent(@Id val analogValueId: UUID? = null )
...
data class UpdateAsynchronousMachineDynamicsEvent(
    ...
    var asynchronousMachine: AsynchronousMachine
)

data class DeleteAsynchronousMachineDynamicsEvent(@Id val asynchronousMachineDynamicsId: UUID? = null)

// single association events
data class AssignAsynchronousMachineToAsynchronousMachineDynamicsEvent(@Id val asynchronousMachineDynamicsId: UUID, val assignment: AsynchronousMachine )
data class UnAssignAsynchronousMachineFromAsynchronousMachineDynamicsEvent(@Id val asynchronousMachineDynamicsId: UUID? = null )
...
data class UpdateBayEvent(
    ...
    var voltageLevel: VoltageLevel
)

data class DeleteBayEvent(@Id val bayId: UUID? = null)

// single association events
data class AssignVoltageLevelToBayEvent(@Id val bayId: UUID, val assignment: VoltageLevel )
data class UnAssignVoltageLevelFromBayEvent(@Id val bayId: UUID? = null )
...
data class UpdateBusNameMarkerEvent(
    ...
    var reportingGroup: ReportingGroup
)
...
data class AssignReportingGroupToBusNameMarkerEvent(@Id val busNameMarkerId: UUID, val assignment: ReportingGroup )
data class UnAssignReportingGroupFromBusNameMarkerEvent(@Id val busNameMarkerId: UUID? = null )
...
data class UpdateCommandEvent(
    ...
    var value: IntegerProxy,
    var valueAliasSet:  Set<ValueAliasSet>,
    var discreteValue:  Set<DiscreteValue>
)
...
// multiple association events
data class AssignValueAliasSetToCommandEvent(@Id val commandId: UUID, val addTo: ValueAliasSet )
data class RemoveValueAliasSetFromCommandEvent(@Id val commandId: UUID, val removeFrom: ValueAliasSet )
data class AssignDiscreteValueToCommandEvent(@Id val commandId: UUID, val addTo: DiscreteValue )
data class RemoveDiscreteValueFromCommandEvent(@Id val commandId: UUID, val removeFrom: DiscreteValue )
...
data class UpdateConformLoadEvent(
    ...
    var loadGroup: ConformLoadGroup
)

data class DeleteConformLoadEvent(@Id val conformLoadId: UUID? = null)

// single association events
data class AssignLoadGroupToConformLoadEvent(@Id val conformLoadId: UUID, val assignment: ConformLoadGroup )
data class UnAssignLoadGroupFromConformLoadEvent(@Id val conformLoadId: UUID? = null )
...
data class UpdateConformLoadScheduleEvent(
    ...
    var conformLoadGroup: ConformLoadGroup
)

data class DeleteConformLoadScheduleEvent(@Id val conformLoadScheduleId: UUID? = null)

// single association events
data class AssignConformLoadGroupToConformLoadScheduleEvent(@Id val conformLoadScheduleId: UUID, val assignment: ConformLoadGroup )
data class UnAssignConformLoadGroupFromConformLoadScheduleEvent(@Id val conformLoadScheduleId: UUID? = null )
...
data class UpdateConnectivityNodeEvent(
    ...
    var toEndName: StringProxy,
    var toEndNameTso: StringProxy,
    var connectivityNodeContainer: ConnectivityNodeContainer
)
...
data class AssignConnectivityNodeContainerToConnectivityNodeEvent(@Id val connectivityNodeId: UUID, val assignment: ConnectivityNodeContainer )
data class UnAssignConnectivityNodeContainerFromConnectivityNodeEvent(@Id val connectivityNodeId: UUID? = null )
...
data class UpdateControlEvent(
    ...
    @Enumerated(EnumType.STRING) var unitMultiplier: UnitMultiplier,
    @Enumerated(EnumType.STRING) var unitSymbol: UnitSymbol,
    var powerSystemResource: PowerSystemResource
)
...
data class AssignPowerSystemResourceToControlEvent(@Id val controlId: UUID, val assignment: PowerSystemResource )
data class UnAssignPowerSystemResourceFromControlEvent(@Id val controlId: UUID? = null )
...
data class UpdateControlAreaEvent(
    @Id var controlAreaId: UUID? = null,
    @Enumerated(EnumType.STRING) var type: ControlAreaTypeKind,
    var energyArea: EnergyArea
)

data class DeleteControlAreaEvent(@Id val controlAreaId: UUID? = null)

// single association events
data class AssignEnergyAreaToControlAreaEvent(@Id val controlAreaId: UUID, val assignment: EnergyArea )
data class UnAssignEnergyAreaFromControlAreaEvent(@Id val controlAreaId: UUID? = null )
...
data class UpdateControlAreaGeneratingUnitEvent(
    ...
    var generatingUnit: GeneratingUnit
)

data class DeleteControlAreaGeneratingUnitEvent(@Id val controlAreaGeneratingUnitId: UUID? = null)

// single association events
data class AssignControlAreaToControlAreaGeneratingUnitEvent(@Id val controlAreaGeneratingUnitId: UUID, val assignment: ControlArea )
data class UnAssignControlAreaFromControlAreaGeneratingUnitEvent(@Id val controlAreaGeneratingUnitId: UUID? = null )
data class AssignGeneratingUnitToControlAreaGeneratingUnitEvent(@Id val controlAreaGeneratingUnitId: UUID, val assignment: GeneratingUnit )
data class UnAssignGeneratingUnitFromControlAreaGeneratingUnitEvent(@Id val controlAreaGeneratingUnitId: UUID? = null )
...
data class AssignCurveToCurveDataEvent(@Id val curveDataId: UUID, val assignment: Curve )
data class UnAssignCurveFromCurveDataEvent(@Id val curveDataId: UUID? = null )
...
// single association events
data class AssignDCNodeToDCBaseTerminalEvent(@Id val dCBaseTerminalId: UUID, val assignment: DCNode )
data class UnAssignDCNodeFromDCBaseTerminalEvent(@Id val dCBaseTerminalId: UUID? = null )
...
// single association events
data class AssignSubstationToDCConverterUnitEvent(@Id val dCConverterUnitId: UUID, val assignment: Substation )
data class UnAssignSubstationFromDCConverterUnitEvent(@Id val dCConverterUnitId: UUID? = null )
...
data class UpdateDCLineEvent(
    ...
    var region: SubGeographicalRegion
)

data class DeleteDCLineEvent(@Id val dCLineId: UUID? = null)

// single association events
data class AssignRegionToDCLineEvent(@Id val dCLineId: UUID, val assignment: SubGeographicalRegion )
data class UnAssignRegionFromDCLineEvent(@Id val dCLineId: UUID? = null )
...
data class UpdateDCLineSegmentEvent(
    ...
    var perLengthParameter: PerLengthDCLineParameter
)
...
data class AssignPerLengthParameterToDCLineSegmentEvent(@Id val dCLineSegmentId: UUID, val assignment: PerLengthDCLineParameter )
data class UnAssignPerLengthParameterFromDCLineSegmentEvent(@Id val dCLineSegmentId: UUID? = null )
...
data class UpdateDCNodeEvent(
    ...
    var dCEquipmentContainer: DCEquipmentContainer
)

data class DeleteDCNodeEvent(@Id val dCNodeId: UUID? = null)

// single association events
data class AssignDCEquipmentContainerToDCNodeEvent(@Id val dCNodeId: UUID, val assignment: DCEquipmentContainer )
data class UnAssignDCEquipmentContainerFromDCNodeEvent(@Id val dCNodeId: UUID? = null )
...
data class UpdateDCTerminalEvent(
    ...
    var dCConductingEquipment: DCConductingEquipment
)

data class DeleteDCTerminalEvent(@Id val dCTerminalId: UUID? = null)

// single association events
data class AssignDCConductingEquipmentToDCTerminalEvent(@Id val dCTerminalId: UUID, val assignment: DCConductingEquipment )
data class UnAssignDCConductingEquipmentFromDCTerminalEvent(@Id val dCTerminalId: UUID? = null )
...
data class UpdateDCTopologicalIslandEvent(
    ...
    var dCTopologicalNodes: DCTopologicalNode
)

data class DeleteDCTopologicalIslandEvent(@Id val dCTopologicalIslandId: UUID? = null)

// single association events
data class AssignDCTopologicalNodesToDCTopologicalIslandEvent(@Id val dCTopologicalIslandId: UUID, val assignment: DCTopologicalNode )
data class UnAssignDCTopologicalNodesFromDCTopologicalIslandEvent(@Id val dCTopologicalIslandId: UUID? = null )
...
// single association events
data class AssignDCEquipmentContainerToDCTopologicalNodeEvent(@Id val dCTopologicalNodeId: UUID, val assignment: DCEquipmentContainer )
data class UnAssignDCEquipmentContainerFromDCTopologicalNodeEvent(@Id val dCTopologicalNodeId: UUID? = null )
...
data class AssignDiagramStyleToDiagramEvent(@Id val diagramId: UUID, val assignment: DiagramStyle )
data class UnAssignDiagramStyleFromDiagramEvent(@Id val diagramId: UUID? = null )
...
data class UpdateDiagramObjectEvent(
    ...
    var diagramObjectStyle: DiagramObjectStyle,
    var diagram: Diagram,
...
data class AssignDiagramObjectStyleToDiagramObjectEvent(@Id val diagramObjectId: UUID, val assignment: DiagramObjectStyle )
data class UnAssignDiagramObjectStyleFromDiagramObjectEvent(@Id val diagramObjectId: UUID? = null )
data class AssignDiagramToDiagramObjectEvent(@Id val diagramObjectId: UUID, val assignment: Diagram )
data class UnAssignDiagramFromDiagramObjectEvent(@Id val diagramObjectId: UUID? = null )
data class AssignIdentifiedObjectToDiagramObjectEvent(@Id val diagramObjectId: UUID, val assignment: IdentifiedObject )
data class UnAssignIdentifiedObjectFromDiagramObjectEvent(@Id val diagramObjectId: UUID? = null )
...
data class UpdateDiagramObjectPointEvent(
    ...
    var diagramObject: DiagramObject,
    var diagramObjectGluePoint: DiagramObjectGluePoint
)
...
data class AssignDiagramObjectToDiagramObjectPointEvent(@Id val diagramObjectPointId: UUID, val assignment: DiagramObject )
data class UnAssignDiagramObjectFromDiagramObjectPointEvent(@Id val diagramObjectPointId: UUID? = null )
data class AssignDiagramObjectGluePointToDiagramObjectPointEvent(@Id val diagramObjectPointId: UUID, val assignment: DiagramObjectGluePoint )
data class UnAssignDiagramObjectGluePointFromDiagramObjectPointEvent(@Id val diagramObjectPointId: UUID? = null )
...
// single association events
data class AssignExcitationSystemDynamicsToDiscontinuousExcitationControlDynamicsEvent(@Id val discontinuousExcitationControlDynamicsId: UUID, val assignment: ExcitationSystemDynamics )
data class UnAssignExcitationSystemDynamicsFromDiscontinuousExcitationControlDynamicsEvent(@Id val discontinuousExcitationControlDynamicsId: UUID? = null )
...
// multiple association events
data class AssignValueAliasSetToDiscreteEvent(@Id val discreteId: UUID, val addTo: ValueAliasSet )
data class RemoveValueAliasSetFromDiscreteEvent(@Id val discreteId: UUID, val removeFrom: ValueAliasSet )
...
data class AssignDiscreteToDiscreteValueEvent(@Id val discreteValueId: UUID, val assignment: Discrete )
data class UnAssignDiscreteFromDiscreteValueEvent(@Id val discreteValueId: UUID? = null )
...
data class UpdateEnergyConsumerEvent(
    ...
    var loadResponse: LoadResponseCharacteristic
)
...
data class AssignLoadResponseToEnergyConsumerEvent(@Id val energyConsumerId: UUID, val assignment: LoadResponseCharacteristic )
data class UnAssignLoadResponseFromEnergyConsumerEvent(@Id val energyConsumerId: UUID? = null )
...
data class UpdateEnergySourceEvent(
    ...
    var energySchedulingType: EnergySchedulingType
)

data class DeleteEnergySourceEvent(@Id val energySourceId: UUID? = null)

// single association events
data class AssignEnergySchedulingTypeToEnergySourceEvent(@Id val energySourceId: UUID, val assignment: EnergySchedulingType )
data class UnAssignEnergySchedulingTypeFromEnergySourceEvent(@Id val energySourceId: UUID? = null )
...
data class UpdateEquipmentEvent(
    ...
    var equipmentContainer: EquipmentContainer
)

data class DeleteEquipmentEvent(@Id val equipmentId: UUID? = null)

// single association events
data class AssignEquipmentContainerToEquipmentEvent(@Id val equipmentId: UUID, val assignment: EquipmentContainer )
data class UnAssignEquipmentContainerFromEquipmentEvent(@Id val equipmentId: UUID? = null )
...
data class UpdateEquivalentEquipmentEvent(
    ...
    var equivalentNetwork: EquivalentNetwork
)

data class DeleteEquivalentEquipmentEvent(@Id val equivalentEquipmentId: UUID? = null)

// single association events
data class AssignEquivalentNetworkToEquivalentEquipmentEvent(@Id val equivalentEquipmentId: UUID, val assignment: EquivalentNetwork )
data class UnAssignEquivalentNetworkFromEquivalentEquipmentEvent(@Id val equivalentEquipmentId: UUID? = null )
...
data class UpdateEquivalentInjectionEvent(
    ...
    var x0: Reactance,
    var x2: Reactance,
    var reactiveCapabilityCurve: ReactiveCapabilityCurve
)
...
data class AssignReactiveCapabilityCurveToEquivalentInjectionEvent(@Id val equivalentInjectionId: UUID, val assignment: ReactiveCapabilityCurve )
data class UnAssignReactiveCapabilityCurveFromEquivalentInjectionEvent(@Id val equivalentInjectionId: UUID? = null )
...
// single association events
data class AssignSynchronousMachineDynamicsToExcitationSystemDynamicsEvent(@Id val excitationSystemDynamicsId: UUID, val assignment: SynchronousMachineDynamics )
data class UnAssignSynchronousMachineDynamicsFromExcitationSystemDynamicsEvent(@Id val excitationSystemDynamicsId: UUID? = null )
...
data class UpdateFossilFuelEvent(
    @Id var fossilFuelId: UUID? = null,
    @Enumerated(EnumType.STRING) var fossilFuelType: FuelType,
    var thermalGeneratingUnit: ThermalGeneratingUnit
)

data class DeleteFossilFuelEvent(@Id val fossilFuelId: UUID? = null)

// single association events
data class AssignThermalGeneratingUnitToFossilFuelEvent(@Id val fossilFuelId: UUID, val assignment: ThermalGeneratingUnit )
data class UnAssignThermalGeneratingUnitFromFossilFuelEvent(@Id val fossilFuelId: UUID? = null )
...
data class UpdateGenICompensationForGenJEvent(
    ...
    var xcij: PU,
    var synchronousMachineDynamics: SynchronousMachineDynamics,
    var vcompIEEEType2: VCompIEEEType2
)
...
data class AssignSynchronousMachineDynamicsToGenICompensationForGenJEvent(@Id val genICompensationForGenJId: UUID, val assignment: SynchronousMachineDynamics )
data class UnAssignSynchronousMachineDynamicsFromGenICompensationForGenJEvent(@Id val genICompensationForGenJId: UUID? = null )
data class AssignVcompIEEEType2ToGenICompensationForGenJEvent(@Id val genICompensationForGenJId: UUID, val assignment: VCompIEEEType2 )
data class UnAssignVcompIEEEType2FromGenICompensationForGenJEvent(@Id val genICompensationForGenJId: UUID? = null )
...
// single association events
data class AssignGeneratingUnitToGrossToNetActivePowerCurveEvent(@Id val grossToNetActivePowerCurveId: UUID, val assignment: GeneratingUnit )
data class UnAssignGeneratingUnitFromGrossToNetActivePowerCurveEvent(@Id val grossToNetActivePowerCurveId: UUID? = null )
...
data class UpdateHydroGeneratingUnitEvent(
    @Id var hydroGeneratingUnitId: UUID? = null,
    @Enumerated(EnumType.STRING) var energyConversionCapability: HydroEnergyConversionKind,
    var hydroPowerPlant: HydroPowerPlant
)

data class DeleteHydroGeneratingUnitEvent(@Id val hydroGeneratingUnitId: UUID? = null)

// single association events
data class AssignHydroPowerPlantToHydroGeneratingUnitEvent(@Id val hydroGeneratingUnitId: UUID, val assignment: HydroPowerPlant )
data class UnAssignHydroPowerPlantFromHydroGeneratingUnitEvent(@Id val hydroGeneratingUnitId: UUID? = null )
...
data class UpdateHydroPumpEvent(
    ...
    var rotatingMachine: RotatingMachine,
    var hydroPowerPlant: HydroPowerPlant
)
...
// single association events
data class AssignRotatingMachineToHydroPumpEvent(@Id val hydroPumpId: UUID, val assignment: RotatingMachine )
data class UnAssignRotatingMachineFromHydroPumpEvent(@Id val hydroPumpId: UUID? = null )
data class AssignHydroPowerPlantToHydroPumpEvent(@Id val hydroPumpId: UUID, val assignment: HydroPowerPlant )
data class UnAssignHydroPowerPlantFromHydroPumpEvent(@Id val hydroPumpId: UUID? = null )
...
// single association events
data class AssignRegionToLineEvent(@Id val lineId: UUID, val assignment: SubGeographicalRegion )
data class UnAssignRegionFromLineEvent(@Id val lineId: UUID? = null )
...
data class UpdateLoadGroupEvent(
    ...
    var subLoadArea: SubLoadArea
)

data class DeleteLoadGroupEvent(@Id val loadGroupId: UUID? = null)

// single association events
data class AssignSubLoadAreaToLoadGroupEvent(@Id val loadGroupId: UUID, val assignment: SubLoadArea )
data class UnAssignSubLoadAreaFromLoadGroupEvent(@Id val loadGroupId: UUID? = null )
...
data class UpdateLoadMotorEvent(
    ...
    var tv: Seconds,
    var vt: PU,
    var loadAggregate: LoadAggregate
)
...
data class AssignLoadAggregateToLoadMotorEvent(@Id val loadMotorId: UUID, val assignment: LoadAggregate )
data class UnAssignLoadAggregateFromLoadMotorEvent(@Id val loadMotorId: UUID? = null )
...
data class AssignLoadAggregateToLoadStaticEvent(@Id val loadStaticId: UUID, val assignment: LoadAggregate )
data class UnAssignLoadAggregateFromLoadStaticEvent(@Id val loadStaticId: UUID? = null )
...
data class UpdateLocationEvent(
    ...
    var powerSystemResources: PowerSystemResource,
...
// single association events
data class AssignPowerSystemResourcesToLocationEvent(@Id val locationId: UUID, val assignment: PowerSystemResource )
data class UnAssignPowerSystemResourcesFromLocationEvent(@Id val locationId: UUID? = null )
data class AssignCoordinateSystemToLocationEvent(@Id val locationId: UUID, val assignment: CoordinateSystem )
data class UnAssignCoordinateSystemFromLocationEvent(@Id val locationId: UUID? = null )
...
data class AssignPowerSystemResourceToMeasurementEvent(@Id val measurementId: UUID, val assignment: PowerSystemResource )
data class UnAssignPowerSystemResourceFromMeasurementEvent(@Id val measurementId: UUID? = null )
data class AssignTerminalToMeasurementEvent(@Id val measurementId: UUID, val assignment: ACDCTerminal )
data class UnAssignTerminalFromMeasurementEvent(@Id val measurementId: UUID? = null )
...
data class UpdateMeasurementValueEvent(
    ...
    var timeStamp: DateTime,
    var measurementValueSource: MeasurementValueSource
)
...
data class AssignMeasurementValueSourceToMeasurementValueEvent(@Id val measurementValueId: UUID, val assignment: MeasurementValueSource )
data class UnAssignMeasurementValueSourceFromMeasurementValueEvent(@Id val measurementValueId: UUID? = null )
...
// single association events
data class AssignMeasurementValueToMeasurementValueQualityEvent(@Id val measurementValueQualityId: UUID, val assignment: MeasurementValue )
data class UnAssignMeasurementValueFromMeasurementValueQualityEvent(@Id val measurementValueQualityId: UUID? = null )
...
// single association events
data class AssignSynchronousMachineDynamicsToMechanicalLoadDynamicsEvent(@Id val mechanicalLoadDynamicsId: UUID, val assignment: SynchronousMachineDynamics )
data class UnAssignSynchronousMachineDynamicsFromMechanicalLoadDynamicsEvent(@Id val mechanicalLoadDynamicsId: UUID? = null )
data class AssignAsynchronousMachineDynamicsToMechanicalLoadDynamicsEvent(@Id val mechanicalLoadDynamicsId: UUID, val assignment: AsynchronousMachineDynamics )
data class UnAssignAsynchronousMachineDynamicsFromMechanicalLoadDynamicsEvent(@Id val mechanicalLoadDynamicsId: UUID? = null )
...
data class UpdateMutualCouplingEvent(
    ...
    var r0: Resistance,
    var x0: Reactance,
    var second_Terminal: Terminal,
    var first_Terminal: Terminal
)
...
data class AssignSecond_TerminalToMutualCouplingEvent(@Id val mutualCouplingId: UUID, val assignment: Terminal )
data class UnAssignSecond_TerminalFromMutualCouplingEvent(@Id val mutualCouplingId: UUID? = null )
data class AssignFirst_TerminalToMutualCouplingEvent(@Id val mutualCouplingId: UUID, val assignment: Terminal )
data class UnAssignFirst_TerminalFromMutualCouplingEvent(@Id val mutualCouplingId: UUID? = null )
...
data class UpdateNonConformLoadEvent(
    ...
    var loadGroup: NonConformLoadGroup
)

data class DeleteNonConformLoadEvent(@Id val nonConformLoadId: UUID? = null)

// single association events
data class AssignLoadGroupToNonConformLoadEvent(@Id val nonConformLoadId: UUID, val assignment: NonConformLoadGroup )
data class UnAssignLoadGroupFromNonConformLoadEvent(@Id val nonConformLoadId: UUID? = null )
...
data class UpdateNonConformLoadScheduleEvent(
    ...
    var nonConformLoadGroup: NonConformLoadGroup
)

data class DeleteNonConformLoadScheduleEvent(@Id val nonConformLoadScheduleId: UUID? = null)

// single association events
data class AssignNonConformLoadGroupToNonConformLoadScheduleEvent(@Id val nonConformLoadScheduleId: UUID, val assignment: NonConformLoadGroup )
data class UnAssignNonConformLoadGroupFromNonConformLoadScheduleEvent(@Id val nonConformLoadScheduleId: UUID? = null )
...
data class UpdateNonlinearShuntCompensatorPointEvent(
    ...
    var nonlinearShuntCompensator: NonlinearShuntCompensator
)
...
data class AssignNonlinearShuntCompensatorToNonlinearShuntCompensatorPointEvent(@Id val nonlinearShuntCompensatorPointId: UUID, val assignment: NonlinearShuntCompensator )
data class UnAssignNonlinearShuntCompensatorFromNonlinearShuntCompensatorPointEvent(@Id val nonlinearShuntCompensatorPointId: UUID? = null )
...
data class UpdateOperationalLimitEvent(
    ...
    var operationalLimitType: OperationalLimitType,
...
// single association events
data class AssignOperationalLimitTypeToOperationalLimitEvent(@Id val operationalLimitId: UUID, val assignment: OperationalLimitType )
data class UnAssignOperationalLimitTypeFromOperationalLimitEvent(@Id val operationalLimitId: UUID? = null )

// multiple association events
data class AssignOperationalLimitSetToOperationalLimitEvent(@Id val operationalLimitId: UUID, val addTo: OperationalLimitSet )
data class RemoveOperationalLimitSetFromOperationalLimitEvent(@Id val operationalLimitId: UUID, val removeFrom: OperationalLimitSet )
...
// single association events
data class AssignEquipmentToOperationalLimitSetEvent(@Id val operationalLimitSetId: UUID, val assignment: Equipment )
data class UnAssignEquipmentFromOperationalLimitSetEvent(@Id val operationalLimitSetId: UUID? = null )
data class AssignTerminalToOperationalLimitSetEvent(@Id val operationalLimitSetId: UUID, val assignment: ACDCTerminal )
data class UnAssignTerminalFromOperationalLimitSetEvent(@Id val operationalLimitSetId: UUID? = null )
...
// single association events
data class AssignExcitationSystemDynamicsToOverexcitationLimiterDynamicsEvent(@Id val overexcitationLimiterDynamicsId: UUID, val assignment: ExcitationSystemDynamics )
data class UnAssignExcitationSystemDynamicsFromOverexcitationLimiterDynamicsEvent(@Id val overexcitationLimiterDynamicsId: UUID? = null )
...
// single association events
data class AssignExcitationSystemDynamicsToPFVArControllerType1DynamicsEvent(@Id val pFVArControllerType1DynamicsId: UUID, val assignment: ExcitationSystemDynamics )
data class UnAssignExcitationSystemDynamicsFromPFVArControllerType1DynamicsEvent(@Id val pFVArControllerType1DynamicsId: UUID? = null )
...
// single association events
data class AssignExcitationSystemDynamicsToPFVArControllerType2DynamicsEvent(@Id val pFVArControllerType2DynamicsId: UUID, val assignment: ExcitationSystemDynamics )
data class UnAssignExcitationSystemDynamicsFromPFVArControllerType2DynamicsEvent(@Id val pFVArControllerType2DynamicsId: UUID? = null )
...
data class UpdatePhaseTapChangerEvent(
    ...
    var transformerEnd: TransformerEnd
)

data class DeletePhaseTapChangerEvent(@Id val phaseTapChangerId: UUID? = null)

// single association events
data class AssignTransformerEndToPhaseTapChangerEvent(@Id val phaseTapChangerId: UUID, val assignment: TransformerEnd )
data class UnAssignTransformerEndFromPhaseTapChangerEvent(@Id val phaseTapChangerId: UUID? = null )
...
data class UpdatePhaseTapChangerTablePointEvent(
    ...
    var phaseTapChangerTable: PhaseTapChangerTable
)
...
data class AssignPhaseTapChangerTableToPhaseTapChangerTablePointEvent(@Id val phaseTapChangerTablePointId: UUID, val assignment: PhaseTapChangerTable )
data class UnAssignPhaseTapChangerTableFromPhaseTapChangerTablePointEvent(@Id val phaseTapChangerTablePointId: UUID? = null )
...
// single association events
data class AssignPhaseTapChangerTableToPhaseTapChangerTabularEvent(@Id val phaseTapChangerTabularId: UUID, val assignment: PhaseTapChangerTable )
data class UnAssignPhaseTapChangerTableFromPhaseTapChangerTabularEvent(@Id val phaseTapChangerTabularId: UUID? = null )
...
data class AssignLocationToPositionPointEvent(@Id val positionPointId: UUID, val assignment: Location )
data class UnAssignLocationFromPositionPointEvent(@Id val positionPointId: UUID? = null )
...
// single association events
data class AssignExcitationSystemDynamicsToPowerSystemStabilizerDynamicsEvent(@Id val powerSystemStabilizerDynamicsId: UUID, val assignment: ExcitationSystemDynamics )
data class UnAssignExcitationSystemDynamicsFromPowerSystemStabilizerDynamicsEvent(@Id val powerSystemStabilizerDynamicsId: UUID? = null )
...
data class UpdatePowerTransformerEndEvent(
    ...
    var x: Reactance,
    var x0: Reactance,
    var powerTransformer: PowerTransformer
)
...
data class AssignPowerTransformerToPowerTransformerEndEvent(@Id val powerTransformerEndId: UUID, val assignment: PowerTransformer )
data class UnAssignPowerTransformerFromPowerTransformerEndEvent(@Id val powerTransformerEndId: UUID? = null )
...
data class UpdateProprietaryParameterDynamicsEvent(
    ...
    var pFVArControllerType1UserDefined: PFVArControllerType1UserDefined,
    var voltageCompensatorUserDefined: VoltageCompensatorUserDefined,
    var mechanicalLoadUserDefined: MechanicalLoadUserDefined,
    var excitationSystemUserDefined: ExcitationSystemUserDefined,
    var asynchronousMachineUserDefined: AsynchronousMachineUserDefined,
    var discontinuousExcitationControlUserDefined: DiscontinuousExcitationControlUserDefined,
    var turbineGovernorUserDefined: TurbineGovernorUserDefined,
    var voltageAdjusterUserDefined: VoltageAdjusterUserDefined,
    var synchronousMachineUserDefined: SynchronousMachineUserDefined,
    var underexcitationLimiterUserDefined: UnderexcitationLimiterUserDefined,
    var turbineLoadControllerUserDefined: TurbineLoadControllerUserDefined,
    var overexcitationLimiterUserDefined: OverexcitationLimiterUserDefined,
    var powerSystemStabilizerUserDefined: PowerSystemStabilizerUserDefined,
    var loadUserDefined: LoadUserDefined,
    var pFVArControllerType2UserDefined: PFVArControllerType2UserDefined,
    var windType3or4UserDefined: WindType3or4UserDefined,
    var windPlantUserDefined: WindPlantUserDefined,
    var windType1or2UserDefined: WindType1or2UserDefined
)
...
data class AssignPFVArControllerType1UserDefinedToProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID, val assignment: PFVArControllerType1UserDefined )
data class UnAssignPFVArControllerType1UserDefinedFromProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID? = null )
data class AssignVoltageCompensatorUserDefinedToProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID, val assignment: VoltageCompensatorUserDefined )
data class UnAssignVoltageCompensatorUserDefinedFromProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID? = null )
data class AssignMechanicalLoadUserDefinedToProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID, val assignment: MechanicalLoadUserDefined )
data class UnAssignMechanicalLoadUserDefinedFromProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID? = null )
data class AssignExcitationSystemUserDefinedToProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID, val assignment: ExcitationSystemUserDefined )
data class UnAssignExcitationSystemUserDefinedFromProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID? = null )
data class AssignAsynchronousMachineUserDefinedToProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID, val assignment: AsynchronousMachineUserDefined )
data class UnAssignAsynchronousMachineUserDefinedFromProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID? = null )
data class AssignDiscontinuousExcitationControlUserDefinedToProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID, val assignment: DiscontinuousExcitationControlUserDefined )
data class UnAssignDiscontinuousExcitationControlUserDefinedFromProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID? = null )
data class AssignTurbineGovernorUserDefinedToProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID, val assignment: TurbineGovernorUserDefined )
data class UnAssignTurbineGovernorUserDefinedFromProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID? = null )
data class AssignVoltageAdjusterUserDefinedToProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID, val assignment: VoltageAdjusterUserDefined )
data class UnAssignVoltageAdjusterUserDefinedFromProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID? = null )
data class AssignSynchronousMachineUserDefinedToProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID, val assignment: SynchronousMachineUserDefined )
data class UnAssignSynchronousMachineUserDefinedFromProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID? = null )
data class AssignUnderexcitationLimiterUserDefinedToProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID, val assignment: UnderexcitationLimiterUserDefined )
data class UnAssignUnderexcitationLimiterUserDefinedFromProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID? = null )
data class AssignTurbineLoadControllerUserDefinedToProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID, val assignment: TurbineLoadControllerUserDefined )
data class UnAssignTurbineLoadControllerUserDefinedFromProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID? = null )
data class AssignOverexcitationLimiterUserDefinedToProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID, val assignment: OverexcitationLimiterUserDefined )
data class UnAssignOverexcitationLimiterUserDefinedFromProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID? = null )
data class AssignPowerSystemStabilizerUserDefinedToProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID, val assignment: PowerSystemStabilizerUserDefined )
data class UnAssignPowerSystemStabilizerUserDefinedFromProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID? = null )
data class AssignLoadUserDefinedToProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID, val assignment: LoadUserDefined )
data class UnAssignLoadUserDefinedFromProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID? = null )
data class AssignPFVArControllerType2UserDefinedToProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID, val assignment: PFVArControllerType2UserDefined )
data class UnAssignPFVArControllerType2UserDefinedFromProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID? = null )
data class AssignWindType3or4UserDefinedToProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID, val assignment: WindType3or4UserDefined )
data class UnAssignWindType3or4UserDefinedFromProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID? = null )
data class AssignWindPlantUserDefinedToProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID, val assignment: WindPlantUserDefined )
data class UnAssignWindPlantUserDefinedFromProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID? = null )
data class AssignWindType1or2UserDefinedToProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID, val assignment: WindType1or2UserDefined )
data class UnAssignWindType1or2UserDefinedFromProprietaryParameterDynamicsEvent(@Id val proprietaryParameterDynamicsId: UUID? = null )
...
// multiple association events
data class AssignValueAliasSetToRaiseLowerCommandEvent(@Id val raiseLowerCommandId: UUID, val addTo: ValueAliasSet )
data class RemoveValueAliasSetFromRaiseLowerCommandEvent(@Id val raiseLowerCommandId: UUID, val removeFrom: ValueAliasSet )
...
data class UpdateRatioTapChangerEvent(
    ...
    @Enumerated(EnumType.STRING) var tculControlMode: TransformerControlMode,
    var transformerEnd: TransformerEnd,
    var ratioTapChangerTable: RatioTapChangerTable
)
...
data class AssignTransformerEndToRatioTapChangerEvent(@Id val ratioTapChangerId: UUID, val assignment: TransformerEnd )
data class UnAssignTransformerEndFromRatioTapChangerEvent(@Id val ratioTapChangerId: UUID? = null )
data class AssignRatioTapChangerTableToRatioTapChangerEvent(@Id val ratioTapChangerId: UUID, val assignment: RatioTapChangerTable )
data class UnAssignRatioTapChangerTableFromRatioTapChangerEvent(@Id val ratioTapChangerId: UUID? = null )
...
// single association events
data class AssignRatioTapChangerTableToRatioTapChangerTablePointEvent(@Id val ratioTapChangerTablePointId: UUID, val assignment: RatioTapChangerTable )
data class UnAssignRatioTapChangerTableFromRatioTapChangerTablePointEvent(@Id val ratioTapChangerTablePointId: UUID? = null )
...
data class UpdateRegularTimePointEvent(
    ...
    var intervalSchedule: RegularIntervalSchedule
)
...
data class AssignIntervalScheduleToRegularTimePointEvent(@Id val regularTimePointId: UUID, val assignment: RegularIntervalSchedule )
data class UnAssignIntervalScheduleFromRegularTimePointEvent(@Id val regularTimePointId: UUID? = null )
...
// single association events
data class AssignRegulatingControlToRegulatingCondEqEvent(@Id val regulatingCondEqId: UUID, val assignment: RegulatingControl )
data class UnAssignRegulatingControlFromRegulatingCondEqEvent(@Id val regulatingCondEqId: UUID? = null )
...
// single association events
data class AssignTerminalToRegulatingControlEvent(@Id val regulatingControlId: UUID, val assignment: Terminal )
data class UnAssignTerminalFromRegulatingControlEvent(@Id val regulatingControlId: UUID? = null )
...
// single association events
data class AssignRegulatingControlToRegulationScheduleEvent(@Id val regulationScheduleId: UUID, val assignment: RegulatingControl )
data class UnAssignRegulatingControlFromRegulationScheduleEvent(@Id val regulationScheduleId: UUID? = null )
...
// single association events
data class AssignTerminalToRemoteInputSignalEvent(@Id val remoteInputSignalId: UUID, val assignment: Terminal )
data class UnAssignTerminalFromRemoteInputSignalEvent(@Id val remoteInputSignalId: UUID? = null )
data class AssignDiscontinuousExcitationControlDynamicsToRemoteInputSignalEvent(@Id val remoteInputSignalId: UUID, val assignment: DiscontinuousExcitationControlDynamics )
data class UnAssignDiscontinuousExcitationControlDynamicsFromRemoteInputSignalEvent(@Id val remoteInputSignalId: UUID? = null )
data class AssignPowerSystemStabilizerDynamicsToRemoteInputSignalEvent(@Id val remoteInputSignalId: UUID, val assignment: PowerSystemStabilizerDynamics )
data class UnAssignPowerSystemStabilizerDynamicsFromRemoteInputSignalEvent(@Id val remoteInputSignalId: UUID? = null )
data class AssignVoltageCompensatorDynamicsToRemoteInputSignalEvent(@Id val remoteInputSignalId: UUID, val assignment: VoltageCompensatorDynamics )
data class UnAssignVoltageCompensatorDynamicsFromRemoteInputSignalEvent(@Id val remoteInputSignalId: UUID? = null )
data class AssignUnderexcitationLimiterDynamicsToRemoteInputSignalEvent(@Id val remoteInputSignalId: UUID, val assignment: UnderexcitationLimiterDynamics )
data class UnAssignUnderexcitationLimiterDynamicsFromRemoteInputSignalEvent(@Id val remoteInputSignalId: UUID? = null )
data class AssignPFVArControllerType1DynamicsToRemoteInputSignalEvent(@Id val remoteInputSignalId: UUID, val assignment: PFVArControllerType1Dynamics )
data class UnAssignPFVArControllerType1DynamicsFromRemoteInputSignalEvent(@Id val remoteInputSignalId: UUID? = null )
...
data class AssignGeneratingUnitToRotatingMachineEvent(@Id val rotatingMachineId: UUID, val assignment: GeneratingUnit )
data class UnAssignGeneratingUnitFromRotatingMachineEvent(@Id val rotatingMachineId: UUID? = null )
...
// single association events
data class AssignSeasonToSeasonDayTypeScheduleEvent(@Id val seasonDayTypeScheduleId: UUID, val assignment: Season )
data class UnAssignSeasonFromSeasonDayTypeScheduleEvent(@Id val seasonDayTypeScheduleId: UUID? = null )
data class AssignDayTypeToSeasonDayTypeScheduleEvent(@Id val seasonDayTypeScheduleId: UUID, val assignment: DayType )
data class UnAssignDayTypeFromSeasonDayTypeScheduleEvent(@Id val seasonDayTypeScheduleId: UUID? = null )
...
data class UpdateStringMeasurementValueEvent(
    ...
    var stringMeasurement: StringMeasurement
)
...
data class AssignStringMeasurementToStringMeasurementValueEvent(@Id val stringMeasurementValueId: UUID, val assignment: StringMeasurement )
data class UnAssignStringMeasurementFromStringMeasurementValueEvent(@Id val stringMeasurementValueId: UUID? = null )
...
// single association events
data class AssignRegionToSubGeographicalRegionEvent(@Id val subGeographicalRegionId: UUID, val assignment: GeographicalRegion )
data class UnAssignRegionFromSubGeographicalRegionEvent(@Id val subGeographicalRegionId: UUID? = null )
...
// single association events
data class AssignLoadAreaToSubLoadAreaEvent(@Id val subLoadAreaId: UUID, val assignment: LoadArea )
data class UnAssignLoadAreaFromSubLoadAreaEvent(@Id val subLoadAreaId: UUID? = null )
...
// single association events
data class AssignRegionToSubstationEvent(@Id val substationId: UUID, val assignment: SubGeographicalRegion )
data class UnAssignRegionFromSubstationEvent(@Id val substationId: UUID? = null )
...
data class UpdateSvInjectionEvent(
    ...
    var topologicalNode: TopologicalNode
)
...
data class AssignTopologicalNodeToSvInjectionEvent(@Id val svInjectionId: UUID, val assignment: TopologicalNode )
data class UnAssignTopologicalNodeFromSvInjectionEvent(@Id val svInjectionId: UUID? = null )
...
data class AssignTerminalToSvPowerFlowEvent(@Id val svPowerFlowId: UUID, val assignment: Terminal )
data class UnAssignTerminalFromSvPowerFlowEvent(@Id val svPowerFlowId: UUID? = null )
...
data class UpdateSvShuntCompensatorSectionsEvent(
    ...
    var shuntCompensator: ShuntCompensator
)
...
data class AssignShuntCompensatorToSvShuntCompensatorSectionsEvent(@Id val svShuntCompensatorSectionsId: UUID, val assignment: ShuntCompensator )
data class UnAssignShuntCompensatorFromSvShuntCompensatorSectionsEvent(@Id val svShuntCompensatorSectionsId: UUID? = null )
...
data class AssignConductingEquipmentToSvStatusEvent(@Id val svStatusId: UUID, val assignment: ConductingEquipment )
data class UnAssignConductingEquipmentFromSvStatusEvent(@Id val svStatusId: UUID? = null )
...
data class AssignTapChangerToSvTapStepEvent(@Id val svTapStepId: UUID, val assignment: TapChanger )
data class UnAssignTapChangerFromSvTapStepEvent(@Id val svTapStepId: UUID? = null )
...
data class AssignTopologicalNodeToSvVoltageEvent(@Id val svVoltageId: UUID, val assignment: TopologicalNode )
data class UnAssignTopologicalNodeFromSvVoltageEvent(@Id val svVoltageId: UUID? = null )
...
data class UpdateSwitchScheduleEvent(
    ...
    var switchIt: SwitchProxy
)

data class DeleteSwitchScheduleEvent(@Id val switchScheduleId: UUID? = null)

// single association events
data class AssignSwitchItToSwitchScheduleEvent(@Id val switchScheduleId: UUID, val assignment: SwitchProxy )
data class UnAssignSwitchItFromSwitchScheduleEvent(@Id val switchScheduleId: UUID? = null )
...
data class UpdateSynchronousMachineEvent(
    ...
    var x0: PU,
    var x2: PU,
    var initialReactiveCapabilityCurve: ReactiveCapabilityCurve
)
...
data class AssignInitialReactiveCapabilityCurveToSynchronousMachineEvent(@Id val synchronousMachineId: UUID, val assignment: ReactiveCapabilityCurve )
data class UnAssignInitialReactiveCapabilityCurveFromSynchronousMachineEvent(@Id val synchronousMachineId: UUID? = null )
...
data class UpdateSynchronousMachineDynamicsEvent(
    ...
    var synchronousMachine: SynchronousMachine
)

data class DeleteSynchronousMachineDynamicsEvent(@Id val synchronousMachineDynamicsId: UUID? = null)

// single association events
data class AssignSynchronousMachineToSynchronousMachineDynamicsEvent(@Id val synchronousMachineDynamicsId: UUID, val assignment: SynchronousMachine )
data class UnAssignSynchronousMachineFromSynchronousMachineDynamicsEvent(@Id val synchronousMachineDynamicsId: UUID? = null )
...
data class UpdateTapChangerEvent(
    ...
    var tapChangerControl: TapChangerControl
)
...
data class AssignTapChangerControlToTapChangerEvent(@Id val tapChangerId: UUID, val assignment: TapChangerControl )
data class UnAssignTapChangerControlFromTapChangerEvent(@Id val tapChangerId: UUID? = null )
...
// single association events
data class AssignTapChangerToTapScheduleEvent(@Id val tapScheduleId: UUID, val assignment: TapChanger )
data class UnAssignTapChangerFromTapScheduleEvent(@Id val tapScheduleId: UUID? = null )
...
// single association events
data class AssignConductingEquipmentToTerminalEvent(@Id val terminalId: UUID, val assignment: ConductingEquipment )
data class UnAssignConductingEquipmentFromTerminalEvent(@Id val terminalId: UUID? = null )
...
data class AssignControlAreaToTieFlowEvent(@Id val tieFlowId: UUID, val assignment: ControlArea )
data class UnAssignControlAreaFromTieFlowEvent(@Id val tieFlowId: UUID? = null )
data class AssignTerminalToTieFlowEvent(@Id val tieFlowId: UUID, val assignment: Terminal )
data class UnAssignTerminalFromTieFlowEvent(@Id val tieFlowId: UUID? = null )
...
data class UpdateTopologicalIslandEvent(
    ...
    var topologicalNodes: TopologicalNode,
    var angleRefTopologicalNode: TopologicalNode
)

data class DeleteTopologicalIslandEvent(@Id val topologicalIslandId: UUID? = null)

// single association events
data class AssignTopologicalNodesToTopologicalIslandEvent(@Id val topologicalIslandId: UUID, val assignment: TopologicalNode )
data class UnAssignTopologicalNodesFromTopologicalIslandEvent(@Id val topologicalIslandId: UUID? = null )
data class AssignAngleRefTopologicalNodeToTopologicalIslandEvent(@Id val topologicalIslandId: UUID, val assignment: TopologicalNode )
data class UnAssignAngleRefTopologicalNodeFromTopologicalIslandEvent(@Id val topologicalIslandId: UUID? = null )
...
data class AssignConnectivityNodeContainerToTopologicalNodeEvent(@Id val topologicalNodeId: UUID, val assignment: ConnectivityNodeContainer )
data class UnAssignConnectivityNodeContainerFromTopologicalNodeEvent(@Id val topologicalNodeId: UUID? = null )
data class AssignBaseVoltageToTopologicalNodeEvent(@Id val topologicalNodeId: UUID, val assignment: BaseVoltage )
data class UnAssignBaseVoltageFromTopologicalNodeEvent(@Id val topologicalNodeId: UUID? = null )
...
data class AssignBaseVoltageToTransformerEndEvent(@Id val transformerEndId: UUID, val assignment: BaseVoltage )
data class UnAssignBaseVoltageFromTransformerEndEvent(@Id val transformerEndId: UUID? = null )
data class AssignTerminalToTransformerEndEvent(@Id val transformerEndId: UUID, val assignment: Terminal )
data class UnAssignTerminalFromTransformerEndEvent(@Id val transformerEndId: UUID? = null )
...
// single association events
data class AssignAsynchronousMachineDynamicsToTurbineGovernorDynamicsEvent(@Id val turbineGovernorDynamicsId: UUID, val assignment: AsynchronousMachineDynamics )
data class UnAssignAsynchronousMachineDynamicsFromTurbineGovernorDynamicsEvent(@Id val turbineGovernorDynamicsId: UUID? = null )
data class AssignSynchronousMachineDynamicsToTurbineGovernorDynamicsEvent(@Id val turbineGovernorDynamicsId: UUID, val assignment: SynchronousMachineDynamics )
data class UnAssignSynchronousMachineDynamicsFromTurbineGovernorDynamicsEvent(@Id val turbineGovernorDynamicsId: UUID? = null )
...
// single association events
data class AssignTurbineGovernorDynamicsToTurbineLoadControllerDynamicsEvent(@Id val turbineLoadControllerDynamicsId: UUID, val assignment: TurbineGovernorDynamics )
data class UnAssignTurbineGovernorDynamicsFromTurbineLoadControllerDynamicsEvent(@Id val turbineLoadControllerDynamicsId: UUID? = null )
...
// single association events
data class AssignExcitationSystemDynamicsToUnderexcitationLimiterDynamicsEvent(@Id val underexcitationLimiterDynamicsId: UUID, val assignment: ExcitationSystemDynamics )
data class UnAssignExcitationSystemDynamicsFromUnderexcitationLimiterDynamicsEvent(@Id val underexcitationLimiterDynamicsId: UUID? = null )
...
// multiple association events
data class AssignValueAliasSetToValueToAliasEvent(@Id val valueToAliasId: UUID, val addTo: ValueAliasSet )
data class RemoveValueAliasSetFromValueToAliasEvent(@Id val valueToAliasId: UUID, val removeFrom: ValueAliasSet )
...
data class AssignVisibleObjectsToVisibilityLayerEvent(@Id val visibilityLayerId: UUID, val assignment: DiagramObject )
data class UnAssignVisibleObjectsFromVisibilityLayerEvent(@Id val visibilityLayerId: UUID? = null )
...
// single association events
data class AssignPFVArControllerType1DynamicsToVoltageAdjusterDynamicsEvent(@Id val voltageAdjusterDynamicsId: UUID, val assignment: PFVArControllerType1Dynamics )
data class UnAssignPFVArControllerType1DynamicsFromVoltageAdjusterDynamicsEvent(@Id val voltageAdjusterDynamicsId: UUID? = null )
...
// single association events
data class AssignExcitationSystemDynamicsToVoltageCompensatorDynamicsEvent(@Id val voltageCompensatorDynamicsId: UUID, val assignment: ExcitationSystemDynamics )
data class UnAssignExcitationSystemDynamicsFromVoltageCompensatorDynamicsEvent(@Id val voltageCompensatorDynamicsId: UUID? = null )
...
data class AssignBaseVoltageToVoltageLevelEvent(@Id val voltageLevelId: UUID, val assignment: BaseVoltage )
data class UnAssignBaseVoltageFromVoltageLevelEvent(@Id val voltageLevelId: UUID? = null )
data class AssignSubstationToVoltageLevelEvent(@Id val voltageLevelId: UUID, val assignment: Substation )
data class UnAssignSubstationFromVoltageLevelEvent(@Id val voltageLevelId: UUID? = null )
...
data class UpdateVsConverterEvent(
    ...
    var capabilityCurve: VsCapabilityCurve
)
...
data class AssignCapabilityCurveToVsConverterEvent(@Id val vsConverterId: UUID, val assignment: VsCapabilityCurve )
data class UnAssignCapabilityCurveFromVsConverterEvent(@Id val vsConverterId: UUID? = null )
...
data class UpdateWindDynamicsLookupTableEvent(
    ...
    var windContRotorRIEC: WindContRotorRIEC,
    var windContCurrLimIEC: WindContCurrLimIEC,
    var windPlantFreqPcontrolIEC: WindPlantFreqPcontrolIEC,
    var windContPType3IEC: WindContPType3IEC
)
...
data class AssignWindContRotorRIECToWindDynamicsLookupTableEvent(@Id val windDynamicsLookupTableId: UUID, val assignment: WindContRotorRIEC )
data class UnAssignWindContRotorRIECFromWindDynamicsLookupTableEvent(@Id val windDynamicsLookupTableId: UUID? = null )
data class AssignWindContCurrLimIECToWindDynamicsLookupTableEvent(@Id val windDynamicsLookupTableId: UUID, val assignment: WindContCurrLimIEC )
data class UnAssignWindContCurrLimIECFromWindDynamicsLookupTableEvent(@Id val windDynamicsLookupTableId: UUID? = null )
data class AssignWindPlantFreqPcontrolIECToWindDynamicsLookupTableEvent(@Id val windDynamicsLookupTableId: UUID, val assignment: WindPlantFreqPcontrolIEC )
data class UnAssignWindPlantFreqPcontrolIECFromWindDynamicsLookupTableEvent(@Id val windDynamicsLookupTableId: UUID? = null )
data class AssignWindContPType3IECToWindDynamicsLookupTableEvent(@Id val windDynamicsLookupTableId: UUID, val assignment: WindContPType3IEC )
data class UnAssignWindContPType3IECFromWindDynamicsLookupTableEvent(@Id val windDynamicsLookupTableId: UUID? = null )
...
data class UpdateWindGenTurbineType1IECEvent(
    ...
    var windAeroConstIEC: WindAeroConstIEC
)

data class DeleteWindGenTurbineType1IECEvent(@Id val windGenTurbineType1IECId: UUID? = null)

// single association events
data class AssignWindAeroConstIECToWindGenTurbineType1IECEvent(@Id val windGenTurbineType1IECId: UUID, val assignment: WindAeroConstIEC )
data class UnAssignWindAeroConstIECFromWindGenTurbineType1IECEvent(@Id val windGenTurbineType1IECId: UUID? = null )
...
data class UpdateWindGenTurbineType2IECEvent(
    ...
    var windContRotorRIEC: WindContRotorRIEC,
    var windPitchContEmulIEC: WindPitchContEmulIEC
)

data class DeleteWindGenTurbineType2IECEvent(@Id val windGenTurbineType2IECId: UUID? = null)

// single association events
data class AssignWindContRotorRIECToWindGenTurbineType2IECEvent(@Id val windGenTurbineType2IECId: UUID, val assignment: WindContRotorRIEC )
data class UnAssignWindContRotorRIECFromWindGenTurbineType2IECEvent(@Id val windGenTurbineType2IECId: UUID? = null )
data class AssignWindPitchContEmulIECToWindGenTurbineType2IECEvent(@Id val windGenTurbineType2IECId: UUID, val assignment: WindPitchContEmulIEC )
data class UnAssignWindPitchContEmulIECFromWindGenTurbineType2IECEvent(@Id val windGenTurbineType2IECId: UUID? = null )
...
data class UpdateWindGenTurbineType3IECEvent(
    ...
    var dipmax: PU,
    var diqmax: PU,
    var windMechIEC: WindMechIEC,
    var windContPitchAngleIEC: WindContPitchAngleIEC,
    var windAeroLinearIEC: WindAeroLinearIEC,
    var windContPType3IEC: WindContPType3IEC
)
...
data class AssignWindMechIECToWindGenTurbineType3IECEvent(@Id val windGenTurbineType3IECId: UUID, val assignment: WindMechIEC )
data class UnAssignWindMechIECFromWindGenTurbineType3IECEvent(@Id val windGenTurbineType3IECId: UUID? = null )
data class AssignWindContPitchAngleIECToWindGenTurbineType3IECEvent(@Id val windGenTurbineType3IECId: UUID, val assignment: WindContPitchAngleIEC )
data class UnAssignWindContPitchAngleIECFromWindGenTurbineType3IECEvent(@Id val windGenTurbineType3IECId: UUID? = null )
data class AssignWindAeroLinearIECToWindGenTurbineType3IECEvent(@Id val windGenTurbineType3IECId: UUID, val assignment: WindAeroLinearIEC )
data class UnAssignWindAeroLinearIECFromWindGenTurbineType3IECEvent(@Id val windGenTurbineType3IECId: UUID? = null )
data class AssignWindContPType3IECToWindGenTurbineType3IECEvent(@Id val windGenTurbineType3IECId: UUID, val assignment: WindContPType3IEC )
data class UnAssignWindContPType3IECFromWindGenTurbineType3IECEvent(@Id val windGenTurbineType3IECId: UUID? = null )
...
data class UpdateWindPlantDynamicsEvent(
    ...
    var remoteInputSignal: RemoteInputSignal
)

data class DeleteWindPlantDynamicsEvent(@Id val windPlantDynamicsId: UUID? = null)

// single association events
data class AssignRemoteInputSignalToWindPlantDynamicsEvent(@Id val windPlantDynamicsId: UUID, val assignment: RemoteInputSignal )
data class UnAssignRemoteInputSignalFromWindPlantDynamicsEvent(@Id val windPlantDynamicsId: UUID? = null )
...
data class UpdateWindPlantIECEvent(
    ...
    var windPlantFreqPcontrolIEC: WindPlantFreqPcontrolIEC,
    var windPlantReactiveControlIEC: WindPlantReactiveControlIEC
)

data class DeleteWindPlantIECEvent(@Id val windPlantIECId: UUID? = null)

// single association events
data class AssignWindPlantFreqPcontrolIECToWindPlantIECEvent(@Id val windPlantIECId: UUID, val assignment: WindPlantFreqPcontrolIEC )
data class UnAssignWindPlantFreqPcontrolIECFromWindPlantIECEvent(@Id val windPlantIECId: UUID? = null )
data class AssignWindPlantReactiveControlIECToWindPlantIECEvent(@Id val windPlantIECId: UUID, val assignment: WindPlantReactiveControlIEC )
data class UnAssignWindPlantReactiveControlIECFromWindPlantIECEvent(@Id val windPlantIECId: UUID? = null )
...
// single association events
data class AssignAsynchronousMachineDynamicsToWindTurbineType1or2DynamicsEvent(@Id val windTurbineType1or2DynamicsId: UUID, val assignment: AsynchronousMachineDynamics )
data class UnAssignAsynchronousMachineDynamicsFromWindTurbineType1or2DynamicsEvent(@Id val windTurbineType1or2DynamicsId: UUID? = null )
data class AssignRemoteInputSignalToWindTurbineType1or2DynamicsEvent(@Id val windTurbineType1or2DynamicsId: UUID, val assignment: RemoteInputSignal )
data class UnAssignRemoteInputSignalFromWindTurbineType1or2DynamicsEvent(@Id val windTurbineType1or2DynamicsId: UUID? = null )
...
data class UpdateWindTurbineType1or2IECEvent(
    ...
    var windProtectionIEC: WindProtectionIEC,
    var windMechIEC: WindMechIEC
)
...
// single association events
data class AssignWindProtectionIECToWindTurbineType1or2IECEvent(@Id val windTurbineType1or2IECId: UUID, val assignment: WindProtectionIEC )
data class UnAssignWindProtectionIECFromWindTurbineType1or2IECEvent(@Id val windTurbineType1or2IECId: UUID? = null )
data class AssignWindMechIECToWindTurbineType1or2IECEvent(@Id val windTurbineType1or2IECId: UUID, val assignment: WindMechIEC )
data class UnAssignWindMechIECFromWindTurbineType1or2IECEvent(@Id val windTurbineType1or2IECId: UUID? = null )
...
// single association events
data class AssignEnergySourceToWindTurbineType3or4DynamicsEvent(@Id val windTurbineType3or4DynamicsId: UUID, val assignment: EnergySource )
data class UnAssignEnergySourceFromWindTurbineType3or4DynamicsEvent(@Id val windTurbineType3or4DynamicsId: UUID? = null )
data class AssignWindPlantDynamicsToWindTurbineType3or4DynamicsEvent(@Id val windTurbineType3or4DynamicsId: UUID, val assignment: WindPlantDynamics )
data class UnAssignWindPlantDynamicsFromWindTurbineType3or4DynamicsEvent(@Id val windTurbineType3or4DynamicsId: UUID? = null )
data class AssignRemoteInputSignalToWindTurbineType3or4DynamicsEvent(@Id val windTurbineType3or4DynamicsId: UUID, val assignment: RemoteInputSignal )
data class UnAssignRemoteInputSignalFromWindTurbineType3or4DynamicsEvent(@Id val windTurbineType3or4DynamicsId: UUID? = null )
...
data class UpdateWindTurbineType3or4IECEvent(
    ...
    var windProtectionIEC: WindProtectionIEC,
    var windContCurrLimIEC: WindContCurrLimIEC,
    var wIndContQIEC: WindContQIEC
)

data class DeleteWindTurbineType3or4IECEvent(@Id val windTurbineType3or4IECId: UUID? = null)

// single association events
data class AssignWindProtectionIECToWindTurbineType3or4IECEvent(@Id val windTurbineType3or4IECId: UUID, val assignment: WindProtectionIEC )
data class UnAssignWindProtectionIECFromWindTurbineType3or4IECEvent(@Id val windTurbineType3or4IECId: UUID? = null )
data class AssignWindContCurrLimIECToWindTurbineType3or4IECEvent(@Id val windTurbineType3or4IECId: UUID, val assignment: WindContCurrLimIEC )
data class UnAssignWindContCurrLimIECFromWindTurbineType3or4IECEvent(@Id val windTurbineType3or4IECId: UUID? = null )
data class AssignWIndContQIECToWindTurbineType3or4IECEvent(@Id val windTurbineType3or4IECId: UUID, val assignment: WindContQIEC )
data class UnAssignWIndContQIECFromWindTurbineType3or4IECEvent(@Id val windTurbineType3or4IECId: UUID? = null )
...
data class UpdateWindTurbineType4aIECEvent(
    ...
    var windContPType4aIEC: WindContPType4aIEC
)

data class DeleteWindTurbineType4aIECEvent(@Id val windTurbineType4aIECId: UUID? = null)

// single association events
data class AssignWindContPType4aIECToWindTurbineType4aIECEvent(@Id val windTurbineType4aIECId: UUID, val assignment: WindContPType4aIEC )
data class UnAssignWindContPType4aIECFromWindTurbineType4aIECEvent(@Id val windTurbineType4aIECId: UUID? = null )
...
data class UpdateWindTurbineType4bIECEvent(
    ...
    var windMechIEC: WindMechIEC,
    var windContPType4bIEC: WindContPType4bIEC
)

data class DeleteWindTurbineType4bIECEvent(@Id val windTurbineType4bIECId: UUID? = null)

// single association events
data class AssignWindMechIECToWindTurbineType4bIECEvent(@Id val windTurbineType4bIECId: UUID, val assignment: WindMechIEC )
data class UnAssignWindMechIECFromWindTurbineType4bIECEvent(@Id val windTurbineType4bIECId: UUID? = null )
data class AssignWindContPType4bIECToWindTurbineType4bIECEvent(@Id val windTurbineType4bIECId: UUID, val assignment: WindContPType4bIEC )
data class UnAssignWindContPType4bIECFromWindTurbineType4bIECEvent(@Id val windTurbineType4bIECId: UUID? = null )
