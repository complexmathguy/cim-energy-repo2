...
data class ACDCConverter(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "pccTerminal") var pccTerminal: Terminal? = null
)
...
data class ACDCConverterDCTerminal(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "dCConductingEquipment") var dCConductingEquipment: ACDCConverter? = null
)
...
data class ACDCTerminal(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "busNameMarker") var busNameMarker: BusNameMarker? = null
)
...
data class AccumulatorLimit(
    ...
    @OneToMany(fetch = FetchType.EAGER) @JoinColumn(name = "limitSet") var limitSet:  Set<AccumulatorLimitSet>? = null
)

@Entity
data class AccumulatorLimitSet(
    @Id var accumulatorLimitSetId: UUID? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "measurements") var measurements: Accumulator? = null
)

@Entity
data class AccumulatorReset(
    @Id var accumulatorResetId: UUID? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "accumulatorValue") var accumulatorValue: AccumulatorValue? = null
)
...
data class AccumulatorValue(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "value") var value: IntegerProxy? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "accumulator") var accumulator: Accumulator? = null
)
...
data class AnalogControl(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "analogValue") var analogValue: AnalogValue? = null
)
...
data class AnalogLimit(
    ...
    @OneToMany(fetch = FetchType.EAGER) @JoinColumn(name = "limitSet") var limitSet:  Set<AnalogLimitSet>? = null
)

@Entity
data class AnalogLimitSet(
    @Id var analogLimitSetId: UUID? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "measurements") var measurements: Analog? = null
)
...
data class AnalogValue(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "value") var value: Simple_Float? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "analog") var analog: Analog? = null
)
...
data class AsynchronousMachineDynamics(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "asynchronousMachine") var asynchronousMachine: AsynchronousMachine? = null
)
...
data class Bay(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "voltageLevel") var voltageLevel: VoltageLevel? = null
)
...
data class BusNameMarker(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "reportingGroup") var reportingGroup: ReportingGroup? = null
)
...
data class Command(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "value") var value: IntegerProxy? = null,
    @OneToMany(fetch = FetchType.EAGER) @JoinColumn(name = "valueAliasSet") var valueAliasSet:  Set<ValueAliasSet>? = null,
    @OneToMany(fetch = FetchType.EAGER) @JoinColumn(name = "discreteValue") var discreteValue:  Set<DiscreteValue>? = null
)
...
data class ConformLoad(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "loadGroup") var loadGroup: ConformLoadGroup? = null
)
...
data class ConformLoadSchedule(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "conformLoadGroup") var conformLoadGroup: ConformLoadGroup? = null
)
...
data class ConnectivityNode(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "toEndName") var toEndName: StringProxy? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "toEndNameTso") var toEndNameTso: StringProxy? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "connectivityNodeContainer") var connectivityNodeContainer: ConnectivityNodeContainer? = null
)
...
data class Control(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "powerSystemResource") var powerSystemResource: PowerSystemResource? = null
)
...
data class ControlArea(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "energyArea") var energyArea: EnergyArea? = null
)
...
data class ControlAreaGeneratingUnit(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "generatingUnit") var generatingUnit: GeneratingUnit? = null
)
...
data class CurveData(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "curve") var curve: Curve? = null
)

@Entity
data class DCBaseTerminal(
    @Id var dCBaseTerminalId: UUID? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "dCNode") var dCNode: DCNode? = null
)
...
data class DCConverterUnit(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "substation") var substation: Substation? = null
)
...
data class DCLine(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "region") var region: SubGeographicalRegion? = null
)
...
data class DCLineSegment(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "perLengthParameter") var perLengthParameter: PerLengthDCLineParameter? = null
)

@Entity
data class DCNode(
    @Id var dCNodeId: UUID? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "dCEquipmentContainer") var dCEquipmentContainer: DCEquipmentContainer? = null
)
...
data class DCTerminal(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "dCConductingEquipment") var dCConductingEquipment: DCConductingEquipment? = null
)

@Entity
data class DCTopologicalIsland(
    @Id var dCTopologicalIslandId: UUID? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "dCTopologicalNodes") var dCTopologicalNodes: DCTopologicalNode? = null
)
...
data class Diagram(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "diagramStyle") var diagramStyle: DiagramStyle? = null
)
...
data class DiagramObject(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "diagramObjectStyle") var diagramObjectStyle: DiagramObjectStyle? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "diagram") var diagram: Diagram? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "identifiedObject") var identifiedObject: IdentifiedObject? = null
)
...
data class DiagramObjectPoint(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "diagramObject") var diagramObject: DiagramObject? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "diagramObjectGluePoint") var diagramObjectGluePoint: DiagramObjectGluePoint? = null
)
...
data class DiscreteValue(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "value") var value: IntegerProxy? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "discrete") var discrete: Discrete? = null
)
...
data class EnergyConsumer(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "loadResponse") var loadResponse: LoadResponseCharacteristic? = null
)
...
data class EnergySource(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "energySchedulingType") var energySchedulingType: EnergySchedulingType? = null
)

@Entity
data class Equipment(
    @Id var equipmentId: UUID? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "equipmentContainer") var equipmentContainer: EquipmentContainer? = null
)
...
data class EquivalentEquipment(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "equivalentNetwork") var equivalentNetwork: EquivalentNetwork? = null
)
...
data class EquivalentInjection(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "reactiveCapabilityCurve") var reactiveCapabilityCurve: ReactiveCapabilityCurve? = null
)
...
data class FossilFuel(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "thermalGeneratingUnit") var thermalGeneratingUnit: ThermalGeneratingUnit? = null
)
...
data class GenICompensationForGenJ(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "synchronousMachineDynamics") var synchronousMachineDynamics: SynchronousMachineDynamics? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "vcompIEEEType2") var vcompIEEEType2: VCompIEEEType2? = null
)
...
data class HydroGeneratingUnit(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "hydroPowerPlant") var hydroPowerPlant: HydroPowerPlant? = null
)
...
data class HydroPump(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "rotatingMachine") var rotatingMachine: RotatingMachine? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "hydroPowerPlant") var hydroPowerPlant: HydroPowerPlant? = null
)
...
data class LoadGroup(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "subLoadArea") var subLoadArea: SubLoadArea? = null
)
...
data class LoadMotor(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "loadAggregate") var loadAggregate: LoadAggregate? = null
)
...
data class Location(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "powerSystemResources") var powerSystemResources: PowerSystemResource? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "coordinateSystem") var coordinateSystem: CoordinateSystem? = null
)
...
data class Measurement(
    ...
    @Enumerated(EnumType.STRING) var unitSymbol: UnitSymbol? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "powerSystemResource") var powerSystemResource: PowerSystemResource? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "terminal") var terminal: ACDCTerminal? = null
)
...
data class MeasurementValue(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "timeStamp") var timeStamp: DateTime? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "measurementValueSource") var measurementValueSource: MeasurementValueSource? = null
)

@Entity
data class MeasurementValueQuality(
    @Id var measurementValueQualityId: UUID? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "measurementValue") var measurementValue: MeasurementValue? = null
)
...
data class MutualCoupling(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "r0") var r0: Resistance? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "x0") var x0: Reactance? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "second_Terminal") var second_Terminal: Terminal? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "first_Terminal") var first_Terminal: Terminal? = null
)

@Entity
data class NonConformLoad(
    @Id var nonConformLoadId: UUID? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "loadGroup") var loadGroup: NonConformLoadGroup? = null
)
...
data class NonConformLoadSchedule(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "nonConformLoadGroup") var nonConformLoadGroup: NonConformLoadGroup? = null
)
...
data class NonlinearShuntCompensatorPoint(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "nonlinearShuntCompensator") var nonlinearShuntCompensator: NonlinearShuntCompensator? = null
)
...
data class OperationalLimit(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "operationalLimitType") var operationalLimitType: OperationalLimitType? = null,
...
data class OperationalLimitSet(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "equipment") var equipment: Equipment? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "terminal") var terminal: ACDCTerminal? = null
)
...
data class PhaseTapChanger(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "transformerEnd") var transformerEnd: TransformerEnd? = null
)
...
data class PhaseTapChangerTablePoint(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "phaseTapChangerTable") var phaseTapChangerTable: PhaseTapChangerTable? = null
)
...
data class PowerTransformerEnd(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "x") var x: Reactance? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "x0") var x0: Reactance? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "powerTransformer") var powerTransformer: PowerTransformer? = null
)
...
data class ProprietaryParameterDynamics(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "pFVArControllerType1UserDefined") var pFVArControllerType1UserDefined: PFVArControllerType1UserDefined? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "voltageCompensatorUserDefined") var voltageCompensatorUserDefined: VoltageCompensatorUserDefined? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "mechanicalLoadUserDefined") var mechanicalLoadUserDefined: MechanicalLoadUserDefined? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "excitationSystemUserDefined") var excitationSystemUserDefined: ExcitationSystemUserDefined? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "asynchronousMachineUserDefined") var asynchronousMachineUserDefined: AsynchronousMachineUserDefined? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "discontinuousExcitationControlUserDefined") var discontinuousExcitationControlUserDefined: DiscontinuousExcitationControlUserDefined? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "turbineGovernorUserDefined") var turbineGovernorUserDefined: TurbineGovernorUserDefined? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "voltageAdjusterUserDefined") var voltageAdjusterUserDefined: VoltageAdjusterUserDefined? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "synchronousMachineUserDefined") var synchronousMachineUserDefined: SynchronousMachineUserDefined? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "underexcitationLimiterUserDefined") var underexcitationLimiterUserDefined: UnderexcitationLimiterUserDefined? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "turbineLoadControllerUserDefined") var turbineLoadControllerUserDefined: TurbineLoadControllerUserDefined? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "overexcitationLimiterUserDefined") var overexcitationLimiterUserDefined: OverexcitationLimiterUserDefined? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "powerSystemStabilizerUserDefined") var powerSystemStabilizerUserDefined: PowerSystemStabilizerUserDefined? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "loadUserDefined") var loadUserDefined: LoadUserDefined? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "pFVArControllerType2UserDefined") var pFVArControllerType2UserDefined: PFVArControllerType2UserDefined? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windType3or4UserDefined") var windType3or4UserDefined: WindType3or4UserDefined? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windPlantUserDefined") var windPlantUserDefined: WindPlantUserDefined? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windType1or2UserDefined") var windType1or2UserDefined: WindType1or2UserDefined? = null
)
...
data class RatioTapChanger(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "transformerEnd") var transformerEnd: TransformerEnd? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "ratioTapChangerTable") var ratioTapChangerTable: RatioTapChangerTable? = null
)
...
data class RegularTimePoint(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "intervalSchedule") var intervalSchedule: RegularIntervalSchedule? = null
)
...
data class RegulatingControl(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "terminal") var terminal: Terminal? = null
)
...
data class SeasonDayTypeSchedule(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "season") var season: Season? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "dayType") var dayType: DayType? = null
)
...
data class StringMeasurementValue(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "stringMeasurement") var stringMeasurement: StringMeasurement? = null
)
...
data class SubGeographicalRegion(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "region") var region: GeographicalRegion? = null
)

@Entity
data class SubLoadArea(
    @Id var subLoadAreaId: UUID? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "loadArea") var loadArea: LoadArea? = null
)
...
data class SvInjection(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "topologicalNode") var topologicalNode: TopologicalNode? = null
)
...
data class SvShuntCompensatorSections(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "shuntCompensator") var shuntCompensator: ShuntCompensator? = null
)
...
data class SvStatus(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "conductingEquipment") var conductingEquipment: ConductingEquipment? = null
)
...
data class SvTapStep(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "tapChanger") var tapChanger: TapChanger? = null
)
...
data class SwitchSchedule(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "switchIt") var switchIt: SwitchProxy? = null
)
...
data class SynchronousMachine(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "initialReactiveCapabilityCurve") var initialReactiveCapabilityCurve: ReactiveCapabilityCurve? = null
)
...
data class SynchronousMachineDynamics(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "synchronousMachine") var synchronousMachine: SynchronousMachine? = null
)
...
data class TapChanger(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "tapChangerControl") var tapChangerControl: TapChangerControl? = null
)
...
data class TopologicalIsland(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "topologicalNodes") var topologicalNodes: TopologicalNode? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "angleRefTopologicalNode") var angleRefTopologicalNode: TopologicalNode? = null
)
...
data class TopologicalNode(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "toEndNameTso") var toEndNameTso: StringProxy? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "connectivityNodeContainer") var connectivityNodeContainer: ConnectivityNodeContainer? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "baseVoltage") var baseVoltage: BaseVoltage? = null
)
...
data class VisibilityLayer(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "drawingOrder") var drawingOrder: IntegerProxy? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "visibleObjects") var visibleObjects: DiagramObject? = null
)
...
data class VsConverter(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "capabilityCurve") var capabilityCurve: VsCapabilityCurve? = null
)
...
data class WindDynamicsLookupTable(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windContRotorRIEC") var windContRotorRIEC: WindContRotorRIEC? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windContCurrLimIEC") var windContCurrLimIEC: WindContCurrLimIEC? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windPlantFreqPcontrolIEC") var windPlantFreqPcontrolIEC: WindPlantFreqPcontrolIEC? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windContPType3IEC") var windContPType3IEC: WindContPType3IEC? = null
)

@Entity
data class WindGenTurbineType1IEC(
    @Id var windGenTurbineType1IECId: UUID? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windAeroConstIEC") var windAeroConstIEC: WindAeroConstIEC? = null
)
...
data class WindGenTurbineType2IEC(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windContRotorRIEC") var windContRotorRIEC: WindContRotorRIEC? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windPitchContEmulIEC") var windPitchContEmulIEC: WindPitchContEmulIEC? = null
)
...
data class WindGenTurbineType3IEC(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windMechIEC") var windMechIEC: WindMechIEC? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windContPitchAngleIEC") var windContPitchAngleIEC: WindContPitchAngleIEC? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windAeroLinearIEC") var windAeroLinearIEC: WindAeroLinearIEC? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windContPType3IEC") var windContPType3IEC: WindContPType3IEC? = null
)
...
data class WindPlantDynamics(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "remoteInputSignal") var remoteInputSignal: RemoteInputSignal? = null
)
...
data class WindPlantIEC(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windPlantFreqPcontrolIEC") var windPlantFreqPcontrolIEC: WindPlantFreqPcontrolIEC? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windPlantReactiveControlIEC") var windPlantReactiveControlIEC: WindPlantReactiveControlIEC? = null
)
...
data class WindTurbineType1or2IEC(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windProtectionIEC") var windProtectionIEC: WindProtectionIEC? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windMechIEC") var windMechIEC: WindMechIEC? = null
)
...
data class WindTurbineType3or4Dynamics(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "energySource") var energySource: EnergySource? = null,
...
data class WindTurbineType3or4IEC(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windProtectionIEC") var windProtectionIEC: WindProtectionIEC? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windContCurrLimIEC") var windContCurrLimIEC: WindContCurrLimIEC? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "wIndContQIEC") var wIndContQIEC: WindContQIEC? = null
)

@Entity
data class WindTurbineType4aIEC(
    @Id var windTurbineType4aIECId: UUID? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windContPType4aIEC") var windContPType4aIEC: WindContPType4aIEC? = null
)
...
data class WindTurbineType4bIEC(
    ...
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windMechIEC") var windMechIEC: WindMechIEC? = null,
    @OneToOne(fetch = FetchType.EAGER) @JoinColumn(name = "windContPType4bIEC") var windContPType4bIEC: WindContPType4bIEC? = null
)
