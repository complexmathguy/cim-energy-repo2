...
public class DCTerminalCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save DCConductingEquipment on DCTerminal
     * @param		command AssignDCConductingEquipmentToDCTerminalCommand
     */     
	@PutMapping("/assignDCConductingEquipment")
	public void assignDCConductingEquipment( @RequestBody AssignDCConductingEquipmentToDCTerminalCommand command ) {
		try {
			DCTerminalBusinessDelegate.getDCTerminalInstance().assignDCConductingEquipment( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign DCConductingEquipment on DCTerminal
     * @param		 command UnAssignDCConductingEquipmentFromDCTerminalCommand
     */     
	@PutMapping("/unAssignDCConductingEquipment")
	public void unAssignDCConductingEquipment( @RequestBody(required=true)  UnAssignDCConductingEquipmentFromDCTerminalCommand command ) {
		try {
			DCTerminalBusinessDelegate.getDCTerminalInstance().unAssignDCConductingEquipment( command );   
		}
		catch( Exception exc ) {
