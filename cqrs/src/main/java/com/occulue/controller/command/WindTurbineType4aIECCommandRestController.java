...
public class WindTurbineType4aIECCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save WindContPType4aIEC on WindTurbineType4aIEC
     * @param		command AssignWindContPType4aIECToWindTurbineType4aIECCommand
     */     
	@PutMapping("/assignWindContPType4aIEC")
	public void assignWindContPType4aIEC( @RequestBody AssignWindContPType4aIECToWindTurbineType4aIECCommand command ) {
		try {
			WindTurbineType4aIECBusinessDelegate.getWindTurbineType4aIECInstance().assignWindContPType4aIEC( command );   
		}
        catch( Throwable exc ) {
        	LOGGER.log( Level.WARNING, "Failed to assign WindContPType4aIEC", exc );
        }
	}

    /**
     * unassign WindContPType4aIEC on WindTurbineType4aIEC
     * @param		 command UnAssignWindContPType4aIECFromWindTurbineType4aIECCommand
     */     
	@PutMapping("/unAssignWindContPType4aIEC")
	public void unAssignWindContPType4aIEC( @RequestBody(required=true)  UnAssignWindContPType4aIECFromWindTurbineType4aIECCommand command ) {
		try {
			WindTurbineType4aIECBusinessDelegate.getWindTurbineType4aIECInstance().unAssignWindContPType4aIEC( command );   
		}
		catch( Exception exc ) {
			LOGGER.log( Level.WARNING, "Failed to unassign WindContPType4aIEC", exc );
		}
	}
