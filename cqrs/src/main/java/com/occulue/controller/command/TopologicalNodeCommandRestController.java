...
public class TopologicalNodeCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save ConnectivityNodeContainer on TopologicalNode
     * @param		command AssignConnectivityNodeContainerToTopologicalNodeCommand
     */     
	@PutMapping("/assignConnectivityNodeContainer")
	public void assignConnectivityNodeContainer( @RequestBody AssignConnectivityNodeContainerToTopologicalNodeCommand command ) {
		try {
			TopologicalNodeBusinessDelegate.getTopologicalNodeInstance().assignConnectivityNodeContainer( command );   
		}
        catch( Throwable exc ) {
        	LOGGER.log( Level.WARNING, "Failed to assign ConnectivityNodeContainer", exc );
        }
	}

    /**
     * unassign ConnectivityNodeContainer on TopologicalNode
     * @param		 command UnAssignConnectivityNodeContainerFromTopologicalNodeCommand
     */     
	@PutMapping("/unAssignConnectivityNodeContainer")
	public void unAssignConnectivityNodeContainer( @RequestBody(required=true)  UnAssignConnectivityNodeContainerFromTopologicalNodeCommand command ) {
		try {
			TopologicalNodeBusinessDelegate.getTopologicalNodeInstance().unAssignConnectivityNodeContainer( command );   
		}
		catch( Exception exc ) {
			LOGGER.log( Level.WARNING, "Failed to unassign ConnectivityNodeContainer", exc );
		}
	}
	
    /**
     * save BaseVoltage on TopologicalNode
     * @param		command AssignBaseVoltageToTopologicalNodeCommand
     */     
	@PutMapping("/assignBaseVoltage")
	public void assignBaseVoltage( @RequestBody AssignBaseVoltageToTopologicalNodeCommand command ) {
		try {
			TopologicalNodeBusinessDelegate.getTopologicalNodeInstance().assignBaseVoltage( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign BaseVoltage on TopologicalNode
     * @param		 command UnAssignBaseVoltageFromTopologicalNodeCommand
     */     
	@PutMapping("/unAssignBaseVoltage")
	public void unAssignBaseVoltage( @RequestBody(required=true)  UnAssignBaseVoltageFromTopologicalNodeCommand command ) {
		try {
			TopologicalNodeBusinessDelegate.getTopologicalNodeInstance().unAssignBaseVoltage( command );   
		}
		catch( Exception exc ) {
