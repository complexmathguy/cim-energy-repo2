...
public class MechanicalLoadDynamicsCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save SynchronousMachineDynamics on MechanicalLoadDynamics
     * @param		command AssignSynchronousMachineDynamicsToMechanicalLoadDynamicsCommand
     */     
	@PutMapping("/assignSynchronousMachineDynamics")
	public void assignSynchronousMachineDynamics( @RequestBody AssignSynchronousMachineDynamicsToMechanicalLoadDynamicsCommand command ) {
		try {
			MechanicalLoadDynamicsBusinessDelegate.getMechanicalLoadDynamicsInstance().assignSynchronousMachineDynamics( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign SynchronousMachineDynamics on MechanicalLoadDynamics
	...
	public void unAssignSynchronousMachineDynamics( @RequestBody(required=true)  UnAssignSynchronousMachineDynamicsFromMechanicalLoadDynamicsCommand command ) {
		try {
			MechanicalLoadDynamicsBusinessDelegate.getMechanicalLoadDynamicsInstance().unAssignSynchronousMachineDynamics( command );   
		}
		catch( Exception exc ) {
    ...
    /**
     * save AsynchronousMachineDynamics on MechanicalLoadDynamics
	...
	public void assignAsynchronousMachineDynamics( @RequestBody AssignAsynchronousMachineDynamicsToMechanicalLoadDynamicsCommand command ) {
		try {
			MechanicalLoadDynamicsBusinessDelegate.getMechanicalLoadDynamicsInstance().assignAsynchronousMachineDynamics( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign AsynchronousMachineDynamics on MechanicalLoadDynamics
	...
	public void unAssignAsynchronousMachineDynamics( @RequestBody(required=true)  UnAssignAsynchronousMachineDynamicsFromMechanicalLoadDynamicsCommand command ) {
		try {
			MechanicalLoadDynamicsBusinessDelegate.getMechanicalLoadDynamicsInstance().unAssignAsynchronousMachineDynamics( command );   
		}
		catch( Exception exc ) {
