...
public class ExcitationSystemDynamicsCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save SynchronousMachineDynamics on ExcitationSystemDynamics
	...
	public void assignSynchronousMachineDynamics( @RequestBody AssignSynchronousMachineDynamicsToExcitationSystemDynamicsCommand command ) {
		try {
			ExcitationSystemDynamicsBusinessDelegate.getExcitationSystemDynamicsInstance().assignSynchronousMachineDynamics( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign SynchronousMachineDynamics on ExcitationSystemDynamics
	...
	public void unAssignSynchronousMachineDynamics( @RequestBody(required=true)  UnAssignSynchronousMachineDynamicsFromExcitationSystemDynamicsCommand command ) {
		try {
			ExcitationSystemDynamicsBusinessDelegate.getExcitationSystemDynamicsInstance().unAssignSynchronousMachineDynamics( command );   
		}
		catch( Exception exc ) {
