...
public class EquivalentInjectionCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save ReactiveCapabilityCurve on EquivalentInjection
     * @param		command AssignReactiveCapabilityCurveToEquivalentInjectionCommand
     */     
	@PutMapping("/assignReactiveCapabilityCurve")
	public void assignReactiveCapabilityCurve( @RequestBody AssignReactiveCapabilityCurveToEquivalentInjectionCommand command ) {
		try {
			EquivalentInjectionBusinessDelegate.getEquivalentInjectionInstance().assignReactiveCapabilityCurve( command );   
		}
        catch( Throwable exc ) {
        	LOGGER.log( Level.WARNING, "Failed to assign ReactiveCapabilityCurve", exc );
        }
	}

    /**
     * unassign ReactiveCapabilityCurve on EquivalentInjection
     * @param		 command UnAssignReactiveCapabilityCurveFromEquivalentInjectionCommand
     */     
	@PutMapping("/unAssignReactiveCapabilityCurve")
	public void unAssignReactiveCapabilityCurve( @RequestBody(required=true)  UnAssignReactiveCapabilityCurveFromEquivalentInjectionCommand command ) {
		try {
			EquivalentInjectionBusinessDelegate.getEquivalentInjectionInstance().unAssignReactiveCapabilityCurve( command );   
		}
		catch( Exception exc ) {
			LOGGER.log( Level.WARNING, "Failed to unassign ReactiveCapabilityCurve", exc );
		}
	}
