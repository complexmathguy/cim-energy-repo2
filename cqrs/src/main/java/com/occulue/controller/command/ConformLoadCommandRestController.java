...
public class ConformLoadCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save LoadGroup on ConformLoad
     * @param		command AssignLoadGroupToConformLoadCommand
     */     
	@PutMapping("/assignLoadGroup")
	public void assignLoadGroup( @RequestBody AssignLoadGroupToConformLoadCommand command ) {
		try {
			ConformLoadBusinessDelegate.getConformLoadInstance().assignLoadGroup( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignLoadGroup( @RequestBody(required=true)  UnAssignLoadGroupFromConformLoadCommand command ) {
		try {
			ConformLoadBusinessDelegate.getConformLoadInstance().unAssignLoadGroup( command );   
		}
		catch( Exception exc ) {
