...
public class SynchronousMachineDynamicsCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save SynchronousMachine on SynchronousMachineDynamics
     * @param		command AssignSynchronousMachineToSynchronousMachineDynamicsCommand
     */     
	@PutMapping("/assignSynchronousMachine")
	public void assignSynchronousMachine( @RequestBody AssignSynchronousMachineToSynchronousMachineDynamicsCommand command ) {
		try {
			SynchronousMachineDynamicsBusinessDelegate.getSynchronousMachineDynamicsInstance().assignSynchronousMachine( command );   
		}
        catch( Throwable exc ) {
        	LOGGER.log( Level.WARNING, "Failed to assign SynchronousMachine", exc );
        }
	}

    /**
     * unassign SynchronousMachine on SynchronousMachineDynamics
     * @param		 command UnAssignSynchronousMachineFromSynchronousMachineDynamicsCommand
     */     
	@PutMapping("/unAssignSynchronousMachine")
	public void unAssignSynchronousMachine( @RequestBody(required=true)  UnAssignSynchronousMachineFromSynchronousMachineDynamicsCommand command ) {
		try {
			SynchronousMachineDynamicsBusinessDelegate.getSynchronousMachineDynamicsInstance().unAssignSynchronousMachine( command );   
		}
		catch( Exception exc ) {
			LOGGER.log( Level.WARNING, "Failed to unassign SynchronousMachine", exc );
		}
	}
