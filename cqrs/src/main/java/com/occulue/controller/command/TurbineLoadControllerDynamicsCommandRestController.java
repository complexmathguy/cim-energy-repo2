...
public class TurbineLoadControllerDynamicsCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save TurbineGovernorDynamics on TurbineLoadControllerDynamics
	...
	public void assignTurbineGovernorDynamics( @RequestBody AssignTurbineGovernorDynamicsToTurbineLoadControllerDynamicsCommand command ) {
		try {
			TurbineLoadControllerDynamicsBusinessDelegate.getTurbineLoadControllerDynamicsInstance().assignTurbineGovernorDynamics( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign TurbineGovernorDynamics on TurbineLoadControllerDynamics
	...
	public void unAssignTurbineGovernorDynamics( @RequestBody(required=true)  UnAssignTurbineGovernorDynamicsFromTurbineLoadControllerDynamicsCommand command ) {
		try {
			TurbineLoadControllerDynamicsBusinessDelegate.getTurbineLoadControllerDynamicsInstance().unAssignTurbineGovernorDynamics( command );   
		}
		catch( Exception exc ) {
