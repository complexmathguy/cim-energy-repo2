...
public class AccumulatorLimitCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save LimitSet on AccumulatorLimit
     * @param		command AssignLimitSetToAccumulatorLimitCommand
     */     
	@PutMapping("/addToLimitSet")
	public void addToLimitSet( @RequestBody(required=true) AssignLimitSetToAccumulatorLimitCommand command ) {
		try {
			AccumulatorLimitBusinessDelegate.getAccumulatorLimitInstance().addToLimitSet( command );   
		}
		catch( Exception exc ) {
    ...
    /**
     * remove LimitSet on AccumulatorLimit
     * @param		command RemoveLimitSetFromAccumulatorLimitCommand
     */     	
	@PutMapping("/removeFromLimitSet")
	public void removeFromLimitSet( 	@RequestBody(required=true) RemoveLimitSetFromAccumulatorLimitCommand command )
	{		
		try {
			AccumulatorLimitBusinessDelegate.getAccumulatorLimitInstance().removeFromLimitSet( command );
		}
		catch( Exception exc ) {
