...
public class OverexcitationLimiterDynamicsCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save ExcitationSystemDynamics on OverexcitationLimiterDynamics
	...
	public void assignExcitationSystemDynamics( @RequestBody AssignExcitationSystemDynamicsToOverexcitationLimiterDynamicsCommand command ) {
		try {
			OverexcitationLimiterDynamicsBusinessDelegate.getOverexcitationLimiterDynamicsInstance().assignExcitationSystemDynamics( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign ExcitationSystemDynamics on OverexcitationLimiterDynamics
	...
	public void unAssignExcitationSystemDynamics( @RequestBody(required=true)  UnAssignExcitationSystemDynamicsFromOverexcitationLimiterDynamicsCommand command ) {
		try {
			OverexcitationLimiterDynamicsBusinessDelegate.getOverexcitationLimiterDynamicsInstance().unAssignExcitationSystemDynamics( command );   
		}
		catch( Exception exc ) {
