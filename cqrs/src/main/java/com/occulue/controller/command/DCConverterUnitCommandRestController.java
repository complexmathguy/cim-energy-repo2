...
public class DCConverterUnitCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save Substation on DCConverterUnit
     * @param		command AssignSubstationToDCConverterUnitCommand
     */     
	@PutMapping("/assignSubstation")
	public void assignSubstation( @RequestBody AssignSubstationToDCConverterUnitCommand command ) {
		try {
			DCConverterUnitBusinessDelegate.getDCConverterUnitInstance().assignSubstation( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign Substation on DCConverterUnit
     * @param		 command UnAssignSubstationFromDCConverterUnitCommand
     */     
	@PutMapping("/unAssignSubstation")
	public void unAssignSubstation( @RequestBody(required=true)  UnAssignSubstationFromDCConverterUnitCommand command ) {
		try {
			DCConverterUnitBusinessDelegate.getDCConverterUnitInstance().unAssignSubstation( command );   
		}
		catch( Exception exc ) {
