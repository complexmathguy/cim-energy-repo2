...
public class TurbineGovernorDynamicsCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save AsynchronousMachineDynamics on TurbineGovernorDynamics
	...
	public void assignAsynchronousMachineDynamics( @RequestBody AssignAsynchronousMachineDynamicsToTurbineGovernorDynamicsCommand command ) {
		try {
			TurbineGovernorDynamicsBusinessDelegate.getTurbineGovernorDynamicsInstance().assignAsynchronousMachineDynamics( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign AsynchronousMachineDynamics on TurbineGovernorDynamics
	...
	public void unAssignAsynchronousMachineDynamics( @RequestBody(required=true)  UnAssignAsynchronousMachineDynamicsFromTurbineGovernorDynamicsCommand command ) {
		try {
			TurbineGovernorDynamicsBusinessDelegate.getTurbineGovernorDynamicsInstance().unAssignAsynchronousMachineDynamics( command );   
		}
		catch( Exception exc ) {
    ...
    /**
     * save SynchronousMachineDynamics on TurbineGovernorDynamics
	...
	public void assignSynchronousMachineDynamics( @RequestBody AssignSynchronousMachineDynamicsToTurbineGovernorDynamicsCommand command ) {
		try {
			TurbineGovernorDynamicsBusinessDelegate.getTurbineGovernorDynamicsInstance().assignSynchronousMachineDynamics( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign SynchronousMachineDynamics on TurbineGovernorDynamics
	...
	public void unAssignSynchronousMachineDynamics( @RequestBody(required=true)  UnAssignSynchronousMachineDynamicsFromTurbineGovernorDynamicsCommand command ) {
		try {
			TurbineGovernorDynamicsBusinessDelegate.getTurbineGovernorDynamicsInstance().unAssignSynchronousMachineDynamics( command );   
		}
		catch( Exception exc ) {
