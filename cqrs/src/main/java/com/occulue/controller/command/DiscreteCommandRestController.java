...
public class DiscreteCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save ValueAliasSet on Discrete
     * @param		command AssignValueAliasSetToDiscreteCommand
     */     
	@PutMapping("/addToValueAliasSet")
	public void addToValueAliasSet( @RequestBody(required=true) AssignValueAliasSetToDiscreteCommand command ) {
		try {
			DiscreteBusinessDelegate.getDiscreteInstance().addToValueAliasSet( command );   
		}
		catch( Exception exc ) {
    ...
    /**
     * remove ValueAliasSet on Discrete
     * @param		command RemoveValueAliasSetFromDiscreteCommand
     */     	
	@PutMapping("/removeFromValueAliasSet")
	public void removeFromValueAliasSet( 	@RequestBody(required=true) RemoveValueAliasSetFromDiscreteCommand command )
	{		
		try {
			DiscreteBusinessDelegate.getDiscreteInstance().removeFromValueAliasSet( command );
		}
		catch( Exception exc ) {
