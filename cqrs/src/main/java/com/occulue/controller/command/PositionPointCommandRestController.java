...
public class PositionPointCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save Location on PositionPoint
     * @param		command AssignLocationToPositionPointCommand
     */     
	@PutMapping("/assignLocation")
	public void assignLocation( @RequestBody AssignLocationToPositionPointCommand command ) {
		try {
			PositionPointBusinessDelegate.getPositionPointInstance().assignLocation( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign Location on PositionPoint
     * @param		 command UnAssignLocationFromPositionPointCommand
     */     
	@PutMapping("/unAssignLocation")
	public void unAssignLocation( @RequestBody(required=true)  UnAssignLocationFromPositionPointCommand command ) {
		try {
			PositionPointBusinessDelegate.getPositionPointInstance().unAssignLocation( command );   
		}
		catch( Exception exc ) {
