...
public class SwitchScheduleCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save SwitchIt on SwitchSchedule
     * @param		command AssignSwitchItToSwitchScheduleCommand
     */     
	@PutMapping("/assignSwitchIt")
	public void assignSwitchIt( @RequestBody AssignSwitchItToSwitchScheduleCommand command ) {
		try {
			SwitchScheduleBusinessDelegate.getSwitchScheduleInstance().assignSwitchIt( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignSwitchIt( @RequestBody(required=true)  UnAssignSwitchItFromSwitchScheduleCommand command ) {
		try {
			SwitchScheduleBusinessDelegate.getSwitchScheduleInstance().unAssignSwitchIt( command );   
		}
		catch( Exception exc ) {
