...
public class UnderexcitationLimiterDynamicsCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save ExcitationSystemDynamics on UnderexcitationLimiterDynamics
	...
	public void assignExcitationSystemDynamics( @RequestBody AssignExcitationSystemDynamicsToUnderexcitationLimiterDynamicsCommand command ) {
		try {
			UnderexcitationLimiterDynamicsBusinessDelegate.getUnderexcitationLimiterDynamicsInstance().assignExcitationSystemDynamics( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign ExcitationSystemDynamics on UnderexcitationLimiterDynamics
	...
	public void unAssignExcitationSystemDynamics( @RequestBody(required=true)  UnAssignExcitationSystemDynamicsFromUnderexcitationLimiterDynamicsCommand command ) {
		try {
			UnderexcitationLimiterDynamicsBusinessDelegate.getUnderexcitationLimiterDynamicsInstance().unAssignExcitationSystemDynamics( command );   
		}
		catch( Exception exc ) {
