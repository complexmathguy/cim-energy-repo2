...
public class SynchronousMachineCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save InitialReactiveCapabilityCurve on SynchronousMachine
     * @param		command AssignInitialReactiveCapabilityCurveToSynchronousMachineCommand
     */     
	@PutMapping("/assignInitialReactiveCapabilityCurve")
	public void assignInitialReactiveCapabilityCurve( @RequestBody AssignInitialReactiveCapabilityCurveToSynchronousMachineCommand command ) {
		try {
			SynchronousMachineBusinessDelegate.getSynchronousMachineInstance().assignInitialReactiveCapabilityCurve( command );   
		}
        catch( Throwable exc ) {
        	LOGGER.log( Level.WARNING, "Failed to assign InitialReactiveCapabilityCurve", exc );
        }
	}

    /**
     * unassign InitialReactiveCapabilityCurve on SynchronousMachine
     * @param		 command UnAssignInitialReactiveCapabilityCurveFromSynchronousMachineCommand
     */     
	@PutMapping("/unAssignInitialReactiveCapabilityCurve")
	public void unAssignInitialReactiveCapabilityCurve( @RequestBody(required=true)  UnAssignInitialReactiveCapabilityCurveFromSynchronousMachineCommand command ) {
		try {
			SynchronousMachineBusinessDelegate.getSynchronousMachineInstance().unAssignInitialReactiveCapabilityCurve( command );   
		}
		catch( Exception exc ) {
			LOGGER.log( Level.WARNING, "Failed to unassign InitialReactiveCapabilityCurve", exc );
		}
	}
