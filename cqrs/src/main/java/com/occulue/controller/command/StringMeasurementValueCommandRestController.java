...
public class StringMeasurementValueCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save StringMeasurement on StringMeasurementValue
     * @param		command AssignStringMeasurementToStringMeasurementValueCommand
     */     
	@PutMapping("/assignStringMeasurement")
	public void assignStringMeasurement( @RequestBody AssignStringMeasurementToStringMeasurementValueCommand command ) {
		try {
			StringMeasurementValueBusinessDelegate.getStringMeasurementValueInstance().assignStringMeasurement( command );   
		}
        catch( Throwable exc ) {
        	LOGGER.log( Level.WARNING, "Failed to assign StringMeasurement", exc );
        }
	}

    /**
     * unassign StringMeasurement on StringMeasurementValue
     * @param		 command UnAssignStringMeasurementFromStringMeasurementValueCommand
     */     
	@PutMapping("/unAssignStringMeasurement")
	public void unAssignStringMeasurement( @RequestBody(required=true)  UnAssignStringMeasurementFromStringMeasurementValueCommand command ) {
		try {
			StringMeasurementValueBusinessDelegate.getStringMeasurementValueInstance().unAssignStringMeasurement( command );   
		}
		catch( Exception exc ) {
			LOGGER.log( Level.WARNING, "Failed to unassign StringMeasurement", exc );
		}
	}
