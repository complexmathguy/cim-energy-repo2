...
public class DCNodeCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save DCEquipmentContainer on DCNode
     * @param		command AssignDCEquipmentContainerToDCNodeCommand
     */     
	@PutMapping("/assignDCEquipmentContainer")
	public void assignDCEquipmentContainer( @RequestBody AssignDCEquipmentContainerToDCNodeCommand command ) {
		try {
			DCNodeBusinessDelegate.getDCNodeInstance().assignDCEquipmentContainer( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDCEquipmentContainer( @RequestBody(required=true)  UnAssignDCEquipmentContainerFromDCNodeCommand command ) {
		try {
			DCNodeBusinessDelegate.getDCNodeInstance().unAssignDCEquipmentContainer( command );   
		}
		catch( Exception exc ) {
