...
public class ConnectivityNodeCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save ConnectivityNodeContainer on ConnectivityNode
     * @param		command AssignConnectivityNodeContainerToConnectivityNodeCommand
     */     
	@PutMapping("/assignConnectivityNodeContainer")
	public void assignConnectivityNodeContainer( @RequestBody AssignConnectivityNodeContainerToConnectivityNodeCommand command ) {
		try {
			ConnectivityNodeBusinessDelegate.getConnectivityNodeInstance().assignConnectivityNodeContainer( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign ConnectivityNodeContainer on ConnectivityNode
     * @param		 command UnAssignConnectivityNodeContainerFromConnectivityNodeCommand
     */     
	@PutMapping("/unAssignConnectivityNodeContainer")
	public void unAssignConnectivityNodeContainer( @RequestBody(required=true)  UnAssignConnectivityNodeContainerFromConnectivityNodeCommand command ) {
		try {
			ConnectivityNodeBusinessDelegate.getConnectivityNodeInstance().unAssignConnectivityNodeContainer( command );   
		}
		catch( Exception exc ) {
