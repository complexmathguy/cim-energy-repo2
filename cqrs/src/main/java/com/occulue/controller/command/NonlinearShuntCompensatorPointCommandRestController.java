...
public class NonlinearShuntCompensatorPointCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save NonlinearShuntCompensator on NonlinearShuntCompensatorPoint
     * @param		command AssignNonlinearShuntCompensatorToNonlinearShuntCompensatorPointCommand
     */     
	@PutMapping("/assignNonlinearShuntCompensator")
	public void assignNonlinearShuntCompensator( @RequestBody AssignNonlinearShuntCompensatorToNonlinearShuntCompensatorPointCommand command ) {
		try {
			NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance().assignNonlinearShuntCompensator( command );   
		}
        catch( Throwable exc ) {
        	LOGGER.log( Level.WARNING, "Failed to assign NonlinearShuntCompensator", exc );
        }
	}

    /**
     * unassign NonlinearShuntCompensator on NonlinearShuntCompensatorPoint
     * @param		 command UnAssignNonlinearShuntCompensatorFromNonlinearShuntCompensatorPointCommand
     */     
	@PutMapping("/unAssignNonlinearShuntCompensator")
	public void unAssignNonlinearShuntCompensator( @RequestBody(required=true)  UnAssignNonlinearShuntCompensatorFromNonlinearShuntCompensatorPointCommand command ) {
		try {
			NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance().unAssignNonlinearShuntCompensator( command );   
		}
		catch( Exception exc ) {
			LOGGER.log( Level.WARNING, "Failed to unassign NonlinearShuntCompensator", exc );
		}
	}
