...
public class PhaseTapChangerTabularCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save PhaseTapChangerTable on PhaseTapChangerTabular
     * @param		command AssignPhaseTapChangerTableToPhaseTapChangerTabularCommand
     */     
	@PutMapping("/assignPhaseTapChangerTable")
	public void assignPhaseTapChangerTable( @RequestBody AssignPhaseTapChangerTableToPhaseTapChangerTabularCommand command ) {
		try {
			PhaseTapChangerTabularBusinessDelegate.getPhaseTapChangerTabularInstance().assignPhaseTapChangerTable( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign PhaseTapChangerTable on PhaseTapChangerTabular
     * @param		 command UnAssignPhaseTapChangerTableFromPhaseTapChangerTabularCommand
     */     
	@PutMapping("/unAssignPhaseTapChangerTable")
	public void unAssignPhaseTapChangerTable( @RequestBody(required=true)  UnAssignPhaseTapChangerTableFromPhaseTapChangerTabularCommand command ) {
		try {
			PhaseTapChangerTabularBusinessDelegate.getPhaseTapChangerTabularInstance().unAssignPhaseTapChangerTable( command );   
		}
		catch( Exception exc ) {
