...
public class PhaseTapChangerCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save TransformerEnd on PhaseTapChanger
     * @param		command AssignTransformerEndToPhaseTapChangerCommand
     */     
	@PutMapping("/assignTransformerEnd")
	public void assignTransformerEnd( @RequestBody AssignTransformerEndToPhaseTapChangerCommand command ) {
		try {
			PhaseTapChangerBusinessDelegate.getPhaseTapChangerInstance().assignTransformerEnd( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTransformerEnd( @RequestBody(required=true)  UnAssignTransformerEndFromPhaseTapChangerCommand command ) {
		try {
			PhaseTapChangerBusinessDelegate.getPhaseTapChangerInstance().unAssignTransformerEnd( command );   
		}
		catch( Exception exc ) {
