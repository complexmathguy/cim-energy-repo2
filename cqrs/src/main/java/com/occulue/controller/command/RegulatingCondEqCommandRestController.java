...
public class RegulatingCondEqCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save RegulatingControl on RegulatingCondEq
     * @param		command AssignRegulatingControlToRegulatingCondEqCommand
     */     
	@PutMapping("/assignRegulatingControl")
	public void assignRegulatingControl( @RequestBody AssignRegulatingControlToRegulatingCondEqCommand command ) {
		try {
			RegulatingCondEqBusinessDelegate.getRegulatingCondEqInstance().assignRegulatingControl( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign RegulatingControl on RegulatingCondEq
     * @param		 command UnAssignRegulatingControlFromRegulatingCondEqCommand
     */     
	@PutMapping("/unAssignRegulatingControl")
	public void unAssignRegulatingControl( @RequestBody(required=true)  UnAssignRegulatingControlFromRegulatingCondEqCommand command ) {
		try {
			RegulatingCondEqBusinessDelegate.getRegulatingCondEqInstance().unAssignRegulatingControl( command );   
		}
		catch( Exception exc ) {
