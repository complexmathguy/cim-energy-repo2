...
public class SvInjectionCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save TopologicalNode on SvInjection
     * @param		command AssignTopologicalNodeToSvInjectionCommand
     */     
	@PutMapping("/assignTopologicalNode")
	public void assignTopologicalNode( @RequestBody AssignTopologicalNodeToSvInjectionCommand command ) {
		try {
			SvInjectionBusinessDelegate.getSvInjectionInstance().assignTopologicalNode( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTopologicalNode( @RequestBody(required=true)  UnAssignTopologicalNodeFromSvInjectionCommand command ) {
		try {
			SvInjectionBusinessDelegate.getSvInjectionInstance().unAssignTopologicalNode( command );   
		}
		catch( Exception exc ) {
