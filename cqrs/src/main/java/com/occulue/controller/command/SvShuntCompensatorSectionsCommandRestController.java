...
public class SvShuntCompensatorSectionsCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save ShuntCompensator on SvShuntCompensatorSections
     * @param		command AssignShuntCompensatorToSvShuntCompensatorSectionsCommand
     */     
	@PutMapping("/assignShuntCompensator")
	public void assignShuntCompensator( @RequestBody AssignShuntCompensatorToSvShuntCompensatorSectionsCommand command ) {
		try {
			SvShuntCompensatorSectionsBusinessDelegate.getSvShuntCompensatorSectionsInstance().assignShuntCompensator( command );   
		}
        catch( Throwable exc ) {
        	LOGGER.log( Level.WARNING, "Failed to assign ShuntCompensator", exc );
        }
	}

    /**
     * unassign ShuntCompensator on SvShuntCompensatorSections
     * @param		 command UnAssignShuntCompensatorFromSvShuntCompensatorSectionsCommand
     */     
	@PutMapping("/unAssignShuntCompensator")
	public void unAssignShuntCompensator( @RequestBody(required=true)  UnAssignShuntCompensatorFromSvShuntCompensatorSectionsCommand command ) {
		try {
			SvShuntCompensatorSectionsBusinessDelegate.getSvShuntCompensatorSectionsInstance().unAssignShuntCompensator( command );   
		}
		catch( Exception exc ) {
			LOGGER.log( Level.WARNING, "Failed to unassign ShuntCompensator", exc );
		}
	}
