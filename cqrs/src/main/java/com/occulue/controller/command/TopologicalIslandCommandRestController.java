...
public class TopologicalIslandCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save TopologicalNodes on TopologicalIsland
     * @param		command AssignTopologicalNodesToTopologicalIslandCommand
     */     
	@PutMapping("/assignTopologicalNodes")
	public void assignTopologicalNodes( @RequestBody AssignTopologicalNodesToTopologicalIslandCommand command ) {
		try {
			TopologicalIslandBusinessDelegate.getTopologicalIslandInstance().assignTopologicalNodes( command );   
		}
        catch( Throwable exc ) {
        	LOGGER.log( Level.WARNING, "Failed to assign TopologicalNodes", exc );
        }
	}

    /**
     * unassign TopologicalNodes on TopologicalIsland
     * @param		 command UnAssignTopologicalNodesFromTopologicalIslandCommand
     */     
	@PutMapping("/unAssignTopologicalNodes")
	public void unAssignTopologicalNodes( @RequestBody(required=true)  UnAssignTopologicalNodesFromTopologicalIslandCommand command ) {
		try {
			TopologicalIslandBusinessDelegate.getTopologicalIslandInstance().unAssignTopologicalNodes( command );   
		}
		catch( Exception exc ) {
			LOGGER.log( Level.WARNING, "Failed to unassign TopologicalNodes", exc );
		}
	}
	
    /**
     * save AngleRefTopologicalNode on TopologicalIsland
     * @param		command AssignAngleRefTopologicalNodeToTopologicalIslandCommand
     */     
	@PutMapping("/assignAngleRefTopologicalNode")
	public void assignAngleRefTopologicalNode( @RequestBody AssignAngleRefTopologicalNodeToTopologicalIslandCommand command ) {
		try {
			TopologicalIslandBusinessDelegate.getTopologicalIslandInstance().assignAngleRefTopologicalNode( command );   
		}
        catch( Throwable exc ) {
        	LOGGER.log( Level.WARNING, "Failed to assign AngleRefTopologicalNode", exc );
        }
	}

    /**
     * unassign AngleRefTopologicalNode on TopologicalIsland
     * @param		 command UnAssignAngleRefTopologicalNodeFromTopologicalIslandCommand
     */     
	@PutMapping("/unAssignAngleRefTopologicalNode")
	public void unAssignAngleRefTopologicalNode( @RequestBody(required=true)  UnAssignAngleRefTopologicalNodeFromTopologicalIslandCommand command ) {
		try {
			TopologicalIslandBusinessDelegate.getTopologicalIslandInstance().unAssignAngleRefTopologicalNode( command );   
		}
		catch( Exception exc ) {
			LOGGER.log( Level.WARNING, "Failed to unassign AngleRefTopologicalNode", exc );
		}
	}
