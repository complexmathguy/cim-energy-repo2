...
public class SvTapStepCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save TapChanger on SvTapStep
     * @param		command AssignTapChangerToSvTapStepCommand
     */     
	@PutMapping("/assignTapChanger")
	public void assignTapChanger( @RequestBody AssignTapChangerToSvTapStepCommand command ) {
		try {
			SvTapStepBusinessDelegate.getSvTapStepInstance().assignTapChanger( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign TapChanger on SvTapStep
     * @param		 command UnAssignTapChangerFromSvTapStepCommand
     */     
	@PutMapping("/unAssignTapChanger")
	public void unAssignTapChanger( @RequestBody(required=true)  UnAssignTapChangerFromSvTapStepCommand command ) {
		try {
			SvTapStepBusinessDelegate.getSvTapStepInstance().unAssignTapChanger( command );   
		}
		catch( Exception exc ) {
