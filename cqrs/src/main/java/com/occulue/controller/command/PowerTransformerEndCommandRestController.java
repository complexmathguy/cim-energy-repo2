...
public class PowerTransformerEndCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save PowerTransformer on PowerTransformerEnd
     * @param		command AssignPowerTransformerToPowerTransformerEndCommand
     */     
	@PutMapping("/assignPowerTransformer")
	public void assignPowerTransformer( @RequestBody AssignPowerTransformerToPowerTransformerEndCommand command ) {
		try {
			PowerTransformerEndBusinessDelegate.getPowerTransformerEndInstance().assignPowerTransformer( command );   
		}
        catch( Throwable exc ) {
        	LOGGER.log( Level.WARNING, "Failed to assign PowerTransformer", exc );
        }
	}

    /**
     * unassign PowerTransformer on PowerTransformerEnd
     * @param		 command UnAssignPowerTransformerFromPowerTransformerEndCommand
     */     
	@PutMapping("/unAssignPowerTransformer")
	public void unAssignPowerTransformer( @RequestBody(required=true)  UnAssignPowerTransformerFromPowerTransformerEndCommand command ) {
		try {
			PowerTransformerEndBusinessDelegate.getPowerTransformerEndInstance().unAssignPowerTransformer( command );   
		}
		catch( Exception exc ) {
			LOGGER.log( Level.WARNING, "Failed to unassign PowerTransformer", exc );
		}
	}
