...
public class VoltageCompensatorDynamicsCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save ExcitationSystemDynamics on VoltageCompensatorDynamics
     * @param		command AssignExcitationSystemDynamicsToVoltageCompensatorDynamicsCommand
     */     
	@PutMapping("/assignExcitationSystemDynamics")
	public void assignExcitationSystemDynamics( @RequestBody AssignExcitationSystemDynamicsToVoltageCompensatorDynamicsCommand command ) {
		try {
			VoltageCompensatorDynamicsBusinessDelegate.getVoltageCompensatorDynamicsInstance().assignExcitationSystemDynamics( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign ExcitationSystemDynamics on VoltageCompensatorDynamics
	...
	public void unAssignExcitationSystemDynamics( @RequestBody(required=true)  UnAssignExcitationSystemDynamicsFromVoltageCompensatorDynamicsCommand command ) {
		try {
			VoltageCompensatorDynamicsBusinessDelegate.getVoltageCompensatorDynamicsInstance().unAssignExcitationSystemDynamics( command );   
		}
		catch( Exception exc ) {
