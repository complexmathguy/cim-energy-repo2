...
public class GrossToNetActivePowerCurveCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save GeneratingUnit on GrossToNetActivePowerCurve
     * @param		command AssignGeneratingUnitToGrossToNetActivePowerCurveCommand
     */     
	@PutMapping("/assignGeneratingUnit")
	public void assignGeneratingUnit( @RequestBody AssignGeneratingUnitToGrossToNetActivePowerCurveCommand command ) {
		try {
			GrossToNetActivePowerCurveBusinessDelegate.getGrossToNetActivePowerCurveInstance().assignGeneratingUnit( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignGeneratingUnit( @RequestBody(required=true)  UnAssignGeneratingUnitFromGrossToNetActivePowerCurveCommand command ) {
		try {
			GrossToNetActivePowerCurveBusinessDelegate.getGrossToNetActivePowerCurveInstance().unAssignGeneratingUnit( command );   
		}
		catch( Exception exc ) {
