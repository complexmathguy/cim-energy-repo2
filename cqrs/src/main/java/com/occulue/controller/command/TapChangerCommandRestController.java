...
public class TapChangerCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save TapChangerControl on TapChanger
     * @param		command AssignTapChangerControlToTapChangerCommand
     */     
	@PutMapping("/assignTapChangerControl")
	public void assignTapChangerControl( @RequestBody AssignTapChangerControlToTapChangerCommand command ) {
		try {
			TapChangerBusinessDelegate.getTapChangerInstance().assignTapChangerControl( command );   
		}
        catch( Throwable exc ) {
        	LOGGER.log( Level.WARNING, "Failed to assign TapChangerControl", exc );
        }
	}

    /**
     * unassign TapChangerControl on TapChanger
     * @param		 command UnAssignTapChangerControlFromTapChangerCommand
     */     
	@PutMapping("/unAssignTapChangerControl")
	public void unAssignTapChangerControl( @RequestBody(required=true)  UnAssignTapChangerControlFromTapChangerCommand command ) {
		try {
			TapChangerBusinessDelegate.getTapChangerInstance().unAssignTapChangerControl( command );   
		}
		catch( Exception exc ) {
			LOGGER.log( Level.WARNING, "Failed to unassign TapChangerControl", exc );
		}
	}
