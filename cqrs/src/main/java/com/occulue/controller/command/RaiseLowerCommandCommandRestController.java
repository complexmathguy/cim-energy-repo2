...
public class RaiseLowerCommandCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save ValueAliasSet on RaiseLowerCommand
     * @param		command AssignValueAliasSetToRaiseLowerCommandCommand
     */     
	@PutMapping("/addToValueAliasSet")
	public void addToValueAliasSet( @RequestBody(required=true) AssignValueAliasSetToRaiseLowerCommandCommand command ) {
		try {
			RaiseLowerCommandBusinessDelegate.getRaiseLowerCommandInstance().addToValueAliasSet( command );   
		}
		catch( Exception exc ) {
    ...
    /**
     * remove ValueAliasSet on RaiseLowerCommand
     * @param		command RemoveValueAliasSetFromRaiseLowerCommandCommand
     */     	
	@PutMapping("/removeFromValueAliasSet")
	public void removeFromValueAliasSet( 	@RequestBody(required=true) RemoveValueAliasSetFromRaiseLowerCommandCommand command )
	{		
		try {
			RaiseLowerCommandBusinessDelegate.getRaiseLowerCommandInstance().removeFromValueAliasSet( command );
		}
		catch( Exception exc ) {
