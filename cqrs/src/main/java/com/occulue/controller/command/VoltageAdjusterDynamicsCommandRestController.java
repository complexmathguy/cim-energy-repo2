...
public class VoltageAdjusterDynamicsCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save PFVArControllerType1Dynamics on VoltageAdjusterDynamics
	...
	public void assignPFVArControllerType1Dynamics( @RequestBody AssignPFVArControllerType1DynamicsToVoltageAdjusterDynamicsCommand command ) {
		try {
			VoltageAdjusterDynamicsBusinessDelegate.getVoltageAdjusterDynamicsInstance().assignPFVArControllerType1Dynamics( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign PFVArControllerType1Dynamics on VoltageAdjusterDynamics
	...
	public void unAssignPFVArControllerType1Dynamics( @RequestBody(required=true)  UnAssignPFVArControllerType1DynamicsFromVoltageAdjusterDynamicsCommand command ) {
		try {
			VoltageAdjusterDynamicsBusinessDelegate.getVoltageAdjusterDynamicsInstance().unAssignPFVArControllerType1Dynamics( command );   
		}
		catch( Exception exc ) {
