...
public class RegulatingControlCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save Terminal on RegulatingControl
     * @param		command AssignTerminalToRegulatingControlCommand
     */     
	@PutMapping("/assignTerminal")
	public void assignTerminal( @RequestBody AssignTerminalToRegulatingControlCommand command ) {
		try {
			RegulatingControlBusinessDelegate.getRegulatingControlInstance().assignTerminal( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign Terminal on RegulatingControl
     * @param		 command UnAssignTerminalFromRegulatingControlCommand
     */     
	@PutMapping("/unAssignTerminal")
	public void unAssignTerminal( @RequestBody(required=true)  UnAssignTerminalFromRegulatingControlCommand command ) {
		try {
			RegulatingControlBusinessDelegate.getRegulatingControlInstance().unAssignTerminal( command );   
		}
		catch( Exception exc ) {
