...
public class SvStatusCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save ConductingEquipment on SvStatus
     * @param		command AssignConductingEquipmentToSvStatusCommand
     */     
	@PutMapping("/assignConductingEquipment")
	public void assignConductingEquipment( @RequestBody AssignConductingEquipmentToSvStatusCommand command ) {
		try {
			SvStatusBusinessDelegate.getSvStatusInstance().assignConductingEquipment( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign ConductingEquipment on SvStatus
     * @param		 command UnAssignConductingEquipmentFromSvStatusCommand
     */     
	@PutMapping("/unAssignConductingEquipment")
	public void unAssignConductingEquipment( @RequestBody(required=true)  UnAssignConductingEquipmentFromSvStatusCommand command ) {
		try {
			SvStatusBusinessDelegate.getSvStatusInstance().unAssignConductingEquipment( command );   
		}
		catch( Exception exc ) {
