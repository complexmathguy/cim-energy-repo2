...
public class HydroGeneratingUnitCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save HydroPowerPlant on HydroGeneratingUnit
     * @param		command AssignHydroPowerPlantToHydroGeneratingUnitCommand
     */     
	@PutMapping("/assignHydroPowerPlant")
	public void assignHydroPowerPlant( @RequestBody AssignHydroPowerPlantToHydroGeneratingUnitCommand command ) {
		try {
			HydroGeneratingUnitBusinessDelegate.getHydroGeneratingUnitInstance().assignHydroPowerPlant( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignHydroPowerPlant( @RequestBody(required=true)  UnAssignHydroPowerPlantFromHydroGeneratingUnitCommand command ) {
		try {
			HydroGeneratingUnitBusinessDelegate.getHydroGeneratingUnitInstance().unAssignHydroPowerPlant( command );   
		}
		catch( Exception exc ) {
