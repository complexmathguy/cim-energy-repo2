...
public class RegulationScheduleCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save RegulatingControl on RegulationSchedule
     * @param		command AssignRegulatingControlToRegulationScheduleCommand
     */     
	@PutMapping("/assignRegulatingControl")
	public void assignRegulatingControl( @RequestBody AssignRegulatingControlToRegulationScheduleCommand command ) {
		try {
			RegulationScheduleBusinessDelegate.getRegulationScheduleInstance().assignRegulatingControl( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign RegulatingControl on RegulationSchedule
     * @param		 command UnAssignRegulatingControlFromRegulationScheduleCommand
     */     
	@PutMapping("/unAssignRegulatingControl")
	public void unAssignRegulatingControl( @RequestBody(required=true)  UnAssignRegulatingControlFromRegulationScheduleCommand command ) {
		try {
			RegulationScheduleBusinessDelegate.getRegulationScheduleInstance().unAssignRegulatingControl( command );   
		}
		catch( Exception exc ) {
