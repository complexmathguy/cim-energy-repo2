...
public class PFVArControllerType2DynamicsCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save ExcitationSystemDynamics on PFVArControllerType2Dynamics
	...
	public void assignExcitationSystemDynamics( @RequestBody AssignExcitationSystemDynamicsToPFVArControllerType2DynamicsCommand command ) {
		try {
			PFVArControllerType2DynamicsBusinessDelegate.getPFVArControllerType2DynamicsInstance().assignExcitationSystemDynamics( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign ExcitationSystemDynamics on PFVArControllerType2Dynamics
	...
	public void unAssignExcitationSystemDynamics( @RequestBody(required=true)  UnAssignExcitationSystemDynamicsFromPFVArControllerType2DynamicsCommand command ) {
		try {
			PFVArControllerType2DynamicsBusinessDelegate.getPFVArControllerType2DynamicsInstance().unAssignExcitationSystemDynamics( command );   
		}
		catch( Exception exc ) {
