...
public class PowerSystemStabilizerDynamicsCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save ExcitationSystemDynamics on PowerSystemStabilizerDynamics
	...
	public void assignExcitationSystemDynamics( @RequestBody AssignExcitationSystemDynamicsToPowerSystemStabilizerDynamicsCommand command ) {
		try {
			PowerSystemStabilizerDynamicsBusinessDelegate.getPowerSystemStabilizerDynamicsInstance().assignExcitationSystemDynamics( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign ExcitationSystemDynamics on PowerSystemStabilizerDynamics
	...
	public void unAssignExcitationSystemDynamics( @RequestBody(required=true)  UnAssignExcitationSystemDynamicsFromPowerSystemStabilizerDynamicsCommand command ) {
		try {
			PowerSystemStabilizerDynamicsBusinessDelegate.getPowerSystemStabilizerDynamicsInstance().unAssignExcitationSystemDynamics( command );   
		}
		catch( Exception exc ) {
