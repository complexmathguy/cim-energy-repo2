...
public class PhaseTapChangerTablePointCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save PhaseTapChangerTable on PhaseTapChangerTablePoint
     * @param		command AssignPhaseTapChangerTableToPhaseTapChangerTablePointCommand
     */     
	@PutMapping("/assignPhaseTapChangerTable")
	public void assignPhaseTapChangerTable( @RequestBody AssignPhaseTapChangerTableToPhaseTapChangerTablePointCommand command ) {
		try {
			PhaseTapChangerTablePointBusinessDelegate.getPhaseTapChangerTablePointInstance().assignPhaseTapChangerTable( command );   
		}
        catch( Throwable exc ) {
        	LOGGER.log( Level.WARNING, "Failed to assign PhaseTapChangerTable", exc );
        }
	}

    /**
     * unassign PhaseTapChangerTable on PhaseTapChangerTablePoint
     * @param		 command UnAssignPhaseTapChangerTableFromPhaseTapChangerTablePointCommand
     */     
	@PutMapping("/unAssignPhaseTapChangerTable")
	public void unAssignPhaseTapChangerTable( @RequestBody(required=true)  UnAssignPhaseTapChangerTableFromPhaseTapChangerTablePointCommand command ) {
		try {
			PhaseTapChangerTablePointBusinessDelegate.getPhaseTapChangerTablePointInstance().unAssignPhaseTapChangerTable( command );   
		}
		catch( Exception exc ) {
			LOGGER.log( Level.WARNING, "Failed to unassign PhaseTapChangerTable", exc );
		}
	}
