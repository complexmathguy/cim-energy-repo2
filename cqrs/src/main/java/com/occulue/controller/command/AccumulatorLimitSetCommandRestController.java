...
public class AccumulatorLimitSetCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save Measurements on AccumulatorLimitSet
     * @param		command AssignMeasurementsToAccumulatorLimitSetCommand
     */     
	@PutMapping("/assignMeasurements")
	public void assignMeasurements( @RequestBody AssignMeasurementsToAccumulatorLimitSetCommand command ) {
		try {
			AccumulatorLimitSetBusinessDelegate.getAccumulatorLimitSetInstance().assignMeasurements( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign Measurements on AccumulatorLimitSet
     * @param		 command UnAssignMeasurementsFromAccumulatorLimitSetCommand
     */     
	@PutMapping("/unAssignMeasurements")
	public void unAssignMeasurements( @RequestBody(required=true)  UnAssignMeasurementsFromAccumulatorLimitSetCommand command ) {
		try {
			AccumulatorLimitSetBusinessDelegate.getAccumulatorLimitSetInstance().unAssignMeasurements( command );   
		}
		catch( Exception exc ) {
