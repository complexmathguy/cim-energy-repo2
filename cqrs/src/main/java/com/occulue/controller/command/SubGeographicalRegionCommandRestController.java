...
public class SubGeographicalRegionCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save Region on SubGeographicalRegion
     * @param		command AssignRegionToSubGeographicalRegionCommand
     */     
	@PutMapping("/assignRegion")
	public void assignRegion( @RequestBody AssignRegionToSubGeographicalRegionCommand command ) {
		try {
			SubGeographicalRegionBusinessDelegate.getSubGeographicalRegionInstance().assignRegion( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignRegion( @RequestBody(required=true)  UnAssignRegionFromSubGeographicalRegionCommand command ) {
		try {
			SubGeographicalRegionBusinessDelegate.getSubGeographicalRegionInstance().unAssignRegion( command );   
		}
		catch( Exception exc ) {
