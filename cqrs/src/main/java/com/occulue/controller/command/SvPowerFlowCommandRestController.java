...
public class SvPowerFlowCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save Terminal on SvPowerFlow
     * @param		command AssignTerminalToSvPowerFlowCommand
     */     
	@PutMapping("/assignTerminal")
	public void assignTerminal( @RequestBody AssignTerminalToSvPowerFlowCommand command ) {
		try {
			SvPowerFlowBusinessDelegate.getSvPowerFlowInstance().assignTerminal( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign Terminal on SvPowerFlow
     * @param		 command UnAssignTerminalFromSvPowerFlowCommand
     */     
	@PutMapping("/unAssignTerminal")
	public void unAssignTerminal( @RequestBody(required=true)  UnAssignTerminalFromSvPowerFlowCommand command ) {
		try {
			SvPowerFlowBusinessDelegate.getSvPowerFlowInstance().unAssignTerminal( command );   
		}
		catch( Exception exc ) {
