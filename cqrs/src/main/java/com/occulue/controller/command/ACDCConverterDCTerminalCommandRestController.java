...
public class ACDCConverterDCTerminalCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save DCConductingEquipment on ACDCConverterDCTerminal
     * @param		command AssignDCConductingEquipmentToACDCConverterDCTerminalCommand
     */     
	@PutMapping("/assignDCConductingEquipment")
	public void assignDCConductingEquipment( @RequestBody AssignDCConductingEquipmentToACDCConverterDCTerminalCommand command ) {
		try {
			ACDCConverterDCTerminalBusinessDelegate.getACDCConverterDCTerminalInstance().assignDCConductingEquipment( command );   
		}
        catch( Throwable exc ) {
        	LOGGER.log( Level.WARNING, "Failed to assign DCConductingEquipment", exc );
        }
	}

    /**
     * unassign DCConductingEquipment on ACDCConverterDCTerminal
     * @param		 command UnAssignDCConductingEquipmentFromACDCConverterDCTerminalCommand
     */     
	@PutMapping("/unAssignDCConductingEquipment")
	public void unAssignDCConductingEquipment( @RequestBody(required=true)  UnAssignDCConductingEquipmentFromACDCConverterDCTerminalCommand command ) {
		try {
			ACDCConverterDCTerminalBusinessDelegate.getACDCConverterDCTerminalInstance().unAssignDCConductingEquipment( command );   
		}
		catch( Exception exc ) {
			LOGGER.log( Level.WARNING, "Failed to unassign DCConductingEquipment", exc );
		}
	}
