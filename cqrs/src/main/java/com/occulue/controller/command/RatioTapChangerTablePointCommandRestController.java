...
public class RatioTapChangerTablePointCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save RatioTapChangerTable on RatioTapChangerTablePoint
     * @param		command AssignRatioTapChangerTableToRatioTapChangerTablePointCommand
     */     
	@PutMapping("/assignRatioTapChangerTable")
	public void assignRatioTapChangerTable( @RequestBody AssignRatioTapChangerTableToRatioTapChangerTablePointCommand command ) {
		try {
			RatioTapChangerTablePointBusinessDelegate.getRatioTapChangerTablePointInstance().assignRatioTapChangerTable( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignRatioTapChangerTable( @RequestBody(required=true)  UnAssignRatioTapChangerTableFromRatioTapChangerTablePointCommand command ) {
		try {
			RatioTapChangerTablePointBusinessDelegate.getRatioTapChangerTablePointInstance().unAssignRatioTapChangerTable( command );   
		}
		catch( Exception exc ) {
