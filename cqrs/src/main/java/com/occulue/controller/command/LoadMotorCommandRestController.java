...
public class LoadMotorCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save LoadAggregate on LoadMotor
     * @param		command AssignLoadAggregateToLoadMotorCommand
     */     
	@PutMapping("/assignLoadAggregate")
	public void assignLoadAggregate( @RequestBody AssignLoadAggregateToLoadMotorCommand command ) {
		try {
			LoadMotorBusinessDelegate.getLoadMotorInstance().assignLoadAggregate( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign LoadAggregate on LoadMotor
     * @param		 command UnAssignLoadAggregateFromLoadMotorCommand
     */     
	@PutMapping("/unAssignLoadAggregate")
	public void unAssignLoadAggregate( @RequestBody(required=true)  UnAssignLoadAggregateFromLoadMotorCommand command ) {
		try {
			LoadMotorBusinessDelegate.getLoadMotorInstance().unAssignLoadAggregate( command );   
		}
		catch( Exception exc ) {
