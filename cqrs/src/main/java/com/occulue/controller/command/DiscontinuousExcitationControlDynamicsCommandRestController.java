...
public class DiscontinuousExcitationControlDynamicsCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save ExcitationSystemDynamics on DiscontinuousExcitationControlDynamics
	...
	public void assignExcitationSystemDynamics( @RequestBody AssignExcitationSystemDynamicsToDiscontinuousExcitationControlDynamicsCommand command ) {
		try {
			DiscontinuousExcitationControlDynamicsBusinessDelegate.getDiscontinuousExcitationControlDynamicsInstance().assignExcitationSystemDynamics( command );   
		}
        catch( Throwable exc ) {
    ...
    /**
     * unassign ExcitationSystemDynamics on DiscontinuousExcitationControlDynamics
	...
	public void unAssignExcitationSystemDynamics( @RequestBody(required=true)  UnAssignExcitationSystemDynamicsFromDiscontinuousExcitationControlDynamicsCommand command ) {
		try {
			DiscontinuousExcitationControlDynamicsBusinessDelegate.getDiscontinuousExcitationControlDynamicsInstance().unAssignExcitationSystemDynamics( command );   
		}
		catch( Exception exc ) {
